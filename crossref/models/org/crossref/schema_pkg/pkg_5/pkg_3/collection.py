...
from crossref.models.org.crossref.schema_pkg.pkg_5.pkg_3.collection_multi_resolution import CollectionMultiResolution
from crossref.models.org.crossref.schema_pkg.pkg_5.pkg_3.collection_property import CollectionProperty
from crossref.models.org.crossref.schema_pkg.pkg_5.pkg_3.item import Item
...
class Collection:
    ...
    info:
    https://www.crossref.org/education/content-registration/creating-and-managing-dois/multiple-resolution/</li><li>country-based:
    more info:
    https://www.crossref.org/education/content-registration/creating-and-managing-dois/multiple-resolution/#00130</li><li>crawler-based:
    for Similarity Check URLs, more info:
