...
class TransportExecutionPlanType:
    ...
    transport_execution_plan_request_document_reference: Optional[TransportExecutionPlanRequestDocumentReference] = field(
        default=None,
        metadata={
    ...
    transport_service_description_document_reference: Optional[TransportServiceDescriptionDocumentReference] = field(
        default=None,
        metadata={
    ...
    transport_service_provider_response_required_period: Optional[TransportServiceProviderResponseRequiredPeriod] = field(
        default=None,
        metadata={
