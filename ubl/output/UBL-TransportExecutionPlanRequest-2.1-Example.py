...
from ubl.models.common.ubl_common_aggregate_components_2_1 import RequestedDeliveryTransportEvent
from ubl.models.common.ubl_common_aggregate_components_2_1 import RequestedPickupTransportEvent
...
from ubl.models.common.ubl_common_aggregate_components_2_1 import TransportServiceProviderResponseDeadlinePeriod
...
from ubl.models.maindoc.ubl_transport_execution_plan_request_2_1 import TransportExecutionPlanRequest
...
obj = TransportExecutionPlanRequest(
    ...
    transport_service_provider_response_deadline_period=[
        TransportServiceProviderResponseDeadlinePeriod(
            end_date=EndDate(
                value=XmlDate(2011, 9, 13)
            ),
            end_time=EndTime(
                value=XmlTime(11, 0, 10, 0, 60)
            )
        ),
    ],
    ...
    consignment=[
        Consignment(
            ...
            requested_pickup_transport_event=RequestedPickupTransportEvent(
                location=Location(
                    address=Address(
                        id=Id(
                            value='DEHAM',
            ...
            requested_delivery_transport_event=RequestedDeliveryTransportEvent(
                location=Location(
                    address=Address(
                        street_name=StreetName(
                            value='Grosse strasse 34'
