...
from ubl.models.common.ubl_common_aggregate_components_2_1 import DigitalSignatureAttachment
    ...
    signature=[
        Signature(
            ...
            signature_method=SignatureMethod(
                value='urn:oasis:names:specification:ubl:dsig:detached'
            ),
            ...
            digital_signature_attachment=DigitalSignatureAttachment(
                external_reference=ExternalReference(
                    uri=Uri(
                        value='UBL-Invoice-2.0-Detached-Signature.xml'
                    )
                )
            )
        ),
