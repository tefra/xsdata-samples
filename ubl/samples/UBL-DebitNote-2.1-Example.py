...
from ubl.models.common.ubl_common_aggregate_components_2_1 import DebitNoteLine
...
from ubl.models.common.ubl_common_aggregate_components_2_1 import RequestedMonetaryTotal
...
from ubl.models.common.ubl_common_basic_components_2_1 import DebitedQuantity
...
from ubl.models.maindoc.ubl_debit_note_2_1 import DebitNote
...
obj = DebitNote(
    ...
    debit_note_line=[
        DebitNoteLine(
            ...
            debited_quantity=DebitedQuantity(
                value=Decimal('1'),
                unit_code='C62'
            ),
            line_extension_amount=LineExtensionAmount(
