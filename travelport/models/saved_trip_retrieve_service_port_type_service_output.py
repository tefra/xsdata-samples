...
class SavedTripRetrieveServicePortTypeServiceOutput:
    ...
    body: SavedTripRetrieveServicePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: (
            None | SavedTripRetrieveServicePortTypeServiceOutput.Body.Fault
        ) = field(
            default=None,
            metadata={
                "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | SavedTripRetrieveServicePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
