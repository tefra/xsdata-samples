...
class BookingAirSegmentPortTypeServiceInput:
    ...
    header: BookingAirSegmentPortTypeServiceInput.Header = field(
        metadata={
            "name": "Header",
            "type": "Element",
        }
    )
    body: BookingAirSegmentPortTypeServiceInput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    @dataclass(kw_only=True)
    class Body:
        booking_air_segment_req: BookingAirSegmentReq = field(
            metadata={
