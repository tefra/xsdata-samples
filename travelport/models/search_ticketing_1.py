...
class SearchTicketing1:
    ...
    ticket_status: SearchTicketingTicketStatus1 = field(
        default=SearchTicketingTicketStatus1.BOTH,
        metadata={
            "name": "TicketStatus",
            "type": "Attribute",
        }
    )
    reservation_status: SearchTicketingReservationStatus1 = field(
        default=SearchTicketingReservationStatus1.BOTH,
        metadata={
