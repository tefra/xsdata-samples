...
class ServiceRuleType1:
    ...
    application_rules: None | ServiceRuleType1.ApplicationRules = field(
        default=None,
        metadata={
    ...
    application_level: None | ServiceRuleType1.ApplicationLevel = field(
        default=None,
        metadata={
    ...
    modify_rules: None | ServiceRuleType1.ModifyRules = field(
        default=None,
        metadata={
            "name": "ModifyRules",
            "type": "Element",
    ...
    secondary_type_rules: None | ServiceRuleType1.SecondaryTypeRules = field(
        default=None,
        metadata={
    ...
    remarks: list[FormattedTextTextType1] = field(
    ...
    class ApplicationLevel:
        ...
        provider_defined_applicable_levels
            ...
            mapped to Other
        """
        application_limits: None | ServiceRuleType1.ApplicationLevel.ApplicationLimits = field(
            default=None,
            metadata={
        ...
        applicable_levels: list[OptionalServiceApplicabilityType1] = field(
            default_factory=list,
            metadata={
        ...
        class ApplicationLimits:
            ...
            """
            application_limit: list[OptionalServiceApplicationLimitType1] = field(
                default_factory=list,
                metadata={
    ...
    class ModifyRules:
        ...
        provider_defined_modification_type
            ...
            mapped to Other
        """
        modify_rule: list[ServiceRuleType1.ModifyRules.ModifyRule] = field(
            default_factory=list,
            metadata={
                "name": "ModifyRule",
                "type": "Element",
        ...
        supported_modifications: list[ModificationType1] = field(
            default_factory=list,
            metadata={
        ...
        class ModifyRule:
            ...
            """
            modification: None | ModificationType1 = field(
                default=None,
                metadata={
                    "name": "Modification",
                    "type": "Attribute",
    ...
    class SecondaryTypeRules:
        ...
        secondary_type_rule
            ...
            service.
        """
        secondary_type_rule: list[ServiceRuleType1.SecondaryTypeRules.SecondaryTypeRule] = field(
            default_factory=list,
            metadata={
