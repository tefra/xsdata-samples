...
class ServiceRuleType1:
    ...
    class ApplicationLevel:
        ...
        application_limits: (
            None | ServiceRuleType1.ApplicationLevel.ApplicationLimits
        ) = field(
            default=None,
            metadata={
        ...
        class ApplicationLimits:
            ...
            application_limit: list[OptionalServiceApplicationLimitType1] = (
                field(
                    default_factory=list,
                    metadata={
    ...
    class SecondaryTypeRules:
        ...
        secondary_type_rule: list[
            ServiceRuleType1.SecondaryTypeRules.SecondaryTypeRule
        ] = field(
            default_factory=list,
            metadata={
