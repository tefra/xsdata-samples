...
class TransactionType1:
    ...
    air: None | TransactionType1.Air = field(
        default=None,
        metadata={
            "name": "Air",
            "type": "Element",
    ...
    hotel: None | TypeTransactionsAllowed1 = field(
        default=None,
        metadata={
            "name": "Hotel",
            "type": "Element",
    ...
    rail: None | TypeTransactionsAllowed1 = field(
        default=None,
        metadata={
            "name": "Rail",
            "type": "Element",
    ...
    vehicle: None | TypeTransactionsAllowed1 = field(
        default=None,
        metadata={
            "name": "Vehicle",
            "type": "Element",
    ...
    passive: None | TypeBookingTransactionsAllowed1 = field(
        default=None,
        metadata={
            "name": "Passive",
            "type": "Element",
    ...
    background_passive: None | TypeBookingTransactionsAllowed1 = field(
        default=None,
        metadata={
    ...
    @dataclass
    class Air(TypeTransactionsAllowed1):
        """
        Parameters
        ----------
        tier
        ...
        return_upsell_fare
            ...
            shop response.  Provider: 1G, 1V, 1P, ACH
        """

        tier: None | AirTier1 = field(
            default=None,
            metadata={
                "name": "Tier",
                "type": "Attribute",
