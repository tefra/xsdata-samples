...
class HotelUpsellSearchServicePortTypeServiceOutput:
    ...
    body: HotelUpsellSearchServicePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: (
            None | HotelUpsellSearchServicePortTypeServiceOutput.Body.Fault
        ) = field(
            default=None,
            metadata={
                "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | HotelUpsellSearchServicePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
