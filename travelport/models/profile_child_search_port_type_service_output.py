...
class ProfileChildSearchPortTypeServiceOutput:
    ...
    body: None | ProfileChildSearchPortTypeServiceOutput.Body = field(
        default=None,
        metadata={
            "name": "Body",
            "type": "Element",
    ...
    class Body:
        ...
        fault: None | ProfileChildSearchPortTypeServiceOutput.Body.Fault = field(
            default=None,
            metadata={
                "name": "Fault",
                "type": "Element",
        ...
        class Fault:
            ...
            detail: None | ProfileChildSearchPortTypeServiceOutput.Body.Fault.Detail = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "",
