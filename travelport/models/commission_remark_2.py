...
class CommissionRemark2:
    ...
    provider_reservation_level: None | CommissionRemark2.ProviderReservationLevel = field(
        default=None,
        metadata={
    ...
    passenger_type_level: list[CommissionRemark2.PassengerTypeLevel] = field(
