...
class AirExchangeInfo6:
    ...
    total_penalty_tax_info: None | AirExchangeInfo6.TotalPenaltyTaxInfo = field(
        default=None,
        metadata={
    ...
    ticket_fee_info: list[AirExchangeInfo6.TicketFeeInfo] = field(
        default_factory=list,
        metadata={
            "name": "TicketFeeInfo",
            "type": "Element",
    ...
    fee_info: list[TypeFeeInfo6] = field(
        default_factory=list,
        metadata={
            "name": "FeeInfo",
            "type": "Element",
    ...
    fare_pull: None | TypeFarePull6 = field(
        default=None,
        metadata={
            "name": "FarePull",
            "type": "Attribute",
    ...
    class TotalPenaltyTaxInfo:
        penalty_tax_info: list[TypeTax6] = field(
            default_factory=list,
            metadata={
                "name": "PenaltyTaxInfo",
                "type": "Element",
