...
class HotelRulesServicePortTypeServiceOutput:
    ...
    body: None | HotelRulesServicePortTypeServiceOutput.Body = field(
        default=None,
        metadata={
            "name": "Body",
            "type": "Element",
    ...
    @dataclass
    class Body:
        hotel_rules_rsp: None | HotelRulesRsp = field(
            default=None,
            metadata={
                "name": "HotelRulesRsp",
                "type": "Element",
        ...
        fault: None | HotelRulesServicePortTypeServiceOutput.Body.Fault = field(
            default=None,
            metadata={
                "name": "Fault",
                "type": "Element",
