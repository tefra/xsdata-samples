...
@dataclass
class TypeCreditCardType1(TypePaymentCard1):
    """
    Parameters
    ----------
    extended_payment
        Used for American Express (AX) and other credit cards, e.g., Visa
        (VI) and Master card (CA), that allow Extended Payment, subject to
        the BSP market rule.
    customer_reference
