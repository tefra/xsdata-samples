...
class BookingHotelPnrElementPortTypeServiceInput:
    ...
    header: BookingHotelPnrElementPortTypeServiceInput.Header = field(
        metadata={
            "name": "Header",
            "type": "Element",
        }
    )
    body: BookingHotelPnrElementPortTypeServiceInput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    @dataclass(kw_only=True)
    class Body:
        booking_hotel_pnr_element_req: BookingHotelPnrElementReq = field(
            metadata={
