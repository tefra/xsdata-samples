...
class ServiceRuleType3:
    ...
    application_rules: None | ServiceRuleType3.ApplicationRules = field(
        default=None,
        metadata={
    ...
    application_level: None | ServiceRuleType3.ApplicationLevel = field(
        default=None,
        metadata={
    ...
    modify_rules: None | ServiceRuleType3.ModifyRules = field(
        default=None,
        metadata={
            "name": "ModifyRules",
            "type": "Element",
    ...
    secondary_type_rules: None | ServiceRuleType3.SecondaryTypeRules = field(
        default=None,
        metadata={
    ...
    remarks: list[FormattedTextTextType3] = field(
    ...
    class ApplicationLevel:
        ...
        provider_defined_applicable_levels
            ...
            mapped to Other
        """
        application_limits: None | ServiceRuleType3.ApplicationLevel.ApplicationLimits = field(
            default=None,
            metadata={
        ...
        service_data: list[ServiceData3] = field(
            default_factory=list,
            metadata={
                "name": "ServiceData",
                "type": "Element",
        ...
        applicable_levels: list[OptionalServiceApplicabilityType3] = field(
            default_factory=list,
            metadata={
        ...
        class ApplicationLimits:
            ...
            """
            application_limit: list[OptionalServiceApplicationLimitType3] = field(
                default_factory=list,
                metadata={
    ...
    class ModifyRules:
        ...
        provider_defined_modification_type
            ...
            mapped to Other
        """
        modify_rule: list[ServiceRuleType3.ModifyRules.ModifyRule] = field(
            default_factory=list,
            metadata={
                "name": "ModifyRule",
                "type": "Element",
        ...
        supported_modifications: list[ModificationType3] = field(
            default_factory=list,
            metadata={
        ...
        class ModifyRule:
            ...
            """
            modification: None | ModificationType3 = field(
                default=None,
                metadata={
                    "name": "Modification",
                    "type": "Attribute",
    ...
    class SecondaryTypeRules:
        ...
        secondary_type_rule
            ...
            service.
        """
        secondary_type_rule: list[ServiceRuleType3.SecondaryTypeRules.SecondaryTypeRule] = field(
            default_factory=list,
            metadata={
