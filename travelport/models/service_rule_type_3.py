...
class ServiceRuleType3:
    ...
    class ApplicationLevel:
        ...
        application_limits: (
            None | ServiceRuleType3.ApplicationLevel.ApplicationLimits
        ) = field(
            default=None,
            metadata={
        ...
        class ApplicationLimits:
            ...
            application_limit: list[OptionalServiceApplicationLimitType3] = (
                field(
                    default_factory=list,
                    metadata={
    ...
    class SecondaryTypeRules:
        ...
        secondary_type_rule: list[
            ServiceRuleType3.SecondaryTypeRules.SecondaryTypeRule
        ] = field(
            default_factory=list,
            metadata={
