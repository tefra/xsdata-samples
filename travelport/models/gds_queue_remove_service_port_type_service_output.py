...
class GdsQueueRemoveServicePortTypeServiceOutput:
    ...
    body: None | GdsQueueRemoveServicePortTypeServiceOutput.Body = field(
        default=None,
        metadata={
            "name": "Body",
            "type": "Element",
    ...
    @dataclass
    class Body:
        gds_queue_remove_rsp: None | GdsQueueRemoveRsp = field(
            default=None,
            metadata={
        ...
        class Fault:
            ...
            detail: (
                None
                | GdsQueueRemoveServicePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
