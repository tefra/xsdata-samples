...
class AirExchangeInfo3:
    ...
    total_penalty_tax_info: None | AirExchangeInfo3.TotalPenaltyTaxInfo = field(
        default=None,
        metadata={
    ...
    ticket_fee_info: list[AirExchangeInfo3.TicketFeeInfo] = field(
        default_factory=list,
        metadata={
            "name": "TicketFeeInfo",
            "type": "Element",
    ...
    fee_info: list[TypeFeeInfo3] = field(
        default_factory=list,
        metadata={
            "name": "FeeInfo",
            "type": "Element",
    ...
    fare_pull: None | TypeFarePull3 = field(
        default=None,
        metadata={
            "name": "FarePull",
            "type": "Attribute",
