...
class TravelComplianceData4:
    ...
    policy_compliance: list[TravelComplianceData4.PolicyCompliance] = field(
    ...
    contract_compliance: list[TravelComplianceData4.ContractCompliance] = (
        field(
            default_factory=list,
            metadata={
    ...
    preferred_supplier: list[TravelComplianceData4.PreferredSupplier] = field(
        default_factory=list,
        metadata={
    ...
    class PreferredSupplier:
        ...
        profile_type: TypeProfileType6 = field(
            metadata={
                "name": "ProfileType",
                "type": "Attribute",
                "required": True,
