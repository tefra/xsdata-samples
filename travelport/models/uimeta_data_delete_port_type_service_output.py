...
class UimetaDataDeletePortTypeServiceOutput:
    ...
    body: None | UimetaDataDeletePortTypeServiceOutput.Body = field(
        default=None,
        metadata={
            "name": "Body",
            "type": "Element",
    ...
    @dataclass
    class Body:
        uimeta_data_delete_rsp: None | UimetaDataDeleteRsp = field(
            default=None,
            metadata={
        ...
        fault: None | UimetaDataDeletePortTypeServiceOutput.Body.Fault = field(
            default=None,
            metadata={
                "name": "Fault",
                "type": "Element",
