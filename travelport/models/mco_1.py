...
class Mco1(Mcoinformation1):
    ...
    endorsement: None | Endorsement1 = field(
        default=None,
        metadata={
            "name": "Endorsement",
            "type": "Element",
    ...
    mcoexchange_info: None | McoexchangeInfo1 = field(
        default=None,
        metadata={
    ...
    mcofee_info: None | McofeeInfo1 = field(
        default=None,
        metadata={
            "name": "MCOFeeInfo",
            "type": "Element",
    ...
    mcoremark: list[Mcoremark1] = field(
        default_factory=list,
        metadata={
            "name": "MCORemark",
            "type": "Element",
    ...
    mcoprice_data: None | McopriceData1 = field(
        default=None,
        metadata={
            "name": "MCOPriceData",
            "type": "Element",
    ...
    stock_control: list[StockControl1] = field(
        default_factory=list,
        metadata={
            "name": "StockControl",
            "type": "Element",
