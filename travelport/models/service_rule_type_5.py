...
class ServiceRuleType5:
    ...
    class ApplicationLevel:
        ...
        provider_defined_applicable_levels
            ...
            mapped to Other
        """
        application_limits: None | ServiceRuleType5.ApplicationLevel.ApplicationLimits = field(
            default=None,
            metadata={
        ...
        class ApplicationLimits:
            ...
            """
            application_limit: list[OptionalServiceApplicationLimitType5] = field(
                default_factory=list,
                metadata={
    ...
    class ModifyRules:
        ...
        class ModifyRule:
            ...
            """
            modification: None | ModificationType5 = field(
                default=None,
                metadata={
                    "name": "Modification",
                    "type": "Attribute",
    ...
    class SecondaryTypeRules:
        ...
        secondary_type_rule
            ...
            service.
        """
        secondary_type_rule: list[ServiceRuleType5.SecondaryTypeRules.SecondaryTypeRule] = field(
            default_factory=list,
            metadata={
