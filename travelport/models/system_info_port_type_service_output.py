...
class SystemInfoPortTypeServiceOutput:
    ...
    body: None | SystemInfoPortTypeServiceOutput.Body = field(
        default=None,
        metadata={
            "name": "Body",
            "type": "Element",
    ...
    @dataclass
    class Body:
        system_info_rsp: None | SystemInfoRsp = field(
            default=None,
            metadata={
                "name": "SystemInfoRsp",
                "type": "Element",
        ...
        fault: None | SystemInfoPortTypeServiceOutput.Body.Fault = field(
            default=None,
            metadata={
                "name": "Fault",
                "type": "Element",
