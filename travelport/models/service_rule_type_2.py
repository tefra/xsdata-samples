...
class ServiceRuleType2:
    ...
    class ApplicationLevel:
        ...
        application_limits: (
            None | ServiceRuleType2.ApplicationLevel.ApplicationLimits
        ) = field(
            default=None,
            metadata={
        ...
        class ApplicationLimits:
            ...
            application_limit: list[OptionalServiceApplicationLimitType2] = (
                field(
                    default_factory=list,
                    metadata={
    ...
    class SecondaryTypeRules:
        ...
        secondary_type_rule: list[
            ServiceRuleType2.SecondaryTypeRules.SecondaryTypeRule
        ] = field(
            default_factory=list,
            metadata={
