...
class VehicleLocationServicePortTypeServiceOutput:
    ...
    class Body:
        ...
        fault: None | VehicleLocationServicePortTypeServiceOutput.Body.Fault = field(
            default=None,
            metadata={
                "name": "Fault",
                "type": "Element",
        ...
        class Fault:
            ...
            detail: None | VehicleLocationServicePortTypeServiceOutput.Body.Fault.Detail = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "",
