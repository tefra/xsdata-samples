...
class HotelSuperShopperServicePortTypeServiceOutput:
    ...
    body: HotelSuperShopperServicePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: (
            None | HotelSuperShopperServicePortTypeServiceOutput.Body.Fault
        ) = field(
            default=None,
            metadata={
                "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | HotelSuperShopperServicePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
