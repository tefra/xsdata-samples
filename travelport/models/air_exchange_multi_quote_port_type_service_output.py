...
class AirExchangeMultiQuotePortTypeServiceOutput:
    ...
    body: AirExchangeMultiQuotePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: None | AirExchangeMultiQuotePortTypeServiceOutput.Body.Fault = (
            field(
                default=None,
                metadata={
                    "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | AirExchangeMultiQuotePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
