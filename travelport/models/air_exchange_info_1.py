...
class AirExchangeInfo1:
    ...
    total_penalty_tax_info: None | AirExchangeInfo1.TotalPenaltyTaxInfo = field(
        default=None,
        metadata={
    ...
    ticket_fee_info: list[AirExchangeInfo1.TicketFeeInfo] = field(
        default_factory=list,
        metadata={
            "name": "TicketFeeInfo",
            "type": "Element",
    ...
    fee_info: list[TypeFeeInfo1] = field(
        default_factory=list,
        metadata={
            "name": "FeeInfo",
            "type": "Element",
    ...
    tax_info: list[TypeTaxInfo1] = field(
        default_factory=list,
        metadata={
            "name": "TaxInfo",
            "type": "Element",
    ...
    fare_pull: None | TypeFarePull1 = field(
        default=None,
        metadata={
            "name": "FarePull",
            "type": "Attribute",
    ...
    class TotalPenaltyTaxInfo:
        penalty_tax_info: list[TypeTax1] = field(
            default_factory=list,
            metadata={
                "name": "PenaltyTaxInfo",
                "type": "Element",
