...
class CommissionRemark1:
    ...
    provider_reservation_level: None | CommissionRemark1.ProviderReservationLevel = field(
        default=None,
        metadata={
    ...
    passenger_type_level: list[CommissionRemark1.PassengerTypeLevel] = field(
