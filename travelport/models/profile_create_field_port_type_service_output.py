...
class ProfileCreateFieldPortTypeServiceOutput:
    ...
    body: ProfileCreateFieldPortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: None | ProfileCreateFieldPortTypeServiceOutput.Body.Fault = (
            field(
                default=None,
                metadata={
                    "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | ProfileCreateFieldPortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
