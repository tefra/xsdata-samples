...
from travelport.models.travelport_com_schema_common_v48_0 import (
    ...
    Payment,
    PaymentRestriction,
    Penalty as TravelportComSchemaCommonV480Penalty,
    PhoneNumber,
    PointOfCommencement,
    PointOfSale,
    Provider,
    ...
    Remark,
    ResponseMessage,
    Restriction as TravelportComSchemaCommonV480Restriction,
    Ssr,
    Ssrinfo,
    SearchPassenger,
    Segment,
    ...
    TypeResultMessage,
    TypeSearchLocation,
    TypeSegmentRef as TravelportComSchemaCommonV480TypeSegmentRef,
...
class AirExchangeBundleTotal:
    ...
    penalty: List[TravelportComSchemaCommonV480Penalty] = field(
        default_factory=list,
        metadata=dict(
            name="Penalty",
            type="Element",
...
class BrandingInfo:
    ...
    air_segment_ref: List[TravelportComSchemaCommonV480TypeSegmentRef] = field(
        default_factory=list,
        metadata=dict(
            name="AirSegmentRef",
            type="Element",
...
class Etr:
    ...
    restriction: List[TravelportComSchemaCommonV480Restriction] = field(
        default_factory=list,
        metadata=dict(
            name="Restriction",
            type="Element",
