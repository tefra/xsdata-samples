...
class VehicleLocationDetailServicePortTypeServiceInput:
    ...
    header: VehicleLocationDetailServicePortTypeServiceInput.Header = field(
        metadata={
            "name": "Header",
            "type": "Element",
        }
    )
    body: VehicleLocationDetailServicePortTypeServiceInput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    @dataclass(kw_only=True)
    class Body:
        vehicle_location_detail_req: VehicleLocationDetailReq = field(
            metadata={
