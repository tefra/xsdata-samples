...
class TravelDocument1(TypeKeyTaggedElement1):
    ...
    address: None | TypeTravelDocumentAddress1 = field(
        default=None,
        metadata={
            "name": "Address",
            "type": "Element",
    ...
    height_unit: None | TravelDocumentHeightUnit1 = field(
        default=None,
        metadata={
            "name": "HeightUnit",
            "type": "Attribute",
    ...
    weight_unit: None | TravelDocumentWeightUnit1 = field(
        default=None,
        metadata={
            "name": "WeightUnit",
            "type": "Attribute",
    ...
    issued_for_geo_political_area_type: None | TypeGeoPoliticalAreaType1 = field(
        default=None,
        metadata={
