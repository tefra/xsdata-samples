...
class HotelReservationServicePortTypeServiceOutput:
    ...
    body: HotelReservationServicePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: (
            None | HotelReservationServicePortTypeServiceOutput.Body.Fault
        ) = field(
            default=None,
            metadata={
                "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | HotelReservationServicePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
