...
class CommissionRemark5:
    ...
    provider_reservation_level: None | CommissionRemark5.ProviderReservationLevel = field(
        default=None,
        metadata={
    ...
    passenger_type_level: list[CommissionRemark5.PassengerTypeLevel] = field(
