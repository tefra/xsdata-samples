...
class ProfileModifyTemplatePortTypeServiceOutput:
    ...
    body: ProfileModifyTemplatePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: None | ProfileModifyTemplatePortTypeServiceOutput.Body.Fault = (
            field(
                default=None,
                metadata={
                    "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | ProfileModifyTemplatePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
