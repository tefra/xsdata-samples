...
class TravelComplianceData5:
    ...
    policy_compliance: list[TravelComplianceData5.PolicyCompliance] = field(
    ...
    contract_compliance: list[TravelComplianceData5.ContractCompliance] = (
        field(
            default_factory=list,
            metadata={
    ...
    class PreferredSupplier:
        ...
        profile_type: TypeProfileType8 = field(
            metadata={
                "name": "ProfileType",
                "type": "Attribute",
                "required": True,
