...
class TravelComplianceData6:
    ...
    policy_compliance: list[TravelComplianceData6.PolicyCompliance] = field(
    ...
    contract_compliance: list[TravelComplianceData6.ContractCompliance] = field(
        default_factory=list,
        metadata={
    ...
    preferred_supplier: list[TravelComplianceData6.PreferredSupplier] = field(
        default_factory=list,
        metadata={
    ...
    class PreferredSupplier:
        ...
        profile_type: None | TypeProfileType9 = field(
            default=None,
            metadata={
                "name": "ProfileType",
                "type": "Attribute",
