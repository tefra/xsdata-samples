...
class VehicleMediaLinksServicePortTypeServiceOutput:
    ...
    body: VehicleMediaLinksServicePortTypeServiceOutput.Body = field(
        metadata={
            "name": "Body",
            "type": "Element",
        }
    ...
    class Body:
        ...
        fault: (
            None | VehicleMediaLinksServicePortTypeServiceOutput.Body.Fault
        ) = field(
            default=None,
            metadata={
                "name": "Fault",
        ...
        class Fault:
            ...
            detail: (
                None
                | VehicleMediaLinksServicePortTypeServiceOutput.Body.Fault.Detail
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
