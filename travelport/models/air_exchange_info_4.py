...
class AirExchangeInfo4:
    ...
    total_penalty_tax_info: None | AirExchangeInfo4.TotalPenaltyTaxInfo = field(
        default=None,
        metadata={
    ...
    ticket_fee_info: list[AirExchangeInfo4.TicketFeeInfo] = field(
        default_factory=list,
        metadata={
            "name": "TicketFeeInfo",
            "type": "Element",
    ...
    fee_info: list[TypeFeeInfo4] = field(
        default_factory=list,
        metadata={
            "name": "FeeInfo",
            "type": "Element",
    ...
    tax_info: list[TypeTaxInfo4] = field(
        default_factory=list,
        metadata={
            "name": "TaxInfo",
            "type": "Element",
    ...
    fare_pull: None | TypeFarePull4 = field(
        default=None,
        metadata={
            "name": "FarePull",
            "type": "Attribute",
    ...
    class TotalPenaltyTaxInfo:
        penalty_tax_info: list[TypeTax4] = field(
            default_factory=list,
            metadata={
                "name": "PenaltyTaxInfo",
                "type": "Element",
