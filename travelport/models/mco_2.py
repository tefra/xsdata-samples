...
class Mco2(Mcoinformation2):
    ...
    endorsement: None | Endorsement2 = field(
        default=None,
        metadata={
            "name": "Endorsement",
            "type": "Element",
    ...
    mcoexchange_info: None | McoexchangeInfo2 = field(
        default=None,
        metadata={
    ...
    mcofee_info: None | McofeeInfo2 = field(
        default=None,
        metadata={
            "name": "MCOFeeInfo",
            "type": "Element",
    ...
    mcoremark: list[Mcoremark2] = field(
        default_factory=list,
        metadata={
            "name": "MCORemark",
            "type": "Element",
    ...
    mcoprice_data: None | McopriceData2 = field(
        default=None,
        metadata={
            "name": "MCOPriceData",
            "type": "Element",
    ...
    stock_control: list[StockControl2] = field(
        default_factory=list,
        metadata={
            "name": "StockControl",
            "type": "Element",
