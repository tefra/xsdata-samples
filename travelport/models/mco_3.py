...
class Mco3(Mcoinformation3):
    ...
    endorsement: None | Endorsement3 = field(
        default=None,
        metadata={
            "name": "Endorsement",
            "type": "Element",
    ...
    mcoexchange_info: None | McoexchangeInfo3 = field(
        default=None,
        metadata={
    ...
    mcofee_info: None | McofeeInfo3 = field(
        default=None,
        metadata={
            "name": "MCOFeeInfo",
            "type": "Element",
    ...
    mcoremark: list[Mcoremark3] = field(
        default_factory=list,
        metadata={
            "name": "MCORemark",
            "type": "Element",
    ...
    mcoprice_data: None | McopriceData3 = field(
        default=None,
        metadata={
            "name": "MCOPriceData",
            "type": "Element",
    ...
    stock_control: list[StockControl3] = field(
        default_factory=list,
        metadata={
            "name": "StockControl",
            "type": "Element",
