...
class TravelComplianceData1:
    ...
    policy_compliance: list[TravelComplianceData1.PolicyCompliance] = field(
    ...
    contract_compliance: list[TravelComplianceData1.ContractCompliance] = field(
        default_factory=list,
        metadata={
    ...
    preferred_supplier: list[TravelComplianceData1.PreferredSupplier] = field(
        default_factory=list,
        metadata={
    ...
    class PreferredSupplier:
        ...
        profile_type: None | TypeProfileType1 = field(
            default=None,
            metadata={
                "name": "ProfileType",
                "type": "Attribute",
