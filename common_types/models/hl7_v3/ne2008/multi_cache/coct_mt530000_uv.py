...
class CoctMt530000UvMaterialKind2:
    ...
    determiner_code: EntityDeterminerDetermined | None = field(
        default=None,
        metadata={
            "name": "determinerCode",
            "type": "Attribute",
...
class CoctMt530000UvBirthplace:
    ...
    birthplace: CoctMt530000UvPlace | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt530000UvConditions:
    ...
    criterion: CoctMt530000UvCriterion | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt530000UvDefinition:
    ...
    act_definition: CoctMt530000UvActDefinition | None = field(
        default=None,
        metadata={
            "name": "actDefinition",
            "type": "Element",
...
class CoctMt530000UvHealthCareFacility:
    ...
    location: CoctMt530000UvPlace | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    service_provider_organization: CoctMt530000UvOrganization | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvManufacturedProduct:
    ...
    manufactured_labeled_drug: CoctMt530000UvLabeledDrug | None = field(
        default=None,
        metadata={
    ...
    manufactured_material: CoctMt530000UvMaterial | None = field(
        default=None,
        metadata={
    ...
    manufacturer_organization: CoctMt530000UvOrganization | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvMaterialPart:
    ...
    part_material_kind: CoctMt530000UvMaterialKind2 | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvRole:
    ...
    scoping_organization: CoctMt530000UvOrganization | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvSourceOf1:
    ...
    pause_quantity: PqExplicit | None = field(
        default=None,
        metadata={
            "name": "pauseQuantity",
            "type": "Element",
...
class CoctMt530000UvAnimal:
    ...
    birthplace: CoctMt530000UvBirthplace | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt530000UvDevice:
    ...
    manufactured_product: CoctMt530000UvManufacturedProduct | None = field(
        default=None,
        metadata={
    ...
    type_code: ParticipationTargetDevice | None = field(
        default=None,
        metadata={
            "name": "typeCode",
            "type": "Attribute",
...
class CoctMt530000UvLocation:
    ...
    health_care_facility: CoctMt530000UvHealthCareFacility | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvAdministerableMaterial:
    ...
    administerable_material_kind: CoctMt530000UvMaterialKind | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvReferenceRange:
    ...
    observation_range: CoctMt530000UvObservationRange | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvRelatedEntity:
    ...
    related_person: CoctMt530000UvPerson | None = field(
        default=None,
        metadata={
            "name": "relatedPerson",
            "type": "Element",
    ...
    related_animal: CoctMt530000UvAnimal | None = field(
        default=None,
        metadata={
            "name": "relatedAnimal",
            "type": "Element",
    ...
    related_entity: CoctMt530000UvEntity | None = field(
        default=None,
        metadata={
            "name": "relatedEntity",
            "type": "Element",
    ...
    scoping_person: CoctMt530000UvPerson | None = field(
        default=None,
        metadata={
            "name": "scopingPerson",
            "type": "Element",
    ...
    scoping_animal: CoctMt530000UvAnimal | None = field(
        default=None,
        metadata={
            "name": "scopingAnimal",
            "type": "Element",
    ...
    scoping_entity: CoctMt530000UvEntity | None = field(
        default=None,
        metadata={
            "name": "scopingEntity",
            "type": "Element",
...
class CoctMt530000UvAuthor:
    ...
    related_entity: CoctMt530000UvRelatedEntity | None = field(
        default=None,
        metadata={
            "name": "relatedEntity",
            "type": "Element",
...
class CoctMt530000UvConsumable:
    ...
    administerable_material: CoctMt530000UvAdministerableMaterial | None = (
        field(
            default=None,
            metadata={
...
class CoctMt530000UvControlActEvent:
    ...
    responsible_party: CoctMt530000UvResponsibleParty1 | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvSubject1:
    ...
    control_act_event: CoctMt530000UvControlActEvent | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvAct:
    ...
    record_target: CoctMt530000UvRecordTarget | None = field(
        default=None,
        metadata={
            "name": "recordTarget",
            "type": "Element",
    ...
    data_enterer: CoctMt530000UvDataEnterer | None = field(
        default=None,
        metadata={
            "name": "dataEnterer",
            "type": "Element",
    ...
    definition: CoctMt530000UvDefinition | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    subject_of: CoctMt530000UvSubject1 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class CoctMt530000UvEncounter:
    ...
    length_of_stay_quantity: PqExplicit | None = field(
        default=None,
        metadata={
...
class CoctMt530000UvComponent:
    ...
    substance_administration: CoctMt530000UvSubstanceAdministration | None = (
        field(
            default=None,
            metadata={
...
class CoctMt530000UvSubstanceAdministration:
    ...
    consumable: CoctMt530000UvConsumable | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
