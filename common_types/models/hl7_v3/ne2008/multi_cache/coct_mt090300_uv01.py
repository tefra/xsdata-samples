...
class CoctMt090300Uv01RoleOther:
    ...
    class_code: Optional[Union[RoleClassMutualRelationship, RoleClassPassive, str, RoleClassOntological, RoleClassPartitive, "CoctMt090300Uv01RoleOther.ClassCode"]] = field(
        default=None,
        metadata={
            "name": "classCode",
            "type": "Attribute",
