...
class PrpaMt201304Uv02Citizen:
    ...
    political_nation: PrpaMt201304Uv02Nation = field(
        metadata={
...
class PrpaMt201304Uv02Member:
    ...
    group: None | PrpaMt201304Uv02Group = field(
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
            "nillable": True,
...
class PrpaMt201304Uv02PatientOfOtherProvider:
    ...
    subject_of: PrpaMt201304Uv02Subject = field(
        metadata={
            "name": "subjectOf",
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class PrpaMt201304Uv02Patient:
    ...
    patient_person: None | PrpaMt201304Uv02Person = field(
        default=None,
        metadata={
            "name": "patientPerson",
            "type": "Element",
    ...
    patient_non_person_living_subject: (
        None | PrpaMt201304Uv02NonPersonLivingSubject
    ) = field(
        default=None,
        metadata={
