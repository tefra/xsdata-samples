...
class PrpaMt201303Uv02BirthPlace:
    ...
    subject_of: PrpaMt201303Uv02Subject2 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class PrpaMt201303Uv02Citizen:
    ...
    political_nation: PrpaMt201303Uv02Nation | None = field(
        default=None,
        metadata={
...
class PrpaMt201303Uv02Member:
    ...
    group: PrpaMt201303Uv02Group | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class PrpaMt201303Uv02PatientOfOtherProvider:
    ...
    subject_of: PrpaMt201303Uv02Subject3 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class PrpaMt201303Uv02Subject4:
    ...
    administrative_observation: PrpaMt201303Uv02AdministrativeObservation | None = field(
        default=None,
        metadata={
...
class PrpaMt201303Uv02NonPersonLivingSubject:
    ...
    birth_place: PrpaMt201303Uv02BirthPlace | None = field(
        default=None,
        metadata={
            "name": "birthPlace",
            "type": "Element",
...
class PrpaMt201303Uv02Person:
    ...
    language_communication: list[PrpaMt201303Uv02LanguageCommunication] = (
        field(
            default_factory=list,
            metadata={
...
class PrpaMt201303Uv02Patient:
    ...
    patient_person: PrpaMt201303Uv02Person | None = field(
        default=None,
        metadata={
            "name": "patientPerson",
            "type": "Element",
    ...
    patient_non_person_living_subject: PrpaMt201303Uv02NonPersonLivingSubject | None = field(
        default=None,
        metadata={
