...
class PrpaMt201302Uv02AdministrativeObservationId(Ii):
    ...
    update_mode: PrpaMt201302Uv02AdministrativeObservationIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02CareGiverId(Ii):
    ...
    update_mode: PrpaMt201302Uv02CareGiverIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02CitizenId(Ii):
    ...
    update_mode: PrpaMt201302Uv02CitizenIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02ContactPartyId(Ii):
    ...
    update_mode: PrpaMt201302Uv02ContactPartyIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02CoveredParty:
    ...
    coverage_record: CoctMt510000Uv06CoverageRecord | None = field(
        default=None,
        metadata={
            "name": "coverageRecord",
            "type": "Element",
...
class PrpaMt201302Uv02EmployeeId(Ii):
    ...
    update_mode: PrpaMt201302Uv02EmployeeIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02GuardianId(Ii):
    ...
    update_mode: PrpaMt201302Uv02GuardianIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02MemberId(Ii):
    ...
    update_mode: PrpaMt201302Uv02MemberIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02NonPersonLivingSubjectId(Ii):
    ...
    update_mode: PrpaMt201302Uv02NonPersonLivingSubjectIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02OtherIdsId(Ii):
    ...
    update_mode: PrpaMt201302Uv02OtherIdsIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02PatientId(Ii):
    ...
    update_mode: PrpaMt201302Uv02PatientIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02PatientStatusCode(Cs):
    ...
    update_mode: PrpaMt201302Uv02PatientStatusCodeUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02PersonId(Ii):
    ...
    update_mode: PrpaMt201302Uv02PersonIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02PersonalRelationshipId(Ii):
    ...
    update_mode: PrpaMt201302Uv02PersonalRelationshipIdUpdateMode | None = (
        field(
            default=None,
            metadata={
                "name": "updateMode",
...
class PrpaMt201302Uv02StudentId(Ii):
    ...
    update_mode: PrpaMt201302Uv02StudentIdUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02Subject2:
    ...
    position: CoctMt960000Uv05Position | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class PrpaMt201302Uv02Subject3:
    ...
    care_provision: CoctMt820000UvCareProvision | None = field(
        default=None,
        metadata={
            "name": "careProvision",
            "type": "Element",
...
class PrpaMt201302Uv02BirthPlace:
    ...
    birthplace: CoctMt710007UvPlace | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    subject_of: PrpaMt201302Uv02Subject2 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class PrpaMt201302Uv02CareGiver:
    ...
    care_giver_person: CoctMt030207UvPerson | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02Citizen:
    ...
    political_nation: PrpaMt201302Uv02Nation | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02ContactParty:
    ...
    contact_person: CoctMt030207UvPerson | None = field(
        default=None,
        metadata={
            "name": "contactPerson",
            "type": "Element",
    ...
    contact_organization: CoctMt150007UvOrganization | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02Employee:
    ...
    employer_organization: CoctMt150007UvOrganization | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02Guardian:
    ...
    guardian_person: CoctMt030207UvPerson | None = field(
        default=None,
        metadata={
            "name": "guardianPerson",
            "type": "Element",
    ...
    guardian_organization: CoctMt150007UvOrganization | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02Member:
    ...
    group: PrpaMt201302Uv02Group | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class PrpaMt201302Uv02PatientOfOtherProvider:
    ...
    subject_of: PrpaMt201302Uv02Subject3 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class PrpaMt201302Uv02PersonalRelationship:
    ...
    relationship_holder1: CoctMt030007UvPerson | None = field(
        default=None,
        metadata={
    ...
    relationship_holder2: CoctMt030007UvNonPersonLivingSubject | None = (
        field(
            default=None,
            metadata={
...
class PrpaMt201302Uv02Student:
    ...
    school_organization: CoctMt150007UvOrganization | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02NonPersonLivingSubject:
    ...
    birth_place: PrpaMt201302Uv02BirthPlace | None = field(
        default=None,
        metadata={
            "name": "birthPlace",
            "type": "Element",
...
class PrpaMt201302Uv02Person:
    ...
    education_level_code: Ce | None = field(
        default=None,
        metadata={
    ...
    living_arrangement_code: Ce | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02Subject4:
    ...
    administrative_observation: PrpaMt201302Uv02AdministrativeObservation | None = field(
        default=None,
        metadata={
...
class PrpaMt201302Uv02PatientPatientNonPersonLivingSubject(
    ...
    update_mode: PrpaMt201302Uv02PatientPatientNonPersonLivingSubjectUpdateMode | None = field(
        default=None,
        metadata={
            "name": "updateMode",
            "type": "Attribute",
...
class PrpaMt201302Uv02PatientPatientPerson(PrpaMt201302Uv02Person):
    ...
    update_mode: PrpaMt201302Uv02PatientPatientPersonUpdateMode | None = (
        field(
            default=None,
            metadata={
                "name": "updateMode",
...
class PrpaMt201302Uv02Patient:
    ...
    status_code: PrpaMt201302Uv02PatientStatusCode | None = field(
        default=None,
        metadata={
            "name": "statusCode",
            "type": "Element",
    ...
    patient_person: PrpaMt201302Uv02PatientPatientPerson | None = field(
        default=None,
        metadata={
            "name": "patientPerson",
            "type": "Element",
    ...
    patient_non_person_living_subject: PrpaMt201302Uv02PatientPatientNonPersonLivingSubject | None = field(
        default=None,
        metadata={
