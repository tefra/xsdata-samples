...
class CoctMt490000Uv04ContentPackagedProduct:
    ...
    contained: CoctMt490000Uv04ManufacturedMaterial | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt490000Uv04PertinentInformation:
    ...
    diagnosis: CoctMt490000Uv04Diagnosis | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt490000Uv04Consultant:
    ...
    health_care_provider: CoctMt490000Uv04HealthCareProvider | None = field(
        default=None,
        metadata={
...
class CoctMt490000Uv04ManufacturedMaterial:
    ...
    determiner_code: str | None = field(
        default=None,
        metadata={
            "name": "determinerCode",
            "type": "Attribute",
...
class CoctMt490000Uv04BillableClinicalProduct:
    ...
    product: CoctMt490000Uv04Product | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    referrer: CoctMt490000Uv04Referrer | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    consultant: CoctMt490000Uv04Consultant | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    origin: CoctMt490000Uv04Origin | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    destination: CoctMt490000Uv04Destination | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    location: CoctMt490000Uv04Location | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
