...
class CoctMt260003UvAuthor:
    ...
    assigned_entity: CoctMt260003UvAssignedEntity | None = field(
        default=None,
        metadata={
            "name": "assignedEntity",
            "type": "Element",
...
class CoctMt260003UvDefinition:
    ...
    detected_medication_issue_definition: CoctMt260003UvDetectedMedicationIssueDefinition | None = field(
        default=None,
        metadata={
...
class CoctMt260003UvLocation:
    ...
    pharmacy: CoctMt260003UvPharmacy | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt260003UvManufacturedProduct:
    ...
    manufactured_material_kind: CoctMt260003UvManufacturedMaterialKind | None = field(
        default=None,
        metadata={
...
class CoctMt260003UvSubject:
    ...
    severity_observation: CoctMt260003UvSeverityObservation | None = field(
        default=None,
        metadata={
...
class CoctMt260003UvConsumable:
    ...
    manufactured_product: CoctMt260003UvManufacturedProduct | None = field(
        default=None,
        metadata={
...
class CoctMt260003UvManagement:
    ...
    author: CoctMt260003UvAuthor | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt260003UvOtherSupply:
    ...
    location: CoctMt260003UvLocation | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt260003UvMitigates:
    ...
    management: CoctMt260003UvManagement | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt260003UvOtherMedication:
    ...
    consumable: CoctMt260003UvConsumable | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt260003UvSubject2:
    ...
    other_medication: CoctMt260003UvOtherMedication | None = field(
        default=None,
        metadata={
    ...
    other_supply: CoctMt260003UvOtherSupply | None = field(
        default=None,
        metadata={
            "name": "otherSupply",
            "type": "Element",
