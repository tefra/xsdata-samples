...
class McciMt000200Uv01Acknowledgement:
    ...
    target_message: McciMt000200Uv01TargetMessage | None = field(
        default=None,
        metadata={
            "name": "targetMessage",
            "type": "Element",
...
class McciMt000200Uv01Agent:
    ...
    represented_organization: McciMt000200Uv01Organization | None = field(
        default=None,
        metadata={
...
class McciMt000200Uv01LocatedEntity:
    ...
    location: McciMt000200Uv01Place | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class McciMt000200Uv01Device:
    ...
    as_agent: McciMt000200Uv01Agent | None = field(
        default=None,
        metadata={
            "name": "asAgent",
            "type": "Element",
...
class McciMt000200Uv01Receiver:
    ...
    device: McciMt000200Uv01Device | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class McciMt000200Uv01Message:
    ...
    sender: McciMt000200Uv01Sender | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
