...
class CoctMt090003Uv01AssignedEntity:
    ...
    assigned_person: None | CoctMt090003Uv01Person = field(
        default=None,
        metadata={
            "name": "assignedPerson",
            "type": "Element",
    ...
    assigned_device: None | CoctMt090003Uv01Device = field(
        default=None,
        metadata={
            "name": "assignedDevice",
            "type": "Element",
    ...
    assigned_organization: None | CoctMt090003Uv01Organization = field(
        default=None,
        metadata={
