...
class CoctMt090003Uv01AssignedEntity:
    ...
    assigned_person: CoctMt090003Uv01Person | None = field(
        default=None,
        metadata={
            "name": "assignedPerson",
            "type": "Element",
    ...
    assigned_device: CoctMt090003Uv01Device | None = field(
        default=None,
        metadata={
            "name": "assignedDevice",
            "type": "Element",
    ...
    assigned_organization: CoctMt090003Uv01Organization | None = field(
        default=None,
        metadata={
