...
class CoctMt090100Uv01Member:
    ...
    group: CoctMt090100Uv01Group | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt090100Uv01Person:
    ...
    language_communication: list[CoctMt090100Uv01LanguageCommunication] = (
        field(
            default_factory=list,
            metadata={
...
class CoctMt090100Uv01AssignedPerson:
    ...
    assigned_person: CoctMt090100Uv01Person | None = field(
        default=None,
        metadata={
            "name": "assignedPerson",
            "type": "Element",
