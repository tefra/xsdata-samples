...
class CoctMt300000Uv04Substitution:
    ...
    performer: None | CoctMt300000Uv04Performer2 = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt300000Uv04SubstanceAdministrationOrder:
    ...
    pertinent_information: None | CoctMt300000Uv04PertinentInformation = field(
        default=None,
        metadata={
...
class CoctMt300000Uv04SupplyEvent:
    ...
    origin: None | CoctMt300000Uv04Origin = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    destination: None | CoctMt300000Uv04Destination = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
