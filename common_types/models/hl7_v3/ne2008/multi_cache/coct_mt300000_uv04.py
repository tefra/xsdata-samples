...
from .coct_mt260003_uv import CoctMt260003UvDetectedMedicationIssue
...
class CoctMt300000Uv04Performer1:
    ...
    health_care_provider: CoctMt300000Uv04HealthCareProvider | None = field(
        default=None,
        metadata={
...
class CoctMt300000Uv04Performer2:
    ...
    substitution_role: CoctMt300000Uv04SubstitutionRole | None = field(
        default=None,
        metadata={
...
class CoctMt300000Uv04Reason:
    ...
    supply_order: CoctMt300000Uv04SupplyOrder | None = field(
        default=None,
        metadata={
            "name": "supplyOrder",
            "type": "Element",
...
class CoctMt300000Uv04Author:
    ...
    prescriber_role: CoctMt300000Uv04PrescriberRole | None = field(
        default=None,
        metadata={
            "name": "prescriberRole",
            "type": "Element",
...
class CoctMt300000Uv04Substitution:
    ...
    performer: CoctMt300000Uv04Performer2 | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt300000Uv04PertinentInformation:
    ...
    substitution: CoctMt300000Uv04Substitution | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt300000Uv04SubstanceAdministrationOrder:
    ...
    author: CoctMt300000Uv04Author | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    reason: CoctMt300000Uv04Reason | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class CoctMt300000Uv04SubstanceAdministrationIntent:
    ...
    in_fulfillment_of: CoctMt300000Uv04InFulfillmentOf | None = field(
        default=None,
        metadata={
    ...
    pertinent_information: CoctMt300000Uv04PertinentInformation2 | None = (
        field(
            default=None,
            metadata={
                "name": "pertinentInformation",
...
class CoctMt300000Uv04SupplyEvent:
    ...
    expected_use_time: IvlTs | None = field(
        default=None,
        metadata={
    ...
    product: CoctMt300000Uv04Product | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    performer: CoctMt300000Uv04Performer1 | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    origin: CoctMt300000Uv04Origin | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    destination: CoctMt300000Uv04Destination | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    location: CoctMt300000Uv04Location | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    reason_of: CoctMt300000Uv04Reason2 | None = field(
        default=None,
        metadata={
            "name": "reasonOf",
            "type": "Element",
