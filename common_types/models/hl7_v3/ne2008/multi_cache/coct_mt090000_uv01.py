...
class CoctMt090000Uv01AssignedEntity:
    ...
    assigned_person: None | CoctMt090000Uv01Person = field(
        default=None,
        metadata={
            "name": "assignedPerson",
            "type": "Element",
    ...
    assigned_device: None | CoctMt090000Uv01Device = field(
        default=None,
        metadata={
            "name": "assignedDevice",
            "type": "Element",
    ...
    assigned_organization: None | CoctMt090000Uv01Organization = field(
        default=None,
        metadata={
