...
class CoctMt090003UvAssignedEntity:
    ...
    assigned_organization: CoctMt090003UvOrganization | None = field(
        default=None,
        metadata={
    ...
    assigned_person: CoctMt090003UvPerson | None = field(
        default=None,
        metadata={
            "name": "assignedPerson",
            "type": "Element",
    ...
    assigned_device: CoctMt090003UvDevice | None = field(
        default=None,
        metadata={
            "name": "assignedDevice",
            "type": "Element",
