...
class MfmiMt700711Uv01Definition:
    ...
    act_definition: MfmiMt700711Uv01ActDefinition | None = field(
        default=None,
        metadata={
            "name": "actDefinition",
            "type": "Element",
...
class MfmiMt700711Uv01Subject3:
    ...
    prior_registered_role: MfmiMt700711Uv01PriorRegisteredRole | None = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01Subject4:
    ...
    prior_registered_act: MfmiMt700711Uv01PriorRegisteredAct | None = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01InFulfillmentOf:
    ...
    registration_request: MfmiMt700711Uv01RegistrationRequest | None = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01PriorRegistration:
    ...
    subject1: MfmiMt700711Uv01Subject3 | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    subject2: MfmiMt700711Uv01Subject4 | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class MfmiMt700711Uv01ReplacementOf:
    ...
    prior_registration: MfmiMt700711Uv01PriorRegistration | None = field(
        default=None,
        metadata={
