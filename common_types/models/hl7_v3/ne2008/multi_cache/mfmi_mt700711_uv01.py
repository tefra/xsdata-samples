...
class MfmiMt700711Uv01QueryAck:
    ...
    query_response_code: None | Cs = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01Definition:
    ...
    act_definition: None | MfmiMt700711Uv01ActDefinition = field(
        default=None,
        metadata={
            "name": "actDefinition",
            "type": "Element",
...
class MfmiMt700711Uv01Subject3:
    ...
    prior_registered_role: None | MfmiMt700711Uv01PriorRegisteredRole = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01Subject4:
    ...
    prior_registered_act: None | MfmiMt700711Uv01PriorRegisteredAct = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01InFulfillmentOf:
    ...
    registration_request: None | MfmiMt700711Uv01RegistrationRequest = field(
        default=None,
        metadata={
...
class MfmiMt700711Uv01PriorRegistration:
    ...
    subject1: None | MfmiMt700711Uv01Subject3 = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
    ...
    subject2: None | MfmiMt700711Uv01Subject4 = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class MfmiMt700711Uv01ReplacementOf:
    ...
    prior_registration: None | MfmiMt700711Uv01PriorRegistration = field(
        default=None,
        metadata={
