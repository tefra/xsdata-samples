...
class CoctMt090002Uv01AssignedEntity:
    ...
    assigned_person: CoctMt090002Uv01Person | None = field(
        default=None,
        metadata={
            "name": "assignedPerson",
            "type": "Element",
    ...
    assigned_device: CoctMt090002Uv01Device | None = field(
        default=None,
        metadata={
            "name": "assignedDevice",
            "type": "Element",
    ...
    assigned_organization: CoctMt090002Uv01Organization | None = field(
        default=None,
        metadata={
