...
class PrpaMt201310Uv02BirthPlace:
    ...
    subject_of: PrpaMt201310Uv02Subject2 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class PrpaMt201310Uv02Citizen:
    ...
    political_nation: PrpaMt201310Uv02Nation | None = field(
        default=None,
        metadata={
...
class PrpaMt201310Uv02Member:
    ...
    group: PrpaMt201310Uv02Group | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "urn:hl7-org:v3",
...
class PrpaMt201310Uv02PatientOfOtherProvider:
    ...
    subject_of: PrpaMt201310Uv02Subject3 | None = field(
        default=None,
        metadata={
            "name": "subjectOf",
            "type": "Element",
...
class PrpaMt201310Uv02Subject:
    ...
    query_match_observation: PrpaMt201310Uv02QueryMatchObservation | None = field(
        default=None,
        metadata={
...
class PrpaMt201310Uv02Subject4:
    ...
    administrative_observation: PrpaMt201310Uv02AdministrativeObservation | None = field(
        default=None,
        metadata={
...
class PrpaMt201310Uv02NonPersonLivingSubject:
    ...
    birth_place: PrpaMt201310Uv02BirthPlace | None = field(
        default=None,
        metadata={
            "name": "birthPlace",
            "type": "Element",
...
class PrpaMt201310Uv02Patient:
    ...
    patient_person: PrpaMt201310Uv02Person | None = field(
        default=None,
        metadata={
            "name": "patientPerson",
            "type": "Element",
    ...
    patient_non_person_living_subject: PrpaMt201310Uv02NonPersonLivingSubject | None = field(
        default=None,
        metadata={
