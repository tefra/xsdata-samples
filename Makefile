generate:
	...
	xsdata generate xsd/amadeus/Fare_MasterPricerTravelBoardSearchReply_15_3_1A.xsd --package samples.amadeus.output
	xsdata generate xsd/sabre/BargainFinderMaxRQ_v1-9-7.xsd --package samples.sabre.output
	xsdata generate xsd/sabre/BargainFinderMaxRS_v1-9-7.xsd --package samples.sabre.output
