...
class GeoGridCodelistType(GeoGridCodelistBaseType):
    """GeoGridCodelistType defines the structure of a geographic grid code list.

    These define a geographical grid composed of cells representing
    regular squared portions of the Earth.

    :ivar grid_definition: Contains a regular expression string
        corresponding to the grid definition for the GeoGrid Codelist.
    """

    grid_definition: Optional[str] = field(
        default=None,
        metadata={
            "name": "GridDefinition",
            "type": "Element",
