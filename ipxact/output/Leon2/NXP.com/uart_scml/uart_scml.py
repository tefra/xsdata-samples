        ...
        file_set=[
            FileSet(
                ...
                file=[
                    ...
                    File(
                        name=IpxactUri(
                            value='./src/uart_register_bank.cpp'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.SYSTEM_CSOURCE_2_1
                    ...
                    File(
                        name=IpxactUri(
                            value='./src/uart_interrupt_handler.cpp'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.SYSTEM_CSOURCE_2_1
                    ...
                    File(
                        name=IpxactUri(
                            value='./src/uart_serial_tx_rx.cpp'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.SYSTEM_CSOURCE_2_1
