...
obj = Component(
    ...
    description=Description(
        value='Interrupt controller with improved register description'
    ),
                    ...
                    AddressBlock(
                        ...
                        register=[
                            ...
                            AddressBlockType.Register(
                                ...
                                description=Description(
                                    value="If written with a '1', will clear corresponding bit(s) in interrupt pending register."
                                ),
                                address_offset=UnsignedLongintExpression(
                                    value="'hc"
                                ),
                                ...
                                field_value=[
                                    FieldType(
                                        name='Reserved1',
                                        description=Description(
                                            value='Reserved - write should be ignored'
                                        ),
                                        bit_offset=UnsignedIntExpression(
                                            value='0'
                                        ),
                            ...
                            AddressBlockType.Register(
                                name='interruptClearRegisterRead',
                                display_name=DisplayName(
                                    value='interruptClearRegisterRead'
                                ),
                                description=Description(
                                    value='A read returns X.'
                                ),
                                address_offset=UnsignedLongintExpression(
                                    value="'hc"
                                ),
                            ...
                            AddressBlockType.Register(
                                ...
                                field_value=[
                                    FieldType(
                                        name='pendIntEncode',
                                        description=Description(
                                            value='Pending encoded interrupt'
                                        ),
                                        bit_offset=UnsignedIntExpression(
                                            value='0'
                                        ),
        ...
        file_set=[
            FileSet(
                ...
                file=[
                    ...
                    File(
                        name=IpxactUri(
                            value='../1.2/hdlsrc/irqctrl_rdack.vhd'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.VHDL_SOURCE
                    ...
                    File(
                        name=IpxactUri(
                            value='../1.2/hdlsrc/leon2Irqctrl.vhd'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.VHDL_SOURCE
