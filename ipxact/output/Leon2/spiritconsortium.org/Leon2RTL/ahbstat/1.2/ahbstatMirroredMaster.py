...
obj = Component(
    ...
    bus_interfaces=BusInterfaces(
        bus_interface=[
            ...
            BusInterface(
                name='ambaAHBMirroredMasterMonitor',
                bus_type=ConfigurableLibraryRefType(
                    vendor='amba.com',
                    library='AMBA2',
                    name='AHB',
                ...
                monitor=BusInterfaceType.Monitor(
                    interface_mode=MonitorInterfaceMode.MIRRORED_INITIATOR
                )
            ),
            BusInterface(
                name='ambaAPB',
