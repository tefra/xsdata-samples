...
obj = Component(
    ...
    library='Leon2RTL',
    name='i2c_channel_1m_1s',
    version='1.0',
    description=Description(
        value='1 master, 1 slave i2c channel'
    ),
        ...
        file_set=[
            FileSet(
                ...
                file=[
                    File(
                        name=IpxactUri(
                            value='data/i2c_channel_1m_1s/RTL/i2c_channel_1m_1s.v'
                        ),
                        file_type=[
                            FileType(
            ...
            FileSet(
                ...
                file=[
                    File(
                        name=IpxactUri(
                            value='data/i2c_channel_1m_1s/RTL/i2c_channel_1m_1s.vhd'
                        ),
                        file_type=[
                            FileType(
