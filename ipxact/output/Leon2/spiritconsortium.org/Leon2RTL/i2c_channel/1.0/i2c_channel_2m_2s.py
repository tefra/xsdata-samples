...
obj = Component(
    ...
    library='Leon2RTL',
    name='i2c_channel_2m_2s',
    version='1.0',
    description=Description(
        value='2 master, 2 slave i2c channel'
    ),
        ...
        file_set=[
            FileSet(
                ...
                file=[
                    File(
                        name=IpxactUri(
                            value='data/i2c_channel_2m_2s/RTL/i2c_channel_2m_2s.v'
                        ),
                        file_type=[
                            FileType(
            ...
            FileSet(
                ...
                file=[
                    File(
                        name=IpxactUri(
                            value='data/i2c_channel_2m_2s/RTL/i2c_channel_2m_2s.vhd'
                        ),
                        file_type=[
                            FileType(
