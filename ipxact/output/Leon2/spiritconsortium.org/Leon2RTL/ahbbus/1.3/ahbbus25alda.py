...
obj = Component(
    ...
    description=Description(
        value='2 master, 5 slave AHB channel, with allLogicalDirectionsAllowed for the clock and reset of the mirrored slave ports'
    ),
        ...
        bus_interface=[
            ...
            BusInterface(
                ...
                mirrored_target=BusInterfaceType.MirroredTarget(
                    base_addresses=BusInterfaceType.MirroredTarget.BaseAddresses(
                        remap_addresses=[
                            BusInterfaceType.MirroredTarget.BaseAddresses.RemapAddresses(
                                remap_address=UnsignedLongintExpression(
                                    value='start_addr_slv4_mirror'
                                )
                            ),
                            BusInterfaceType.MirroredTarget.BaseAddresses.RemapAddresses(
                                remap_address=UnsignedLongintExpression(
                                    value='restart_addr_slv4_mirror'
                                ),
                                mode_ref=[
                                    ModeRef(
                                        value='remapped',
                ...
                parameters=Parameters(
                    parameter=[
                        Parameter(
                            name='start_addr_slv4_mirror',
                            value=Value(
                                value="'h40000000"
                            ),
                            parameter_id='start_addr_slv4_mirror',
                            prompt='Slave 4 Starting Address:',
                            choice_ref='BaseAddressChoices',
                            config_groups=[
                                'requiredConfig',
                            ],
                        ...
                        Parameter(
                            name='restart_addr_slv4_mirror',
                            value=Value(
                                value="'h40000000"
                            ),
                            parameter_id='restart_addr_slv4_mirror',
                            prompt='Remap Slave 4 Starting Address:',
                            choice_ref='BaseAddressChoices',
                            config_groups=[
                                'requiredConfig',
                            ],
                        ...
                        Parameter(
                            name='range_slv4_mirror',
                            value=Value(
                                value="'h00010000"
                            ),
                            parameter_id='range_slv4_mirror',
        ...
        instantiations=ModelType.Instantiations(
            component_instantiation=[
                ComponentInstantiationType(
                    ...
                    module_name='leon2Ahbbus25(struct)',
                    module_parameters=ComponentInstantiationType.ModuleParameters(
                        module_parameter=[
                            ...
                            ModuleParameterType(
                                name='restart_addr_slv4',
                                value=Value(
                                    value='restart_addr_slv4'
                                ),
                                data_type='integer'
                            ),
                            ModuleParameterType(
                            ...
                            ModuleParameterType(
                                name='mst_access_slv4',
                                value=Value(
                                    value='mst_access_slv4'
                                ),
                                data_type='integer'
                            ),
                            ModuleParameterType(
        ...
        file_set=[
            FileSet(
                ...
                file=[
                    ...
                    File(
                        name=IpxactUri(
                            value='../1.2/hdlsrc/leon2Ahbbus25.vhd'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.VHDL_SOURCE
    ...
    parameters=Parameters(
        parameter=[
            ...
            Parameter(
                name='start_addr_slv4',
                value=Value(
                    value='start_addr_slv4_mirror / 65536'
                ),
            ...
            Parameter(
                name='restart_addr_slv4',
                value=Value(
                    value='restart_addr_slv4_mirror / 65536'
                ),
                parameter_id='restart_addr_slv4'
            ),
            Parameter(
                name='range_slv4',
                value=Value(
            ...
            Parameter(
                ...
                parameter_id='split_slv4',
                prompt='Slave 4 Splitted Transactions:',
                choice_ref='BooleanChoices',
                config_groups=[
                    'requiredConfig',
                ],
            ...
            Parameter(
                ...
                parameter_id='mst_access_slv4',
                prompt='Masters that can access Slave 4:'
            ),
            Parameter(
                name='defmast',
                value=Value(
