...
obj = Component(
    ...
    description=Description(
        value='1 master, 2 slave AHB channel, with allLogicalDirectionsAllowed for the clock and reset of the mirrored slave ports'
    ),
        ...
        instantiations=ModelType.Instantiations(
            component_instantiation=[
                ComponentInstantiationType(
                    ...
                    module_name='leon2Ahbbus12(struct)',
        ...
        file_set=[
            FileSet(
                ...
                file=[
                    ...
                    File(
                        name=IpxactUri(
                            value='../1.2/hdlsrc/leon2Ahbbus12.vhd'
                        ),
                        file_type=[
                            FileType(
                                value=SimpleFileType.VHDL_SOURCE
