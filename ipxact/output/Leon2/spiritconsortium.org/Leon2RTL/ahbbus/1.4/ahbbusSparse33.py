...
obj = Component(
    ...
    description=Description(
        value='3 master, 3 slave sparse matrix AHB channel/bridge'
    ),
    ...
    model=Model(
        views=ModelType.Views(
            view=[
                ...
                ModelType.Views.View(
                    name='spirit-design-bridgeconfig',
                    env_identifier=[
                        ModelType.Views.View.EnvIdentifier(
                            value='::Hierarchy'
                        ),
                    ],
                    design_instantiation_ref='spirit-design-bridgeconfig'
                ),
                ModelType.Views.View(
                    name='spirit-design-rangeconfig',
                    env_identifier=[
                        ModelType.Views.View.EnvIdentifier(
                            value='::Hierarchy'
                        ),
                    ],
                    design_instantiation_ref='spirit-design-rangeconfig'
                ),
            ]
        ),
