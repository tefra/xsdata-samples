...
class FieldType:
    ...
    array: None | FieldType.Array = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.accellera.org/XMLSchema/IPXACT/1685-2022",
    ...
    alias_of: None | FieldType.AliasOf = field(
        default=None,
        metadata={
            "name": "aliasOf",
            "type": "Element",
    ...
    field_access_policies: None | FieldType.FieldAccessPolicies = field(
        default=None,
        metadata={
    ...
    class Array:
        ...
        bit_stride: None | BitStride = field(
            default=None,
            metadata={
                "name": "bitStride",
                "type": "Element",
    ...
    class AliasOf:
        ...
        memory_map_ref: None | FieldType.AliasOf.MemoryMapRef = field(
            default=None,
            metadata={
                "name": "memoryMapRef",
                "type": "Element",
    ...
    class FieldAccessPolicies(FieldAccessPropertiesType):
        ...
        class FieldAccessPolicy:
            ...
            testable: (
                None | FieldType.FieldAccessPolicies.FieldAccessPolicy.Testable
            ) = field(
                default=None,
                metadata={
                    "type": "Element",
