...
class BankedDefinitionBankType:
    ...
    access_handles: None | BankedDefinitionBankType.AccessHandles = field(
        default=None,
        metadata={
            "name": "accessHandles",
            "type": "Element",
    ...
    bank_definition_ref: None | BankedDefinitionBankType.BankDefinitionRef = (
        field(
            default=None,
            metadata={
    ...
    bank: list[BankedDefinitionBankType.Bank] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.accellera.org/XMLSchema/IPXACT/1685-2022",
