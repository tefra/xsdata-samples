...
class AddressBankDefinitionType:
    ...
    access_handles: None | AddressBankDefinitionType.AccessHandles = field(
        default=None,
        metadata={
            "name": "accessHandles",
            "type": "Element",
    ...
    bank_definition_ref: None | AddressBankDefinitionType.BankDefinitionRef = (
        field(
            default=None,
            metadata={
    ...
    bank: list[AddressBankDefinitionType.Bank] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.accellera.org/XMLSchema/IPXACT/1685-2022",
