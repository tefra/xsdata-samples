...
class LinScheduleTable:
    ...
    annotations: None | LinScheduleTable.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    resume_position: None | ResumePosition = field(
        default=None,
        metadata={
    ...
    table_entrys: None | LinScheduleTable.TableEntrys = field(
        default=None,
        metadata={
            "name": "TABLE-ENTRYS",
            "type": "Element",
