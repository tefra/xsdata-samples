...
class LinScheduleTable:
    ...
    interval between the start of a frame and the start of the following
    frame.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar resume_position: Defines, where a schedule table shall be
        proceeded in case if it has been interrupted by a run-once table
        or MRF/SRF.
    :ivar run_mode: The schedule table can be executed in two different
        modes.
    :ivar table_entrys: The scheduling table consists of table entries,
        which contain Frame slots.
    ...
    short_name_fragments: LinScheduleTable.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: LinScheduleTable.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    resume_position: ResumePosition | None = field(
        default=None,
        metadata={
    ...
    table_entrys: LinScheduleTable.TableEntrys | None = field(
        default=None,
        metadata={
            "name": "TABLE-ENTRYS",
            "type": "Element",
