...
class NvDataInterface:
    """
    A non volatile data interface declares a number of
    ...
    :ivar nv_datas: The VariableDataPrototype of this nv data interface.
    ...
    short_name_fragments: Optional["NvDataInterface.ShortNameFragments"] = (
        field(
            default=None,
            metadata={
    ...
    annotations: Optional["NvDataInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["NvDataInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["NvDataInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    nv_datas: Optional["NvDataInterface.NvDatas"] = field(
        default=None,
        metadata={
            "name": "NV-DATAS",
            "type": "Element",
