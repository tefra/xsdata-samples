...
class NvDataInterface:
    ...
    short_name_fragments: None | NvDataInterface.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | NvDataInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | NvDataInterface.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    namespaces: None | NvDataInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    nv_datas: None | NvDataInterface.NvDatas = field(
        default=None,
        metadata={
            "name": "NV-DATAS",
            "type": "Element",
