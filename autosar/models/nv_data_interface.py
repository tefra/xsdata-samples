...
class NvDataInterface:
    ...
    short_name_fragments: NvDataInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: NvDataInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: NvDataInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: NvDataInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    nv_datas: NvDataInterface.NvDatas | None = field(
        default=None,
        metadata={
            "name": "NV-DATAS",
            "type": "Element",
