...
class DataPrototypeInExecutableInstanceRef:
    ...
    context_root_component_ref: Optional["DataPrototypeInExecutableInstanceRef.ContextRootComponentRef"] = field(
        default=None,
        metadata={
    ...
    context_component_ref: List["DataPrototypeInExecutableInstanceRef.ContextComponentRef"] = field(
    ...
    context_port_ref: Optional["DataPrototypeInExecutableInstanceRef.ContextPortRef"] = field(
        default=None,
        metadata={
    ...
    context_data_prototype_ref: List["DataPrototypeInExecutableInstanceRef.ContextDataPrototypeRef"] = field(
        default_factory=list,
        metadata={
    ...
    target_data_prototype_ref: Optional["DataPrototypeInExecutableInstanceRef.TargetDataPrototypeRef"] = field(
        default=None,
        metadata={
