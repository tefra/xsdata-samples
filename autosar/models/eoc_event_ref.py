...
class EocEventRef:
    ...
    bsw_module_instance_ref: Optional["EocEventRef.BswModuleInstanceRef"] = (
        field(
            default=None,
            metadata={
