...
class DiagnosticWriteMemoryByAddressClass:
    ...
    short_name_fragments: Optional["DiagnosticWriteMemoryByAddressClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticWriteMemoryByAddressClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticWriteMemoryByAddressClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
