...
class PhmHealthChannelStatus:
    """
    The PhmHealthChannelStatus specifies one possible status of the health
    channel.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar status_id: Defines the numeric value which is used to indicate
    ...
    short_name_fragments: Optional["PhmHealthChannelStatus.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PhmHealthChannelStatus.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    triggers_recovery_notification: Optional[Boolean] = field(
        default=None,
        metadata={
            "name": "TRIGGERS-RECOVERY-NOTIFICATION",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
