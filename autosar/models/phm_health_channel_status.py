...
class PhmHealthChannelStatus:
    ...
    short_name_fragments: PhmHealthChannelStatus.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: PhmHealthChannelStatus.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    triggers_recovery_notification: Boolean | None = field(
        default=None,
        metadata={
