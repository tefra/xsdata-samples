...
class SecurityEventContextMappingApplication:
    ...
    events with an IdsM instance and with the executional context of an application
    (e.g. name of SWC on CP or name of SWCL on AP)  in which this IdsM instance can
