...
class ConcretePatternEventTriggering:
    ...
    which occurs following a precisely known pattern.
    ...
    :ivar pattern_period: The optional parameter "Pattern Period"
        ...
        repetitions of the given concrete pattern.
    :ivar offsets: The offset for each occurrence of the event in the
        specified time interval.
    :ivar pattern_length: The length of the observed time interval.
    ...
    annotations: None | ConcretePatternEventTriggering.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    trace_refs: None | ConcretePatternEventTriggering.TraceRefs = field(
        default=None,
        metadata={
            "name": "TRACE-REFS",
            "type": "Element",
    ...
    timing_condition_ref: (
        None | ConcretePatternEventTriggering.TimingConditionRef
    ) = field(
        default=None,
        metadata={
    ...
    event_ref: None | ConcretePatternEventTriggering.EventRef = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
    ...
    offsets: None | ConcretePatternEventTriggering.Offsets = field(
        default=None,
        metadata={
            "name": "OFFSETS",
            "type": "Element",
