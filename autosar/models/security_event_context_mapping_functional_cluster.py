...
class SecurityEventContextMappingFunctionalCluster:
    ...
    events with an IdsM instance and with the executional context of a functional
    cluster in which this IdsM instance can receive reports for these security
    events.
    ...
    :ivar mapped_security_events: This aggregation represents (through
        ...
        -1.
    :ivar affected_functional_cluster: This attribute is used to
        identify the name of the functional cluster in whose executional
        context a security event can occur. The set of functional
        cluster names is standardized by AUTOSAR.
