...
class ComCertificateToCryptoCertificateMapping:
    ...
    :ivar crypto_certificate_ref: Reference to the CryptoCertifcate in
        the Crypto Stack.
    :ivar crypto_service_certificate_ref: Reference to the
        cryptoServiceCertificate in the Com deployment
    ...
    short_name_fragments: Optional["ComCertificateToCryptoCertificateMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ComCertificateToCryptoCertificateMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    crypto_certificate_ref: Optional["ComCertificateToCryptoCertificateMapping.CryptoCertificateRef"] = field(
        default=None,
        metadata={
    ...
    crypto_service_certificate_ref: Optional["ComCertificateToCryptoCertificateMapping.CryptoServiceCertificateRef"] = field(
        default=None,
        metadata={
