...
class CheckpointTransition:
    ...
    annotations: None | CheckpointTransition.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    source_ref: None | CheckpointTransition.SourceRef = field(
        default=None,
        metadata={
            "name": "SOURCE-REF",
            "type": "Element",
    ...
    target_ref: None | CheckpointTransition.TargetRef = field(
        default=None,
        metadata={
            "name": "TARGET-REF",
            "type": "Element",
