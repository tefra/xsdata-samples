...
class SynchronizedTimeBaseProviderInterface:
    ...
    interaction with a Time Synchronization Provider.
    ...
    :ivar time_base_kind: Defines which kind of time base is requested
        at this interface.
    ...
    short_name_fragments: Optional["SynchronizedTimeBaseProviderInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SynchronizedTimeBaseProviderInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["SynchronizedTimeBaseProviderInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["SynchronizedTimeBaseProviderInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    time_base_kind: Optional[TimeSynchronizationKindEnum] = field(
        default=None,
        metadata={
            "name": "TIME-BASE-KIND",
            "type": "Element",
