...
class DiagnosticControlNeeds:
    ...
    short_name_fragments: DiagnosticControlNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticControlNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticControlNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
