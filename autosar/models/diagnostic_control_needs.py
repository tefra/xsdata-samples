...
class DiagnosticControlNeeds:
    ...
    short_name_fragments: None | DiagnosticControlNeeds.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | DiagnosticControlNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticControlNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
