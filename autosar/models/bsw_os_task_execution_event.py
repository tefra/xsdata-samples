...
class BswOsTaskExecutionEvent:
    """
    This BswEvent is supposed to execute BswSchedulableEntitys which have
    to react on the execution of specific OsTasks.

    Therefore, this event is unconditionally raised whenever the OsTask on
    which it is mapped is executed. The main use case for this event is
    scheduling of Runnables of Complex Drivers which have to react on task
    executions.
    ...
    annotations: None | BswOsTaskExecutionEvent.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: (
        None | BswOsTaskExecutionEvent.ActivationReasonRepresentationRef
    ) = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: (
        None | BswOsTaskExecutionEvent.ContextLimitationRefs
    ) = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: (
        None | BswOsTaskExecutionEvent.DisabledInModeIrefs
    ) = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: None | BswOsTaskExecutionEvent.StartsOnEventRef = (
        field(
            default=None,
            metadata={
    ...
    class ContextLimitationRefs:
        context_limitation_ref: list[
            BswOsTaskExecutionEvent.ContextLimitationRefs.ContextLimitationRef
        ] = field(
            default_factory=list,
            metadata={
