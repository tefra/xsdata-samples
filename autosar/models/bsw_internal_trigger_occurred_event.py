...
class BswInternalTriggerOccurredEvent:
    ...
    switch, e.g. from an ISR context into a task context. Activation and
    ...
    :ivar event_source_ref: The activation point is the source of this
        event.
    ...
    short_name_fragments: Optional["BswInternalTriggerOccurredEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswInternalTriggerOccurredEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["BswInternalTriggerOccurredEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswInternalTriggerOccurredEvent.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional["BswInternalTriggerOccurredEvent.DisabledInModeIrefs"] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional["BswInternalTriggerOccurredEvent.StartsOnEventRef"] = field(
        default=None,
        metadata={
    ...
    event_source_ref: Optional["BswInternalTriggerOccurredEvent.EventSourceRef"] = field(
        default=None,
        metadata={
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswInternalTriggerOccurredEvent.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
