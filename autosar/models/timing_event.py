...
class TimingEvent:
    ...
    :ivar offset: The value makes an assumption about the time offset of
        the first activation of the RunnableEntity triggered by the
        mapped TimingEvent relative to the periodic activation of the
        time base of this TimingEvent. Unit: second.
    :ivar period: Period of timing event in seconds. The value of this
    ...
    annotations: None | TimingEvent.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: (
        None | TimingEvent.ActivationReasonRepresentationRef
    ) = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: None | TimingEvent.DisabledModeIrefs = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: None | TimingEvent.StartOnEventRef = field(
        default=None,
        metadata={
