...
class AnalyzedExecutionTime:
    ...
    short_name_fragments: Optional["AnalyzedExecutionTime.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["AnalyzedExecutionTime.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    exclusive_area_ref: Optional["AnalyzedExecutionTime.ExclusiveAreaRef"] = field(
        default=None,
        metadata={
    ...
    executable_entity_ref: Optional["AnalyzedExecutionTime.ExecutableEntityRef"] = field(
        default=None,
        metadata={
    ...
    hw_element_ref: Optional["AnalyzedExecutionTime.HwElementRef"] = field(
        default=None,
        metadata={
            "name": "HW-ELEMENT-REF",
            "type": "Element",
    ...
    included_library_refs: Optional["AnalyzedExecutionTime.IncludedLibraryRefs"] = field(
        default=None,
        metadata={
    ...
    memory_section_locations: Optional["AnalyzedExecutionTime.MemorySectionLocations"] = field(
        default=None,
        metadata={
    ...
    best_case_execution_time: Optional[MultidimensionalTime] = field(
        default=None,
        metadata={
    ...
    worst_case_execution_time: Optional[MultidimensionalTime] = field(
        default=None,
        metadata={
    ...
    class IncludedLibraryRefs:
        included_library_ref: List["AnalyzedExecutionTime.IncludedLibraryRefs.IncludedLibraryRef"] = field(
            default_factory=list,
            metadata={
