...
class DiagnosticEnvironmentalCondition:
    ...
    :ivar formula: This attribute represents the formula part of the
        DiagnosticEnvironmentalCondition.
    :ivar mode_elements: This aggregation contains a representation of
        ModeDeclarations in the context of a
        DiagnosticEnvironmentalCondition.
    ...
    short_name_fragments: Optional["DiagnosticEnvironmentalCondition.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEnvironmentalCondition.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mode_elements: Optional["DiagnosticEnvironmentalCondition.ModeElements"] = field(
        default=None,
        metadata={
            "name": "MODE-ELEMENTS",
            "type": "Element",
    ...
    @dataclass
    class ModeElements:
        diagnostic_env_bsw_mode_element: List[DiagnosticEnvBswModeElement] = field(
            default_factory=list,
            metadata={
        ...
        diagnostic_env_swc_mode_element: List[DiagnosticEnvSwcModeElement] = field(
            default_factory=list,
            metadata={
