...
class UserDefinedPhysicalChannel:
    ...
    short_name_fragments: (
        None | UserDefinedPhysicalChannel.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | UserDefinedPhysicalChannel.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    comm_connectors: None | UserDefinedPhysicalChannel.CommConnectors = field(
        default=None,
        metadata={
    ...
    frame_triggerings: None | UserDefinedPhysicalChannel.FrameTriggerings = (
        field(
            default=None,
            metadata={
    ...
    i_signal_triggerings: (
        None | UserDefinedPhysicalChannel.ISignalTriggerings
    ) = field(
        default=None,
        metadata={
    ...
    managed_physical_channel_refs: (
        None | UserDefinedPhysicalChannel.ManagedPhysicalChannelRefs
    ) = field(
        default=None,
        metadata={
    ...
    pdu_triggerings: None | UserDefinedPhysicalChannel.PduTriggerings = field(
        default=None,
        metadata={
    ...
    class ManagedPhysicalChannelRefs:
        managed_physical_channel_ref: list[
            UserDefinedPhysicalChannel.ManagedPhysicalChannelRefs.ManagedPhysicalChannelRef
        ] = field(
            default_factory=list,
            metadata={
