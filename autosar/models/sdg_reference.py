...
class SdgReference:
    ...
    short_name_fragments: SdgReference.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SdgReference.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    dest_sdg_ref: SdgReference.DestSdgRef | None = field(
        default=None,
        metadata={
            "name": "DEST-SDG-REF",
            "type": "Element",
