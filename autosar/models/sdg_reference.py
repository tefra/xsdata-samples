...
class SdgReference:
    """
    Describes an attribute of a SdgClass which is used on the definition side
    to model a reference from one Sdg to another Sdg on the value side.
    ...
    :ivar upper_multiplicity_infinite: This explicitly specifies, that
        ...
        exclusive.
    :ivar dest_sdg_ref: Refers to a SdgClass which is used on the
        definition side to model the destination type of the referenced
        Sdg. On the value side the reference is realized by means of the
        originating Sdg defining an sdgx attribute which refers to the
        sdgCaption of the referenced Sdg.
    ...
    short_name_fragments: Optional["SdgReference.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SdgReference.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    dest_sdg_ref: Optional["SdgReference.DestSdgRef"] = field(
        default=None,
        metadata={
            "name": "DEST-SDG-REF",
            "type": "Element",
