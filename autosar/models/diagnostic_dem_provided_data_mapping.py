...
class DiagnosticDemProvidedDataMapping:
    ...
    short_name_fragments: Optional[
        "DiagnosticDemProvidedDataMapping.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDemProvidedDataMapping.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    data_element_ref: Optional[
        "DiagnosticDemProvidedDataMapping.DataElementRef"
    ] = field(
        default=None,
        metadata={
