...
class DiagEventDebounceMonitorInternal:
    ...
    short_name_fragments: Optional["DiagEventDebounceMonitorInternal.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagEventDebounceMonitorInternal.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
