...
class DiagnosticInfoType:
    ...
    :ivar data_elements: This represents the data associated with the
        enclosing DiagnosticInfoType.
    :ivar id: This attribute represents the value of InfoType (see SAE
        J1979-DA).
    ...
    short_name_fragments: Optional["DiagnosticInfoType.ShortNameFragments"] = field(
        default=None,
        metadata={
