...
class ConstantSpecificationMappingSet:
    ...
    :ivar mappings: ConstantSpecificationMappings owned by the
    ...
    annotations: None | ConstantSpecificationMappingSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mappings: None | ConstantSpecificationMappingSet.Mappings = field(
        default=None,
        metadata={
            "name": "MAPPINGS",
            "type": "Element",
