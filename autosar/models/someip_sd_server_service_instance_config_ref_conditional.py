...
@dataclass
class SomeipSdServerServiceInstanceConfigRefConditional:
    """
    This element was generated/modified due to an atpVariation stereotype.

    :ivar someip_sd_server_service_instance_config_ref:
    ...
    someip_sd_server_service_instance_config_ref: Optional["SomeipSdServerServiceInstanceConfigRefConditional.SomeipSdServerServiceInstanceConfigRef"] = field(
        default=None,
        metadata={
