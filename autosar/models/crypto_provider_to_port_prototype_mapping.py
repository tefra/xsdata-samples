...
class CryptoProviderToPortPrototypeMapping:
    ...
    CryptoProvider on deployment level to a given PortPrototype that is
    typed by a CryptoProviderInterface.
    ...
    :ivar crypto_provider_ref: This reference represents the mapped
        cryptoProvider.
    ...
    class CryptoProviderRef(Ref):
        dest: Optional[CryptoProviderSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
