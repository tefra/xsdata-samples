...
class ISignal:
    ...
    timeout_substitution_value: Optional["ISignal.TimeoutSubstitutionValue"] = field(
        default=None,
        metadata={
    ...
    transformation_i_signal_propss: Optional["ISignal.TransformationISignalPropss"] = field(
        default=None,
        metadata={
