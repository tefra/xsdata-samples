...
class DiagnosticSessionControl:
    ...
    :ivar diagnostic_session_ref: This represents the applicable
        DiagnosticSessions
    :ivar session_control_class_ref: This reference substantiates that
        ...
        access shared attributes among all DiagnosticSessionControl in
        the given context.
    ...
    annotations: None | DiagnosticSessionControl.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticSessionControl.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    diagnostic_session_ref: (
        None | DiagnosticSessionControl.DiagnosticSessionRef
    ) = field(
        default=None,
        metadata={
    ...
    session_control_class_ref: (
        None | DiagnosticSessionControl.SessionControlClassRef
    ) = field(
        default=None,
        metadata={
