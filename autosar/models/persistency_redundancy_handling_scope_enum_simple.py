...
class PersistencyRedundancyHandlingScopeEnumSimple(Enum):
    ...
    :cvar PERSISTENCY_REDUNDANCY_HANDLING_SCOPE_STORAGE: The redundancy
        ...
        storage) level.
    """
    PERSISTENCY_REDUNDANCY_HANDLING_SCOPE_ELEMENT = "PERSISTENCY-REDUNDANCY-HANDLING-SCOPE-ELEMENT"
    PERSISTENCY_REDUNDANCY_HANDLING_SCOPE_STORAGE = "PERSISTENCY-REDUNDANCY-HANDLING-SCOPE-STORAGE"
