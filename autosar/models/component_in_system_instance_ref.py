...
class ComponentInSystemInstanceRef:
    ...
    context_composition_ref: Optional["ComponentInSystemInstanceRef.ContextCompositionRef"] = field(
        default=None,
        metadata={
    ...
    context_component_ref: List["ComponentInSystemInstanceRef.ContextComponentRef"] = field(
    ...
    target_component_ref: Optional["ComponentInSystemInstanceRef.TargetComponentRef"] = field(
        default=None,
        metadata={
