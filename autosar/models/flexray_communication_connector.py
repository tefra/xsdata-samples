...
class FlexrayCommunicationConnector:
    ...
    :ivar nm_ready_sleep_time: The value of this attribute influences
        the shutdown behavior of the FlexRay NM. FrNm switches to bus
        sleep mode nmReadySleepTime seconds after  the completion of the
        last repetition cycle containing a NM vote.
    :ivar pnc_filter_data_mask: Bit mask for FlexRay Payload used to
        configure the NM filter mask for the Network Management.
    :ivar wake_up_channel: Referenced channel used by the node to send a
        wakeup pattern. (pWakeupChannel)
