...
class RestResourceDef:
    ...
    annotations: RestResourceDef.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    elements: RestResourceDef.Elements | None = field(
        default=None,
        metadata={
            "name": "ELEMENTS",
            "type": "Element",
    ...
    endpoints: RestResourceDef.Endpoints | None = field(
        default=None,
        metadata={
            "name": "ENDPOINTS",
            "type": "Element",
    ...
    resources: RestResourceDef.Resources | None = field(
        default=None,
        metadata={
            "name": "RESOURCES",
            "type": "Element",
