...
class TimingExtensionResource:
    ...
    short_name_fragments: Optional["TimingExtensionResource.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    timing_arguments: Optional["TimingExtensionResource.TimingArguments"] = field(
        default=None,
        metadata={
    ...
    timing_variables: Optional["TimingExtensionResource.TimingVariables"] = field(
        default=None,
        metadata={
