...
class DiagnosticRequestFileTransferClass:
    ...
    short_name_fragments: Optional[
        "DiagnosticRequestFileTransferClass.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestFileTransferClass.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: Optional[
        "DiagnosticRequestFileTransferClass.AccessPermissionRef"
    ] = field(
        default=None,
        metadata={
