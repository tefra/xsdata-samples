...
class DiagnosticRequestFileTransferClass:
    ...
    short_name_fragments: (
        None | DiagnosticRequestFileTransferClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticRequestFileTransferClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRequestFileTransferClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
