...
class DiagnosticRequestFileTransferClass:
    ...
    short_name_fragments: (
        DiagnosticRequestFileTransferClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestFileTransferClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        DiagnosticRequestFileTransferClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
