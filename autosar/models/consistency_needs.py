...
class ConsistencyNeeds:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar dpg_does_not_require_coherencys: This group of
        VariableDataPrototypes does not require coherency with respect
        to the implicit communication behavior. The upper multiplicity
        of this role has been increased to * due to resolving an
        atpVariation stereotype. The previous value was -1.
    :ivar dpg_requires_coherencys: This group of VariableDataPrototypes
        requires coherency with respect to the implicit communication
        behavior, i.e. all read and write access to
        VariableDataPrototypes in the DataPrototypeGroup by the
        RunnableEntitys of the RunnableEntityGroup need to be handled in
        a coherent manner. The upper multiplicity of this role has been
        increased to * due to resolving an atpVariation stereotype. The
        previous value was -1.
    :ivar reg_does_not_require_stabilitys: This group of
        RunnableEntities does not require stability with respect to the
        implicit communication behavior. The upper multiplicity of this
        role has been increased to * due to resolving an atpVariation
        stereotype. The previous value was -1.
    :ivar reg_requires_stabilitys: This group of RunnableEntities
        requires stability with respect to the implicit communication
        behavior, i.e. all read and write access to
        VariableDataPrototypes in the DataPrototypeGroup by the
        RunnableEntitys of the RunnableEntityGroup need to be handled in
        a stable manner. The upper multiplicity of this role has been
        increased to * due to resolving an atpVariation stereotype. The
        previous value was -1.
    ...
    short_name_fragments: ConsistencyNeeds.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    dpg_does_not_require_coherencys: ConsistencyNeeds.DpgDoesNotRequireCoherencys | None = field(
        default=None,
        metadata={
    ...
    dpg_requires_coherencys: ConsistencyNeeds.DpgRequiresCoherencys | None = field(
        default=None,
        metadata={
    ...
    reg_does_not_require_stabilitys: ConsistencyNeeds.RegDoesNotRequireStabilitys | None = field(
        default=None,
        metadata={
    ...
    reg_requires_stabilitys: ConsistencyNeeds.RegRequiresStabilitys | None = field(
        default=None,
        metadata={
