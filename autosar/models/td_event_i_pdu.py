...
class TdEventIPdu:
    ...
    I-PDUs between the bus specific (FlexRay / CAN / LIN) Interface BSW
    module and COM.
    ...
    :ivar i_pdu_ref: The scope of this timing event.
    :ivar physical_channel_ref: The PhysicalChannel on which the IPdu is
        transmitted.
    :ivar td_event_type: The specific type of this timing event.
    ...
    short_name_fragments: Optional["TdEventIPdu.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventIPdu.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_instance_ref: Optional["TdEventIPdu.EcuInstanceRef"] = field(
        default=None,
        metadata={
    ...
    i_pdu_ref: Optional["TdEventIPdu.IPduRef"] = field(
        default=None,
        metadata={
            "name": "I-PDU-REF",
            "type": "Element",
    ...
    physical_channel_ref: Optional["TdEventIPdu.PhysicalChannelRef"] = field(
        default=None,
        metadata={
    ...
    td_event_type: Optional[TdEventIPduTypeEnum] = field(
        default=None,
        metadata={
            "name": "TD-EVENT-TYPE",
            "type": "Element",
