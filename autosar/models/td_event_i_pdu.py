...
class TdEventIPdu:
    ...
    annotations: None | TdEventIPdu.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_instance_ref: None | TdEventIPdu.EcuInstanceRef = field(
        default=None,
        metadata={
    ...
    i_pdu_ref: None | TdEventIPdu.IPduRef = field(
        default=None,
        metadata={
            "name": "I-PDU-REF",
            "type": "Element",
    ...
    physical_channel_ref: None | TdEventIPdu.PhysicalChannelRef = field(
        default=None,
        metadata={
    ...
    td_event_type: None | TdEventIPduTypeEnum = field(
        default=None,
        metadata={
            "name": "TD-EVENT-TYPE",
            "type": "Element",
