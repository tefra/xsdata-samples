...
class PersistencyKeyValueStorageInterface:
    ...
    supporting persistency use cases for data.
    ...
    :ivar update_strategy: This attribute can be used to specify the
        ...
        whole.
    :ivar data_elements: This aggregation represents the collection of
        PersistencyDataElements in the context of the enclosing
        Persistency KeyValueStorageInterface.
    :ivar data_type_for_serialization_refs: This reference identifies
        the AbstractImplementationData Types that shall be supported for
        storing in a key-value storage in addition to the types already
        determined from tha aggregation of PersistencyDataElement.
    ...
    namespaces: Optional["PersistencyKeyValueStorageInterface.Namespaces"] = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
