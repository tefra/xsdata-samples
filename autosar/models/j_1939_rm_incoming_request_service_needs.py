...
class J1939RmIncomingRequestServiceNeeds:
    ...
    short_name_fragments: Optional["J1939RmIncomingRequestServiceNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["J1939RmIncomingRequestServiceNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
