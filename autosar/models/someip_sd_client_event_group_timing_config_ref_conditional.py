...
class SomeipSdClientEventGroupTimingConfigRefConditional:
    ...
    someip_sd_client_event_group_timing_config_ref: Optional["SomeipSdClientEventGroupTimingConfigRefConditional.SomeipSdClientEventGroupTimingConfigRef"] = field(
        default=None,
        metadata={
