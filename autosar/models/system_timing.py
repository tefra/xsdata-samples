...
class SystemTiming:
    ...
    :ivar timing_resource: The timing resource contains all instance
        ...
        timing view.
    :ivar system_ref: This defines the scope of a SystemTiming. All
    ...
    short_name_fragments: Optional["SystemTiming.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SystemTiming.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    timing_conditions: Optional["SystemTiming.TimingConditions"] = field(
        default=None,
        metadata={
    ...
    timing_descriptions: Optional["SystemTiming.TimingDescriptions"] = field(
        default=None,
        metadata={
    ...
    timing_guarantees: Optional["SystemTiming.TimingGuarantees"] = field(
        default=None,
        metadata={
    ...
    timing_requirements: Optional["SystemTiming.TimingRequirements"] = field(
        default=None,
        metadata={
    ...
    system_ref: Optional["SystemTiming.SystemRef"] = field(
        default=None,
        metadata={
            "name": "SYSTEM-REF",
            "type": "Element",
