...
@dataclass
class FunctionGroupStateInFunctionGroupSetInstanceRef:
    """
    ...
    context_mode_declaration_group_prototype_ref: Optional["FunctionGroupStateInFunctionGroupSetInstanceRef.ContextModeDeclarationGroupPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    target_mode_declaration_ref: Optional["FunctionGroupStateInFunctionGroupSetInstanceRef.TargetModeDeclarationRef"] = field(
        default=None,
        metadata={
