...
class GlobalTimeFrSlave:
    ...
    short_name_fragments: Optional["GlobalTimeFrSlave.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    communication_connector_ref: Optional["GlobalTimeFrSlave.CommunicationConnectorRef"] = field(
        default=None,
        metadata={
