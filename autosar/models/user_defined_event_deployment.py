...
class UserDefinedEventDeployment:
    ...
    short_name_fragments: Optional["UserDefinedEventDeployment.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["UserDefinedEventDeployment.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_ref: Optional["UserDefinedEventDeployment.EventRef"] = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
