...
class UserDefinedEventDeployment:
    ...
    short_name_fragments: UserDefinedEventDeployment.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: UserDefinedEventDeployment.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_ref: UserDefinedEventDeployment.EventRef | None = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
