...
class UserDefinedEventDeployment:
    ...
    short_name_fragments: (
        None | UserDefinedEventDeployment.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | UserDefinedEventDeployment.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_ref: None | UserDefinedEventDeployment.EventRef = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
