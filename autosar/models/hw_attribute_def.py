...
class HwAttributeDef:
    ...
    annotations: None | HwAttributeDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_attribute_literals: None | HwAttributeDef.HwAttributeLiterals = field(
        default=None,
        metadata={
    ...
    is_required: None | Boolean = field(
        default=None,
        metadata={
            "name": "IS-REQUIRED",
            "type": "Element",
    ...
    unit_ref: None | HwAttributeDef.UnitRef = field(
        default=None,
        metadata={
            "name": "UNIT-REF",
            "type": "Element",
