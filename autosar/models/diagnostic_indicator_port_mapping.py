...
class DiagnosticIndicatorPortMapping:
    ...
    :ivar indicator_ref: Reference to the DiagnosticIndicator which is
        mapped to a SWC service port with DiagnosticIndicatorNeeds.
    ...
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticIndicatorPortMapping on
    ...
    annotations: None | DiagnosticIndicatorPortMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    indicator_ref: None | DiagnosticIndicatorPortMapping.IndicatorRef = field(
        default=None,
        metadata={
            "name": "INDICATOR-REF",
            "type": "Element",
    ...
    process_ref: None | DiagnosticIndicatorPortMapping.ProcessRef = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
