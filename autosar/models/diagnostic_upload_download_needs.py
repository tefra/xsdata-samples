...
class DiagnosticUploadDownloadNeeds:
    """
    This meta-class represents the ability to specify needs regarding
    upload and download by means of diagnostic services.
    ...
    short_name_fragments: DiagnosticUploadDownloadNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticUploadDownloadNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticUploadDownloadNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
