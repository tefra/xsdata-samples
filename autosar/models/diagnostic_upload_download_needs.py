...
class DiagnosticUploadDownloadNeeds:
    """
    This meta-class represents the ability to specify needs regarding upload
    and download by means of diagnostic services.
    ...
    short_name_fragments: Optional["DiagnosticUploadDownloadNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticUploadDownloadNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticUploadDownloadNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
