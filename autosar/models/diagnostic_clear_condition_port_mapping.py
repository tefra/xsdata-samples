...
class DiagnosticClearConditionPortMapping:
    """
    Defines to which SWC service ports with DiagnosticsClearConditionNeeds the
    DiagnosticClearCondition is mapped.
    ...
    :ivar clear_condition_ref: Reference to the ClearCondition which is
        mapped to a SWC service port with DiagnosticClearConditionNeeds.
    ...
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticClearConditionPortMapping
    ...
    short_name_fragments: Optional["DiagnosticClearConditionPortMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticClearConditionPortMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    clear_condition_ref: Optional["DiagnosticClearConditionPortMapping.ClearConditionRef"] = field(
        default=None,
        metadata={
    ...
    process_ref: Optional["DiagnosticClearConditionPortMapping.ProcessRef"] = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
