...
class DiagnosticOperationCycleInterface:
    ...
    short_name_fragments: Optional[
        "DiagnosticOperationCycleInterface.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticOperationCycleInterface.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: Optional[
        "DiagnosticOperationCycleInterface.BlueprintPolicys"
    ] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticOperationCycleInterface.Namespaces"] = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
