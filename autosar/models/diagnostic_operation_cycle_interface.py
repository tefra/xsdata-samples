...
class DiagnosticOperationCycleInterface:
    ...
    short_name_fragments: (
        DiagnosticOperationCycleInterface.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticOperationCycleInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: (
        DiagnosticOperationCycleInterface.BlueprintPolicys | None
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticOperationCycleInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
