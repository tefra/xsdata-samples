...
class Documentation:
    ...
    :ivar contexts: This is the context of the particular documentation.
    :ivar documentation_content: This is the content of the
        documentation related to the specified contexts.
    ...
    short_name_fragments: Optional["Documentation.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["Documentation.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    contexts: Optional["Documentation.Contexts"] = field(
        default=None,
        metadata={
            "name": "CONTEXTS",
            "type": "Element",
    ...
    documentation_content: Optional[PredefinedChapter] = field(
        default=None,
        metadata={
    ...
    @dataclass
    class Contexts:
        documentation_context: List[DocumentationContext] = field(
            default_factory=list,
            metadata={
