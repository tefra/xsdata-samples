...
class SdgClass:
    ...
    annotations: None | SdgClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    extends_meta_class: None | MetaClassName = field(
        default=None,
        metadata={
    ...
    attributes: None | SdgClass.Attributes = field(
        default=None,
        metadata={
            "name": "ATTRIBUTES",
            "type": "Element",
    ...
    sdg_constraint_refs: None | SdgClass.SdgConstraintRefs = field(
        default=None,
        metadata={
