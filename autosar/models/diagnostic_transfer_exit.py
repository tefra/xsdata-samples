...
class DiagnosticTransferExit:
    ...
    annotations: None | DiagnosticTransferExit.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticTransferExit.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    transfer_exit_class_ref: (
        None | DiagnosticTransferExit.TransferExitClassRef
    ) = field(
        default=None,
        metadata={
