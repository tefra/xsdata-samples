...
class ModeInterfaceMapping:
    ...
    :ivar mode_mapping: Mapping of two ModeDeclarationGroupPrototypes in
        two different ModeInterfaces
    ...
    annotations: None | ModeInterfaceMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ModeInterfaceMapping.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    mode_mapping: None | ModeDeclarationGroupPrototypeMapping = field(
        default=None,
        metadata={
            "name": "MODE-MAPPING",
            "type": "Element",
