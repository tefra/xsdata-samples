...
class CanTpNode:
    ...
    :ivar connector_ref: Association to a CommunicationConnector in the
        ...
        be avoided).
    :ivar max_fc_wait: This attribute defines the maximum number of flow
        control PDUs that can be consecutively be transmitted by a
        receiver.
    :ivar st_min: Sets the duration of the minimum time the CanTp sender
        shall wait between the transmissions of two CF N-PDUs.
    :ivar timeout_ar: This attribute states the timeout between the PDU
        transmit request of the Transport Layer to the Can Interface and
        the corresponding confirmation of the Can Interface on the
        receiver side (for FC or AF). Specified in seconds.
    :ivar timeout_as: This attribute states the timeout between the PDU
        ...
        current connection of the Transport Layer to the Can Interface
        and the corresponding confirmation of the Can Interface (when
        having sent the last PDU of the group used in this connection)
        on the sender side (SF-x, FF-x, CF or FC (in case of Transmit
    ...
    annotations: None | CanTpNode.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    connector_ref: None | CanTpNode.ConnectorRef = field(
        default=None,
        metadata={
            "name": "CONNECTOR-REF",
            "type": "Element",
    ...
    max_fc_wait: None | Integer = field(
        default=None,
        metadata={
            "name": "MAX-FC-WAIT",
            "type": "Element",
    ...
    tp_address_ref: None | CanTpNode.TpAddressRef = field(
        default=None,
        metadata={
            "name": "TP-ADDRESS-REF",
            "type": "Element",
