...
class DiagnosticDataIdentifierSet:
    """
    This represents the ability to define a list of
    DiagnosticDataIdentifiers that can be reused in different contexts.
    ...
    short_name_fragments: (
        None | DiagnosticDataIdentifierSet.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticDataIdentifierSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    data_identifier_refs: (
        None | DiagnosticDataIdentifierSet.DataIdentifierRefs
    ) = field(
        default=None,
        metadata={
