...
class TdEventFrClusterCycleStart:
    ...
    where a communication cycle starts on a FlexRay cluster.
    ...
    :ivar cycle_repetition: The start of every &lt;cycleRepetition&gt;
        cycle is targeted by this event.
    :ivar fr_cluster_ref: The scope of this timing event.
    ...
    short_name_fragments: (
        None | TdEventFrClusterCycleStart.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | TdEventFrClusterCycleStart.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_instance_ref: None | TdEventFrClusterCycleStart.EcuInstanceRef = field(
        default=None,
        metadata={
    ...
    fr_cluster_ref: None | TdEventFrClusterCycleStart.FrClusterRef = field(
        default=None,
        metadata={
            "name": "FR-CLUSTER-REF",
            "type": "Element",
    ...
    @dataclass
    class FrClusterRef(Ref):
        dest: None | FlexrayClusterSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
