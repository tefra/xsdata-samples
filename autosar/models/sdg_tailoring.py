...
class SdgTailoring:
    ...
    :ivar sdg_class_ref: Specification of the structure of the Special
        Data Group.
    ...
    annotations: None | SdgTailoring.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    sdg_class_ref: None | SdgTailoring.SdgClassRef = field(
        default=None,
        metadata={
            "name": "SDG-CLASS-REF",
            "type": "Element",
