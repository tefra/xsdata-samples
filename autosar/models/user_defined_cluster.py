...
class UserDefinedCluster:
    ...
    short_name_fragments: Optional["UserDefinedCluster.ShortNameFragments"] = (
        field(
            default=None,
            metadata={
    ...
    user_defined_cluster_variants: Optional[
        "UserDefinedCluster.UserDefinedClusterVariants"
    ] = field(
        default=None,
        metadata={
