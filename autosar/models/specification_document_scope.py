...
class SpecificationDocumentScope:
    ...
    :ivar custom_documentation_ref: reference to a custom defined
        specification.
    :ivar document_element_scopes: An element with a name or ID that is
        specified in the Spcification Document.
