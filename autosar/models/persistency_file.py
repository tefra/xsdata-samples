...
class PersistencyFile:
    """
    This meta-class represents the model of a file as part of the
    persistency on deployment level.
    ...
    :ivar content_uri: This attribute represents the URI that identifies
        the initial content of the PersistencyFile.
    :ivar file_name: This attribute holds filename part of the storage
        location for the PersistencyFile, e.g. file on the file system.
    ...
    short_name_fragments: Optional["PersistencyFile.ShortNameFragments"] = (
        field(
            default=None,
            metadata={
