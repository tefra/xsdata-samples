...
class DiagnosticSecurityAccess:
    ...
    :ivar request_seed_id: This would be 0x01, 0x03, 0x05, ... The
        sendKey id can be computed by adding 1 to the requestSeedId
    :ivar security_access_class_ref: This reference substantiates that
        ...
        access shared attributes among all DiagnosticSecurityAccess in
        the given context.
    :ivar security_level_ref: This reference identifies the applicable
        security level for the security access.
    ...
    annotations: None | DiagnosticSecurityAccess.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticSecurityAccess.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    request_seed_id: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    security_access_class_ref: (
        None | DiagnosticSecurityAccess.SecurityAccessClassRef
    ) = field(
        default=None,
        metadata={
    ...
    security_level_ref: None | DiagnosticSecurityAccess.SecurityLevelRef = (
        field(
            default=None,
            metadata={
