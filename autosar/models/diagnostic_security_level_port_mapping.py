...
class DiagnosticSecurityLevelPortMapping:
    ...
    :ivar security_level_ref: Reference to the SecurityLevelwhich is
        mapped to a SWC service port with
        DiagnosticCommunicationSecurityNeeds.
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticSecurityLevelMapping on
    ...
    short_name_fragments: Optional["DiagnosticSecurityLevelPortMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticSecurityLevelPortMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    process_ref: Optional["DiagnosticSecurityLevelPortMapping.ProcessRef"] = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
    ...
    security_level_ref: Optional["DiagnosticSecurityLevelPortMapping.SecurityLevelRef"] = field(
        default=None,
        metadata={
