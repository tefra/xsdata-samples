...
class PhmContributionToMachineMapping:
    ...
    :ivar machine_ref: This reference identifies the Machine in the
        context of the PhmContributionToMachineMapping.
    :ivar phm_contribution_refs: This reference identifies one or more
        PlatformHealthManagementContributions in the context of a
    ...
    short_name_fragments: (
        None | PhmContributionToMachineMapping.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | PhmContributionToMachineMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    machine_ref: None | PhmContributionToMachineMapping.MachineRef = field(
        default=None,
        metadata={
            "name": "MACHINE-REF",
            "type": "Element",
    ...
    phm_contribution_refs: (
        None | PhmContributionToMachineMapping.PhmContributionRefs
    ) = field(
        default=None,
        metadata={
    ...
    class PhmContributionRefs:
        ...
        class PhmContributionRef(Ref):
            dest: PlatformHealthManagementContributionSubtypesEnum = field(
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
                    "required": True,
