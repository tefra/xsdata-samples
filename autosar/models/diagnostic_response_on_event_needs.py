...
class DiagnosticResponseOnEventNeeds:
    """
    This meta-class indicates a service use-case for the diagnostic service
    ResponseOnEvent.
    ...
    short_name_fragments: Optional["DiagnosticResponseOnEventNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticResponseOnEventNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticResponseOnEventNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
