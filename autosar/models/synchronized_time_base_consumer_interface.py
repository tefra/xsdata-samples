...
class SynchronizedTimeBaseConsumerInterface:
    ...
    interaction with a Time Synchronization Consumer.
    ...
    short_name_fragments: Optional["SynchronizedTimeBaseConsumerInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SynchronizedTimeBaseConsumerInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["SynchronizedTimeBaseConsumerInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["SynchronizedTimeBaseConsumerInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
