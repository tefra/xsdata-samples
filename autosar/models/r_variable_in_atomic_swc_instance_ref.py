...
class RVariableInAtomicSwcInstanceRef:
    ...
    context_r_port_ref: Optional["RVariableInAtomicSwcInstanceRef.ContextRPortRef"] = field(
        default=None,
        metadata={
    ...
    target_data_element_ref: Optional["RVariableInAtomicSwcInstanceRef.TargetDataElementRef"] = field(
        default=None,
        metadata={
