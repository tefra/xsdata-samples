...
class DiagnosticTroubleCodeUds:
    ...
    :ivar consider_pto_status: This attribute describes the affection of
        ...
        by the Dem PTO handling.  False: the event is not affected by
        the Dem PTO handling.
    ...
    short_name_fragments: Optional["DiagnosticTroubleCodeUds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    wwh_obd_dtc_class: Optional[DiagnosticWwhObdDtcClassEnumValueVariationPoint] = field(
        default=None,
        metadata={
