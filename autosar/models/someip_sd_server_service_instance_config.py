...
class SomeipSdServerServiceInstanceConfig:
    ...
    :ivar request_response_delay: Maximum/Minimum allowable response
        delay to entries received by multicast in seconds. The Service
        Discovery shall delay answers to entries that were transported
        in a multicast SOME/IP-SD message (e.g. FindService).
    :ivar service_offer_time_to_live: Defines the time in seconds the
        service offer is valid.
    ...
    short_name_fragments: Optional["SomeipSdServerServiceInstanceConfig.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SomeipSdServerServiceInstanceConfig.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    service_offer_time_to_live: Optional[PositiveInteger] = field(
        default=None,
        metadata={
            "name": "SERVICE-OFFER-TIME-TO-LIVE",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
