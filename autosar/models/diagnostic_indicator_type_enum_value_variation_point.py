...
@dataclass
class DiagnosticIndicatorTypeEnumValueVariationPoint:
    """
    ...
    sysc_string_ref: List["DiagnosticIndicatorTypeEnumValueVariationPoint.SyscStringRef"] = field(
        default_factory=list,
        metadata={
    ...
    sysc_ref: List["DiagnosticIndicatorTypeEnumValueVariationPoint.SyscRef"] = field(
        default_factory=list,
        metadata={
            "name": "SYSC-REF",
            "type": "Element",
