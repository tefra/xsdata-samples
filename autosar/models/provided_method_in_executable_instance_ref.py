...
class ProvidedMethodInExecutableInstanceRef:
    ...
    context_p_port_prototype_ref: (
        None | ProvidedMethodInExecutableInstanceRef.ContextPPortPrototypeRef
    ) = field(
        default=None,
        metadata={
    ...
    target_method_ref: (
        None | ProvidedMethodInExecutableInstanceRef.TargetMethodRef
    ) = field(
        default=None,
        metadata={
