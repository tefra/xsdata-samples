...
class EcucReferenceValue:
    ...
    definition_ref: EcucReferenceValue.DefinitionRef | None = field(
        default=None,
        metadata={
            "name": "DEFINITION-REF",
            "type": "Element",
    ...
    annotations: EcucReferenceValue.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    value_ref: EcucReferenceValue.ValueRef | None = field(
        default=None,
        metadata={
            "name": "VALUE-REF",
            "type": "Element",
