...
class ComManagementMapping:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar com_management_group_refs: IPduGroup participating in a Mode
        Management PortGroup.
    :ivar com_management_port_group_irefs: Mode Management PortGroup to
        be mapped onto a communication channel. This reference is
        optional in case that the System Description doesn't use a
        complete Software Component Description (VFB View). This
        supports the inclusion of legacy systems.
    :ivar physical_channel_refs: This reference maps the Mode Management
        PortGroup partial network to communication channels.
