...
class DiagnosticReadDataByPeriodicId:
    ...
    short_name_fragments: Optional[
        "DiagnosticReadDataByPeriodicId.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticReadDataByPeriodicId.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: Optional[
        "DiagnosticReadDataByPeriodicId.AccessPermissionRef"
    ] = field(
        default=None,
        metadata={
    ...
    data_identifier_ref: Optional[
        "DiagnosticReadDataByPeriodicId.DataIdentifierRef"
    ] = field(
        default=None,
        metadata={
    ...
    read_data_class_ref: Optional[
        "DiagnosticReadDataByPeriodicId.ReadDataClassRef"
    ] = field(
        default=None,
        metadata={
    ...
    class ReadDataClassRef(Ref):
        dest: Optional[DiagnosticReadDataByPeriodicIdClassSubtypesEnum] = (
            field(
                default=None,
                metadata={
                    "name": "DEST",
