...
class FlexrayFrame:
    ...
    short_name_fragments: None | FlexrayFrame.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | FlexrayFrame.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: None | FlexrayFrame.PduToFrameMappings = field(
        default=None,
        metadata={
