...
class FlexrayFrame:
    ...
    short_name_fragments: FlexrayFrame.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: FlexrayFrame.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: FlexrayFrame.PduToFrameMappings | None = field(
        default=None,
        metadata={
