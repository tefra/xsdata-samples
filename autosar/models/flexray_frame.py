...
class FlexrayFrame:
    ...
    short_name_fragments: Optional["FlexrayFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["FlexrayFrame.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: Optional["FlexrayFrame.PduToFrameMappings"] = field(
        default=None,
        metadata={
