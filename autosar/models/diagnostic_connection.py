...
class DiagnosticConnection:
    """
    DiagnosticConncection that is used to describe the relationship between several
    TP connections.
    ...
    :ivar functional_request_refs: Reference to functional request
        messages.
    :ivar periodic_response_uudt_refs: Reference to UUDT responses.
    :ivar physical_request_ref: Reference to a physical request message.
    :ivar response_on_event_ref: Reference to a ROE message.
    :ivar response_ref: In the vast majority of cases a response is
        required. However, there are also cases where providing the
    ...
    class FunctionalRequestRefs:
        ...
        class FunctionalRequestRef(Ref):
            dest: Optional[TpConnectionIdentSubtypesEnum] = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
