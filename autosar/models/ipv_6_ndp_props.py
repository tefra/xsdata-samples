...
class Ipv6NdpProps:
    ...
    tcp_ip_ndp_neighbor_unreachability_detection_enabled: Optional[Boolean] = field(
        default=None,
        metadata={
    ...
    tcp_ip_ndp_slaac_dad_number_of_transmissions: Optional[PositiveInteger] = field(
        default=None,
        metadata={
