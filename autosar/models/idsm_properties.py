...
class IdsmProperties:
    ...
    annotations: None | IdsmProperties.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    rate_limitation_filters: None | IdsmProperties.RateLimitationFilters = (
        field(
            default=None,
            metadata={
    ...
    traffic_limitation_filters: (
        None | IdsmProperties.TrafficLimitationFilters
    ) = field(
        default=None,
        metadata={
