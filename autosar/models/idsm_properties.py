...
class IdsmProperties:
    ...
    :ivar rate_limitation_filters: This aggregation represents the
        collection of rate limitation filters for security events in the
        enclosing SecurityFilterSet.
    :ivar traffic_limitation_filters: This aggregation represents the
        collection of traffic limitation filters for security events in
        the enclosing SecurityFilterSet.
    ...
    short_name_fragments: Optional["IdsmProperties.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    rate_limitation_filters: Optional["IdsmProperties.RateLimitationFilters"] = field(
        default=None,
        metadata={
    ...
    traffic_limitation_filters: Optional["IdsmProperties.TrafficLimitationFilters"] = field(
        default=None,
        metadata={
