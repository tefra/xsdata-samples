...
class ApplicationAssocMapElement:
    ...
    short_name_fragments: Optional["ApplicationAssocMapElement.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ApplicationAssocMapElement.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_tref: Optional["ApplicationAssocMapElement.TypeTref"] = field(
        default=None,
        metadata={
            "name": "TYPE-TREF",
            "type": "Element",
