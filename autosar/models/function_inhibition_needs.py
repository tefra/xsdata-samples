...
class FunctionInhibitionNeeds:
    ...
    as a symbol identifying the FID from the viewpoint of the component or
    ...
    short_name_fragments: FunctionInhibitionNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: FunctionInhibitionNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
