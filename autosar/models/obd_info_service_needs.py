...
class ObdInfoServiceNeeds:
    ...
    configuration of OBD Services in relation to a given InfoType (OBD
    Service 09) which is supported by this component or module.
    ...
    :ivar data_length: This attribute is applicable only if the
        ...
        this InfoType.
    :ivar info_type: The InfoType according to ISO 15031-5
    ...
    short_name_fragments: None | ObdInfoServiceNeeds.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | ObdInfoServiceNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | ObdInfoServiceNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    info_type: None | PositiveInteger = field(
        default=None,
        metadata={
            "name": "INFO-TYPE",
            "type": "Element",
