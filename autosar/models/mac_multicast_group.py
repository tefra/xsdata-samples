...
class MacMulticastGroup:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar mac_multicast_address: A multicast MAC address (Media Access
        Control address) is a identifier for a group of hosts in a
        network.
    ...
    short_name_fragments: None | MacMulticastGroup.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | MacMulticastGroup.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mac_multicast_address: None | MacAddressString = field(
        default=None,
        metadata={
