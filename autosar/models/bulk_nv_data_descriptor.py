...
class BulkNvDataDescriptor:
    ...
    The purpose of a bulk NV Data Block is to provide access to information
    uploaded to the vehicle at e.g. the end of the production line.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar bulk_nv_block: This aggregation represents the actual bulk
        NVBlock.
    :ivar nv_block_data_mappings: Defines the mapping between the
        VariableDataPrototypes in the NvBlockComponents ports and the
        VariableDataPrototypes of the non-volatile memory. The
        aggregation of NvBlockDataMapping is subject to variability with
        the purpose to support the conditional existence of nv data
        ports. The upper multiplicity of this role has been increased to
    ...
    short_name_fragments: BulkNvDataDescriptor.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    nv_block_data_mappings: BulkNvDataDescriptor.NvBlockDataMappings | None = field(
        default=None,
        metadata={
