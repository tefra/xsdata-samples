...
class DiagnosticSessionControlClass:
    ...
    "Session Control" diagnostic service.
    ...
    short_name_fragments: DiagnosticSessionControlClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticSessionControlClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticSessionControlClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
