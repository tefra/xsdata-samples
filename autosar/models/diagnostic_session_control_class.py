...
class DiagnosticSessionControlClass:
    ...
    short_name_fragments: Optional["DiagnosticSessionControlClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticSessionControlClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticSessionControlClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
