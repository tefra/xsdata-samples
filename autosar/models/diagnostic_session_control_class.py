...
class DiagnosticSessionControlClass:
    ...
    short_name_fragments: (
        None | DiagnosticSessionControlClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticSessionControlClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticSessionControlClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
