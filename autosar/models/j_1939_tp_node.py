...
class J1939TpNode:
    ...
    :ivar tp_address_ref: Reference to the TP Address that is used by
        the TpNode. This reference is optional only when no TP is sent
        and only BAM is received.
    ...
    short_name_fragments: None | J1939TpNode.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | J1939TpNode.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    connector_ref: None | J1939TpNode.ConnectorRef = field(
        default=None,
        metadata={
            "name": "CONNECTOR-REF",
            "type": "Element",
    ...
    tp_address_ref: None | J1939TpNode.TpAddressRef = field(
        default=None,
        metadata={
            "name": "TP-ADDRESS-REF",
            "type": "Element",
