...
class DiagnosticValueNeeds:
    ...
    :ivar data_length: This attribute is applicable only if the
        ServiceNeed is aggregated within BswModuleDependency. This
        attribute represents the length of data (in bytes) provided for
        this particular PID signal.
    :ivar diagnostic_value_access: This attribute controls whether the
        data can be read and written or whether it is to be handled
        read-only.
    :ivar did_number: This represents a Data identifier for the
        diagnostic value. This allows to predefine the DID number if the
        responsible function developer has received a particular
        requirement from the OEM or from a standardization body.
    :ivar fixed_length: This attribute controls whether the data length
        of the data is fixed.
    :ivar processing_style: This attribute controls whether interaction
        requires the software-component to react synchronously on a
        request or whether it processes the request in background but
        still the DCM has to issue the call again to eventually obtain
    ...
    short_name_fragments: Optional["DiagnosticValueNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticValueNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticValueNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    diagnostic_value_access: Optional[DiagnosticValueAccessEnum] = field(
        default=None,
        metadata={
    ...
    fixed_length: Optional[Boolean] = field(
        default=None,
        metadata={
            "name": "FIXED-LENGTH",
            "type": "Element",
    ...
    processing_style: Optional[DiagnosticProcessingStyleEnum] = field(
        default=None,
        metadata={
