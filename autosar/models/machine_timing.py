...
class MachineTiming:
    ...
    :ivar timing_resource: The timing resource contains all instance
        ...
        timing view.
    :ivar machine_ref: This defines the scope of a MachineTiming. All
    ...
    annotations: None | MachineTiming.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    timing_conditions: None | MachineTiming.TimingConditions = field(
        default=None,
        metadata={
    ...
    timing_descriptions: None | MachineTiming.TimingDescriptions = field(
        default=None,
        metadata={
    ...
    timing_guarantees: None | MachineTiming.TimingGuarantees = field(
        default=None,
        metadata={
    ...
    timing_requirements: None | MachineTiming.TimingRequirements = field(
        default=None,
        metadata={
    ...
    machine_ref: None | MachineTiming.MachineRef = field(
        default=None,
        metadata={
            "name": "MACHINE-REF",
            "type": "Element",
