...
class SignalBasedMethodToISignalTriggeringMapping:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar call_signal_triggering_ref: Reference to the ISignalTriggering
        that is used to transport the method call in a signal-based way
        over a communication channel.
    :ivar method_ref: Reference to a method defined in the context of a
        ServiceInterface.
    :ivar return_signal_triggering_ref: Reference to the
        ISignalTriggering that is used to transport the method response
        in a signal-based way over a communication channel.
