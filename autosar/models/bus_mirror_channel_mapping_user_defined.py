...
class BusMirrorChannelMappingUserDefined:
    ...
    short_name_fragments: (
        BusMirrorChannelMappingUserDefined.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: BusMirrorChannelMappingUserDefined.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    target_pdu_triggerings: (
        BusMirrorChannelMappingUserDefined.TargetPduTriggerings | None
    ) = field(
        default=None,
        metadata={
