...
class BusMirrorChannelMappingUserDefined:
    ...
    short_name_fragments: BusMirrorChannelMappingUserDefined.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: BusMirrorChannelMappingUserDefined.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    target_pdu_triggerings: BusMirrorChannelMappingUserDefined.TargetPduTriggerings | None = field(
        default=None,
        metadata={
    ...
    transmission_deadline: TimeValue | None = field(
        default=None,
        metadata={
