...
class BusMirrorChannelMappingUserDefined:
    ...
    sourceChannel and a UserDefined targetChannel.
    ...
    :ivar transmission_deadline: Time in seconds after which the
        collection of source frames into the destination frame is
        stopped and the frame is sent at the latest.  If omitted,
        destination frames are only sent when full or when the time
        stamp overflows.
    ...
    short_name_fragments: Optional["BusMirrorChannelMappingUserDefined.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BusMirrorChannelMappingUserDefined.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    target_pdu_triggerings: Optional["BusMirrorChannelMappingUserDefined.TargetPduTriggerings"] = field(
        default=None,
        metadata={
    ...
    transmission_deadline: Optional[TimeValue] = field(
        default=None,
        metadata={
            "name": "TRANSMISSION-DEADLINE",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
