...
class BswCalledEntity:
    ...
    short_name_fragments: Optional["BswCalledEntity.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswCalledEntity.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reasons: Optional["BswCalledEntity.ActivationReasons"] = field(
        default=None,
        metadata={
    ...
    can_enter_exclusive_area_refs: Optional["BswCalledEntity.CanEnterExclusiveAreaRefs"] = field(
        default=None,
        metadata={
    ...
    exclusive_area_nesting_order_refs: Optional["BswCalledEntity.ExclusiveAreaNestingOrderRefs"] = field(
        default=None,
        metadata={
    ...
    runs_inside_exclusive_area_refs: Optional["BswCalledEntity.RunsInsideExclusiveAreaRefs"] = field(
        default=None,
        metadata={
    ...
    sw_addr_method_ref: Optional["BswCalledEntity.SwAddrMethodRef"] = field(
        default=None,
        metadata={
    ...
    accessed_mode_groups: Optional["BswCalledEntity.AccessedModeGroups"] = field(
        default=None,
        metadata={
    ...
    call_points: Optional["BswCalledEntity.CallPoints"] = field(
        default=None,
        metadata={
            "name": "CALL-POINTS",
            "type": "Element",
    ...
    called_entrys: Optional["BswCalledEntity.CalledEntrys"] = field(
        default=None,
        metadata={
            "name": "CALLED-ENTRYS",
            "type": "Element",
    ...
    data_receive_points: Optional["BswCalledEntity.DataReceivePoints"] = field(
        default=None,
        metadata={
    ...
    data_send_points: Optional["BswCalledEntity.DataSendPoints"] = field(
        default=None,
        metadata={
    ...
    implemented_entry_ref: Optional["BswCalledEntity.ImplementedEntryRef"] = field(
        default=None,
        metadata={
    ...
    managed_mode_groups: Optional["BswCalledEntity.ManagedModeGroups"] = field(
        default=None,
        metadata={
    ...
    scheduler_name_prefix_ref: Optional["BswCalledEntity.SchedulerNamePrefixRef"] = field(
        default=None,
        metadata={
    ...
    class CanEnterExclusiveAreaRefs:
        can_enter_exclusive_area_ref: List["BswCalledEntity.CanEnterExclusiveAreaRefs.CanEnterExclusiveAreaRef"] = field(
            default_factory=list,
            metadata={
    ...
    class ExclusiveAreaNestingOrderRefs:
        exclusive_area_nesting_order_ref: List["BswCalledEntity.ExclusiveAreaNestingOrderRefs.ExclusiveAreaNestingOrderRef"] = field(
            default_factory=list,
            metadata={
    ...
    class RunsInsideExclusiveAreaRefs:
        runs_inside_exclusive_area_ref: List["BswCalledEntity.RunsInsideExclusiveAreaRefs.RunsInsideExclusiveAreaRef"] = field(
            default_factory=list,
            metadata={
