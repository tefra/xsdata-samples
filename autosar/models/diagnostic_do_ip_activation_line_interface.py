...
class DiagnosticDoIpActivationLineInterface:
    ...
    implement the DoIPActivationLine on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticDoIpActivationLineInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDoIpActivationLineInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDoIpActivationLineInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDoIpActivationLineInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
