...
class DiagnosticDoIpActivationLineInterface:
    ...
    short_name_fragments: (
        None | DiagnosticDoIpActivationLineInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticDoIpActivationLineInterface.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: (
        None | DiagnosticDoIpActivationLineInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: None | DiagnosticDoIpActivationLineInterface.Namespaces = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
