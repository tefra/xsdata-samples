...
class CryptoCertificateKeySlotNeeds:
    ...
    short_name_fragments: Optional["CryptoCertificateKeySlotNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CryptoCertificateKeySlotNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
