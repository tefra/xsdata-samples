...
class DiagnosticClearResetEmissionRelatedInfoClass:
    ...
    short_name_fragments: DiagnosticClearResetEmissionRelatedInfoClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticClearResetEmissionRelatedInfoClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticClearResetEmissionRelatedInfoClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
