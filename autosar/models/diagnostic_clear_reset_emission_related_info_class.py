...
class DiagnosticClearResetEmissionRelatedInfoClass:
    ...
    short_name_fragments: (
        None | DiagnosticClearResetEmissionRelatedInfoClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | DiagnosticClearResetEmissionRelatedInfoClass.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticClearResetEmissionRelatedInfoClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
