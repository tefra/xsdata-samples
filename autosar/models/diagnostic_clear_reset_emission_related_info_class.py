...
class DiagnosticClearResetEmissionRelatedInfoClass:
    ...
    instances of the "Clear Reset Emission Related Data" OBD diagnostic
    service.
    ...
    short_name_fragments: Optional["DiagnosticClearResetEmissionRelatedInfoClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticClearResetEmissionRelatedInfoClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticClearResetEmissionRelatedInfoClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
