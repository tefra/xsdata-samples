...
class CanPhysicalChannel:
    ...
    short_name_fragments: Optional["CanPhysicalChannel.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CanPhysicalChannel.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    comm_connectors: Optional["CanPhysicalChannel.CommConnectors"] = field(
        default=None,
        metadata={
    ...
    frame_triggerings: Optional["CanPhysicalChannel.FrameTriggerings"] = field(
        default=None,
        metadata={
    ...
    i_signal_triggerings: Optional["CanPhysicalChannel.ISignalTriggerings"] = field(
        default=None,
        metadata={
    ...
    managed_physical_channel_refs: Optional["CanPhysicalChannel.ManagedPhysicalChannelRefs"] = field(
        default=None,
        metadata={
    ...
    pdu_triggerings: Optional["CanPhysicalChannel.PduTriggerings"] = field(
        default=None,
        metadata={
    ...
    class ManagedPhysicalChannelRefs:
        managed_physical_channel_ref: List["CanPhysicalChannel.ManagedPhysicalChannelRefs.ManagedPhysicalChannelRef"] = field(
            default_factory=list,
            metadata={
