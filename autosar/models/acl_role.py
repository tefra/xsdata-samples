...
class AclRole:
    ...
    short_name_fragments: None | AclRole.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | AclRole.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | AclRole.BlueprintPolicys = field(
        default=None,
        metadata={
