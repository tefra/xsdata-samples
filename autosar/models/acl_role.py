...
class AclRole:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar ldap_url: This is an URL which allows to represent users or
        organizations taking the particular role.
    ...
    short_name_fragments: AclRole.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: AclRole.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: AclRole.BlueprintPolicys | None = field(
        default=None,
        metadata={
