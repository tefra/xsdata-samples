...
class DiagnosticCommunicationManagerNeeds:
    ...
    :ivar service_request_callback_type: This represents the ability to
        define whether the usage of PortInterface
        ServiceRequestNotification has the characteristics of being
        initiated by a manufacturer or by a supplier.
    ...
    audiences: Optional["DiagnosticCommunicationManagerNeeds.Audiences"] = (
        field(
            default=None,
            metadata={
                "name": "AUDIENCES",
