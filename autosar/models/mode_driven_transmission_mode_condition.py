...
class ModeDrivenTransmissionModeCondition:
    ...
    mode_declaration_refs: Optional["ModeDrivenTransmissionModeCondition.ModeDeclarationRefs"] = field(
        default=None,
        metadata={
    ...
    class ModeDeclarationRefs:
        mode_declaration_ref: List["ModeDrivenTransmissionModeCondition.ModeDeclarationRefs.ModeDeclarationRef"] = field(
