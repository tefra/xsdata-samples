...
class DiagnosticWriteDataByIdentifierClass:
    ...
    short_name_fragments: (
        None | DiagnosticWriteDataByIdentifierClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticWriteDataByIdentifierClass.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticWriteDataByIdentifierClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
