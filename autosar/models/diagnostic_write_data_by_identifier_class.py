...
class DiagnosticWriteDataByIdentifierClass:
    ...
    short_name_fragments: (
        DiagnosticWriteDataByIdentifierClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticWriteDataByIdentifierClass.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        DiagnosticWriteDataByIdentifierClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
