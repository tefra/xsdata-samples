...
class PhmSupervisedEntityInterface:
    ...
    short_name_fragments: PhmSupervisedEntityInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    blueprint_policys: PhmSupervisedEntityInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
