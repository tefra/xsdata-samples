...
class PhmSupervisedEntityInterface:
    ...
    :ivar checkpoints: Defines the set of checkpoints which can be
        reported on this supervised entity.
    ...
    short_name_fragments: Optional["PhmSupervisedEntityInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PhmSupervisedEntityInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["PhmSupervisedEntityInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["PhmSupervisedEntityInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    checkpoints: Optional["PhmSupervisedEntityInterface.Checkpoints"] = field(
        default=None,
        metadata={
            "name": "CHECKPOINTS",
            "type": "Element",
    ...
    @dataclass
    class Checkpoints:
        phm_checkpoint: List[PhmCheckpoint] = field(
            default_factory=list,
            metadata={
                "name": "PHM-CHECKPOINT",
                "type": "Element",
