...
class ObdRatioDenominatorNeeds:
    ...
    wants to access the in-use-monitoring performance ration denominator.
    ...
    :ivar denominator_condition: This attribute indicates the applicable
    ...
    annotations: None | ObdRatioDenominatorNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | ObdRatioDenominatorNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    denominator_condition: None | DiagnosticDenominatorConditionEnum = field(
        default=None,
        metadata={
