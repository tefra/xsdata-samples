...
class ObdPidServiceNeeds:
    ...
    configuration of OBD Services in relation to a particular PID (parameter
    identifier) which is supported by this component or module.
    ...
    :ivar data_length: This attribute is applicable only if the
        ServiceNeeds is aggregated within BswModuleDependency. This
        attribute represents the length of data (in bytes) provided for
        this particular PID signal.
    :ivar parameter_id: Standardized parameter identifier (PID)
        according to the OBD standard specified in attribute "standard".
    :ivar standard: Annotates the standard according to which the PID is
    ...
    short_name_fragments: Optional["ObdPidServiceNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ObdPidServiceNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["ObdPidServiceNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    parameter_id: Optional[PositiveInteger] = field(
        default=None,
        metadata={
            "name": "PARAMETER-ID",
            "type": "Element",
    ...
    standard: Optional[String] = field(
        default=None,
        metadata={
            "name": "STANDARD",
            "type": "Element",
