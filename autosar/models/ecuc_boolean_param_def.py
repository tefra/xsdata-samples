...
class EcucBooleanParamDef:
    ...
    :ivar default_value: Default value of the boolean configuration
    ...
    annotations: None | EcucBooleanParamDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: None | EcucBooleanParamDef.RelatedTraceItemRef = (
        field(
            default=None,
            metadata={
    ...
    ecuc_validation_conds: None | EcucBooleanParamDef.EcucValidationConds = (
        field(
            default=None,
            metadata={
    ...
    implementation_config_classes: (
        None | EcucBooleanParamDef.ImplementationConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        None | EcucBooleanParamDef.MultiplicityConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: None | EcucBooleanParamDef.ValueConfigClasses = (
        field(
            default=None,
            metadata={
    ...
    default_value: None | BooleanValueVariationPoint = field(
        default=None,
        metadata={
            "name": "DEFAULT-VALUE",
            "type": "Element",
