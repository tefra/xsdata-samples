...
class DiagnosticEcuResetInterface:
    """
    This meta-class represents the ability to implement a focused PortInterface
    for handling the diagnostic service EcuReset on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticEcuResetInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEcuResetInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticEcuResetInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticEcuResetInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
