...
class DiagnosticEcuResetInterface:
    ...
    annotations: None | DiagnosticEcuResetInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | DiagnosticEcuResetInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | DiagnosticEcuResetInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
