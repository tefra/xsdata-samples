...
class DiagnosticEcuResetInterface:
    ...
    PortInterface for handling the diagnostic service EcuReset on the
    adaptive platform.
    ...
    short_name_fragments: DiagnosticEcuResetInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticEcuResetInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: DiagnosticEcuResetInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticEcuResetInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
