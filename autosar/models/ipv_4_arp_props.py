...
class Ipv4ArpProps:
    ...
    tcp_ip_arp_num_gratuitous_arp_on_startup: Optional[PositiveInteger] = field(
        default=None,
        metadata={
    ...
    tcp_ip_arp_packet_queue_enabled: Optional[Boolean] = field(
        default=None,
        metadata={
    ...
    tcp_ip_arp_request_timeout: Optional[TimeValue] = field(
        default=None,
        metadata={
    ...
    tcp_ip_arp_table_entry_timeout: Optional[TimeValue] = field(
        default=None,
        metadata={
