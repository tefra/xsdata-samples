...
class LifeCycleStateDefinitionGroup:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar lc_states: Describes a single life cycle state of this life
        cycle state definition group.
    ...
    short_name_fragments: Optional["LifeCycleStateDefinitionGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["LifeCycleStateDefinitionGroup.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["LifeCycleStateDefinitionGroup.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    lc_states: Optional["LifeCycleStateDefinitionGroup.LcStates"] = field(
        default=None,
        metadata={
            "name": "LC-STATES",
            "type": "Element",
