...
class LifeCycleStateDefinitionGroup:
    ...
    short_name_fragments: LifeCycleStateDefinitionGroup.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    blueprint_policys: LifeCycleStateDefinitionGroup.BlueprintPolicys | None = field(
        default=None,
        metadata={
