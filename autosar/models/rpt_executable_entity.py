...
class RptExecutableEntity:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar rpt_executable_entity_events: ExecutableEntity event instance
        activation the owning RptExecutableEntity. The upper
        multiplicity of this role has been increased to * due to
        resolving an atpVariation stereotype. The previous value was -1.
    :ivar rpt_reads: read access to a variable The upper multiplicity of
        this role has been increased to * due to resolving an
        atpVariation stereotype. The previous value was -1.
    :ivar rpt_writes: write access to a variable The upper multiplicity
        of this role has been increased to * due to resolving an
        atpVariation stereotype. The previous value was -1.
    :ivar symbol: The symbol describing this ExecutableEntity's entry
        point.
    ...
    short_name_fragments: Optional["RptExecutableEntity.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RptExecutableEntity.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    rpt_executable_entity_events: Optional["RptExecutableEntity.RptExecutableEntityEvents"] = field(
        default=None,
        metadata={
    ...
    rpt_reads: Optional["RptExecutableEntity.RptReads"] = field(
        default=None,
        metadata={
            "name": "RPT-READS",
            "type": "Element",
    ...
    rpt_writes: Optional["RptExecutableEntity.RptWrites"] = field(
        default=None,
        metadata={
            "name": "RPT-WRITES",
            "type": "Element",
