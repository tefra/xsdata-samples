...
class RptExecutableEntity:
    ...
    annotations: RptExecutableEntity.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    rpt_reads: RptExecutableEntity.RptReads | None = field(
        default=None,
        metadata={
            "name": "RPT-READS",
            "type": "Element",
    ...
    rpt_writes: RptExecutableEntity.RptWrites | None = field(
        default=None,
        metadata={
            "name": "RPT-WRITES",
            "type": "Element",
