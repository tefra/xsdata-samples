...
class BswEntryRelationshipSet:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar bsw_entry_relationships: Relationship between two
        BswModuleEntrys.
    ...
    annotations: None | BswEntryRelationshipSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | BswEntryRelationshipSet.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    bsw_entry_relationships: (
        None | BswEntryRelationshipSet.BswEntryRelationships
    ) = field(
        default=None,
        metadata={
