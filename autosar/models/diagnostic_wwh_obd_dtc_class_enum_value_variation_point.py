...
@dataclass
class DiagnosticWwhObdDtcClassEnumValueVariationPoint:
    """
    ...
    sysc_string_ref: List["DiagnosticWwhObdDtcClassEnumValueVariationPoint.SyscStringRef"] = field(
        default_factory=list,
        metadata={
    ...
    sysc_ref: List["DiagnosticWwhObdDtcClassEnumValueVariationPoint.SyscRef"] = field(
        default_factory=list,
        metadata={
            "name": "SYSC-REF",
            "type": "Element",
