...
class SecurityEventMapping:
    ...
    :ivar id: This attribute defines the numerical identification of the
        security event subject to deployment.
    :ivar process_ref: This reference identifies the process in which
        context the seurity event is reported.
    :ivar reporting_port_prototype_iref: This instanceRef identifies the
        portPrototype over which the security event is reported.
    ...
    annotations: None | SecurityEventMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    process_ref: None | SecurityEventMapping.ProcessRef = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
