...
class BswExternalTriggerOccurredEvent:
    ...
    short_name_fragments: Optional[
        "BswExternalTriggerOccurredEvent.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswExternalTriggerOccurredEvent.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    context_limitation_refs: Optional[
        "BswExternalTriggerOccurredEvent.ContextLimitationRefs"
    ] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional[
        "BswExternalTriggerOccurredEvent.DisabledInModeIrefs"
    ] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional[
        "BswExternalTriggerOccurredEvent.StartsOnEventRef"
    ] = field(
        default=None,
        metadata={
    ...
    trigger_ref: Optional["BswExternalTriggerOccurredEvent.TriggerRef"] = (
        field(
            default=None,
            metadata={
                "name": "TRIGGER-REF",
