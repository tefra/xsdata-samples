...
class CryptoTrustMasterInterface:
    ...
    short_name_fragments: Optional["CryptoTrustMasterInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CryptoTrustMasterInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["CryptoTrustMasterInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["CryptoTrustMasterInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
