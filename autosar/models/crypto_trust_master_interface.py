...
class CryptoTrustMasterInterface:
    ...
    short_name_fragments: (
        None | CryptoTrustMasterInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | CryptoTrustMasterInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | CryptoTrustMasterInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | CryptoTrustMasterInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
