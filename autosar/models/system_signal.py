...
class SystemSignal:
    ...
    :ivar dynamic_length: The length of dynamic length signals is
        variable in run-time. Only a maximum length of such a signal is
        specified in the configuration (attribute length in ISignal
        element).
    :ivar physical_props: Specification of the physical representation.
    ...
    short_name_fragments: Optional["SystemSignal.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SystemSignal.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    dynamic_length: Optional[Boolean] = field(
        default=None,
        metadata={
            "name": "DYNAMIC-LENGTH",
            "type": "Element",
    ...
    physical_props: Optional[SwDataDefProps] = field(
        default=None,
        metadata={
            "name": "PHYSICAL-PROPS",
            "type": "Element",
