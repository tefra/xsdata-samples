...
class SystemSignal:
    ...
    short_name_fragments: SystemSignal.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SystemSignal.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    dynamic_length: Boolean | None = field(
        default=None,
        metadata={
            "name": "DYNAMIC-LENGTH",
            "type": "Element",
    ...
    physical_props: SwDataDefProps | None = field(
        default=None,
        metadata={
            "name": "PHYSICAL-PROPS",
            "type": "Element",
