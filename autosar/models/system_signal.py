...
class SystemSignal:
    ...
    short_name_fragments: None | SystemSignal.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | SystemSignal.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    dynamic_length: None | Boolean = field(
        default=None,
        metadata={
            "name": "DYNAMIC-LENGTH",
            "type": "Element",
    ...
    physical_props: None | SwDataDefProps = field(
        default=None,
        metadata={
            "name": "PHYSICAL-PROPS",
            "type": "Element",
