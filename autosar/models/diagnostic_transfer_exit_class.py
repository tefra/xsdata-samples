...
class DiagnosticTransferExitClass:
    ...
    short_name_fragments: DiagnosticTransferExitClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticTransferExitClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticTransferExitClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
