...
class DiagnosticTransferExitClass:
    ...
    short_name_fragments: Optional["DiagnosticTransferExitClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticTransferExitClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticTransferExitClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
