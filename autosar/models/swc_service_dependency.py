...
class SwcServiceDependency:
    ...
    short_name_fragments: SwcServiceDependency.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    assigned_data_types: SwcServiceDependency.AssignedDataTypes | None = field(
        default=None,
        metadata={
    ...
    represented_port_group_ref: (
        SwcServiceDependency.RepresentedPortGroupRef | None
    ) = field(
        default=None,
        metadata={
