...
class ComEventGrantDesign:
    ...
    short_name_fragments: Optional["ComEventGrantDesign.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    process_design_ref: Optional["ComEventGrantDesign.ProcessDesignRef"] = field(
        default=None,
        metadata={
    ...
    remote_subject_ref: Optional["ComEventGrantDesign.RemoteSubjectRef"] = field(
        default=None,
        metadata={
