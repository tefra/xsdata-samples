...
class DiagnosticFimFunctionMapping:
    ...
    :ivar mapped_flat_swc_service_dependency_ref: This represents the
        ...
        component hierarchy.
    :ivar mapped_function_ref: This represents the mapped FID.
    :ivar mapped_swc_service_dependency_iref: This represents the
        ability to point into the component hierarchy (under possible
    ...
    annotations: None | DiagnosticFimFunctionMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mapped_bsw_service_dependency_ref: (
        None | DiagnosticFimFunctionMapping.MappedBswServiceDependencyRef
    ) = field(
        default=None,
        metadata={
    ...
    mapped_flat_swc_service_dependency_ref: (
        None | DiagnosticFimFunctionMapping.MappedFlatSwcServiceDependencyRef
    ) = field(
        default=None,
        metadata={
    ...
    mapped_function_ref: (
        None | DiagnosticFimFunctionMapping.MappedFunctionRef
    ) = field(
        default=None,
        metadata={
