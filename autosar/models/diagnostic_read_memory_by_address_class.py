...
class DiagnosticReadMemoryByAddressClass:
    ...
    "Read Memory by Address" diagnostic service.
    ...
    short_name_fragments: DiagnosticReadMemoryByAddressClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticReadMemoryByAddressClass.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: DiagnosticReadMemoryByAddressClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
