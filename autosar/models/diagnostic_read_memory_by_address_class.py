...
class DiagnosticReadMemoryByAddressClass:
    ...
    short_name_fragments: Optional[
        "DiagnosticReadMemoryByAddressClass.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticReadMemoryByAddressClass.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: Optional[
        "DiagnosticReadMemoryByAddressClass.AccessPermissionRef"
    ] = field(
        default=None,
        metadata={
