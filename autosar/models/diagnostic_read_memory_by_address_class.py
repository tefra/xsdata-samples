...
class DiagnosticReadMemoryByAddressClass:
    ...
    short_name_fragments: (
        None | DiagnosticReadMemoryByAddressClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticReadMemoryByAddressClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticReadMemoryByAddressClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
