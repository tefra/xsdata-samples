...
class DiagnosticReadMemoryByAddressClass:
    """
    This meta-class contains attributes shared by all instances of the "Read Memory
    by Address" diagnostic service.
    ...
    short_name_fragments: Optional["DiagnosticReadMemoryByAddressClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticReadMemoryByAddressClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticReadMemoryByAddressClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
