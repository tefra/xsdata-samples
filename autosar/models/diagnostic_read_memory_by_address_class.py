...
class DiagnosticReadMemoryByAddressClass:
    ...
    short_name_fragments: (
        DiagnosticReadMemoryByAddressClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticReadMemoryByAddressClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        DiagnosticReadMemoryByAddressClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
