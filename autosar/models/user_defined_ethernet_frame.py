...
class UserDefinedEthernetFrame:
    ...
    short_name_fragments: (
        None | UserDefinedEthernetFrame.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | UserDefinedEthernetFrame.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: (
        None | UserDefinedEthernetFrame.PduToFrameMappings
    ) = field(
        default=None,
        metadata={
