...
class TlsCryptoServiceMapping:
    ...
    for the socket-based configuration of Transport Layer Security (TLS).
    ...
    :ivar key_exchange_refs: This reference identifies the shared(i.e.
        applicable for each of the aggregated cipher suites) crypto
        service primitive for the execution of key exchange during the
        handshake phase.
    :ivar tls_cipher_suites: This aggregation represents the collection
    ...
    annotations: None | TlsCryptoServiceMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    key_exchange_refs: None | TlsCryptoServiceMapping.KeyExchangeRefs = field(
        default=None,
        metadata={
    ...
    tls_cipher_suites: None | TlsCryptoServiceMapping.TlsCipherSuites = field(
        default=None,
        metadata={
