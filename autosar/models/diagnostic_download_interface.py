...
class DiagnosticDownloadInterface:
    ...
    short_name_fragments: DiagnosticDownloadInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticDownloadInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: DiagnosticDownloadInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticDownloadInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
