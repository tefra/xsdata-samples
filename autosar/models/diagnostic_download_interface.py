...
class DiagnosticDownloadInterface:
    ...
    short_name_fragments: (
        None | DiagnosticDownloadInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticDownloadInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | DiagnosticDownloadInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | DiagnosticDownloadInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
