...
class DiagnosticReadScalingDataByIdentifierClass:
    ...
    short_name_fragments: Optional["DiagnosticReadScalingDataByIdentifierClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticReadScalingDataByIdentifierClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticReadScalingDataByIdentifierClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
