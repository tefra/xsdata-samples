...
class DiagnosticReadScalingDataByIdentifierClass:
    ...
    short_name_fragments: (
        None | DiagnosticReadScalingDataByIdentifierClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | DiagnosticReadScalingDataByIdentifierClass.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticReadScalingDataByIdentifierClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
