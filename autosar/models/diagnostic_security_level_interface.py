...
class DiagnosticSecurityLevelInterface:
    ...
    short_name_fragments: Optional[
        "DiagnosticSecurityLevelInterface.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticSecurityLevelInterface.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: Optional[
        "DiagnosticSecurityLevelInterface.BlueprintPolicys"
    ] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticSecurityLevelInterface.Namespaces"] = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
