...
class DiagnosticSecurityLevelInterface:
    ...
    security-level-focused PortInterface for diagnostics on the adaptive
    platform.
    ...
    short_name_fragments: (
        None | DiagnosticSecurityLevelInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticSecurityLevelInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: (
        None | DiagnosticSecurityLevelInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: None | DiagnosticSecurityLevelInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
