...
class DiagnosticSecurityLevelInterface:
    """
    This meta-class represents the ability to implement a security-level-
    ...
    short_name_fragments: Optional["DiagnosticSecurityLevelInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticSecurityLevelInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticSecurityLevelInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticSecurityLevelInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
