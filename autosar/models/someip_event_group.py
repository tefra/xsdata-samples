...
class SomeipEventGroup:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar event_group_id: Unique Identifier that identifies the
        EventGroup in SOME/IP. This Identifier is sent as Eventgroup ID
        in SOME/IP Service Discovery messages.
    :ivar event_refs: Reference to an event that is part of the
        EventGroup.
    ...
    short_name_fragments: Optional["SomeipEventGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SomeipEventGroup.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_group_id: Optional[PositiveInteger] = field(
        default=None,
        metadata={
            "name": "EVENT-GROUP-ID",
            "type": "Element",
    ...
    event_refs: Optional["SomeipEventGroup.EventRefs"] = field(
        default=None,
        metadata={
            "name": "EVENT-REFS",
            "type": "Element",
