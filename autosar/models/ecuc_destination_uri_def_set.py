...
class EcucDestinationUriDefSet:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar destination_uri_defs: This is one particular
    ...
    short_name_fragments: Optional["EcucDestinationUriDefSet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EcucDestinationUriDefSet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["EcucDestinationUriDefSet.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    destination_uri_defs: Optional["EcucDestinationUriDefSet.DestinationUriDefs"] = field(
        default=None,
        metadata={
