...
class SwGenericAxisParamType:
    ...
    short_name_fragments: SwGenericAxisParamType.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SwGenericAxisParamType.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    data_constr_ref: SwGenericAxisParamType.DataConstrRef | None = field(
        default=None,
        metadata={
