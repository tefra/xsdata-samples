...
class SwGenericAxisParamType:
    ...
    * If this parameter contains structures, these can be simulated through the recursive use of SwGenericAxisParamTypes.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar data_constr_ref: This refernce denoted data constraints
        applicable to the generic axis parameter.
    ...
    short_name_fragments: Optional["SwGenericAxisParamType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SwGenericAxisParamType.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    data_constr_ref: Optional["SwGenericAxisParamType.DataConstrRef"] = field(
        default=None,
        metadata={
