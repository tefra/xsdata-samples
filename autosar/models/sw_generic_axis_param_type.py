...
class SwGenericAxisParamType:
    ...
    short_name_fragments: None | SwGenericAxisParamType.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | SwGenericAxisParamType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    data_constr_ref: None | SwGenericAxisParamType.DataConstrRef = field(
        default=None,
        metadata={
