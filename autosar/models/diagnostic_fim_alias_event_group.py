...
class DiagnosticFimAliasEventGroup:
    ...
    until a further refinement is possible.
    ...
    :ivar grouped_alias_event_refs: By means of this reference the
        grouping of DiagnosticAliasEvents within the
    ...
    annotations: None | DiagnosticFimAliasEventGroup.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    grouped_alias_event_refs: (
        None | DiagnosticFimAliasEventGroup.GroupedAliasEventRefs
    ) = field(
        default=None,
        metadata={
