...
class PerInstanceMemory:
    ...
    short_name_fragments: Optional["PerInstanceMemory.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PerInstanceMemory.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    init_value: Optional[String] = field(
        default=None,
        metadata={
            "name": "INIT-VALUE",
            "type": "Element",
