...
class TdEventServiceInstanceDiscoveryTypeEnumSimple(Enum):
    ...
    ADAPTIVE_SERVICE_STOP_SUBSCRIPTION_COMPLETED = (
        "ADAPTIVE-SERVICE-STOP-SUBSCRIPTION-COMPLETED"
    )
    ADAPTIVE_SERVICE_STOP_SUBSCRIPTION_STARTED = (
        "ADAPTIVE-SERVICE-STOP-SUBSCRIPTION-STARTED"
    )
    ADAPTIVE_SERVICE_SUBSCRIPTION_ACKNOWLEDGE_COMPLETED = (
        "ADAPTIVE-SERVICE-SUBSCRIPTION-ACKNOWLEDGE-COMPLETED"
    )
    ADAPTIVE_SERVICE_SUBSCRIPTION_ACKNOWLEDGE_STARTED = (
        "ADAPTIVE-SERVICE-SUBSCRIPTION-ACKNOWLEDGE-STARTED"
    )
    ADAPTIVE_SERVICE_SUBSCRIPTION_COMPLETED = (
        "ADAPTIVE-SERVICE-SUBSCRIPTION-COMPLETED"
    )
    ADAPTIVE_SERVICE_SUBSCRIPTION_STARTED = (
