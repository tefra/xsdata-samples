...
class SecOcJobMapping:
    ...
    short_name_fragments: Optional["SecOcJobMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    sec_oc_job_requirement_ref: Optional["SecOcJobMapping.SecOcJobRequirementRef"] = field(
        default=None,
        metadata={
