...
class DiagnosticOperationCycleNeeds:
    ...
    :ivar operation_cycle: Operation cycles types for the Dem to be
        supported by cycle-state APIs.
    :ivar operation_cycle_automatic_end: If this attribute is set to
        true the Dem shall automatically end the driving cycle at either
        Dem_Shutdown() or Dem_Init().
    :ivar operation_cycle_autostart: If this attribute is set to true
        the operation cycles is automatically (re-)started during
        Dem_PreInit().
    ...
    short_name_fragments: (
        None | DiagnosticOperationCycleNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticOperationCycleNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticOperationCycleNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    operation_cycle: None | OperationCycleTypeEnum = field(
        default=None,
        metadata={
    ...
    operation_cycle_automatic_end: None | Boolean = field(
        default=None,
        metadata={
    ...
    operation_cycle_autostart: None | Boolean = field(
        default=None,
        metadata={
