...
class FieldInExecutableInstanceRef:
    ...
    context_root_sw_component_prototype_ref: Optional["FieldInExecutableInstanceRef.ContextRootSwComponentPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    context_sw_component_prototype_ref: List["FieldInExecutableInstanceRef.ContextSwComponentPrototypeRef"] = field(
    ...
    context_r_port_prototype_ref: Optional["FieldInExecutableInstanceRef.ContextRPortPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    target_field_ref: Optional["FieldInExecutableInstanceRef.TargetFieldRef"] = field(
        default=None,
        metadata={
