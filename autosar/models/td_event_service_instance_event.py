...
class TdEventServiceInstanceEvent:
    """
    This is used to describe timing description events related to events of a
    service.
    ...
    :ivar event_ref: The event provided by the service.
    :ivar td_event_service_instance_event_type: The specific type of
        this timing event.
    ...
    short_name_fragments: Optional["TdEventServiceInstanceEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    service_instance_to_port_prototype_mapping_ref: Optional["TdEventServiceInstanceEvent.ServiceInstanceToPortPrototypeMappingRef"] = field(
        default=None,
        metadata={
    ...
    td_event_service_instance_event_type: Optional[TdEventServiceInstanceEventTypeEnum] = field(
        default=None,
        metadata={
