...
class TdEventServiceInstanceEvent:
    """
    This is used to describe timing description events related to events of
    a service.
    ...
    short_name_fragments: (
        None | TdEventServiceInstanceEvent.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | TdEventServiceInstanceEvent.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_ref: None | TdEventServiceInstanceEvent.EventRef = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
    ...
    td_event_service_instance_event_type: (
        None | TdEventServiceInstanceEventTypeEnum
    ) = field(
        default=None,
        metadata={
