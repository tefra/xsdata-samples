...
class LinUnconditionalFrame:
    ...
    short_name_fragments: Optional["LinUnconditionalFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["LinUnconditionalFrame.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: Optional["LinUnconditionalFrame.PduToFrameMappings"] = field(
        default=None,
        metadata={
