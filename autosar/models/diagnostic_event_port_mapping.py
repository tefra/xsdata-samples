...
class DiagnosticEventPortMapping:
    """
    Defines to which SWC service ports with DiagnosticEventNeeds the
    DiagnosticEvent is mapped.
    ...
    :ivar bsw_service_dependency_ref: Reference to a
        BswServiceDependency that links ServiceNeeds to
        BswModuleEntries.
    :ivar diagnostic_event_ref: Reference to the DiagnosticEvent that is
        assigned to SWC service ports with DiagnosticEventNeeds.
    ...
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticEventPortMapping on the
