...
class ConsistencyNeedsBlueprintSet:
    ...
    :ivar consistency_needss: This represents a particular blueprint of
        consistencyNeeds. Note that it is The upper multiplicity of this
    ...
    annotations: None | ConsistencyNeedsBlueprintSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    consistency_needss: (
        None | ConsistencyNeedsBlueprintSet.ConsistencyNeedss
    ) = field(
        default=None,
        metadata={
