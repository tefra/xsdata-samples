...
class InterfaceMapping:
    ...
    annotations: InterfaceMapping.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_mappings: InterfaceMapping.EventMappings | None = field(
        default=None,
        metadata={
            "name": "EVENT-MAPPINGS",
            "type": "Element",
    ...
    field_mappings: InterfaceMapping.FieldMappings | None = field(
        default=None,
        metadata={
            "name": "FIELD-MAPPINGS",
            "type": "Element",
