...
class BusMirrorChannelMappingIp:
    ...
    short_name_fragments: (
        None | BusMirrorChannelMappingIp.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | BusMirrorChannelMappingIp.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    target_pdu_triggerings: (
        None | BusMirrorChannelMappingIp.TargetPduTriggerings
    ) = field(
        default=None,
        metadata={
