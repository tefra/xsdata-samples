...
class DiagnosticDataChangeTrigger:
    """
    This represents the ability to define a trigger based on the change of a
    given DiagnosticDataIdentifier.
    ...
    data_identifier_ref: Optional["DiagnosticDataChangeTrigger.DataIdentifierRef"] = field(
        default=None,
        metadata={
