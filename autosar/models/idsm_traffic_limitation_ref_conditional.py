...
class IdsmTrafficLimitationRefConditional:
    ...
    :ivar idsm_traffic_limitation_ref:
    ...
    idsm_traffic_limitation_ref: Optional["IdsmTrafficLimitationRefConditional.IdsmTrafficLimitationRef"] = field(
        default=None,
        metadata={
    ...
    class IdsmTrafficLimitationRef(Ref):
        dest: Optional[IdsmTrafficLimitationSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
