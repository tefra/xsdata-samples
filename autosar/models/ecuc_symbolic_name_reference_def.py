...
class EcucSymbolicNameReferenceDef:
    """
    This meta-class specifies that the implementation of the reference is done
    using a symbolic name defined by the referenced Container's shortName.
    ...
    short_name_fragments: Optional["EcucSymbolicNameReferenceDef.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EcucSymbolicNameReferenceDef.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: Optional["EcucSymbolicNameReferenceDef.RelatedTraceItemRef"] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional["EcucSymbolicNameReferenceDef.EcucValidationConds"] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional["EcucSymbolicNameReferenceDef.ImplementationConfigClasses"] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional["EcucSymbolicNameReferenceDef.MultiplicityConfigClasses"] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional["EcucSymbolicNameReferenceDef.ValueConfigClasses"] = field(
        default=None,
        metadata={
    ...
    destination_ref: Optional["EcucSymbolicNameReferenceDef.DestinationRef"] = field(
        default=None,
        metadata={
    ...
    class DestinationRef(Ref):
        dest: Optional[EcucParamConfContainerDefSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
