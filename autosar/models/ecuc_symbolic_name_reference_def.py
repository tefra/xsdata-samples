...
class EcucSymbolicNameReferenceDef:
    """
    This meta-class specifies that the implementation of the reference is
    done using a symbolic name defined by the referenced Container's
    shortName.
    ...
    short_name_fragments: (
        None | EcucSymbolicNameReferenceDef.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | EcucSymbolicNameReferenceDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: (
        None | EcucSymbolicNameReferenceDef.RelatedTraceItemRef
    ) = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: (
        None | EcucSymbolicNameReferenceDef.EcucValidationConds
    ) = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: (
        None | EcucSymbolicNameReferenceDef.ImplementationConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        None | EcucSymbolicNameReferenceDef.MultiplicityConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: (
        None | EcucSymbolicNameReferenceDef.ValueConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    destination_ref: None | EcucSymbolicNameReferenceDef.DestinationRef = (
        field(
            default=None,
            metadata={
    ...
    class DestinationRef(Ref):
        dest: None | EcucParamConfContainerDefSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
