...
class CpSoftwareClusterResourcePool:
    ...
    :ivar ecu_scope_refs: This reference identifies the EcuInstance in
        which the resource pool is defined.
    :ivar resources: This aggregation represents the collection of
        resources in the enclosing resource pool.
    ...
    annotations: None | CpSoftwareClusterResourcePool.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_scope_refs: None | CpSoftwareClusterResourcePool.EcuScopeRefs = field(
        default=None,
        metadata={
            "name": "ECU-SCOPE-REFS",
            "type": "Element",
    ...
    resources: None | CpSoftwareClusterResourcePool.Resources = field(
        default=None,
        metadata={
            "name": "RESOURCES",
            "type": "Element",
