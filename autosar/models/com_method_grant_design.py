...
class ComMethodGrantDesign:
    ...
    :ivar remote_subject_ref: This optional reference defines the
        ...
        the Grant.
    :ivar method_iref: This reference identifies the corresponding
        method.
    ...
    annotations: None | ComMethodGrantDesign.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    process_design_ref: None | ComMethodGrantDesign.ProcessDesignRef = field(
        default=None,
        metadata={
    ...
    remote_subject_ref: None | ComMethodGrantDesign.RemoteSubjectRef = field(
        default=None,
        metadata={
    ...
    method_iref: None | RequiredMethodInExecutableInstanceRef = field(
        default=None,
        metadata={
            "name": "METHOD-IREF",
            "type": "Element",
