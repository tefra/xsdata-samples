...
class DiagnosticRequestControlOfOnBoardDeviceClass:
    ...
    short_name_fragments: Optional["DiagnosticRequestControlOfOnBoardDeviceClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestControlOfOnBoardDeviceClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestControlOfOnBoardDeviceClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
