...
class DiagnosticRequestControlOfOnBoardDeviceClass:
    ...
    short_name_fragments: (
        DiagnosticRequestControlOfOnBoardDeviceClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        DiagnosticRequestControlOfOnBoardDeviceClass.Annotations | None
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        DiagnosticRequestControlOfOnBoardDeviceClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
