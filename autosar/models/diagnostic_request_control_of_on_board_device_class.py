...
class DiagnosticRequestControlOfOnBoardDeviceClass:
    ...
    short_name_fragments: (
        None | DiagnosticRequestControlOfOnBoardDeviceClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | DiagnosticRequestControlOfOnBoardDeviceClass.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticRequestControlOfOnBoardDeviceClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
