...
class ClientServerInterface:
    ...
    :ivar operations: ClientServerOperation(s) of this
        ClientServerInterface. The upper multiplicity of this role has
        been increased to * due to resolving an atpVariation stereotype.
        The previous value was -1.
    :ivar possible_errors: Application errors that are defined as part
        of this interface.
    ...
    short_name_fragments: Optional["ClientServerInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ClientServerInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["ClientServerInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["ClientServerInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    operations: Optional["ClientServerInterface.Operations"] = field(
        default=None,
        metadata={
            "name": "OPERATIONS",
            "type": "Element",
    ...
    possible_errors: Optional["ClientServerInterface.PossibleErrors"] = field(
        default=None,
        metadata={
