...
class DataWriteCompletedEvent:
    ...
    :ivar event_source_ref: The variable access that triggers the event.
    ...
    short_name_fragments: Optional["DataWriteCompletedEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DataWriteCompletedEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["DataWriteCompletedEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["DataWriteCompletedEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["DataWriteCompletedEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
    ...
    event_source_ref: Optional["DataWriteCompletedEvent.EventSourceRef"] = field(
        default=None,
        metadata={
