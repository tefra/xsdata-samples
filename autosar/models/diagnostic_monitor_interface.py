...
class DiagnosticMonitorInterface:
    """
    This meta-class represents the ability to implement a monitor-focused
    ...
    short_name_fragments: Optional["DiagnosticMonitorInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticMonitorInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticMonitorInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticMonitorInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
