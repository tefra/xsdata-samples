...
class NmConfig:
    ...
    annotations: None | NmConfig.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    nm_clusters: None | NmConfig.NmClusters = field(
        default=None,
        metadata={
            "name": "NM-CLUSTERS",
            "type": "Element",
    ...
    nm_cluster_couplings: None | NmConfig.NmClusterCouplings = field(
        default=None,
        metadata={
    ...
    nm_if_ecus: None | NmConfig.NmIfEcus = field(
        default=None,
        metadata={
            "name": "NM-IF-ECUS",
            "type": "Element",
