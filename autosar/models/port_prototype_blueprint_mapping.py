...
class PortPrototypeBlueprintMapping:
    ...
    port_prototype_blueprint_ref: Optional["PortPrototypeBlueprintMapping.PortPrototypeBlueprintRef"] = field(
        default=None,
        metadata={
    ...
    derived_port_prototype_ref: Optional["PortPrototypeBlueprintMapping.DerivedPortPrototypeRef"] = field(
        default=None,
        metadata={
