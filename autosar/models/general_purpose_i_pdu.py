...
class GeneralPurposeIPdu:
    """This element is used for AUTOSAR Pdus without attributes that are routed
    by the PduR.
    ...
    short_name_fragments: Optional["GeneralPurposeIPdu.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["GeneralPurposeIPdu.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
