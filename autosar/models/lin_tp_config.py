...
class LinTpConfig:
    ...
    annotations: None | LinTpConfig.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: None | LinTpConfig.CommunicationClusterRef = (
        field(
            default=None,
            metadata={
    ...
    tp_addresss: None | LinTpConfig.TpAddresss = field(
        default=None,
        metadata={
            "name": "TP-ADDRESSS",
            "type": "Element",
    ...
    tp_connections: None | LinTpConfig.TpConnections = field(
        default=None,
        metadata={
            "name": "TP-CONNECTIONS",
            "type": "Element",
    ...
    tp_nodes: None | LinTpConfig.TpNodes = field(
        default=None,
        metadata={
            "name": "TP-NODES",
            "type": "Element",
