...
class AliasNameSet:
    ...
    short_name_fragments: AliasNameSet.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: AliasNameSet.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: AliasNameSet.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    alias_names: AliasNameSet.AliasNames | None = field(
        default=None,
        metadata={
            "name": "ALIAS-NAMES",
            "type": "Element",
