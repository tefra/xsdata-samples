...
class AliasNameSet:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar alias_names: AliasNames contained in the AliasNameSet. The
    ...
    short_name_fragments: Optional["AliasNameSet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["AliasNameSet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["AliasNameSet.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    alias_names: Optional["AliasNameSet.AliasNames"] = field(
        default=None,
        metadata={
            "name": "ALIAS-NAMES",
            "type": "Element",
    ...
    @dataclass
    class AliasNames:
        alias_name_assignment: list[AliasNameAssignment] = field(
            default_factory=list,
            metadata={
