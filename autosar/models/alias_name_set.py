...
class AliasNameSet:
    ...
    short_name_fragments: None | AliasNameSet.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | AliasNameSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | AliasNameSet.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    alias_names: None | AliasNameSet.AliasNames = field(
        default=None,
        metadata={
            "name": "ALIAS-NAMES",
            "type": "Element",
