...
class ObdControlServiceNeeds:
    ...
    short_name_fragments: ObdControlServiceNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: ObdControlServiceNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: ObdControlServiceNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
