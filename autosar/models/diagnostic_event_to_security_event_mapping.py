...
class DiagnosticEventToSecurityEventMapping:
    ...
    :ivar diagnostic_event_ref: This reference identifies the applicable
        diagnostic event.
    :ivar security_event_props_ref: This reference identifies the
        qualification of the applicable security event
    ...
    short_name_fragments: DiagnosticEventToSecurityEventMapping.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticEventToSecurityEventMapping.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_event_ref: DiagnosticEventToSecurityEventMapping.DiagnosticEventRef | None = field(
        default=None,
        metadata={
    ...
    security_event_props_ref: DiagnosticEventToSecurityEventMapping.SecurityEventPropsRef | None = field(
        default=None,
        metadata={
    ...
    @dataclass
    class SecurityEventPropsRef(Ref):
