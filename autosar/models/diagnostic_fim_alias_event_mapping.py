...
class DiagnosticFimAliasEventMapping:
    ...
    annotations: None | DiagnosticFimAliasEventMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    actual_event_ref: None | DiagnosticFimAliasEventMapping.ActualEventRef = (
        field(
            default=None,
            metadata={
    ...
    alias_event_ref: None | DiagnosticFimAliasEventMapping.AliasEventRef = (
        field(
            default=None,
            metadata={
