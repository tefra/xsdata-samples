...
class PersistencyPortPrototypeToFileStorageMapping:
    ...
    :ivar file_storage_ref: This reference represents the mapped file
        storage.
    ...
    short_name_fragments: Optional["PersistencyPortPrototypeToFileStorageMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PersistencyPortPrototypeToFileStorageMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    process_ref: Optional["PersistencyPortPrototypeToFileStorageMapping.ProcessRef"] = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
    ...
    file_storage_ref: Optional["PersistencyPortPrototypeToFileStorageMapping.FileStorageRef"] = field(
        default=None,
        metadata={
