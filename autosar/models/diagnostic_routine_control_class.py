...
class DiagnosticRoutineControlClass:
    ...
    short_name_fragments: Optional["DiagnosticRoutineControlClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRoutineControlClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRoutineControlClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
