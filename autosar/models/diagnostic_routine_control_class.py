...
class DiagnosticRoutineControlClass:
    ...
    short_name_fragments: (
        None | DiagnosticRoutineControlClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticRoutineControlClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRoutineControlClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
