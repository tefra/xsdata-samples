...
class DiagnosticRoutineControlClass:
    ...
    "Routine Control" diagnostic service.
    ...
    short_name_fragments: DiagnosticRoutineControlClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRoutineControlClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticRoutineControlClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
