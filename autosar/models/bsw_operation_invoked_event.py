...
class BswOperationInvokedEvent:
    ...
    short_name_fragments: Optional[
        "BswOperationInvokedEvent.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    activation_reason_representation_ref: Optional[
        "BswOperationInvokedEvent.ActivationReasonRepresentationRef"
    ] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional[
        "BswOperationInvokedEvent.ContextLimitationRefs"
    ] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional[
        "BswOperationInvokedEvent.DisabledInModeIrefs"
    ] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional[
        "BswOperationInvokedEvent.StartsOnEventRef"
    ] = field(
        default=None,
        metadata={
    ...
    class ContextLimitationRefs:
        context_limitation_ref: list[
            "BswOperationInvokedEvent.ContextLimitationRefs.ContextLimitationRef"
        ] = field(
            default_factory=list,
            metadata={
