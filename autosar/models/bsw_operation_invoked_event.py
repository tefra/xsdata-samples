...
class BswOperationInvokedEvent:
    ...
    Communication via the BSW Scheduler. Its "entry" reference provides the
    BswClientServerEntry that is called subsequently.
    ...
    :ivar entry_ref: The providedClientServerEntry invoked by this
        event.
    ...
    short_name_fragments: Optional["BswOperationInvokedEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswOperationInvokedEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["BswOperationInvokedEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswOperationInvokedEvent.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional["BswOperationInvokedEvent.DisabledInModeIrefs"] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional["BswOperationInvokedEvent.StartsOnEventRef"] = field(
        default=None,
        metadata={
    ...
    entry_ref: Optional["BswOperationInvokedEvent.EntryRef"] = field(
        default=None,
        metadata={
            "name": "ENTRY-REF",
            "type": "Element",
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswOperationInvokedEvent.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
