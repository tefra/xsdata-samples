...
class PlatformModuleEthernetEndpointConfiguration:
    ...
    :ivar communication_connector_ref: Reference to the
        CommunicationConnector (VLAN) for which the network
    ...
    :ivar ipv_6_multicast_ip_address: Multicast IPv6 Address to which
        the message will be transmitted.
    :ivar tcp_port: This attribute allows to configure a tcp port
        number.
    :ivar udp_port: This attribute allows to configure a udp port
        number.
