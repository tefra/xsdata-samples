...
class PortInterfaceMappingSet:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar port_interface_mappings: Specifies one PortInterfaceMapping to
        support the connection of Ports typed by two different
        PortInterfaces with PortInterface elements having unequal names
        and/or unequal semantic (resolution or range). The upper
    ...
    blueprint_policys: Optional["PortInterfaceMappingSet.BlueprintPolicys"] = (
        field(
            default=None,
            metadata={
