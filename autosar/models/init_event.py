...
class InitEvent:
    ...
    short_name_fragments: InitEvent.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: InitEvent.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: InitEvent.ActivationReasonRepresentationRef | None = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: InitEvent.DisabledModeIrefs | None = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: InitEvent.StartOnEventRef | None = field(
        default=None,
        metadata={
