...
class InitEvent:
    ...
    executed for the first time. The execution order depends on the task
    mapping.
    ...
    short_name_fragments: Optional["InitEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["InitEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["InitEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["InitEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["InitEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
