...
class PPortInCompositionInstanceRef:
    ...
    context_component_ref: Optional["PPortInCompositionInstanceRef.ContextComponentRef"] = field(
        default=None,
        metadata={
    ...
    target_p_port_ref: Optional["PPortInCompositionInstanceRef.TargetPPortRef"] = field(
        default=None,
        metadata={
