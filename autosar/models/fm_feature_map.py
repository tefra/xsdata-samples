...
class FmFeatureMap:
    ...
    short_name_fragments: FmFeatureMap.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: FmFeatureMap.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mappings: FmFeatureMap.Mappings | None = field(
        default=None,
        metadata={
            "name": "MAPPINGS",
            "type": "Element",
