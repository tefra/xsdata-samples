...
class FmFeatureMap:
    ...
    :ivar mappings: Set of mappings defined by this FMFeatureMap.
    ...
    short_name_fragments: Optional["FmFeatureMap.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["FmFeatureMap.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mappings: Optional["FmFeatureMap.Mappings"] = field(
        default=None,
        metadata={
            "name": "MAPPINGS",
            "type": "Element",
