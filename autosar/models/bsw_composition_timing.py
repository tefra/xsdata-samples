...
class BswCompositionTiming:
    ...
    set of BswImplementations representing a BSW composition. A constraint
    defined at this level holds true for all referenced BswImplementations.
    Note, that multiple implementations of the same basic software module could
    be involved.

    TimingDescriptions aggregated by BswCompositionTiming are restricted
    to event chains referring to events which are derived from the class
    TDEventBswInternalBehavior and TDEventBsw.
    ...
    short_name_fragments: Optional["BswCompositionTiming.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    timing_conditions: Optional["BswCompositionTiming.TimingConditions"] = field(
        default=None,
        metadata={
    ...
    timing_descriptions: Optional["BswCompositionTiming.TimingDescriptions"] = field(
        default=None,
        metadata={
    ...
    timing_guarantees: Optional["BswCompositionTiming.TimingGuarantees"] = field(
        default=None,
        metadata={
    ...
    timing_requirements: Optional["BswCompositionTiming.TimingRequirements"] = field(
        default=None,
        metadata={
    ...
    implementation_refs: Optional["BswCompositionTiming.ImplementationRefs"] = field(
        default=None,
        metadata={
    ...
    class ImplementationRefs:
        implementation_ref: List["BswCompositionTiming.ImplementationRefs.ImplementationRef"] = field(
            default_factory=list,
            metadata={
