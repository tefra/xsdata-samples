...
class ApplicationDataPrototypeInSystemInstanceRef:
    ...
    context_composition_ref: Optional["ApplicationDataPrototypeInSystemInstanceRef.ContextCompositionRef"] = field(
        default=None,
        metadata={
    ...
    context_component_ref: List["ApplicationDataPrototypeInSystemInstanceRef.ContextComponentRef"] = field(
    ...
    context_port_ref: Optional["ApplicationDataPrototypeInSystemInstanceRef.ContextPortRef"] = field(
        default=None,
        metadata={
    ...
    root_data_prototype_ref: Optional["ApplicationDataPrototypeInSystemInstanceRef.RootDataPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    context_data_prototype_ref: List["ApplicationDataPrototypeInSystemInstanceRef.ContextDataPrototypeRef"] = field(
        default_factory=list,
        metadata={
    ...
    target_data_prototype_ref: Optional["ApplicationDataPrototypeInSystemInstanceRef.TargetDataPrototypeRef"] = field(
        default=None,
        metadata={
