...
class AsynchronousServerCallReturnsEvent:
    ...
    :ivar event_source_ref: The referenced
        AsynchronousServerCallResultPoint which is raises the RTEEvent
        in case of returning asynchronous server call.
    ...
    short_name_fragments: (
        None | AsynchronousServerCallReturnsEvent.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | AsynchronousServerCallReturnsEvent.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    disabled_mode_irefs: (
        None | AsynchronousServerCallReturnsEvent.DisabledModeIrefs
    ) = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: (
        None | AsynchronousServerCallReturnsEvent.StartOnEventRef
    ) = field(
        default=None,
        metadata={
    ...
    event_source_ref: (
        None | AsynchronousServerCallReturnsEvent.EventSourceRef
    ) = field(
        default=None,
        metadata={
    ...
    class EventSourceRef(Ref):
        dest: None | AsynchronousServerCallResultPointSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
