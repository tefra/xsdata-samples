...
class UdpNmCluster:
    ...
    :ivar network_configuration: Configuration of a UDP port and UDP
        multicast IP address of the Nm communication on a VLAN.
    :ivar nm_cbv_position: Defines the position of the control bit
        vector within the Nm Pdu (Byte position). If this attribute is
        not configured, the Control Bit Vector is not used.
    :ivar nm_channel_active: This switch determines if the respective
        UdpNm channel is active or not. Indicates whether a particular
        UdpNm channel shall be initialized (TRUE) or not (FALSE). If
        this parameter is set to FALSE the respective NM instance shall
        not be used during runtime.
    :ivar nm_immediate_nm_cycle_time: Defines the immediate NmPdu cycle
        ...
        NmPdu transmissions. This attribute is only valid if
        nmImmediateNmTransmissions is greater one.
    :ivar nm_immediate_nm_transmissions: Defines the number of immediate
        ...
        immediate NmPdus are transmitted. The cycle time of immediate
    ...
    :ivar nm_network_timeout: Network Timeout for NmPdus in seconds. It
        denotes the time how long the UdpNm shall stay in the Network
    ...
    :ivar nm_user_data_length: Defines the length in bytes of the user
        data contained in the Nm message. User data excludes the PN
        information.
    :ivar nm_user_data_offset: Specifies the offset (in bytes) of the
        user data information in the NM message. User data excludes the
        PN information.
    :ivar nm_wait_bus_sleep_time: Timeout for bus calm down phase in
        ...
        shall take place.
    :ivar vlan_ref: Reference to the vlan (represented by the
        EthernetPhysicalChannel) this UdpNmCluster shall apply to.
    ...
    short_name_fragments: Optional["UdpNmCluster.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["UdpNmCluster.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: Optional["UdpNmCluster.CommunicationClusterRef"] = field(
        default=None,
        metadata={
    ...
    nm_nodes: Optional["UdpNmCluster.NmNodes"] = field(
        default=None,
        metadata={
            "name": "NM-NODES",
            "type": "Element",
    ...
    network_configuration: Optional[UdpNmNetworkConfiguration] = field(
        default=None,
        metadata={
    ...
    nm_user_data_offset: Optional[PositiveInteger] = field(
        default=None,
        metadata={
            "name": "NM-USER-DATA-OFFSET",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
    ...
    vlan_ref: Optional["UdpNmCluster.VlanRef"] = field(
        default=None,
        metadata={
            "name": "VLAN-REF",
            "type": "Element",
