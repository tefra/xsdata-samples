...
class PhmSupervisionRecoveryNotificationInterface:
    ...
    short_name_fragments: (
        None | PhmSupervisionRecoveryNotificationInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | PhmSupervisionRecoveryNotificationInterface.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    blueprint_policys: (
        None | PhmSupervisionRecoveryNotificationInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: (
        None | PhmSupervisionRecoveryNotificationInterface.Namespaces
    ) = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
