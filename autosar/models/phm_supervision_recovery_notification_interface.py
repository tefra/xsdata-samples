...
class PhmSupervisionRecoveryNotificationInterface:
    ...
    short_name_fragments: Optional["PhmSupervisionRecoveryNotificationInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PhmSupervisionRecoveryNotificationInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["PhmSupervisionRecoveryNotificationInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["PhmSupervisionRecoveryNotificationInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
