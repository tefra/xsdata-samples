...
class DiagnosticAccessPermission:
    ...
    :ivar diagnostic_session_refs: This represents the associated
        DiagnosticSessions
    :ivar environmental_condition_ref: This represents the environmental
        conditions associated with the access permission.
    :ivar security_level_refs: This represents the associated
        DiagnosticSecurityLevels
    ...
    annotations: None | DiagnosticAccessPermission.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_session_refs: (
        None | DiagnosticAccessPermission.DiagnosticSessionRefs
    ) = field(
        default=None,
        metadata={
    ...
    environmental_condition_ref: (
        None | DiagnosticAccessPermission.EnvironmentalConditionRef
    ) = field(
        default=None,
        metadata={
    ...
    security_level_refs: (
        None | DiagnosticAccessPermission.SecurityLevelRefs
    ) = field(
        default=None,
        metadata={
