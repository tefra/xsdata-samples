...
class DiagnosticRequestPowertrainFreezeFrameData:
    ...
    annotations: (
        None | DiagnosticRequestPowertrainFreezeFrameData.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticRequestPowertrainFreezeFrameData.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    freeze_frame_ref: (
        None | DiagnosticRequestPowertrainFreezeFrameData.FreezeFrameRef
    ) = field(
        default=None,
        metadata={
