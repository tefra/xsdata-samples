...
class DiagnosticDebounceBehaviorEnumValueVariationPoint:
    ...
    sysc_string_ref: List["DiagnosticDebounceBehaviorEnumValueVariationPoint.SyscStringRef"] = field(
        default_factory=list,
        metadata={
    ...
    sysc_ref: List["DiagnosticDebounceBehaviorEnumValueVariationPoint.SyscRef"] = field(
        default_factory=list,
        metadata={
            "name": "SYSC-REF",
            "type": "Element",
