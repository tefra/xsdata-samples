...
class EcucReferenceDef:
    ...
    short_name_fragments: Optional["EcucReferenceDef.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    related_trace_item_ref: Optional["EcucReferenceDef.RelatedTraceItemRef"] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional["EcucReferenceDef.EcucValidationConds"] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional["EcucReferenceDef.ImplementationConfigClasses"] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional["EcucReferenceDef.MultiplicityConfigClasses"] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional["EcucReferenceDef.ValueConfigClasses"] = field(
        default=None,
        metadata={
