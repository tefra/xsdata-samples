...
class DiagnosticRequestFileTransferNeeds:
    """
    This meta-class indicates the existence of a service use case that involves UDS
    ...
    short_name_fragments: Optional["DiagnosticRequestFileTransferNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestFileTransferNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticRequestFileTransferNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
