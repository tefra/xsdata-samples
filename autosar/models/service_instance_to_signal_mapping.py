...
class ServiceInstanceToSignalMapping:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar event_element_mappings: Mapping of an event or an element
        inside of the event to an ISignalTriggering.
    :ivar field_mappings: Mapping of a field to ISignalTriggerings.
    :ivar method_mapping: Mapping of a method to ISignalTriggerings.
    :ivar service_instance_ref: Reference to a ServiceInstance from
        which the corresponding ServiceInterface elements will be
        transported in the signal-based way over a communication medium.
    ...
    annotations: None | ServiceInstanceToSignalMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_element_mappings: (
        None | ServiceInstanceToSignalMapping.EventElementMappings
    ) = field(
        default=None,
        metadata={
    ...
    field_mappings: None | ServiceInstanceToSignalMapping.FieldMappings = (
        field(
            default=None,
            metadata={
                "name": "FIELD-MAPPINGS",
    ...
    method_mapping: None | SignalBasedMethodToISignalTriggeringMapping = field(
        default=None,
        metadata={
            "name": "METHOD-MAPPING",
            "type": "Element",
    ...
    service_instance_ref: (
        None | ServiceInstanceToSignalMapping.ServiceInstanceRef
    ) = field(
        default=None,
        metadata={
