...
class DiagnosticIumprGroup:
    ...
    :ivar group_identifier: This attribute shall be taken to define an
    ...
    :ivar iumpr_group_identifiers: This aggregation allows for the
        variant modeling of the groupIdentifier. The upper multiplicity
        of this role has been increased to * due to resolving an
        atpVariation stereotype. The previous value was 1.
    :ivar iumpr_refs: This reference collects DiagnosticIumpr to a
    ...
    short_name_fragments: DiagnosticIumprGroup.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    iumpr_group_identifiers: DiagnosticIumprGroup.IumprGroupIdentifiers | None = field(
        default=None,
        metadata={
