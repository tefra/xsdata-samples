...
class SomeipTpConfig:
    ...
    :ivar tp_channels: Definition of SomeipTpChannels that are
        collecting configuration properties that are valid for a
        collection of SomeipTpConnections.
    :ivar tp_connections: Senders and receivers of SOME/IP TP messages.
    ...
    annotations: None | SomeipTpConfig.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: (
        None | SomeipTpConfig.CommunicationClusterRef
    ) = field(
        default=None,
        metadata={
    ...
    tp_channels: None | SomeipTpConfig.TpChannels = field(
        default=None,
        metadata={
            "name": "TP-CHANNELS",
            "type": "Element",
    ...
    tp_connections: None | SomeipTpConfig.TpConnections = field(
        default=None,
        metadata={
            "name": "TP-CONNECTIONS",
            "type": "Element",
