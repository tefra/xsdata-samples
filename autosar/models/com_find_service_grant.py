...
class ComFindServiceGrant:
    ...
    :ivar design_ref: This reference identifies the
        ComFindServiceGrantDesign that the enclosing ComFindServiceGrant
        was created from.
    ...
    short_name_fragments: ComFindServiceGrant.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    service_instance_ref: ComFindServiceGrant.ServiceInstanceRef | None = field(
        default=None,
        metadata={
