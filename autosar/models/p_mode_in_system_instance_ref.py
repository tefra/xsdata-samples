...
class PModeInSystemInstanceRef:
    ...
    context_composition_ref: Optional["PModeInSystemInstanceRef.ContextCompositionRef"] = field(
        default=None,
        metadata={
    ...
    context_component_ref: List["PModeInSystemInstanceRef.ContextComponentRef"] = field(
    ...
    context_p_port_ref: Optional["PModeInSystemInstanceRef.ContextPPortRef"] = field(
        default=None,
        metadata={
    ...
    context_mode_declaration_group_ref: Optional["PModeInSystemInstanceRef.ContextModeDeclarationGroupRef"] = field(
        default=None,
        metadata={
    ...
    target_mode_ref: Optional["PModeInSystemInstanceRef.TargetModeRef"] = field(
        default=None,
        metadata={
