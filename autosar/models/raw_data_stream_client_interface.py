...
class RawDataStreamClientInterface:
    ...
    short_name_fragments: (
        None | RawDataStreamClientInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | RawDataStreamClientInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | RawDataStreamClientInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | RawDataStreamClientInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
