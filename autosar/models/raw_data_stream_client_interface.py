...
class RawDataStreamClientInterface:
    ...
    short_name_fragments: Optional[
        "RawDataStreamClientInterface.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RawDataStreamClientInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional[
        "RawDataStreamClientInterface.BlueprintPolicys"
    ] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["RawDataStreamClientInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
