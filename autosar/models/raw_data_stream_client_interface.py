...
class RawDataStreamClientInterface:
    ...
    * read: access incoming data on the communication channel
    ...
    short_name_fragments: Optional["RawDataStreamClientInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    blueprint_policys: Optional["RawDataStreamClientInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
