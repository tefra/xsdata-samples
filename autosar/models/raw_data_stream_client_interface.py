...
class RawDataStreamClientInterface:
    ...
    Each RawDataStreamClientInterface supports the following capabilities
    without further modeling: * connect: set up the communication channel *
    shutdown: close the communication channel * write: send data down the
    communication channel * read: access incoming data on the communication
    channel.
    ...
    short_name_fragments: RawDataStreamClientInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: RawDataStreamClientInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: RawDataStreamClientInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: RawDataStreamClientInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
