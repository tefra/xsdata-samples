...
class ApplicationError:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar error_code: The RTE generator is forced to assign this value
        to the corresponding error symbol. Note that for error codes
    ...
    short_name_fragments: Optional["ApplicationError.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ApplicationError.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
