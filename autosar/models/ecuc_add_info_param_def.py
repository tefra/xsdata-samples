...
class EcucAddInfoParamDef:
    ...
    short_name_fragments: None | EcucAddInfoParamDef.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | EcucAddInfoParamDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: None | EcucAddInfoParamDef.RelatedTraceItemRef = (
        field(
            default=None,
            metadata={
    ...
    ecuc_validation_conds: None | EcucAddInfoParamDef.EcucValidationConds = (
        field(
            default=None,
            metadata={
    ...
    implementation_config_classes: (
        None | EcucAddInfoParamDef.ImplementationConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        None | EcucAddInfoParamDef.MultiplicityConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: None | EcucAddInfoParamDef.ValueConfigClasses = (
        field(
            default=None,
            metadata={
