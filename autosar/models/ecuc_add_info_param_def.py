...
class EcucAddInfoParamDef:
    ...
    short_name_fragments: EcucAddInfoParamDef.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    related_trace_item_ref: EcucAddInfoParamDef.RelatedTraceItemRef | None = (
        field(
            default=None,
            metadata={
    ...
    ecuc_validation_conds: EcucAddInfoParamDef.EcucValidationConds | None = (
        field(
            default=None,
            metadata={
    ...
    implementation_config_classes: (
        EcucAddInfoParamDef.ImplementationConfigClasses | None
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        EcucAddInfoParamDef.MultiplicityConfigClasses | None
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: EcucAddInfoParamDef.ValueConfigClasses | None = (
        field(
            default=None,
            metadata={
