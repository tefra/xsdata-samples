...
class HealthChannelSupervision:
    ...
    :ivar supervision_ref: Reference to the GlobalSupervision as source
        for the health channel.
    ...
    short_name_fragments: Optional["HealthChannelSupervision.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    supervision_ref: Optional["HealthChannelSupervision.SupervisionRef"] = field(
        default=None,
        metadata={
