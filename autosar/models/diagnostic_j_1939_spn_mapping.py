...
class DiagnosticJ1939SpnMapping:
    ...
    :ivar sending_node_refs: This additional reference has a supporting
        role in that it identifies all sending nodes of a given SPN. It
        is positively possible thata given SPN is sent by more than one
        node. Even tough the reference targets the DiagnosticJ1939Node
        the semantics of the reference is bound to the J1939NmNode that
        is in turn referenced by the DiagnosticJ1939Node.
    :ivar spn_ref: This reference goes to the SPN that shall be
        associated with a SystemSignal.
    :ivar system_signal_ref: This reference goes to the SystemSignal
        that shall be associated with an SPN.
    ...
    annotations: None | DiagnosticJ1939SpnMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    sending_node_refs: None | DiagnosticJ1939SpnMapping.SendingNodeRefs = (
        field(
            default=None,
            metadata={
    ...
    spn_ref: None | DiagnosticJ1939SpnMapping.SpnRef = field(
        default=None,
        metadata={
            "name": "SPN-REF",
            "type": "Element",
    ...
    system_signal_ref: None | DiagnosticJ1939SpnMapping.SystemSignalRef = (
        field(
            default=None,
            metadata={
