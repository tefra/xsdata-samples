...
class PersistencyFileStorage:
    ...
    annotations: None | PersistencyFileStorage.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    redundancy_handlings: None | PersistencyFileStorage.RedundancyHandlings = (
        field(
            default=None,
            metadata={
    ...
    files: None | PersistencyFileStorage.Files = field(
        default=None,
        metadata={
            "name": "FILES",
            "type": "Element",
