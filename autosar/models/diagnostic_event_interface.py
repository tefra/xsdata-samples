...
class DiagnosticEventInterface:
    ...
    short_name_fragments: (
        None | DiagnosticEventInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticEventInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | DiagnosticEventInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | DiagnosticEventInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
