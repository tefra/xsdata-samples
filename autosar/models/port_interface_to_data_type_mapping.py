...
class PortInterfaceToDataTypeMapping:
    """This meta-class represents the ability to associate a PortInterface with
    a DataTypeMappingSet. This association is needed for the generation of
    header files in the scope of a single PortInterface.

    The association is intentionally made outside the scope of the
    PortInterface itself because the designers of a PortInterface most
    likely will not want to add details about the level of
    ...
    :ivar data_type_mapping_set_refs: This represents the reference to
        the applicable dataTypemappingSet
    :ivar port_interface_ref: This represents the reference to the
        applicable PortInterface
