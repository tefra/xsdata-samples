...
class FullBindingTimeEnumSimple(Enum):
    """
    ...
    :cvar POST_BUILD: PostBuild is the binding time which is bound
        latest at startup of the ECU. In other words this is everything
        between creation of the executable program and startup of the
        ECU.
