...
class ServiceInterfaceMapping:
    ...
    ServiceInterface is composite of several other ServiceInterfaces.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar composite_service_interface_ref: This represents the composite
        ServiceInterface.
    :ivar source_service_interface_refs: ServiceInterface that is mapped
        into the composite ServiceInterface.
    ...
    annotations: None | ServiceInterfaceMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    composite_service_interface_ref: (
        None | ServiceInterfaceMapping.CompositeServiceInterfaceRef
    ) = field(
        default=None,
        metadata={
    ...
    source_service_interface_refs: (
        None | ServiceInterfaceMapping.SourceServiceInterfaceRefs
    ) = field(
        default=None,
        metadata={
