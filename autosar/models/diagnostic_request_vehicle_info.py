...
class DiagnosticRequestVehicleInfo:
    ...
    :ivar info_type_ref: This represents the info type associated with
        the mode 0x09 service.
    :ivar request_vehicle_information_class_ref: This reference
    ...
    annotations: None | DiagnosticRequestVehicleInfo.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRequestVehicleInfo.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    info_type_ref: None | DiagnosticRequestVehicleInfo.InfoTypeRef = field(
        default=None,
        metadata={
            "name": "INFO-TYPE-REF",
            "type": "Element",
    ...
    request_vehicle_information_class_ref: (
        None | DiagnosticRequestVehicleInfo.RequestVehicleInformationClassRef
    ) = field(
        default=None,
        metadata={
