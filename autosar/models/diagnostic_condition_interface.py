...
class DiagnosticConditionInterface:
    ...
    short_name_fragments: DiagnosticConditionInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticConditionInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: DiagnosticConditionInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticConditionInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
