...
class DiagnosticEventToTroubleCodeJ1939Mapping:
    ...
    :ivar diagnostic_event_ref: Reference to a DiagnosticEvent to which
        a J1939 Diagnostic Trouble Code is assigned.
    :ivar trouble_code_j_1939_ref: Reference to a J1939 Diagnostic
        Trouble Code to which a DiagnosticEvent is assigned.
    ...
    annotations: (
        None | DiagnosticEventToTroubleCodeJ1939Mapping.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    diagnostic_event_ref: (
        None | DiagnosticEventToTroubleCodeJ1939Mapping.DiagnosticEventRef
    ) = field(
        default=None,
        metadata={
    ...
    trouble_code_j_1939_ref: (
        None | DiagnosticEventToTroubleCodeJ1939Mapping.TroubleCodeJ1939Ref
    ) = field(
        default=None,
        metadata={
