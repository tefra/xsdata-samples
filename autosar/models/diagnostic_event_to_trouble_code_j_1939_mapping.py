...
class DiagnosticEventToTroubleCodeJ1939Mapping:
    """
    By means of this meta-class it is possible to associate a DiagnosticEvent
    to a DiagnosticTroubleCodeJ1939.
    ...
    class TroubleCodeJ1939Ref(Ref):
        dest: Optional[DiagnosticTroubleCodeJ1939SubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
