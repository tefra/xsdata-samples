...
class DiagnosticRequestPowertrainFreezeFrameDataClass:
    ...
    short_name_fragments: Optional["DiagnosticRequestPowertrainFreezeFrameDataClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestPowertrainFreezeFrameDataClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestPowertrainFreezeFrameDataClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
