...
class DataPrototypeInSystemInstanceRef:
    ...
    context_root_composition_ref: Optional["DataPrototypeInSystemInstanceRef.ContextRootCompositionRef"] = field(
        default=None,
        metadata={
    ...
    context_component_ref: List["DataPrototypeInSystemInstanceRef.ContextComponentRef"] = field(
    ...
    context_port_ref: Optional["DataPrototypeInSystemInstanceRef.ContextPortRef"] = field(
        default=None,
        metadata={
    ...
    context_data_prototype_ref: List["DataPrototypeInSystemInstanceRef.ContextDataPrototypeRef"] = field(
        default_factory=list,
        metadata={
    ...
    target_data_prototype_ref: Optional["DataPrototypeInSystemInstanceRef.TargetDataPrototypeRef"] = field(
        default=None,
        metadata={
