...
class PPortPrototypeInExecutableInstanceRef:
    ...
    context_root_sw_component_prototype_ref: Optional["PPortPrototypeInExecutableInstanceRef.ContextRootSwComponentPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    context_component_prototype_ref: List["PPortPrototypeInExecutableInstanceRef.ContextComponentPrototypeRef"] = field(
    ...
    target_p_port_prototype_ref: Optional["PPortPrototypeInExecutableInstanceRef.TargetPPortPrototypeRef"] = field(
        default=None,
        metadata={
