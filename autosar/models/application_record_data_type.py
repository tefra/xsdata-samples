...
class ApplicationRecordDataType:
    ...
    annotations: None | ApplicationRecordDataType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ApplicationRecordDataType.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    elements: None | ApplicationRecordDataType.Elements = field(
        default=None,
        metadata={
            "name": "ELEMENTS",
            "type": "Element",
