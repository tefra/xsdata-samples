...
class ApplicationRecordDataType:
    ...
    :ivar elements: Specifies an element of a record.  The aggregation
        of ApplicationRecordElement is subject to variability with the
        purpose to support the conditional existence of elements inside
        a ApplicationrecordDataType. The upper multiplicity of this role
    ...
    short_name_fragments: Optional["ApplicationRecordDataType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ApplicationRecordDataType.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["ApplicationRecordDataType.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    elements: Optional["ApplicationRecordDataType.Elements"] = field(
        default=None,
        metadata={
            "name": "ELEMENTS",
            "type": "Element",
