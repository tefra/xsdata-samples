...
class ApplicationRecordElement:
    ...
    short_name_fragments: (
        None | ApplicationRecordElement.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | ApplicationRecordElement.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_tref: None | ApplicationRecordElement.TypeTref = field(
        default=None,
        metadata={
            "name": "TYPE-TREF",
            "type": "Element",
