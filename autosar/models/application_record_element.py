...
class ApplicationRecordElement:
    """
    Describes the properties of one particular element of an application
    record data type.
    ...
    :ivar is_optional: This attribute represents the ability to declare
        the enclosing ApplicationRecordElement as optional. This means
        the that, at runtime, the ApplicationRecordElement may or may
        not have a valid value and shall therefore be ignored. The
        underlying runtime software provides means to set the
        ApplicationRecordElement as not valid at the sending end of a
        communication and determine its validity at the receiving end.
    ...
    class Meta:
        name = "APPLICATION-RECORD-ELEMENT"
    ...
    short_name_fragments: ApplicationRecordElement.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: ApplicationRecordElement.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_tref: ApplicationRecordElement.TypeTref | None = field(
        default=None,
        metadata={
            "name": "TYPE-TREF",
            "type": "Element",
