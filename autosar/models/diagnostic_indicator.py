...
class DiagnosticIndicator:
    ...
    short_name_fragments: None | DiagnosticIndicator.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | DiagnosticIndicator.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_value: None | DiagnosticIndicatorTypeEnumValueVariationPoint = field(
        default=None,
        metadata={
            "name": "TYPE",
            "type": "Element",
