...
class AdaptiveApplicationSwComponentType:
    """This meta-class represents the ability to support the formal modeling of
    application software on the AUTOSAR adaptive platform.

    Consequently, it shall only be used on the AUTOSAR adaptive
    platform.
    ...
    :ivar unit_group_refs: This allows for the specification of which
        ...
        SwComponentType.
    :ivar internal_behaviors: This aggregation represents the internal
        behavior of the AdaptiveApplicationSwComponentType for the
        AUTOSAR adaptive platform. The upper multiplicity of this role
        has been increased to * due to resolving an atpVariation
        stereotype. The previous value was 1.
    ...
    short_name_fragments: Optional["AdaptiveApplicationSwComponentType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["AdaptiveApplicationSwComponentType.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["AdaptiveApplicationSwComponentType.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    sw_component_documentations: Optional["AdaptiveApplicationSwComponentType.SwComponentDocumentations"] = field(
        default=None,
        metadata={
    ...
    consistency_needss: Optional["AdaptiveApplicationSwComponentType.ConsistencyNeedss"] = field(
        default=None,
        metadata={
    ...
    ports: Optional["AdaptiveApplicationSwComponentType.Ports"] = field(
        default=None,
        metadata={
            "name": "PORTS",
            "type": "Element",
    ...
    port_groups: Optional["AdaptiveApplicationSwComponentType.PortGroups"] = field(
        default=None,
        metadata={
            "name": "PORT-GROUPS",
            "type": "Element",
    ...
    unit_group_refs: Optional["AdaptiveApplicationSwComponentType.UnitGroupRefs"] = field(
        default=None,
        metadata={
    ...
    internal_behaviors: Optional["AdaptiveApplicationSwComponentType.InternalBehaviors"] = field(
        default=None,
        metadata={
    ...
    @dataclass
    class UnitGroupRefs:
        unit_group_ref: List["AdaptiveApplicationSwComponentType.UnitGroupRefs.UnitGroupRef"] = field(
            default_factory=list,
            metadata={
                "name": "UNIT-GROUP-REF",
                "type": "Element",
    ...
    class InternalBehaviors:
        adaptive_swc_internal_behavior: List[AdaptiveSwcInternalBehavior] = field(
            default_factory=list,
            metadata={
