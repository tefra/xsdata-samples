...
class UdpNmClusterCoupling:
    ...
    coupled_cluster_refs: Optional["UdpNmClusterCoupling.CoupledClusterRefs"] = field(
        default=None,
        metadata={
    ...
    class CoupledClusterRefs:
        coupled_cluster_ref: List["UdpNmClusterCoupling.CoupledClusterRefs.CoupledClusterRef"] = field(
