...
class EthernetCommunicationController:
    ...
    :ivar ethernet_communication_controller_variants: This element was
    ...
    short_name_fragments: (
        None | EthernetCommunicationController.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | EthernetCommunicationController.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
