...
class KeywordSet:
    ...
    short_name_fragments: None | KeywordSet.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | KeywordSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | KeywordSet.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    keywords: None | KeywordSet.Keywords = field(
        default=None,
        metadata={
            "name": "KEYWORDS",
            "type": "Element",
