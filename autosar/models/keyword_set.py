...
class KeywordSet:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar keywords: This is one particular keyword in the keyword set.
    ...
    short_name_fragments: Optional["KeywordSet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["KeywordSet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["KeywordSet.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    keywords: Optional["KeywordSet.Keywords"] = field(
        default=None,
        metadata={
            "name": "KEYWORDS",
            "type": "Element",
