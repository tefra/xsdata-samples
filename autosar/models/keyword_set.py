...
class KeywordSet:
    ...
    short_name_fragments: KeywordSet.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: KeywordSet.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: KeywordSet.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    keywords: KeywordSet.Keywords | None = field(
        default=None,
        metadata={
            "name": "KEYWORDS",
            "type": "Element",
