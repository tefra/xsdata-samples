...
class DiagnosticIoControlNeeds:
    ...
    short_name_fragments: DiagnosticIoControlNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticIoControlNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticIoControlNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    current_value_ref: DiagnosticIoControlNeeds.CurrentValueRef | None = (
        field(
            default=None,
            metadata={
    ...
    freeze_current_state_supported: Boolean | None = field(
        default=None,
        metadata={
    ...
    reset_to_default_supported: Boolean | None = field(
        default=None,
        metadata={
    ...
    short_term_adjustment_supported: Boolean | None = field(
        default=None,
        metadata={
    ...
    class CurrentValueRef(Ref):
        dest: DiagnosticValueNeedsSubtypesEnum | None = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
