...
class GlobalTimeFrMaster:
    ...
    short_name_fragments: Optional["GlobalTimeFrMaster.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    communication_connector_ref: Optional["GlobalTimeFrMaster.CommunicationConnectorRef"] = field(
        default=None,
        metadata={
