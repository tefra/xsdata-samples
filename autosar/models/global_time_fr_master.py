...
class GlobalTimeFrMaster:
    ...
    short_name_fragments: None | GlobalTimeFrMaster.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | GlobalTimeFrMaster.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_connector_ref: (
        None | GlobalTimeFrMaster.CommunicationConnectorRef
    ) = field(
        default=None,
        metadata={
