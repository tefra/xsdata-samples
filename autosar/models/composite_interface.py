...
class CompositeInterface:
    ...
    a composition of commands and indications.
    ...
    :ivar commands: The upper multiplicity of this role has been
        increased to * due to resolving an atpVariation stereotype. The
        previous value was -1.
    :ivar indications: The upper multiplicity of this role has been
        increased to * due to resolving an atpVariation stereotype. The
        previous value was -1.
    ...
    annotations: None | CompositeInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | CompositeInterface.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    namespaces: None | CompositeInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    commands: None | CompositeInterface.Commands = field(
        default=None,
        metadata={
            "name": "COMMANDS",
            "type": "Element",
    ...
    indications: None | CompositeInterface.Indications = field(
        default=None,
        metadata={
            "name": "INDICATIONS",
            "type": "Element",
