...
class DiagnosticEnableConditionPortMapping:
    ...
    :ivar enable_condition_ref: Reference to the EnableCondition which
        is mapped to a SWC service port with
    ...
    :ivar swc_flat_service_dependency_ref: Reference to a
        ...
        ports. This reference can be used in early stages of the
        development in order to identify the SwcServiceDependency
        without a full System Context.
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticEnableConditionPortMapping
    ...
    short_name_fragments: Optional["DiagnosticEnableConditionPortMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEnableConditionPortMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    enable_condition_ref: Optional["DiagnosticEnableConditionPortMapping.EnableConditionRef"] = field(
        default=None,
        metadata={
    ...
    process_ref: Optional["DiagnosticEnableConditionPortMapping.ProcessRef"] = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
    ...
    swc_flat_service_dependency_ref: Optional["DiagnosticEnableConditionPortMapping.SwcFlatServiceDependencyRef"] = field(
        default=None,
        metadata={
