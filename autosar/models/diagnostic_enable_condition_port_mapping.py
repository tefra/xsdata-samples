...
class DiagnosticEnableConditionPortMapping:
    ...
    short_name_fragments: (
        None | DiagnosticEnableConditionPortMapping.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticEnableConditionPortMapping.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    enable_condition_ref: (
        None | DiagnosticEnableConditionPortMapping.EnableConditionRef
    ) = field(
        default=None,
        metadata={
    ...
    process_ref: None | DiagnosticEnableConditionPortMapping.ProcessRef = (
        field(
            default=None,
            metadata={
                "name": "PROCESS-REF",
    ...
    swc_flat_service_dependency_ref: (
        None | DiagnosticEnableConditionPortMapping.SwcFlatServiceDependencyRef
    ) = field(
        default=None,
        metadata={
    ...
    class EnableConditionRef(Ref):
        dest: None | DiagnosticEnableConditionSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
