...
class DcmIPdu:
    ...
    :ivar diag_pdu_type: Attribute is used to distinguish a request from
        a response.
    ...
    short_name_fragments: Optional["DcmIPdu.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DcmIPdu.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diag_pdu_type: Optional[DiagPduType] = field(
        default=None,
        metadata={
            "name": "DIAG-PDU-TYPE",
            "type": "Element",
