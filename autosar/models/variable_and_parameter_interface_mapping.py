...
class VariableAndParameterInterfaceMapping:
    ...
    :ivar data_mappings: Defines the mapping of two particular
        VariableDataPrototypes or ParameterDataPrototypes with unequal
        names and/or unequal semantic (resolution or range) in context
        of two different SenderReceiverInterfaces, NvDataInterfaces or
        ParameterInterfaces
    ...
    short_name_fragments: Optional["VariableAndParameterInterfaceMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["VariableAndParameterInterfaceMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["VariableAndParameterInterfaceMapping.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    data_mappings: Optional["VariableAndParameterInterfaceMapping.DataMappings"] = field(
        default=None,
        metadata={
            "name": "DATA-MAPPINGS",
            "type": "Element",
