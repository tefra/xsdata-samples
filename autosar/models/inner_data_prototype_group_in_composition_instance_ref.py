...
class InnerDataPrototypeGroupInCompositionInstanceRef:
    ...
    context_sw_component_prototype_ref: List["InnerDataPrototypeGroupInCompositionInstanceRef.ContextSwComponentPrototypeRef"] = field(
    ...
    target_data_prototype_group_ref: Optional["InnerDataPrototypeGroupInCompositionInstanceRef.TargetDataPrototypeGroupRef"] = field(
        default=None,
        metadata={
