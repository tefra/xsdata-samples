...
class DiagnosticEnableConditionNeeds:
    ...
    :ivar initial_status: Defines the initial status for enable or
        disable of acceptance of event reports of a diagnostic event.
    ...
    short_name_fragments: Optional["DiagnosticEnableConditionNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEnableConditionNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticEnableConditionNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    initial_status: Optional[EventAcceptanceStatusEnum] = field(
        default=None,
        metadata={
            "name": "INITIAL-STATUS",
            "type": "Element",
