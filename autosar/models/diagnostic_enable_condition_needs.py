...
class DiagnosticEnableConditionNeeds:
    ...
    short_name_fragments: DiagnosticEnableConditionNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticEnableConditionNeeds.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    audiences: DiagnosticEnableConditionNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    initial_status: EventAcceptanceStatusEnum | None = field(
        default=None,
        metadata={
            "name": "INITIAL-STATUS",
            "type": "Element",
