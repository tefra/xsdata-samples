...
class ServiceInterface:
    ...
    a heterogeneous collection of methods, events and fields.
    ...
    :ivar major_version: Major version of the service contract.
    :ivar minor_version: Minor version of the service contract.
    :ivar events: The upper multiplicity of this role has been increased
        to * due to resolving an atpVariation stereotype. The previous
        value was -1.
    :ivar fields: The upper multiplicity of this role has been increased
        to * due to resolving an atpVariation stereotype. The previous
        value was -1.
    :ivar methods: The upper multiplicity of this role has been
    ...
    annotations: None | ServiceInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ServiceInterface.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    namespaces: None | ServiceInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    minor_version: None | PositiveInteger = field(
        default=None,
        metadata={
            "name": "MINOR-VERSION",
            "type": "Element",
    ...
    events: None | ServiceInterface.Events = field(
        default=None,
        metadata={
            "name": "EVENTS",
            "type": "Element",
    ...
    fields: None | ServiceInterface.Fields = field(
        default=None,
        metadata={
            "name": "FIELDS",
            "type": "Element",
    ...
    methods: None | ServiceInterface.Methods = field(
        default=None,
        metadata={
            "name": "METHODS",
            "type": "Element",
