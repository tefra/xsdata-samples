...
class DiagnosticDataIdentifierGenericInterface:
    """
    This meta-class represents the ability to implement a generic DID-focused
    ...
    short_name_fragments: Optional["DiagnosticDataIdentifierGenericInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDataIdentifierGenericInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDataIdentifierGenericInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDataIdentifierGenericInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
