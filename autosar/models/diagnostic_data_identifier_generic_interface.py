...
class DiagnosticDataIdentifierGenericInterface:
    ...
    short_name_fragments: (
        None | DiagnosticDataIdentifierGenericInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | DiagnosticDataIdentifierGenericInterface.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    blueprint_policys: (
        None | DiagnosticDataIdentifierGenericInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: None | DiagnosticDataIdentifierGenericInterface.Namespaces = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
