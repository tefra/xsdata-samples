...
class ReferrableSubtypesEnum(Enum):
    ...
    ABSTRACT_SECURITY_IDSM_INSTANCE_FILTER = (
    ...
    APPLICATION_PARTITION_TO_ECU_PARTITION_MAPPING = (
    ...
    BSW_ASYNCHRONOUS_SERVER_CALL_RETURNS_EVENT = (
    ...
    COUPLING_PORT_TRAFFIC_CLASS_ASSIGNMENT = (
    ...
    CP_SOFTWARE_CLUSTER_RESOURCE_TO_APPLICATION_PARTITION_MAPPING = (
    ...
    CP_SOFTWARE_CLUSTER_TO_ECU_INSTANCE_MAPPING = (
        "CP-SOFTWARE-CLUSTER-TO-ECU-INSTANCE-MAPPING"
    )
    CP_SOFTWARE_CLUSTER_TO_RESOURCE_MAPPING = (
    ...
    PORT_ELEMENT_TO_COMMUNICATION_RESOURCE_MAPPING = (
    ...
    SIGNAL_SERVICE_TRANSLATION_ELEMENT_PROPS = (
        "SIGNAL-SERVICE-TRANSLATION-ELEMENT-PROPS"
    )
    SIGNAL_SERVICE_TRANSLATION_EVENT_PROPS = (
    ...
    SWC_TO_APPLICATION_PARTITION_MAPPING = (
    ...
    TD_CP_SOFTWARE_CLUSTER_RESOURCE_MAPPING = (
    ...
    TRANSFORMATION_PROPS_TO_SERVICE_INTERFACE_ELEMENT_MAPPING = (
