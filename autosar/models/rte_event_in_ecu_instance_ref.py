...
class RteEventInEcuInstanceRef:
    ...
    context_root_composition_ref: Optional["RteEventInEcuInstanceRef.ContextRootCompositionRef"] = field(
        default=None,
        metadata={
    ...
    context_atomic_component_ref: Optional["RteEventInEcuInstanceRef.ContextAtomicComponentRef"] = field(
        default=None,
        metadata={
    ...
    target_rte_event_ref: Optional["RteEventInEcuInstanceRef.TargetRteEventRef"] = field(
        default=None,
        metadata={
