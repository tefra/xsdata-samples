...
class DiagnosticServiceTableRefConditional:
    ...
    diagnostic_service_table_ref: DiagnosticServiceTableRefConditional.DiagnosticServiceTableRef | None = field(
        default=None,
        metadata={
    ...
    class DiagnosticServiceTableRef(Ref):
        dest: DiagnosticServiceTableSubtypesEnum | None = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
