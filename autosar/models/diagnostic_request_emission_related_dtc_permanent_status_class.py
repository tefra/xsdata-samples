...
class DiagnosticRequestEmissionRelatedDtcPermanentStatusClass:
    ...
    instances of the "Request Emission Related DTC Permanent Status" OBD diagnostic
    service.
    ...
    short_name_fragments: Optional["DiagnosticRequestEmissionRelatedDtcPermanentStatusClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestEmissionRelatedDtcPermanentStatusClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestEmissionRelatedDtcPermanentStatusClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
