...
class BlueprintMappingSet:
    ...
    :ivar blueprint_maps: This represents a particular blueprint map in
        the set.
    ...
    short_name_fragments: Optional["BlueprintMappingSet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BlueprintMappingSet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_maps: Optional["BlueprintMappingSet.BlueprintMaps"] = field(
        default=None,
        metadata={
            "name": "BLUEPRINT-MAPS",
            "type": "Element",
    ...
    class BlueprintMaps:
        ...
        port_interface_blueprint_mapping: List[PortInterfaceBlueprintMapping] = field(
            default_factory=list,
            metadata={
        ...
        port_prototype_blueprint_mapping: List[PortPrototypeBlueprintMapping] = field(
            default_factory=list,
            metadata={
