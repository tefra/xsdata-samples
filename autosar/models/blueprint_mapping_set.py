...
class BlueprintMappingSet:
    ...
    short_name_fragments: None | BlueprintMappingSet.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | BlueprintMappingSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_maps: None | BlueprintMappingSet.BlueprintMaps = field(
        default=None,
        metadata={
            "name": "BLUEPRINT-MAPS",
            "type": "Element",
