...
class DiagnosticClearConditionNeeds:
    ...
    the capability to set a clear condition.
    ...
    short_name_fragments: DiagnosticClearConditionNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticClearConditionNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticClearConditionNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
