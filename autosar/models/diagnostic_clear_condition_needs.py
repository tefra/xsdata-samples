...
class DiagnosticClearConditionNeeds:
    ...
    capability to set a clear condition.
    ...
    short_name_fragments: Optional["DiagnosticClearConditionNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticClearConditionNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticClearConditionNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
