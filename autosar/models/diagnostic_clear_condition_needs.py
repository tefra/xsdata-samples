...
class DiagnosticClearConditionNeeds:
    ...
    short_name_fragments: (
        None | DiagnosticClearConditionNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticClearConditionNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticClearConditionNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
