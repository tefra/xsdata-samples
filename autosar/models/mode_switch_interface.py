...
class ModeSwitchInterface:
    """
    A mode switch interface declares a ModeDeclarationGroupPrototype to be
    sent and received.
    ...
    :ivar mode_group: The ModeDeclarationGroupPrototype of this mode
        interface.
    ...
    short_name_fragments: Optional[
        "ModeSwitchInterface.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ModeSwitchInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["ModeSwitchInterface.BlueprintPolicys"] = (
        field(
            default=None,
            metadata={
    ...
    namespaces: Optional["ModeSwitchInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    mode_group: Optional[ModeDeclarationGroupPrototype] = field(
        default=None,
        metadata={
            "name": "MODE-GROUP",
            "type": "Element",
