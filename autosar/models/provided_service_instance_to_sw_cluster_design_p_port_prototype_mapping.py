...
class ProvidedServiceInstanceToSwClusterDesignPPortPrototypeMapping:
    ...
    layer-dependent ProvidedServiceInstance to a PPortPrototype in the context
    ...
    :ivar provided_port_prototype_iref: This reference identifies the
        applicable PortPrototype in the scope of the SwClusterDesign.
    :ivar provided_service_instance_ref: Reference to a
        ProvidedServiceInstance mapped to a given PPortPrototype in the
