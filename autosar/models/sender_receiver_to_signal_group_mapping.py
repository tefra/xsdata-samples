...
class SenderReceiverToSignalGroupMapping:
    ...
    event_group_refs: Optional["SenderReceiverToSignalGroupMapping.EventGroupRefs"] = field(
        default=None,
        metadata={
    ...
    event_handler_refs: Optional["SenderReceiverToSignalGroupMapping.EventHandlerRefs"] = field(
        default=None,
        metadata={
    ...
    service_instance_refs: Optional["SenderReceiverToSignalGroupMapping.ServiceInstanceRefs"] = field(
        default=None,
        metadata={
    ...
    signal_group_ref: Optional["SenderReceiverToSignalGroupMapping.SignalGroupRef"] = field(
        default=None,
        metadata={
    ...
    type_mapping: Optional["SenderReceiverToSignalGroupMapping.TypeMapping"] = field(
        default=None,
        metadata={
            "name": "TYPE-MAPPING",
            "type": "Element",
    ...
    class EventGroupRefs:
        event_group_ref: List["SenderReceiverToSignalGroupMapping.EventGroupRefs.EventGroupRef"] = field(
    ...
    class EventHandlerRefs:
        event_handler_ref: List["SenderReceiverToSignalGroupMapping.EventHandlerRefs.EventHandlerRef"] = field(
            default_factory=list,
            metadata={
    ...
    class ServiceInstanceRefs:
        service_instance_ref: List["SenderReceiverToSignalGroupMapping.ServiceInstanceRefs.ServiceInstanceRef"] = field(
            default_factory=list,
            metadata={
