...
class MsrQueryTopic1:
    """
    This meta-class represents the ability to specify a query which yields a
    set of topics as a result.

    :ivar msr_query_props: This is argument and properties of the topic
        query.
    :ivar msr_query_result_topic_1: This represents the result of the
        query.
