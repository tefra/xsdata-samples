...
class FmFeatureRelation:
    ...
    short_name_fragments: FmFeatureRelation.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: FmFeatureRelation.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    feature_refs: FmFeatureRelation.FeatureRefs | None = field(
        default=None,
        metadata={
            "name": "FEATURE-REFS",
            "type": "Element",
