...
class FmFeatureRelation:
    ...
    short_name_fragments: None | FmFeatureRelation.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | FmFeatureRelation.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    feature_refs: None | FmFeatureRelation.FeatureRefs = field(
        default=None,
        metadata={
            "name": "FEATURE-REFS",
            "type": "Element",
