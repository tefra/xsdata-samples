...
class DiagnosticDoIpGroupIdentificationInterface:
    ...
    short_name_fragments: DiagnosticDoIpGroupIdentificationInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticDoIpGroupIdentificationInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: DiagnosticDoIpGroupIdentificationInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticDoIpGroupIdentificationInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
