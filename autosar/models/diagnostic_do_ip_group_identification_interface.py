...
class DiagnosticDoIpGroupIdentificationInterface:
    ...
    implement the DoIP Group Identification on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticDoIpGroupIdentificationInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDoIpGroupIdentificationInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDoIpGroupIdentificationInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDoIpGroupIdentificationInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
