...
class TimeSyncPortPrototypeToTimeBaseMapping:
    ...
    AbstractSynchronizedTimeBaseInterface to a TimeBaseResource in the
    ...
    :ivar process_ref: Reference to the context Process this mapping
        applies to.
    :ivar time_base_resource_ref: Reference to the mapped
        TimeBaseResource.
    :ivar time_sync_p_port_prototype_iref: Instance reference to the
        mapped PPortPrototype typed by a
        AbstractSynchronizedTimeBaseInterface.
    :ivar time_sync_r_port_prototype_iref: Instance reference to the
        mapped RPortPrototype typed by a
        AbstractSynchronizedTimeBaseInterface.
    ...
    annotations: None | TimeSyncPortPrototypeToTimeBaseMapping.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    process_ref: None | TimeSyncPortPrototypeToTimeBaseMapping.ProcessRef = (
        field(
            default=None,
            metadata={
                "name": "PROCESS-REF",
    ...
    time_base_resource_ref: (
        None | TimeSyncPortPrototypeToTimeBaseMapping.TimeBaseResourceRef
    ) = field(
        default=None,
        metadata={
