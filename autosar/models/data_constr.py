...
class DataConstr:
    ...
    annotations: None | DataConstr.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | DataConstr.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    data_constr_rules: None | DataConstr.DataConstrRules = field(
        default=None,
        metadata={
