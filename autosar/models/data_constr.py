...
class DataConstr:
    ...
    short_name_fragments: DataConstr.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DataConstr.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: DataConstr.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    data_constr_rules: DataConstr.DataConstrRules | None = field(
        default=None,
        metadata={
