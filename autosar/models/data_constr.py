...
class DataConstr:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar data_constr_rules: This is one particular rule within the data
        constraints.
    ...
    short_name_fragments: Optional["DataConstr.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DataConstr.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DataConstr.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    data_constr_rules: Optional["DataConstr.DataConstrRules"] = field(
        default=None,
        metadata={
            "name": "DATA-CONSTR-RULES",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
