...
class PortGroup:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar inner_group_irefs: Links a PortGroup in a composition to
        another PortGroup, that is defined in a component which is part
        of this CompositionSwComponentType.
    :ivar outer_ports: Outer PortPrototype of this AtomicSwComponentType
        which belongs to the group. A port can belong to several groups
        or to no group at all. This property was modified due to
    ...
    short_name_fragments: Optional["PortGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PortGroup.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    inner_group_irefs: Optional["PortGroup.InnerGroupIrefs"] = field(
        default=None,
        metadata={
            "name": "INNER-GROUP-IREFS",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
    outer_ports: Optional["PortGroup.OuterPorts"] = field(
        default=None,
        metadata={
            "name": "OUTER-PORTS",
            "type": "Element",
    ...
    @dataclass
    class OuterPorts:
        port_prototype_ref_conditional: List[PortPrototypeRefConditional] = field(
            default_factory=list,
            metadata={
