...
class TdEventServiceInstanceMethod:
    """
    This is used to describe timing description events related to methods of a
    service.
    ...
    :ivar occurrence_expression: The occurrence expression for this
        event.
    :ivar service_instance_to_port_prototype_mapping_ref: The service
        and the port this service is provided.
    :ivar method_ref: The method provided by the service.
    :ivar td_event_service_instance_method_type: The specific type of
        this timing event.
    ...
    short_name_fragments: Optional["TdEventServiceInstanceMethod.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventServiceInstanceMethod.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    service_instance_to_port_prototype_mapping_ref: Optional["TdEventServiceInstanceMethod.ServiceInstanceToPortPrototypeMappingRef"] = field(
        default=None,
        metadata={
    ...
    method_ref: Optional["TdEventServiceInstanceMethod.MethodRef"] = field(
        default=None,
        metadata={
            "name": "METHOD-REF",
            "type": "Element",
    ...
    td_event_service_instance_method_type: Optional[TdEventServiceInstanceMethodTypeEnum] = field(
        default=None,
        metadata={
