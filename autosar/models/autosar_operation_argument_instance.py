...
class AutosarOperationArgumentInstance:
    ...
    short_name_fragments: Optional[
        "AutosarOperationArgumentInstance.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["AutosarOperationArgumentInstance.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    operation_argument_instance_iref: Optional[
        OperationArgumentInComponentInstanceRef
    ] = field(
        default=None,
        metadata={
