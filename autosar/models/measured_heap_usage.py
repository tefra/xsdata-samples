...
class MeasuredHeapUsage:
    ...
    :ivar hardware_configuration: Contains information about the
        hardware context this heap usage is describing.
    :ivar hw_element_ref: Specifies for which hardware element (e.g.
        ECU) this heap usage  usage is given.
    :ivar software_context: Contains details about the software context
        this heap usage is provided for.
    :ivar variation_point: This element was generated/modified due to an
        atpVariation stereotype.
    :ivar average_memory_consumption: The average heap usage measured.
        Unit: byte.
    :ivar maximum_memory_consumption: The maximum heap usage measured.
        Unit: byte.
    :ivar minimum_memory_consumption: The minimum heap usage measured.
        Unit: byte.
    :ivar test_pattern: Description of the test pattern used to acquire
        the measured values.
    ...
    short_name_fragments: Optional["MeasuredHeapUsage.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["MeasuredHeapUsage.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_element_ref: Optional["MeasuredHeapUsage.HwElementRef"] = field(
        default=None,
        metadata={
            "name": "HW-ELEMENT-REF",
            "type": "Element",
