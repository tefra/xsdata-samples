...
class DiagnosticTroubleCodeUdsToClearConditionGroupMapping:
    """
    This meta-class provides the ability to map a DiagnosticClearConditionGroup
    to a collection of DiagnosticTroubleCodeUds.
    ...
    :ivar clear_condition_group_ref: Thi reference identifies the
        applicable DiagnosticClearConditionGroup.
    :ivar trouble_code_uds_ref: This reference identifies the
        DiagnosticTroubleCodeUds that are relevant for the mapping.
    ...
    class ClearConditionGroupRef(Ref):
        dest: Optional[DiagnosticClearConditionGroupSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
