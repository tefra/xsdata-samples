...
class ClientServerInterfaceMapping:
    ...
    :ivar error_mappings: Map two different ApplicationErrors defined in
        the context of two different ClientServerInterfaces.
    :ivar operation_mappings: Mapping of two ClientServerOperations in
