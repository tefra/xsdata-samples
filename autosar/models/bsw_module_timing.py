...
class BswModuleTiming:
    ...
    short_name_fragments: Optional["BswModuleTiming.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    timing_descriptions: Optional["BswModuleTiming.TimingDescriptions"] = field(
        default=None,
        metadata={
    ...
    timing_requirements: Optional["BswModuleTiming.TimingRequirements"] = field(
        default=None,
        metadata={
