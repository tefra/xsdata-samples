...
class FireAndForgetMapping:
    """
    Mapping of a Fire&amp;Forget Method that is located in a ServiceInterface
    to a VariableDataPrototype in a SenderReceiverInterface or to a Trigger in
    a TriggerInterface.
    ...
    short_name_fragments: Optional["FireAndForgetMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
