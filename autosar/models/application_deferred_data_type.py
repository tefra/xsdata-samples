...
class ApplicationDeferredDataType:
    ...
    short_name_fragments: ApplicationDeferredDataType.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: ApplicationDeferredDataType.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: ApplicationDeferredDataType.BlueprintPolicys | None = field(
        default=None,
        metadata={
