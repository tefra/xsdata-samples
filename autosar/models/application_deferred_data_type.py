...
class ApplicationDeferredDataType:
    ...
    short_name_fragments: Optional["ApplicationDeferredDataType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ApplicationDeferredDataType.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["ApplicationDeferredDataType.BlueprintPolicys"] = field(
        default=None,
        metadata={
