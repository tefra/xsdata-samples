...
class ApplicationDeferredDataType:
    ...
    short_name_fragments: (
        None | ApplicationDeferredDataType.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | ApplicationDeferredDataType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ApplicationDeferredDataType.BlueprintPolicys = (
        field(
            default=None,
            metadata={
