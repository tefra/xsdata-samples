...
class TdEventBswModule:
    """
    This is used to describe timing events related to the interaction between BSW
    modules.
    ...
    :ivar bsw_module_entry_ref: The scope of this timing event.
    :ivar td_event_bsw_module_type: The specific type of this timing
        event.
