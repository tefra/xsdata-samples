...
class ProcessDesign:
    ...
    :ivar deterministic_client_resource_needss: This aggregation
        represents the collection of applicable resource needs for the
        design of deterministic clients.
    ...
    short_name_fragments: ProcessDesign.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: ProcessDesign.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    deterministic_client_resource_needss: ProcessDesign.DeterministicClientResourceNeedss | None = field(
        default=None,
        metadata={
    ...
    executable_ref: ProcessDesign.ExecutableRef | None = field(
        default=None,
        metadata={
            "name": "EXECUTABLE-REF",
            "type": "Element",
