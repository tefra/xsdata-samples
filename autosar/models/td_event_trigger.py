...
class TdEventTrigger:
    """
    This is used to describe timing events related to triggers at VFB
    level.
    ...
    :ivar td_event_trigger_type: The specific type of this timing event.
    :ivar trigger_ref: The trigger which is provided (released) or
        required (activate) in the given context.
    ...
    annotations: None | TdEventTrigger.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    port_prototype_blueprint_ref: (
        None | TdEventTrigger.PortPrototypeBlueprintRef
    ) = field(
        default=None,
        metadata={
    ...
    port_ref: None | TdEventTrigger.PortRef = field(
        default=None,
        metadata={
            "name": "PORT-REF",
            "type": "Element",
    ...
    td_event_trigger_type: None | TdEventTriggerTypeEnum = field(
        default=None,
        metadata={
    ...
    trigger_ref: None | TdEventTrigger.TriggerRef = field(
        default=None,
        metadata={
            "name": "TRIGGER-REF",
            "type": "Element",
