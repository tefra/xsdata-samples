...
class SecureCommunicationAuthenticationProps:
    ...
    short_name_fragments: SecureCommunicationAuthenticationProps.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SecureCommunicationAuthenticationProps.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
