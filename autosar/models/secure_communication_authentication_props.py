...
class SecureCommunicationAuthenticationProps:
    ...
    short_name_fragments: Optional["SecureCommunicationAuthenticationProps.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SecureCommunicationAuthenticationProps.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
