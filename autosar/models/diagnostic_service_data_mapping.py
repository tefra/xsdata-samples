...
class DiagnosticServiceDataMapping:
    ...
    ServiceInterfaces on the adaptive platform.
    ...
    :ivar diagnostic_data_element_ref: This represents the applicable
        payload that corresponds to the referenced DataPrototype in the
        role mappedDataElement or (in case of a usage on the adaptive
        platform) mappedApDataElement.
    :ivar mapped_ap_data_element_iref: This represents the dataElement
        in the application software of an adaptive AUTOSAR application
        that is accessed for diagnostic purpose.
    :ivar mapped_data_element_iref: This represents the dataElement in
        the application software that is accessed for diagnostic
        purpose. This role is applicable on the classic platform.
    ...
    short_name_fragments: (
        None | DiagnosticServiceDataMapping.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticServiceDataMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_data_element_ref: (
        None | DiagnosticServiceDataMapping.DiagnosticDataElementRef
    ) = field(
        default=None,
        metadata={
    ...
    mapped_ap_data_element_iref: (
        None | DataPrototypeInExecutableInstanceRef
    ) = field(
        default=None,
        metadata={
    ...
    mapped_data_element_iref: None | DataPrototypeInSystemInstanceRef = field(
        default=None,
        metadata={
    ...
    process_ref: None | DiagnosticServiceDataMapping.ProcessRef = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
