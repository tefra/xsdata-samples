...
class J1939DcmIPdu:
    ...
    :ivar diagnostic_message_type: This attribute is used to identify
        the actual DMx message, e.g 1 means DM01, etc.
    ...
    short_name_fragments: None | J1939DcmIPdu.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | J1939DcmIPdu.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_message_type: None | PositiveInteger = field(
        default=None,
        metadata={
