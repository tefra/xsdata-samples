...
class J1939DcmIPdu:
    ...
    short_name_fragments: J1939DcmIPdu.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: J1939DcmIPdu.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_message_type: PositiveInteger | None = field(
        default=None,
        metadata={
