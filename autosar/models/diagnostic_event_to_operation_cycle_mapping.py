...
class DiagnosticEventToOperationCycleMapping:
    ...
    :ivar diagnostic_event_ref: Reference to a DiagnosticEvent to which
        an OperationCycle is assigned.
    :ivar operation_cycle_ref: Reference to an OperationCycle assigned
        to a DiagnosticEvent.
    ...
    short_name_fragments: Optional["DiagnosticEventToOperationCycleMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEventToOperationCycleMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_event_ref: Optional["DiagnosticEventToOperationCycleMapping.DiagnosticEventRef"] = field(
        default=None,
        metadata={
    ...
    operation_cycle_ref: Optional["DiagnosticEventToOperationCycleMapping.OperationCycleRef"] = field(
        default=None,
        metadata={
