...
class J1939ControllerApplication:
    ...
    :ivar function_id: This attribute represents the numerical function
        id of the J1939 controller application.
    :ivar sw_component_prototype_iref: This represents the
        SwComponentPrototype (which is typically typed by a
        CompositionSwComponentType) that corresponds to the
    ...
    short_name_fragments: Optional["J1939ControllerApplication.ShortNameFragments"] = field(
        default=None,
        metadata={
