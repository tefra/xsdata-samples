...
class ClientServerInterfaceToBswModuleEntryBlueprintMapping:
    ...
    implementation of ClientServerOperations by specific BswModuleEntries
    under consideration of PortDefinedArguments.

    Such a mapping enables the formal check whether the number of arguments
    and the data types of arguments of the operation + additional
    PortDefinedArguments matches the signature of the BswModuleEntry.
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar client_server_interface_ref: The referenced
        ClientServerInterface represents the client server interface the
        mapping is dedicated to.
    :ivar operation_mappings: This specifies the operations used in the
        mapping between the ClientServerInterface and the
        BswModuleEntry. The upper multiplicity of this role has been
        increased to * due to resolving an atpVariation stereotype. The
        previous value was -1.
    :ivar port_defined_argument_blueprints: This specifies the
        PortDefinedArguments used in the mapping between the
        ClientServerInterface and the BswModuleEntry. The upper
    ...
    class ClientServerInterfaceRef(Ref):
        dest: Optional[ClientServerInterfaceSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
