...
class SecurityEventReportInterface:
    ...
    short_name_fragments: SecurityEventReportInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SecurityEventReportInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: SecurityEventReportInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: SecurityEventReportInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
