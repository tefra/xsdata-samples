...
class SecurityEventReportInterface:
    ...
    short_name_fragments: Optional["SecurityEventReportInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SecurityEventReportInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["SecurityEventReportInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["SecurityEventReportInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
