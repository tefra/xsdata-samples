...
class SecurityEventReportInterface:
    ...
    short_name_fragments: (
        None | SecurityEventReportInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | SecurityEventReportInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | SecurityEventReportInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | SecurityEventReportInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
