...
class ComSecOcToCryptoKeySlotMapping:
    """
    This meta-class maps the ServiceElementSecureComConfig defined in the COM
    deployment to the CryptoKeySlot defined in the Crypto Stack.
    ...
    annotations: Optional["ComSecOcToCryptoKeySlotMapping.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    class ServiceElementSecureComConfigRef(Ref):
        dest: Optional[ServiceInterfaceElementSecureComConfigSubtypesEnum] = (
            field(
                default=None,
                metadata={
                    "name": "DEST",
