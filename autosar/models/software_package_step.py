...
class SoftwarePackageStep:
    ...
    annotations: None | SoftwarePackageStep.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_switch: None | Boolean = field(
        default=None,
        metadata={
    ...
    pre_activate_refs: None | SoftwarePackageStep.PreActivateRefs = field(
        default=None,
        metadata={
    ...
    process_ref: None | SoftwarePackageStep.ProcessRef = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
    ...
    transfers: None | SoftwarePackageStep.Transfers = field(
        default=None,
        metadata={
            "name": "TRANSFERS",
            "type": "Element",
    ...
    verify_refs: None | SoftwarePackageStep.VerifyRefs = field(
        default=None,
        metadata={
            "name": "VERIFY-REFS",
            "type": "Element",
