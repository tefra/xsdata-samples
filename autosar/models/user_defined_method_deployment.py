...
class UserDefinedMethodDeployment:
    ...
    short_name_fragments: Optional["UserDefinedMethodDeployment.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["UserDefinedMethodDeployment.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    method_ref: Optional["UserDefinedMethodDeployment.MethodRef"] = field(
        default=None,
        metadata={
            "name": "METHOD-REF",
            "type": "Element",
