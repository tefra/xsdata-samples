...
class PortPrototypeInExecutableInstanceRef:
    ...
    :ivar target_port_prototype_ref:
    ...
    context_root_sw_component_prototype_ref: Optional["PortPrototypeInExecutableInstanceRef.ContextRootSwComponentPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    context_component_prototype_ref: List["PortPrototypeInExecutableInstanceRef.ContextComponentPrototypeRef"] = field(
    ...
    target_port_prototype_ref: Optional["PortPrototypeInExecutableInstanceRef.TargetPortPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    @dataclass
    class TargetPortPrototypeRef(Ref):
