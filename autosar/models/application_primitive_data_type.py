...
class ApplicationPrimitiveDataType:
    ...
    short_name_fragments: ApplicationPrimitiveDataType.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    blueprint_policys: ApplicationPrimitiveDataType.BlueprintPolicys | None = field(
        default=None,
        metadata={
