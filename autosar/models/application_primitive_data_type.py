...
class ApplicationPrimitiveDataType:
    ...
    short_name_fragments: Optional["ApplicationPrimitiveDataType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ApplicationPrimitiveDataType.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["ApplicationPrimitiveDataType.BlueprintPolicys"] = field(
        default=None,
        metadata={
