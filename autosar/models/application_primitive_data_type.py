...
class ApplicationPrimitiveDataType:
    ...
    short_name_fragments: (
        None | ApplicationPrimitiveDataType.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | ApplicationPrimitiveDataType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ApplicationPrimitiveDataType.BlueprintPolicys = (
        field(
            default=None,
            metadata={
