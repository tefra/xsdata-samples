...
class CompuMethod:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar display_format: This property specifies, how the physical
        value shall be displayed e.g. in documents or measurement and
        calibration tools.
    :ivar unit_ref: This is the physical unit of the Physical values for
        which the CompuMethod applies.
    :ivar compu_internal_to_phys: This specifies the computation from
        internal values to physical values.
    :ivar compu_phys_to_internal: This represents the computation from
        physical values to the internal values.
    ...
    short_name_fragments: Optional["CompuMethod.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CompuMethod.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["CompuMethod.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    unit_ref: Optional["CompuMethod.UnitRef"] = field(
        default=None,
        metadata={
            "name": "UNIT-REF",
            "type": "Element",
    ...
    compu_internal_to_phys: Optional[Compu] = field(
        default=None,
        metadata={
    ...
    compu_phys_to_internal: Optional[Compu] = field(
        default=None,
        metadata={
