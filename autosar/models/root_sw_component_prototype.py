...
class RootSwComponentPrototype:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar application_type_tref: This SwComponentType acts as the Type
        of the RootSwComponentPrototype.
    ...
    short_name_fragments: Optional["RootSwComponentPrototype.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RootSwComponentPrototype.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    application_type_tref: Optional["RootSwComponentPrototype.ApplicationTypeTref"] = field(
        default=None,
        metadata={
