...
class RawDataStreamServerInterface:
    ...
    Each RawDataStreamServerInterface supports the following capabilities
    without further modeling: * waitForConnection: wait until a
    communication channel is set up. * shutdown: close the communication
    channel * write: send data down the communication channel * read:
    access incoming data on the communication channel.
    ...
    short_name_fragments: RawDataStreamServerInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: RawDataStreamServerInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: RawDataStreamServerInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: RawDataStreamServerInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
