...
class J1939SharedAddressCluster:
    ...
    J1939Clusters that share a common address space for the routing of
    messages.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar participating_j_1939_cluster_refs: This identifies the
        J1939Clusters that share a common address space
    ...
    annotations: None | J1939SharedAddressCluster.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    participating_j_1939_cluster_refs: (
        None | J1939SharedAddressCluster.ParticipatingJ1939ClusterRefs
    ) = field(
        default=None,
        metadata={
