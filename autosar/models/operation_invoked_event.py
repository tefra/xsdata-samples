...
class OperationInvokedEvent:
    """
    The OperationInvokedEvent references the ClientServerOperation invoked by
    the client.
    ...
    :ivar operation_iref: The operation to be executed as the
    ...
    short_name_fragments: Optional["OperationInvokedEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    activation_reason_representation_ref: Optional["OperationInvokedEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["OperationInvokedEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["OperationInvokedEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
