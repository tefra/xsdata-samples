...
class CanFrame:
    ...
    short_name_fragments: Optional["CanFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CanFrame.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: Optional["CanFrame.PduToFrameMappings"] = field(
        default=None,
        metadata={
