...
class CanFrame:
    ...
    short_name_fragments: None | CanFrame.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | CanFrame.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: None | CanFrame.PduToFrameMappings = field(
        default=None,
        metadata={
