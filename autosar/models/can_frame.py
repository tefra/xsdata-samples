...
class CanFrame:
    ...
    short_name_fragments: CanFrame.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: CanFrame.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: CanFrame.PduToFrameMappings | None = field(
        default=None,
        metadata={
