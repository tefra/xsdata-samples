...
class IdsmModuleInstantiation:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar network_interface_ref: This association contains the network
        configuration that shall be applied to an instance of an IDS
        entity.
    :ivar time_bases: This reference identifies the applicable time base
        resource. This property was modified due to atpVariation
        (DirectedAssociationPattern).
    :ivar reportable_security_event_refs: Collection of reportable
        instances of security events.
    ...
    annotations: None | IdsmModuleInstantiation.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    network_interface_ref: (
        None | IdsmModuleInstantiation.NetworkInterfaceRef
    ) = field(
        default=None,
        metadata={
    ...
    time_bases: None | IdsmModuleInstantiation.TimeBases = field(
        default=None,
        metadata={
            "name": "TIME-BASES",
            "type": "Element",
    ...
    reportable_security_event_refs: (
        None | IdsmModuleInstantiation.ReportableSecurityEventRefs
    ) = field(
        default=None,
        metadata={
