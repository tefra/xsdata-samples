...
class TimingDescriptionEventChain:
    ...
    :ivar stimulus_ref: The stimulus event representing the point in
        time where the event chain is activated.
    :ivar response_ref: The response event representing the point in
        time where the event chain is terminated.
    :ivar segment_refs: A composed event chain consists of an arbitrary
    ...
    annotations: None | TimingDescriptionEventChain.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    stimulus_ref: None | TimingDescriptionEventChain.StimulusRef = field(
        default=None,
        metadata={
            "name": "STIMULUS-REF",
            "type": "Element",
    ...
    response_ref: None | TimingDescriptionEventChain.ResponseRef = field(
        default=None,
        metadata={
            "name": "RESPONSE-REF",
            "type": "Element",
    ...
    segment_refs: None | TimingDescriptionEventChain.SegmentRefs = field(
        default=None,
        metadata={
            "name": "SEGMENT-REFS",
            "type": "Element",
