...
class ApApplicationErrorDomain:
    ...
    annotations: None | ApApplicationErrorDomain.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    namespaces: None | ApApplicationErrorDomain.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    value: None | PositiveUnlimitedInteger = field(
        default=None,
        metadata={
            "name": "VALUE",
            "type": "Element",
