...
class McFunctionDataRefSetConditional:
    ...
    flat_map_entry_refs: Optional["McFunctionDataRefSetConditional.FlatMapEntryRefs"] = field(
        default=None,
        metadata={
    ...
    mc_data_instance_refs: Optional["McFunctionDataRefSetConditional.McDataInstanceRefs"] = field(
        default=None,
        metadata={
    ...
    class FlatMapEntryRefs:
        flat_map_entry_ref: List["McFunctionDataRefSetConditional.FlatMapEntryRefs.FlatMapEntryRef"] = field(
    ...
    class McDataInstanceRefs:
        mc_data_instance_ref: List["McFunctionDataRefSetConditional.McDataInstanceRefs.McDataInstanceRef"] = field(
            default_factory=list,
            metadata={
