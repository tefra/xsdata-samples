...
class SecOcSecureComProps:
    ...
    :ivar freshness_value_length: This attribute defines the complete
        length in bits of the Freshness Value.
    :ivar freshness_value_tx_length: This attribute defines the length
        ...
        the secured message. In other words this attribute defines the
        length of the authenticated Message.
    :ivar job_requirements: Collection of cryptographic job
        requirements.
    ...
    annotations: None | SecOcSecureComProps.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    job_requirements: None | SecOcSecureComProps.JobRequirements = field(
        default=None,
        metadata={
