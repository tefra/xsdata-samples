...
class BswModeSwitchedAckEvent:
    ...
    :ivar mode_group_ref: A mode group provided by this module. The
        acknowledgement of a switch of this group raises this event.
    ...
    short_name_fragments: Optional["BswModeSwitchedAckEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswModeSwitchedAckEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["BswModeSwitchedAckEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswModeSwitchedAckEvent.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional["BswModeSwitchedAckEvent.DisabledInModeIrefs"] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional["BswModeSwitchedAckEvent.StartsOnEventRef"] = field(
        default=None,
        metadata={
    ...
    mode_group_ref: Optional["BswModeSwitchedAckEvent.ModeGroupRef"] = field(
        default=None,
        metadata={
            "name": "MODE-GROUP-REF",
            "type": "Element",
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswModeSwitchedAckEvent.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
