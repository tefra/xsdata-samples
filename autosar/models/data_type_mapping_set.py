...
class DataTypeMappingSet:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar data_type_maps: This is one particular association between an
        ApplicationDataType and its AbstractImplementationDataType.
    :ivar mode_request_type_maps: This is one particular association
        between an ModeDeclarationGroup and its
    ...
    annotations: None | DataTypeMappingSet.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | DataTypeMappingSet.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    data_type_maps: None | DataTypeMappingSet.DataTypeMaps = field(
        default=None,
        metadata={
            "name": "DATA-TYPE-MAPS",
            "type": "Element",
    ...
    mode_request_type_maps: None | DataTypeMappingSet.ModeRequestTypeMaps = (
        field(
            default=None,
            metadata={
