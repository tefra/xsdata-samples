...
class DiagnosticGenericUdsInterface:
    """
    This meta-class represents the ability to implement a generic UDS PortInterface
    ...
    short_name_fragments: Optional["DiagnosticGenericUdsInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticGenericUdsInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticGenericUdsInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticGenericUdsInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
