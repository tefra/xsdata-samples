...
class TdEventVfbReference:
    ...
    Virtual Functional Bus (VFB) view which are specified in other timing
    views.
    ...
    :ivar component_iref: The context for the scope of this timing
        event.
    :ivar referenced_td_event_vfb_ref: The referenced timing description
        event.
    ...
    short_name_fragments: TdEventVfbReference.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: TdEventVfbReference.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    referenced_td_event_vfb_ref: TdEventVfbReference.ReferencedTdEventVfbRef | None = field(
        default=None,
        metadata={
    ...
    class ReferencedTdEventVfbRef(Ref):
        dest: TdEventVfbSubtypesEnum | None = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
