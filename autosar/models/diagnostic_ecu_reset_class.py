...
class DiagnosticEcuResetClass:
    ...
    short_name_fragments: DiagnosticEcuResetClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticEcuResetClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticEcuResetClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
