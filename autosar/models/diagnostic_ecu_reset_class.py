...
class DiagnosticEcuResetClass:
    """
    This meta-class contains attributes shared by all instances of the "Ecu Reset"
    diagnostic service.
    ...
    short_name_fragments: Optional["DiagnosticEcuResetClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEcuResetClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticEcuResetClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
