...
class DiagnosticEcuResetClass:
    ...
    short_name_fragments: None | DiagnosticEcuResetClass.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | DiagnosticEcuResetClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticEcuResetClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
