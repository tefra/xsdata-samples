...
class HealthChannelExternalStatus:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar recovery_notification: Defines the RecoveryNotification.
    :ivar health_channel_iref: Refers to the HealthChannel.
    :ivar notified_statuss: This is a list of statuses which shall
        trigger the RecoveryNotification of this
        HealthChannelExternalStatus.
    :ivar process_ref: Defines the Process this Health Channel shall be
        monitored.
    ...
    short_name_fragments: HealthChannelExternalStatus.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    notified_statuss: HealthChannelExternalStatus.NotifiedStatuss | None = field(
        default=None,
        metadata={
