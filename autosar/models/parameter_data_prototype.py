...
class ParameterDataPrototype:
    """
    A parameter element used for parameter interface and internal behavior,
    supporting signal like parameter and characteristic value communication
    patterns and parameter and characteristic value definition.
    ...
    :ivar init_value: Specifies initial value(s) of the
    ...
    short_name_fragments: ParameterDataPrototype.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: ParameterDataPrototype.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_tref: ParameterDataPrototype.TypeTref | None = field(
        default=None,
        metadata={
            "name": "TYPE-TREF",
            "type": "Element",
    ...
    init_value: ParameterDataPrototype.InitValue | None = field(
        default=None,
        metadata={
            "name": "INIT-VALUE",
            "type": "Element",
