...
class DdsServiceInstanceToMachineMapping:
    ...
    annotations: None | DdsServiceInstanceToMachineMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_connector_ref: (
        None | DdsServiceInstanceToMachineMapping.CommunicationConnectorRef
    ) = field(
        default=None,
        metadata={
    ...
    sec_oc_com_props_for_multicast_refs: (
        None | DdsServiceInstanceToMachineMapping.SecOcComPropsForMulticastRefs
    ) = field(
        default=None,
        metadata={
    ...
    secure_com_props_for_tcp_refs: (
        None | DdsServiceInstanceToMachineMapping.SecureComPropsForTcpRefs
    ) = field(
        default=None,
        metadata={
    ...
    secure_com_props_for_udp_refs: (
        None | DdsServiceInstanceToMachineMapping.SecureComPropsForUdpRefs
    ) = field(
        default=None,
        metadata={
    ...
    service_instance_refs: (
        None | DdsServiceInstanceToMachineMapping.ServiceInstanceRefs
    ) = field(
        default=None,
        metadata={
