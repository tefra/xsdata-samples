...
class RestEndpointGet:
    """
    This meta-class represents the ability to model a REST endpoint with GET
    semantics.
    ...
    short_name_fragments: Optional["RestEndpointGet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RestEndpointGet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["RestEndpointGet.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    arguments: Optional["RestEndpointGet.Arguments"] = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
