...
class DiagnosticFimEventGroup:
    ...
    :ivar event_refs: This reference represents the way of grouping
        diagnostic events into a summary event in the context of the
        Fim.
    ...
    short_name_fragments: Optional["DiagnosticFimEventGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticFimEventGroup.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_refs: Optional["DiagnosticFimEventGroup.EventRefs"] = field(
        default=None,
        metadata={
            "name": "EVENT-REFS",
            "type": "Element",
