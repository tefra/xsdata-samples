...
class CryptoProvider:
    ...
    short_name_fragments: Optional["CryptoProvider.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    crypto_provider_documentation_ref: Optional["CryptoProvider.CryptoProviderDocumentationRef"] = field(
        default=None,
        metadata={
