...
class CryptoProvider:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar crypto_provider_documentation_ref: Documentation of the
        CryptoProvider that describes the implemented cryptographic
        primitives.
    :ivar key_slots: This aggregation represents the key slots that are
    ...
    annotations: None | CryptoProvider.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    crypto_provider_documentation_ref: (
        None | CryptoProvider.CryptoProviderDocumentationRef
    ) = field(
        default=None,
        metadata={
    ...
    key_slots: None | CryptoProvider.KeySlots = field(
        default=None,
        metadata={
            "name": "KEY-SLOTS",
            "type": "Element",
