...
class DiagnosticServiceDataIdentifierPortMapping:
    ...
    :ivar diagnostic_data_element_ref: This reference represents the
        applicable DiagnosticDataElement.
    :ivar diagnostic_data_identifier_ref: This reference represents the
        applicable DiagnosticDataIdentfiier.
    ...
    :ivar swc_service_dependency_in_executable_iref: This reference
        identifies the applicable SwcServiceDependency. The reference
        has the ability to point into the component hierarchy (under
    ...
    short_name_fragments: Optional["DiagnosticServiceDataIdentifierPortMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticServiceDataIdentifierPortMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_data_element_ref: Optional["DiagnosticServiceDataIdentifierPortMapping.DiagnosticDataElementRef"] = field(
        default=None,
        metadata={
    ...
    diagnostic_data_identifier_ref: Optional["DiagnosticServiceDataIdentifierPortMapping.DiagnosticDataIdentifierRef"] = field(
        default=None,
        metadata={
    ...
    process_ref: Optional["DiagnosticServiceDataIdentifierPortMapping.ProcessRef"] = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
