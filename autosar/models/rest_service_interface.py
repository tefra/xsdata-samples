...
class RestServiceInterface:
    ...
    :ivar resources: This aggregation represents the collectioin of
        resources owned by the enclosing REST service.
    ...
    annotations: None | RestServiceInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | RestServiceInterface.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    namespaces: None | RestServiceInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    resources: None | RestServiceInterface.Resources = field(
        default=None,
        metadata={
            "name": "RESOURCES",
            "type": "Element",
