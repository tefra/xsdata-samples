...
class DiagnosticRequestVehicleInfoClass:
    ...
    short_name_fragments: (
        None | DiagnosticRequestVehicleInfoClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticRequestVehicleInfoClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRequestVehicleInfoClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
