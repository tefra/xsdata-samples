...
class DiagnosticRequestVehicleInfoClass:
    ...
    short_name_fragments: (
        DiagnosticRequestVehicleInfoClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestVehicleInfoClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        DiagnosticRequestVehicleInfoClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
