...
class DiagnosticRequestVehicleInfoClass:
    ...
    all instances of the "Request Vehicle Info" OBD diagnostic service.
    ...
    short_name_fragments: DiagnosticRequestVehicleInfoClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestVehicleInfoClass.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: DiagnosticRequestVehicleInfoClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
