...
class DiagnosticRequestVehicleInfoClass:
    ...
    short_name_fragments: Optional[
        "DiagnosticRequestVehicleInfoClass.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestVehicleInfoClass.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: Optional[
        "DiagnosticRequestVehicleInfoClass.AccessPermissionRef"
    ] = field(
        default=None,
        metadata={
