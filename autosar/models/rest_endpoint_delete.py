...
class RestEndpointDelete:
    ...
    annotations: None | RestEndpointDelete.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | RestEndpointDelete.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    arguments: None | RestEndpointDelete.Arguments = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
