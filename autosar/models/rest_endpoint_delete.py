...
class RestEndpointDelete:
    ...
    short_name_fragments: RestEndpointDelete.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: RestEndpointDelete.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: RestEndpointDelete.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    arguments: RestEndpointDelete.Arguments | None = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
