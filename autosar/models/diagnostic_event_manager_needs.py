...
class DiagnosticEventManagerNeeds:
    ...
    Event Manager (Dem) which are not related to a particular item.
    ...
    short_name_fragments: Optional[
        "DiagnosticEventManagerNeeds.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticEventManagerNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticEventManagerNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
