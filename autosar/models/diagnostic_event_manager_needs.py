...
class DiagnosticEventManagerNeeds:
    ...
    short_name_fragments: (
        None | DiagnosticEventManagerNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticEventManagerNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticEventManagerNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
