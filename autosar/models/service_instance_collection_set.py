...
class ServiceInstanceCollectionSet:
    ...
    :ivar service_instances: ServiceInstances that are part of the
        collection. The upper multiplicity of this role has been
    ...
    short_name_fragments: Optional["ServiceInstanceCollectionSet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ServiceInstanceCollectionSet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    service_instances: Optional["ServiceInstanceCollectionSet.ServiceInstances"] = field(
        default=None,
        metadata={
