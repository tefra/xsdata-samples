...
class DiagnosticFunctionIdentifierInhibit:
    ...
    :ivar function_identifier_ref: This represents the corresponding
        function identifier.
    :ivar inhibit_sources: This represents a collection of
        DiagnosticFunctionInhibitSource that contribute to the
        configuration of the enclosing
        DiagnosticFunctionIdentiferInhibit.
    :ivar inhibition_mask: This represents the value of the inhibition
        mask behavior.
    ...
    annotations: None | DiagnosticFunctionIdentifierInhibit.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    function_identifier_ref: (
        None | DiagnosticFunctionIdentifierInhibit.FunctionIdentifierRef
    ) = field(
        default=None,
        metadata={
    ...
    inhibit_sources: (
        None | DiagnosticFunctionIdentifierInhibit.InhibitSources
    ) = field(
        default=None,
        metadata={
    ...
    inhibition_mask: None | DiagnosticInhibitionMaskEnum = field(
        default=None,
        metadata={
