...
class PhmHealthChannelRecoveryNotificationInterface:
    ...
    short_name_fragments: (
        None | PhmHealthChannelRecoveryNotificationInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | PhmHealthChannelRecoveryNotificationInterface.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    blueprint_policys: (
        None | PhmHealthChannelRecoveryNotificationInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: (
        None | PhmHealthChannelRecoveryNotificationInterface.Namespaces
    ) = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
