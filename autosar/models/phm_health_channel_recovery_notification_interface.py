...
class PhmHealthChannelRecoveryNotificationInterface:
    ...
    implementing a PHM HealthChannel notification.
    ...
    short_name_fragments: Optional["PhmHealthChannelRecoveryNotificationInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PhmHealthChannelRecoveryNotificationInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["PhmHealthChannelRecoveryNotificationInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["PhmHealthChannelRecoveryNotificationInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
