...
class ComFieldGrant:
    ...
    :ivar design_ref: This reference identifies the ComFieldGrantDesign
        that the enclosing ComFieldGrant was created from.
    :ivar role: This attribute provides the ability to further specify
        the access to the ServiceInterface.field.
    ...
    annotations: None | ComFieldGrant.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    remote_subject_refs: None | ComFieldGrant.RemoteSubjectRefs = field(
        default=None,
        metadata={
    ...
    service_instance_ref: None | ComFieldGrant.ServiceInstanceRef = field(
        default=None,
        metadata={
    ...
    design_ref: None | ComFieldGrant.DesignRef = field(
        default=None,
        metadata={
            "name": "DESIGN-REF",
            "type": "Element",
    ...
    service_deployment_ref: None | ComFieldGrant.ServiceDeploymentRef = field(
        default=None,
        metadata={
    ...
    @dataclass
    class DesignRef(Ref):
        dest: None | ComFieldGrantDesignSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
