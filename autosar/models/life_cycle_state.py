...
class LifeCycleState:
    ...
    short_name_fragments: None | LifeCycleState.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | LifeCycleState.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | LifeCycleState.BlueprintPolicys = field(
        default=None,
        metadata={
