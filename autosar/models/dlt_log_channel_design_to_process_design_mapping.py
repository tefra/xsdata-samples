...
class DltLogChannelDesignToProcessDesignMapping:
    ...
    Channel in the Design to a ProcessDesign.
    ...
    :ivar dlt_log_channel_design_ref: Reference to the Log&amp;Trace
        channel that contains the log/trace message output.
    :ivar process_design_ref: Reference to the ProcessDesign that is
        monitored by the DltLogChannel.
    ...
    annotations: (
        None | DltLogChannelDesignToProcessDesignMapping.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    dlt_log_channel_design_ref: (
        None | DltLogChannelDesignToProcessDesignMapping.DltLogChannelDesignRef
    ) = field(
        default=None,
        metadata={
    ...
    process_design_ref: (
        None | DltLogChannelDesignToProcessDesignMapping.ProcessDesignRef
    ) = field(
        default=None,
        metadata={
