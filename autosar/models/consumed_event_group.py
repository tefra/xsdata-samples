...
class ConsumedEventGroup:
    ...
    short_name_fragments: Optional["ConsumedEventGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    application_endpoint_ref: Optional["ConsumedEventGroup.ApplicationEndpointRef"] = field(
        default=None,
        metadata={
    ...
    event_multicast_addresss: Optional["ConsumedEventGroup.EventMulticastAddresss"] = field(
        default=None,
        metadata={
    ...
    pdu_activation_routing_groups: Optional["ConsumedEventGroup.PduActivationRoutingGroups"] = field(
        default=None,
        metadata={
    ...
    routing_group_refs: Optional["ConsumedEventGroup.RoutingGroupRefs"] = field(
        default=None,
        metadata={
    ...
    sd_client_timer_configs: Optional["ConsumedEventGroup.SdClientTimerConfigs"] = field(
        default=None,
        metadata={
    ...
    class RoutingGroupRefs:
        routing_group_ref: List["ConsumedEventGroup.RoutingGroupRefs.RoutingGroupRef"] = field(
            default_factory=list,
            metadata={
    ...
    class SdClientTimerConfigs:
        someip_sd_client_event_group_timing_config_ref_conditional: List[SomeipSdClientEventGroupTimingConfigRefConditional] = field(
            default_factory=list,
            metadata={
