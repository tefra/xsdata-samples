...
class CouplingPortFifo:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar assigned_traffic_classs:
    :ivar minimum_fifo_length: FIFO minimum length in Byte. An actual
        configuration/hardware may use a bigger value.
    ...
    short_name_fragments: Optional["CouplingPortFifo.ShortNameFragments"] = (
        field(
            default=None,
            metadata={
