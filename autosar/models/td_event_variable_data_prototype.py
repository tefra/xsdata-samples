...
class TdEventVariableDataPrototype:
    ...
    :ivar data_element_ref: The referenced VariableDataPrototype
    :ivar td_event_variable_data_prototype_type: The specific type of
        this timing event.
    ...
    short_name_fragments: (
        None | TdEventVariableDataPrototype.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | TdEventVariableDataPrototype.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    port_prototype_blueprint_ref: (
        None | TdEventVariableDataPrototype.PortPrototypeBlueprintRef
    ) = field(
        default=None,
        metadata={
    ...
    port_ref: None | TdEventVariableDataPrototype.PortRef = field(
        default=None,
        metadata={
            "name": "PORT-REF",
            "type": "Element",
    ...
    data_element_ref: None | TdEventVariableDataPrototype.DataElementRef = (
        field(
            default=None,
            metadata={
    ...
    td_event_variable_data_prototype_type: (
        None | TdEventVariableDataPrototypeTypeEnum
    ) = field(
        default=None,
        metadata={
