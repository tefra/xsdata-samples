...
class DiagnosticsCommunicationSecurityNeeds:
    """
    This meta-class represents the needs of a software-component to verify
    the access to security level via diagnostic services.
    ...
    short_name_fragments: (
        None | DiagnosticsCommunicationSecurityNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticsCommunicationSecurityNeeds.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    audiences: None | DiagnosticsCommunicationSecurityNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
