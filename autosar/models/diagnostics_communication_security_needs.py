...
class DiagnosticsCommunicationSecurityNeeds:
    ...
    short_name_fragments: Optional[
        "DiagnosticsCommunicationSecurityNeeds.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional[
        "DiagnosticsCommunicationSecurityNeeds.Annotations"
    ] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    audiences: Optional["DiagnosticsCommunicationSecurityNeeds.Audiences"] = (
        field(
            default=None,
            metadata={
                "name": "AUDIENCES",
