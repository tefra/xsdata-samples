...
class DiagnosticIndicatorNeeds:
    ...
    capability to implement an indicator.
    ...
    short_name_fragments: Optional["DiagnosticIndicatorNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticIndicatorNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticIndicatorNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
