...
class DiagnosticIndicatorNeeds:
    ...
    the capability to implement an indicator.
    ...
    short_name_fragments: DiagnosticIndicatorNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticIndicatorNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticIndicatorNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
