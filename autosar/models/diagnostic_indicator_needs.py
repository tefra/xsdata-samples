...
class DiagnosticIndicatorNeeds:
    ...
    short_name_fragments: (
        None | DiagnosticIndicatorNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticIndicatorNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticIndicatorNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
