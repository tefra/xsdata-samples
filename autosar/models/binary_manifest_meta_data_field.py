...
class BinaryManifestMetaDataField:
    """
    This meta-class provides the ability to define a meta-data field for
    the binary manifest descriptor.
    ...
    :ivar symbol: This attribute specifies the symbol of the addressable
        object.
    :ivar size: The value of this attribute represents the size of the
        meta-data field in bytes.
    :ivar value: This attribute specifies the value of the meta-data
        field.
    ...
    short_name_fragments: (
        None | BinaryManifestMetaDataField.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | BinaryManifestMetaDataField.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
