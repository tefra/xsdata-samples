...
class SwRecordLayout:
    ...
    short_name_fragments: SwRecordLayout.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SwRecordLayout.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    sw_record_layout_group: SwRecordLayoutGroup | None = field(
        default=None,
        metadata={
