...
class SwRecordLayout:
    ...
    :ivar sw_record_layout_group: This is the top level record layout
        group.
    ...
    short_name_fragments: Optional["SwRecordLayout.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SwRecordLayout.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    sw_record_layout_group: Optional[SwRecordLayoutGroup] = field(
        default=None,
        metadata={
