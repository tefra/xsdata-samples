...
class ApplicationArrayDataType:
    ...
    short_name_fragments: Optional["ApplicationArrayDataType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    blueprint_policys: Optional["ApplicationArrayDataType.BlueprintPolicys"] = field(
        default=None,
        metadata={
