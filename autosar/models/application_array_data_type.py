...
class ApplicationArrayDataType:
    ...
    :ivar dynamic_array_size_profile: Specifies the profile which the
        array will follow if it is a variable size array.
    :ivar element: This association implements the concept of an array
        element. That is, in some cases it is necessary to be able to
        identify single array elements, e.g. as input values for an
    ...
    annotations: None | ApplicationArrayDataType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ApplicationArrayDataType.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    element: None | ApplicationArrayElement = field(
        default=None,
        metadata={
            "name": "ELEMENT",
            "type": "Element",
