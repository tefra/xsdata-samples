...
class DiagnosticServiceValidationInterface:
    ...
    annotations: None | DiagnosticServiceValidationInterface.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: (
        None | DiagnosticServiceValidationInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: None | DiagnosticServiceValidationInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
