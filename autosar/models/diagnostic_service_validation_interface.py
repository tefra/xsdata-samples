...
class DiagnosticServiceValidationInterface:
    """
    This meta-class represents the ability to implement a PortInterface to process
    requests for service validation on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticServiceValidationInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticServiceValidationInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticServiceValidationInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticServiceValidationInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
