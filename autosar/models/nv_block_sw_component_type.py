...
class NvBlockSwComponentType:
    ...
    :ivar bulk_nv_data_descriptors: This aggregation formally defines
        the bulk Nv Blocks that are provided to the application software
        by the enclosing NvBlockSwComponentType. The upper multiplicity
        of this role has been increased to * due to resolving an
        atpVariation stereotype. The previous value was -1.
    :ivar nv_block_descriptors: Specification of the properties of
        exactly one NVRAM Block. The upper multiplicity of this role has
    ...
    annotations: None | NvBlockSwComponentType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | NvBlockSwComponentType.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    sw_component_documentations: (
        None | NvBlockSwComponentType.SwComponentDocumentations
    ) = field(
        default=None,
        metadata={
    ...
    consistency_needss: None | NvBlockSwComponentType.ConsistencyNeedss = (
        field(
            default=None,
            metadata={
    ...
    ports: None | NvBlockSwComponentType.Ports = field(
        default=None,
        metadata={
            "name": "PORTS",
            "type": "Element",
    ...
    port_groups: None | NvBlockSwComponentType.PortGroups = field(
        default=None,
        metadata={
            "name": "PORT-GROUPS",
            "type": "Element",
    ...
    unit_group_refs: None | NvBlockSwComponentType.UnitGroupRefs = field(
        default=None,
        metadata={
    ...
    internal_behaviors: None | NvBlockSwComponentType.InternalBehaviors = (
        field(
            default=None,
            metadata={
    ...
    bulk_nv_data_descriptors: (
        None | NvBlockSwComponentType.BulkNvDataDescriptors
    ) = field(
        default=None,
        metadata={
    ...
    nv_block_descriptors: None | NvBlockSwComponentType.NvBlockDescriptors = (
        field(
            default=None,
            metadata={
