...
class EcucFunctionNameDef:
    ...
    :ivar ecuc_function_name_def_variants: This element was
    ...
    short_name_fragments: Optional["EcucFunctionNameDef.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EcucFunctionNameDef.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: Optional["EcucFunctionNameDef.RelatedTraceItemRef"] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional["EcucFunctionNameDef.EcucValidationConds"] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional["EcucFunctionNameDef.ImplementationConfigClasses"] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional["EcucFunctionNameDef.MultiplicityConfigClasses"] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional["EcucFunctionNameDef.ValueConfigClasses"] = field(
        default=None,
        metadata={
    ...
    ecuc_function_name_def_variants: Optional["EcucFunctionNameDef.EcucFunctionNameDefVariants"] = field(
        default=None,
        metadata={
            "name": "ECUC-FUNCTION-NAME-DEF-VARIANTS",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
    ...
    @dataclass
    class EcucFunctionNameDefVariants:
        ecuc_function_name_def_conditional: List[EcucFunctionNameDefConditional] = field(
            default_factory=list,
            metadata={
                "name": "ECUC-FUNCTION-NAME-DEF-CONDITIONAL",
                "type": "Element",
                "namespace": "http://autosar.org/schema/r4.0",
            }
        )
