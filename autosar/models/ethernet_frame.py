...
class EthernetFrame:
    ...
    short_name_fragments: Optional["EthernetFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EthernetFrame.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: Optional["EthernetFrame.PduToFrameMappings"] = field(
        default=None,
        metadata={
