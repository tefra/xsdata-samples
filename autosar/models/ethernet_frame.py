...
class EthernetFrame:
    ...
    short_name_fragments: EthernetFrame.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: EthernetFrame.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: EthernetFrame.PduToFrameMappings | None = field(
        default=None,
        metadata={
