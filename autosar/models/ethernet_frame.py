...
class EthernetFrame:
    ...
    short_name_fragments: None | EthernetFrame.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | EthernetFrame.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: None | EthernetFrame.PduToFrameMappings = field(
        default=None,
        metadata={
