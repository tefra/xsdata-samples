...
class EthernetFrameTriggering:
    ...
    :ivar frame_port_refs: References to the FramePort on every ECU of
        the system which sends and/or receives the frame.  References
    ...
    short_name_fragments: Optional["EthernetFrameTriggering.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EthernetFrameTriggering.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    frame_port_refs: Optional["EthernetFrameTriggering.FramePortRefs"] = field(
        default=None,
        metadata={
    ...
    frame_ref: Optional["EthernetFrameTriggering.FrameRef"] = field(
        default=None,
        metadata={
            "name": "FRAME-REF",
            "type": "Element",
    ...
    pdu_triggerings: Optional["EthernetFrameTriggering.PduTriggerings"] = field(
        default=None,
        metadata={
    ...
    @dataclass
    class FramePortRefs:
        frame_port_ref: List["EthernetFrameTriggering.FramePortRefs.FramePortRef"] = field(
            default_factory=list,
            metadata={
                "name": "FRAME-PORT-REF",
                "type": "Element",
