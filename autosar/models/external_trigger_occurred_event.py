...
class ExternalTriggerOccurredEvent:
    ...
    :ivar trigger_iref: Reference to the applicable Trigger.
    ...
    short_name_fragments: (
        None | ExternalTriggerOccurredEvent.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | ExternalTriggerOccurredEvent.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: (
        None | ExternalTriggerOccurredEvent.ActivationReasonRepresentationRef
    ) = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: (
        None | ExternalTriggerOccurredEvent.DisabledModeIrefs
    ) = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: None | ExternalTriggerOccurredEvent.StartOnEventRef = (
        field(
            default=None,
            metadata={
    ...
    trigger_iref: None | RTriggerInAtomicSwcInstanceRef = field(
        default=None,
        metadata={
            "name": "TRIGGER-IREF",
            "type": "Element",
