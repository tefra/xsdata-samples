...
class ServiceInstanceToSignalMappingSet:
    ...
    short_name_fragments: Optional[
        "ServiceInstanceToSignalMappingSet.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ServiceInstanceToSignalMappingSet.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    service_instance_to_signal_mappings: Optional[
