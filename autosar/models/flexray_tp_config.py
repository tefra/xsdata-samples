...
class FlexrayTpConfig:
    ...
    :ivar pdu_pools: The upper multiplicity of this role has been
    ...
    :ivar tp_connections: The upper multiplicity of this role has been
        increased to * due to resolving an atpVariation stereotype. The
        previous value was -1.
    :ivar tp_connection_controls: The upper multiplicity of this role
    ...
    annotations: None | FlexrayTpConfig.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: (
        None | FlexrayTpConfig.CommunicationClusterRef
    ) = field(
        default=None,
        metadata={
    ...
    pdu_pools: None | FlexrayTpConfig.PduPools = field(
        default=None,
        metadata={
            "name": "PDU-POOLS",
            "type": "Element",
    ...
    tp_addresss: None | FlexrayTpConfig.TpAddresss = field(
        default=None,
        metadata={
            "name": "TP-ADDRESSS",
            "type": "Element",
    ...
    tp_connections: None | FlexrayTpConfig.TpConnections = field(
        default=None,
        metadata={
            "name": "TP-CONNECTIONS",
            "type": "Element",
    ...
    tp_connection_controls: None | FlexrayTpConfig.TpConnectionControls = (
        field(
            default=None,
            metadata={
    ...
    tp_ecus: None | FlexrayTpConfig.TpEcus = field(
        default=None,
        metadata={
            "name": "TP-ECUS",
            "type": "Element",
    ...
    tp_nodes: None | FlexrayTpConfig.TpNodes = field(
        default=None,
        metadata={
            "name": "TP-NODES",
            "type": "Element",
