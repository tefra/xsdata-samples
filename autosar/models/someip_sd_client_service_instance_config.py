...
class SomeipSdClientServiceInstanceConfig:
    ...
    :ivar initial_find_behavior: Controls initial find behavior of
        clients.
    :ivar service_find_time_to_live: This attribute represents the
        ability to define the time in seconds the service find is valid.
    ...
    short_name_fragments: Optional["SomeipSdClientServiceInstanceConfig.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SomeipSdClientServiceInstanceConfig.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
