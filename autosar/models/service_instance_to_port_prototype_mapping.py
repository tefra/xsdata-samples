...
class ServiceInstanceToPortPrototypeMapping:
    ...
    :ivar enables_log_trace: This attribute enables/disables
        Log&amp;Trace for the communication on the referenced Port of
        the referenced process. True: Log&amp;Trace is enabled. False:
        Log&amp;Trace is disabled.
    :ivar port_prototype_iref: Reference to a specific PortPrototype
        that represents the ServiceInstance.
    :ivar process_design_ref: Reference to the ProcessDesign in which
        the Executable that contains the SoftwareComponent and the
        referenced PortPrototype is executed.
    :ivar process_ref: Reference to the Process in which the enclosing
        ServiceInstanceToPortPrototypeMapping is executed.
    :ivar service_instance_ref: Reference to a ServiceInstance that is
        represented in the Software Component by the mapped group of
        PortPrototypes.
    ...
    annotations: None | ServiceInstanceToPortPrototypeMapping.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    enables_log_trace: None | Boolean = field(
        default=None,
        metadata={
    ...
    process_design_ref: (
        None | ServiceInstanceToPortPrototypeMapping.ProcessDesignRef
    ) = field(
        default=None,
        metadata={
    ...
    process_ref: None | ServiceInstanceToPortPrototypeMapping.ProcessRef = (
        field(
            default=None,
            metadata={
                "name": "PROCESS-REF",
    ...
    service_instance_ref: (
        None | ServiceInstanceToPortPrototypeMapping.ServiceInstanceRef
    ) = field(
        default=None,
        metadata={
