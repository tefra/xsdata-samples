...
class DiagnosticCustomServiceClass:
    ...
    :ivar custom_service_id: This attribute may only be used for the
        definition of custom services. The values shall not overlap with
    ...
    short_name_fragments: Optional["DiagnosticCustomServiceClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    access_permission_ref: Optional["DiagnosticCustomServiceClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
