...
class TdEventSwcInternalBehavior:
    """
    This is used to describe timing events related to the SwcInternalBehavior
    of an AtomicSwComponentType.
    ...
    :ivar component_iref: The context for the scope of this timing
        event.
    :ivar runnable_ref: The scope of this timing event.
    :ivar td_event_swc_internal_behavior_type: The specific type of this
        timing event.
    :ivar variable_access_ref: The scope of this timing event.
    ...
    short_name_fragments: Optional["TdEventSwcInternalBehavior.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventSwcInternalBehavior.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    runnable_ref: Optional["TdEventSwcInternalBehavior.RunnableRef"] = field(
        default=None,
        metadata={
            "name": "RUNNABLE-REF",
            "type": "Element",
    ...
    td_event_swc_internal_behavior_type: Optional[TdEventSwcInternalBehaviorTypeEnum] = field(
        default=None,
        metadata={
    ...
    variable_access_ref: Optional["TdEventSwcInternalBehavior.VariableAccessRef"] = field(
        default=None,
        metadata={
