...
class TdEventSwcInternalBehavior:
    ...
    annotations: None | TdEventSwcInternalBehavior.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    runnable_ref: None | TdEventSwcInternalBehavior.RunnableRef = field(
        default=None,
        metadata={
            "name": "RUNNABLE-REF",
            "type": "Element",
    ...
    td_event_swc_internal_behavior_type: (
        None | TdEventSwcInternalBehaviorTypeEnum
    ) = field(
        default=None,
        metadata={
    ...
    variable_access_ref: (
        None | TdEventSwcInternalBehavior.VariableAccessRef
    ) = field(
        default=None,
        metadata={
