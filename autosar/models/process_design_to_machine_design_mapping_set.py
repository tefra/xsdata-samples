...
@dataclass
class ProcessDesignToMachineDesignMappingSet:
    """
    ...
    :ivar process_design_to_machine_design_mappings: This represents the
        collection of ProcessDesignToMachineDesignMappings of the
        enclosing ProcessDesignToMachineDesignMappingSet.
    ...
    short_name_fragments: (
        None | ProcessDesignToMachineDesignMappingSet.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | ProcessDesignToMachineDesignMappingSet.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
