...
class BswDataReceivedEvent:
    """
    This event is thrown on reception of the referenced data via Sender-
    Receiver-Communication over the BSW Scheduler.
    ...
    :ivar data_ref: The received data.
    ...
    short_name_fragments: Optional["BswDataReceivedEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswDataReceivedEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["BswDataReceivedEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswDataReceivedEvent.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional["BswDataReceivedEvent.DisabledInModeIrefs"] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional["BswDataReceivedEvent.StartsOnEventRef"] = field(
        default=None,
        metadata={
    ...
    data_ref: Optional["BswDataReceivedEvent.DataRef"] = field(
        default=None,
        metadata={
            "name": "DATA-REF",
            "type": "Element",
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswDataReceivedEvent.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
