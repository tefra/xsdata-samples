...
class DiagnosticDataIdentifierInterface:
    """
    This meta-class represents the ability to implement a DID-focused
    ...
    short_name_fragments: (
        None | DiagnosticDataIdentifierInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticDataIdentifierInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: (
        None | DiagnosticDataIdentifierInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: None | DiagnosticDataIdentifierInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    read: None | ClientServerOperation = field(
        default=None,
        metadata={
            "name": "READ",
            "type": "Element",
    ...
    write: None | ClientServerOperation = field(
        default=None,
        metadata={
            "name": "WRITE",
            "type": "Element",
