...
class DiagnosticDataIdentifierInterface:
    """
    This meta-class represents the ability to implement a DID-focused PortInterface
    for diagnostics on the adaptive platform.
    ...
    :ivar read: This represents the method to read the content of a
        diagnostic data identifier.
    :ivar write: This represents the method to write the contents of a
        diagnostic data identifier.
    ...
    short_name_fragments: Optional["DiagnosticDataIdentifierInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDataIdentifierInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDataIdentifierInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDataIdentifierInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
