...
class DataPrototypeTransformationProps:
    ...
    data_protototype_in_port_interface_ref: Optional["DataPrototypeTransformationProps.DataProtototypeInPortInterfaceRef"] = field(
        default=None,
        metadata={
    ...
    data_prototype_in_port_interface_ref: Optional["DataPrototypeTransformationProps.DataPrototypeInPortInterfaceRef"] = field(
        default=None,
        metadata={
    ...
    data_prototype_ref: Optional["DataPrototypeTransformationProps.DataPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    transformation_props_ref: Optional["DataPrototypeTransformationProps.TransformationPropsRef"] = field(
        default=None,
        metadata={
    ...
    class DataPrototypeRef:
        data_prototype_with_application_data_type_in_system_ref: Optional[DataPrototypeWithApplicationDataTypeInSystemRef] = field(
            default=None,
            metadata={
        ...
        implementation_data_type_element_in_system_ref: Optional[ImplementationDataTypeElementInSystemRef] = field(
            default=None,
            metadata={
