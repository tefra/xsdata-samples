...
class OsTaskExecutionEvent:
    ...
    short_name_fragments: Optional["OsTaskExecutionEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    activation_reason_representation_ref: Optional["OsTaskExecutionEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["OsTaskExecutionEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["OsTaskExecutionEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
