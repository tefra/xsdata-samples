...
class OsTaskExecutionEvent:
    ...
    annotations: None | OsTaskExecutionEvent.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: (
        None | OsTaskExecutionEvent.ActivationReasonRepresentationRef
    ) = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: None | OsTaskExecutionEvent.DisabledModeIrefs = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: None | OsTaskExecutionEvent.StartOnEventRef = field(
        default=None,
        metadata={
