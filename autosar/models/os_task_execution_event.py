...
class OsTaskExecutionEvent:
    ...
    short_name_fragments: OsTaskExecutionEvent.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    activation_reason_representation_ref: (
        OsTaskExecutionEvent.ActivationReasonRepresentationRef | None
    ) = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: OsTaskExecutionEvent.DisabledModeIrefs | None = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: OsTaskExecutionEvent.StartOnEventRef | None = field(
        default=None,
        metadata={
