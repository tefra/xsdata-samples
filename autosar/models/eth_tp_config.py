...
class EthTpConfig:
    ...
    annotations: None | EthTpConfig.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: None | EthTpConfig.CommunicationClusterRef = (
        field(
            default=None,
            metadata={
    ...
    tp_connections: None | EthTpConfig.TpConnections = field(
        default=None,
        metadata={
            "name": "TP-CONNECTIONS",
            "type": "Element",
