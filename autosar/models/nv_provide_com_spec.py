...
class NvProvideComSpec:
    ...
    :ivar ram_block_init_value: This represents the initial value of the
        RAM Block that corresponds to the referenced variable.
    :ivar rom_block_init_value: This represents the initial value of the
        ROM block that corresponds to the referenced variable.
    :ivar variable_ref: This represents the variable for which the
        ComSpec is specified.
    ...
    ram_block_init_value: NvProvideComSpec.RamBlockInitValue | None = field(
        default=None,
        metadata={
    ...
    rom_block_init_value: NvProvideComSpec.RomBlockInitValue | None = field(
        default=None,
        metadata={
    ...
    variable_ref: NvProvideComSpec.VariableRef | None = field(
        default=None,
        metadata={
            "name": "VARIABLE-REF",
            "type": "Element",
