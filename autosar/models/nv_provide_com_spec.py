...
class NvProvideComSpec:
    ...
    ram_block_init_value: None | NvProvideComSpec.RamBlockInitValue = field(
        default=None,
        metadata={
    ...
    rom_block_init_value: None | NvProvideComSpec.RomBlockInitValue = field(
        default=None,
        metadata={
    ...
    variable_ref: None | NvProvideComSpec.VariableRef = field(
        default=None,
        metadata={
            "name": "VARIABLE-REF",
            "type": "Element",
