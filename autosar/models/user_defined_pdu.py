...
class UserDefinedPdu:
    ...
    :ivar cdd_type: This attribute defines the CDD that transmits or
        receives the UserDefinedIPdu. If several CDDs are defined this
    ...
    short_name_fragments: Optional["UserDefinedPdu.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["UserDefinedPdu.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
