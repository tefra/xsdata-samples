...
class ModeSwitchPoint:
    ...
    :ivar return_value_provision: This attribute controls the provision
        ...
        access point.
    :ivar mode_group_iref: The mode declaration group that is switched
        by this runnable.
    ...
    short_name_fragments: Optional["ModeSwitchPoint.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ModeSwitchPoint.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
