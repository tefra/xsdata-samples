...
class TdEventISignal:
    ...
    :ivar i_signal_ref: The scope of this timing event.
    :ivar physical_channel_ref: The PhysicalChannel on which the ISignal
        is transmitted.
    ...
    short_name_fragments: Optional["TdEventISignal.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventISignal.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_instance_ref: Optional["TdEventISignal.EcuInstanceRef"] = field(
        default=None,
        metadata={
    ...
    i_signal_ref: Optional["TdEventISignal.ISignalRef"] = field(
        default=None,
        metadata={
            "name": "I-SIGNAL-REF",
            "type": "Element",
    ...
    physical_channel_ref: Optional["TdEventISignal.PhysicalChannelRef"] = field(
        default=None,
        metadata={
