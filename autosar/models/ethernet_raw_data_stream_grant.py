...
class EthernetRawDataStreamGrant:
    ...
    for a EthernetRawDataStream on deployment level.
    ...
    :ivar design_ref: This reference identifies the
        RawDataStreamGrantDesign that the enclosing
        RawDataStreamEventGrant was created from.
    :ivar ethernet_raw_data_stream_mapping_ref: This reference
        identifies the applicable EthernetRawDataStream to which the
        enclosing EthernetRawDataStreamGrant shall apply.
    ...
    annotations: None | EthernetRawDataStreamGrant.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    design_ref: None | EthernetRawDataStreamGrant.DesignRef = field(
        default=None,
        metadata={
            "name": "DESIGN-REF",
            "type": "Element",
    ...
    ethernet_raw_data_stream_mapping_ref: (
        None | EthernetRawDataStreamGrant.EthernetRawDataStreamMappingRef
    ) = field(
        default=None,
        metadata={
