...
class DiagnosticResponseOnEventClass:
    ...
    short_name_fragments: (
        None | DiagnosticResponseOnEventClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticResponseOnEventClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticResponseOnEventClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    inter_message_time: None | TimeValue = field(
        default=None,
        metadata={
