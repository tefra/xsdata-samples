...
class DiagnosticResponseOnEventClass:
    """
    This represents the ability to define common properties for alle
    ...
    :ivar inter_message_time: Provide the minimum time in seconds
        between two consecutive  transmissions of an ROE event.
    ...
    short_name_fragments: DiagnosticResponseOnEventClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticResponseOnEventClass.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: DiagnosticResponseOnEventClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
    ...
    inter_message_time: TimeValue | None = field(
        default=None,
        metadata={
