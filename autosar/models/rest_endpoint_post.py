...
class RestEndpointPost:
    ...
    short_name_fragments: RestEndpointPost.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: RestEndpointPost.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: RestEndpointPost.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    arguments: RestEndpointPost.Arguments | None = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
