...
class RestEndpointPost:
    """
    This meta-class represents the ability to model a REST endpoint with POST
    semantics.
    ...
    short_name_fragments: Optional["RestEndpointPost.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RestEndpointPost.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["RestEndpointPost.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    arguments: Optional["RestEndpointPost.Arguments"] = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
