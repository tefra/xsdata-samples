...
class RestEndpointPost:
    ...
    annotations: None | RestEndpointPost.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | RestEndpointPost.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    arguments: None | RestEndpointPost.Arguments = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
