...
class DoIpTpConfig:
    ...
    :ivar do_ip_logic_addresss: Collection of logical DoIP Addresses.
    :ivar tp_connections: Collection of unidirectional connections
        between a source address and a target address.
    ...
    annotations: None | DoIpTpConfig.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: None | DoIpTpConfig.CommunicationClusterRef = (
        field(
            default=None,
            metadata={
    ...
    do_ip_logic_addresss: None | DoIpTpConfig.DoIpLogicAddresss = field(
        default=None,
        metadata={
    ...
    tp_connections: None | DoIpTpConfig.TpConnections = field(
        default=None,
        metadata={
            "name": "TP-CONNECTIONS",
            "type": "Element",
