...
class RestEndpointPut:
    ...
    short_name_fragments: None | RestEndpointPut.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | RestEndpointPut.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | RestEndpointPut.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    arguments: None | RestEndpointPut.Arguments = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
