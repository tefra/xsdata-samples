...
class RestEndpointPut:
    ...
    short_name_fragments: Optional["RestEndpointPut.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RestEndpointPut.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["RestEndpointPut.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    arguments: Optional["RestEndpointPut.Arguments"] = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
