...
class RestEndpointPut:
    ...
    short_name_fragments: RestEndpointPut.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: RestEndpointPut.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: RestEndpointPut.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    arguments: RestEndpointPut.Arguments | None = field(
        default=None,
        metadata={
            "name": "ARGUMENTS",
            "type": "Element",
