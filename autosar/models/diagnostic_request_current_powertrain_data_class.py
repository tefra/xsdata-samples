...
class DiagnosticRequestCurrentPowertrainDataClass:
    ...
    short_name_fragments: Optional["DiagnosticRequestCurrentPowertrainDataClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestCurrentPowertrainDataClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestCurrentPowertrainDataClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
