...
class DiagnosticRequestCurrentPowertrainDataClass:
    ...
    all instances of the "Request current Powertrain Data" OBD diagnostic
    service.
    ...
    short_name_fragments: DiagnosticRequestCurrentPowertrainDataClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestCurrentPowertrainDataClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticRequestCurrentPowertrainDataClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
