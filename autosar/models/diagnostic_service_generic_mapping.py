...
class DiagnosticServiceGenericMapping:
    ...
    :ivar diagnostic_service_instance_ref: Reference to the
        ServiceInstance  mapped to a SWC service port.
    ...
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticServiceGenericMapping on
    ...
    annotations: None | DiagnosticServiceGenericMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    diagnostic_service_instance_ref: (
        None | DiagnosticServiceGenericMapping.DiagnosticServiceInstanceRef
    ) = field(
        default=None,
        metadata={
    ...
    process_ref: None | DiagnosticServiceGenericMapping.ProcessRef = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
