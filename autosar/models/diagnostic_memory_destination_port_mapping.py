...
class DiagnosticMemoryDestinationPortMapping:
    ...
    DiagnosticMemoryDestination is mapped.
    ...
    :ivar memory_destination_ref: Reference to the MemoryDestination
        which is mapped to a SWC service port with
    ...
    :ivar swc_service_dependency_in_executable_iref: This aggregation
        allows for the usage of the DiagnosticMemoryDestinationMapping
    ...
    annotations: None | DiagnosticMemoryDestinationPortMapping.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    memory_destination_ref: (
        None | DiagnosticMemoryDestinationPortMapping.MemoryDestinationRef
    ) = field(
        default=None,
        metadata={
    ...
    process_ref: None | DiagnosticMemoryDestinationPortMapping.ProcessRef = (
        field(
            default=None,
            metadata={
                "name": "PROCESS-REF",
