...
class GenericEthernetFrame:
    ...
    short_name_fragments: Optional["GenericEthernetFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["GenericEthernetFrame.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_to_frame_mappings: Optional["GenericEthernetFrame.PduToFrameMappings"] = field(
        default=None,
        metadata={
