...
class EcucContainerValue:
    ...
    annotations: None | EcucContainerValue.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    definition_ref: None | EcucContainerValue.DefinitionRef = field(
        default=None,
        metadata={
            "name": "DEFINITION-REF",
            "type": "Element",
    ...
    parameter_values: None | EcucContainerValue.ParameterValues = field(
        default=None,
        metadata={
    ...
    reference_values: None | EcucContainerValue.ReferenceValues = field(
        default=None,
        metadata={
    ...
    sub_containers: None | EcucContainerValue.SubContainers = field(
        default=None,
        metadata={
            "name": "SUB-CONTAINERS",
            "type": "Element",
