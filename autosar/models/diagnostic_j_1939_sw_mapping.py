...
class DiagnosticJ1939SwMapping:
    ...
    :ivar node_ref: This represents the mapped DiagnosticJ1939Node.
    :ivar sw_component_prototype_iref: This represents the mapped
    ...
    short_name_fragments: Optional["DiagnosticJ1939SwMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticJ1939SwMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    node_ref: Optional["DiagnosticJ1939SwMapping.NodeRef"] = field(
        default=None,
        metadata={
            "name": "NODE-REF",
            "type": "Element",
    ...
    sw_component_prototype_iref: Optional[ComponentInCompositionInstanceRef] = field(
        default=None,
        metadata={
