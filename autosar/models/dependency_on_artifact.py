...
class DependencyOnArtifact:
    ...
    annotations: None | DependencyOnArtifact.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    artifact_descriptor: None | AutosarEngineeringObject = field(
        default=None,
        metadata={
    ...
    usages: None | DependencyOnArtifact.Usages = field(
        default=None,
        metadata={
            "name": "USAGES",
            "type": "Element",
