...
class ModeInProcessInstanceRef:
    ...
    context_mode_declaration_group_prototype_ref: Optional["ModeInProcessInstanceRef.ContextModeDeclarationGroupPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    target_mode_declaration_ref: Optional["ModeInProcessInstanceRef.TargetModeDeclarationRef"] = field(
        default=None,
        metadata={
