...
class DiagnosticComponentNeeds:
    """
    This meta-class represents the ability to specify the service needs for
    the configuration of component events.
    ...
    short_name_fragments: DiagnosticComponentNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticComponentNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticComponentNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
