...
class DiagnosticComponentNeeds:
    ...
    short_name_fragments: (
        None | DiagnosticComponentNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticComponentNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticComponentNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
