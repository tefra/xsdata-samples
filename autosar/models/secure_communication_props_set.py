...
class SecureCommunicationPropsSet:
    ...
    :ivar authentication_propss: Authentication properties used to
        configure SecuredIPdus.
    :ivar freshness_propss: Freshness properties used to configure
        SecuredIPdus.
    ...
    short_name_fragments: SecureCommunicationPropsSet.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: SecureCommunicationPropsSet.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    authentication_propss: SecureCommunicationPropsSet.AuthenticationPropss | None = field(
        default=None,
        metadata={
    ...
    freshness_propss: SecureCommunicationPropsSet.FreshnessPropss | None = field(
        default=None,
        metadata={
