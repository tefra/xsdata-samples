...
class ExternalTriggeringPointIdent:
    ...
    """
    class Meta:
        name = "EXTERNAL-TRIGGERING-POINT-IDENT"
    ...
    short_name_fragments: Optional["ExternalTriggeringPointIdent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ExternalTriggeringPointIdent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
