...
class ProvidedUserDefinedServiceInstance:
    ...
    configuration of a provided service instance in a concrete implementation that
    ...
    short_name_fragments: Optional["ProvidedUserDefinedServiceInstance.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["ProvidedUserDefinedServiceInstance.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    e_2_e_event_protection_propss: Optional["ProvidedUserDefinedServiceInstance.E2EEventProtectionPropss"] = field(
        default=None,
        metadata={
    ...
    e_2_e_method_protection_propss: Optional["ProvidedUserDefinedServiceInstance.E2EMethodProtectionPropss"] = field(
        default=None,
        metadata={
    ...
    secure_com_configs: Optional["ProvidedUserDefinedServiceInstance.SecureComConfigs"] = field(
        default=None,
        metadata={
    ...
    service_interface_deployment_ref: Optional["ProvidedUserDefinedServiceInstance.ServiceInterfaceDeploymentRef"] = field(
        default=None,
        metadata={
