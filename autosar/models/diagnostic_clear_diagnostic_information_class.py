...
class DiagnosticClearDiagnosticInformationClass:
    ...
    short_name_fragments: Optional["DiagnosticClearDiagnosticInformationClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticClearDiagnosticInformationClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticClearDiagnosticInformationClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
