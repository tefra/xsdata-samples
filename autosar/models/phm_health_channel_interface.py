...
class PhmHealthChannelInterface:
    ...
    short_name_fragments: PhmHealthChannelInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: PhmHealthChannelInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: PhmHealthChannelInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: PhmHealthChannelInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    statuss: PhmHealthChannelInterface.Statuss | None = field(
        default=None,
        metadata={
            "name": "STATUSS",
            "type": "Element",
