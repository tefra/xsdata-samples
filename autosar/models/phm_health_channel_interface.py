...
class PhmHealthChannelInterface:
    ...
    interaction with the Platform Health Management Health Channel.
    ...
    :ivar statuss: Defines the possible set of status information
        available to the health channel.
    ...
    short_name_fragments: Optional["PhmHealthChannelInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PhmHealthChannelInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["PhmHealthChannelInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["PhmHealthChannelInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    statuss: Optional["PhmHealthChannelInterface.Statuss"] = field(
        default=None,
        metadata={
            "name": "STATUSS",
            "type": "Element",
