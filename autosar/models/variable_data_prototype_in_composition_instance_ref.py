...
class VariableDataPrototypeInCompositionInstanceRef:
    ...
    context_sw_component_prototype_ref: List["VariableDataPrototypeInCompositionInstanceRef.ContextSwComponentPrototypeRef"] = field(
    ...
    context_port_prototype_ref: Optional["VariableDataPrototypeInCompositionInstanceRef.ContextPortPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    target_variable_data_prototype_ref: Optional["VariableDataPrototypeInCompositionInstanceRef.TargetVariableDataPrototypeRef"] = field(
        default=None,
        metadata={
