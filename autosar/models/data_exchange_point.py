...
class DataExchangePoint:
    ...
    * producible data of tool A, version x * consumable data of tool B,
    ...
    annotations: None | DataExchangePoint.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    kind: None | DataExchangePointKind = field(
        default=None,
        metadata={
            "name": "KIND",
            "type": "Element",
    ...
    referenced_baseline: None | Baseline = field(
        default=None,
        metadata={
    ...
    specification_scope: None | SpecificationScope = field(
        default=None,
        metadata={
    ...
    data_format_tailoring: None | DataFormatTailoring = field(
        default=None,
        metadata={
