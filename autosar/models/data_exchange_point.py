...
class DataExchangePoint:
    ...
    templates. An informal description is provided by the 'desc' and 'introduction'
    attributes of the DataExchangePoint. The informal description SHOULD include
    the subject that is described by this data exchange point. E.g.
    ...
    * agreed profile between partner A and partner B in project xyz
    ...
    :ivar specification_scope: The speficication of the relevant subset
        of Autosar standardized and custom specifications.
    :ivar data_format_tailoring: tailoring to the Autosar Exchange Data
        Format The subset and tailoring of the templates specifications
        (Meta-Classes, Attributes, Sdgs, Constraints, SpecItems)
    ...
    short_name_fragments: Optional["DataExchangePoint.ShortNameFragments"] = field(
        default=None,
        metadata={
