...
class ParameterRequireComSpec:
    ...
    :ivar parameter_ref: The ParameterDataPrototype to which the
        ParameterRequireComSpec applies.
    ...
    init_value: Optional["ParameterRequireComSpec.InitValue"] = field(
        default=None,
        metadata={
            "name": "INIT-VALUE",
            "type": "Element",
    ...
    parameter_ref: Optional["ParameterRequireComSpec.ParameterRef"] = field(
        default=None,
        metadata={
            "name": "PARAMETER-REF",
            "type": "Element",
