...
class TlsDeployment:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar psk_identity_to_key_slot_mappings: Mapping of TLS-PSK to a
        concrety key defined in the CryptoDeployment.
    :ivar tls_job_mappings: Mapping of the JobRequirement to a concrete
        crypto job.
