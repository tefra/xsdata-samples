...
class CryptoCertificateInterface:
    ...
    short_name_fragments: (
        None | CryptoCertificateInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | CryptoCertificateInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | CryptoCertificateInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | CryptoCertificateInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
