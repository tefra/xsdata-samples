...
class CryptoCertificateInterface:
    ...
    :ivar is_private: This attribute controls the possibility to access
        the content of the CryptoCertificateSlot by Find() interfaces of
        the X509 Provider.
    :ivar write_access: This attribute defines whether the application
        has write-access to the CryptoCertificate (True) or only read-
        access (False).
    ...
    short_name_fragments: Optional["CryptoCertificateInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CryptoCertificateInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["CryptoCertificateInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["CryptoCertificateInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    is_private: Optional[Boolean] = field(
        default=None,
        metadata={
            "name": "IS-PRIVATE",
            "type": "Element",
