...
class DataSendCompletedEvent:
    ...
    short_name_fragments: Optional["DataSendCompletedEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DataSendCompletedEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["DataSendCompletedEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["DataSendCompletedEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["DataSendCompletedEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
    ...
    event_source_ref: Optional["DataSendCompletedEvent.EventSourceRef"] = field(
        default=None,
        metadata={
