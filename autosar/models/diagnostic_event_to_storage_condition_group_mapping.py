...
class DiagnosticEventToStorageConditionGroupMapping:
    ...
    :ivar diagnostic_event_ref: Reference to a DiagnosticEvent to which
        a StorageConditionGroup is assigned.
    :ivar storage_condition_group_ref: Reference to a
        StorageConditionGroup assigned to a DiagnosticEvent.
    ...
    annotations: (
        None | DiagnosticEventToStorageConditionGroupMapping.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    diagnostic_event_ref: (
        None | DiagnosticEventToStorageConditionGroupMapping.DiagnosticEventRef
    ) = field(
        default=None,
        metadata={
