...
class DiagnosticRequestUpload:
    ...
    annotations: None | DiagnosticRequestUpload.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRequestUpload.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    memory_range_refs: None | DiagnosticRequestUpload.MemoryRangeRefs = field(
        default=None,
        metadata={
    ...
    request_upload_class_ref: (
        None | DiagnosticRequestUpload.RequestUploadClassRef
    ) = field(
        default=None,
        metadata={
