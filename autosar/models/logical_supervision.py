...
class LogicalSupervision:
    """
    Defines a LogicalSupervision graph consisting of transitions, initial- and
    final checkpoints.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar initial_checkpoint_refs: Reference to the initial
        Checkpoint(s) for this LogicalSupervision.
    :ivar final_checkpoint_refs: Reference to the final Checkpoint(s)
        for this LogicalSupervision.
    :ivar transition_refs: Reference to the transitions for this
        LogicalSupervision.
    ...
    short_name_fragments: Optional["LogicalSupervision.ShortNameFragments"] = (
        field(
            default=None,
            metadata={
    ...
    class TransitionRefs:
        ...
        class TransitionRef(Ref):
            dest: Optional[CheckpointTransitionSubtypesEnum] = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
