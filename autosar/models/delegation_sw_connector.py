...
class DelegationSwConnector:
    ...
    :ivar inner_port_iref: The port that belongs to the
        ComponentPrototype in the composition
    :ivar outer_port_ref: The port that is located on the outside of the
        CompositionType
    ...
    annotations: None | DelegationSwConnector.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    mapping_ref: None | DelegationSwConnector.MappingRef = field(
        default=None,
        metadata={
            "name": "MAPPING-REF",
            "type": "Element",
    ...
    inner_port_iref: None | DelegationSwConnector.InnerPortIref = field(
        default=None,
        metadata={
    ...
    outer_port_ref: None | DelegationSwConnector.OuterPortRef = field(
        default=None,
        metadata={
            "name": "OUTER-PORT-REF",
            "type": "Element",
    ...
    class InnerPortIref:
        ...
        r_port_in_composition_instance_ref: (
            None | RPortInCompositionInstanceRef
        ) = field(
            default=None,
            metadata={
