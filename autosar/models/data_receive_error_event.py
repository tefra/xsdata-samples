...
class DataReceiveErrorEvent:
    """
    This event is raised by the RTE when the Com layer detects and notifies an
    error concerning the reception of the referenced data element.
    ...
    :ivar data_iref: Data element referenced by event
    ...
    short_name_fragments: Optional["DataReceiveErrorEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DataReceiveErrorEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["DataReceiveErrorEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["DataReceiveErrorEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["DataReceiveErrorEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
    ...
    data_iref: Optional[RVariableInAtomicSwcInstanceRef] = field(
        default=None,
        metadata={
            "name": "DATA-IREF",
            "type": "Element",
