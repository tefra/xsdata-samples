...
class DataReceiveErrorEvent:
    """
    This event is raised by the RTE when the Com layer detects and notifies
    an error concerning the reception of the referenced data element.
    ...
    short_name_fragments: Optional[
        "DataReceiveErrorEvent.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    activation_reason_representation_ref: Optional[
        "DataReceiveErrorEvent.ActivationReasonRepresentationRef"
    ] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional[
        "DataReceiveErrorEvent.DisabledModeIrefs"
    ] = field(
        default=None,
        metadata={
