...
class SimulatedExecutionTime:
    ...
    short_name_fragments: Optional["SimulatedExecutionTime.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SimulatedExecutionTime.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    exclusive_area_ref: Optional["SimulatedExecutionTime.ExclusiveAreaRef"] = field(
        default=None,
        metadata={
    ...
    executable_entity_ref: Optional["SimulatedExecutionTime.ExecutableEntityRef"] = field(
        default=None,
        metadata={
    ...
    hw_element_ref: Optional["SimulatedExecutionTime.HwElementRef"] = field(
        default=None,
        metadata={
            "name": "HW-ELEMENT-REF",
            "type": "Element",
    ...
    included_library_refs: Optional["SimulatedExecutionTime.IncludedLibraryRefs"] = field(
        default=None,
        metadata={
    ...
    memory_section_locations: Optional["SimulatedExecutionTime.MemorySectionLocations"] = field(
        default=None,
        metadata={
    ...
    class IncludedLibraryRefs:
        included_library_ref: List["SimulatedExecutionTime.IncludedLibraryRefs.IncludedLibraryRef"] = field(
            default_factory=list,
            metadata={
