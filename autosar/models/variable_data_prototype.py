...
class VariableDataPrototype:
    ...
    annotations: None | VariableDataPrototype.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_tref: None | VariableDataPrototype.TypeTref = field(
        default=None,
        metadata={
            "name": "TYPE-TREF",
            "type": "Element",
    ...
    init_value: None | VariableDataPrototype.InitValue = field(
        default=None,
        metadata={
            "name": "INIT-VALUE",
            "type": "Element",
