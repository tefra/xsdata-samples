...
class VariableDataPrototype:
    ...
    annotations: VariableDataPrototype.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    type_tref: VariableDataPrototype.TypeTref | None = field(
        default=None,
        metadata={
            "name": "TYPE-TREF",
            "type": "Element",
    ...
    init_value: VariableDataPrototype.InitValue | None = field(
        default=None,
        metadata={
            "name": "INIT-VALUE",
            "type": "Element",
