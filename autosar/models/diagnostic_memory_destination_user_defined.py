...
class DiagnosticMemoryDestinationUserDefined:
    ...
    :ivar memory_id: This represents the identifier of the user-defined
        memory.
    ...
    short_name_fragments: Optional["DiagnosticMemoryDestinationUserDefined.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticMemoryDestinationUserDefined.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    memory_id: Optional[PositiveInteger] = field(
        default=None,
        metadata={
            "name": "MEMORY-ID",
            "type": "Element",
