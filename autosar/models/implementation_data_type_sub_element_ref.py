...
class ImplementationDataTypeSubElementRef:
    ...
    implementation_data_type_element: Optional[ArVariableInImplementationDataInstanceRef] = field(
        default=None,
        metadata={
    ...
    parameter_implementation_data_type_element: Optional[ArParameterInImplementationDataInstanceRef] = field(
        default=None,
        metadata={
