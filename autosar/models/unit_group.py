...
class UnitGroup:
    ...
    :ivar unit_refs: This represents one particular unit in the
        UnitGroup.
    ...
    short_name_fragments: Optional["UnitGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["UnitGroup.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    unit_refs: Optional["UnitGroup.UnitRefs"] = field(
        default=None,
        metadata={
            "name": "UNIT-REFS",
            "type": "Element",
    ...
    @dataclass
    class UnitRefs:
        unit_ref: List["UnitGroup.UnitRefs.UnitRef"] = field(
            default_factory=list,
            metadata={
                "name": "UNIT-REF",
                "type": "Element",
