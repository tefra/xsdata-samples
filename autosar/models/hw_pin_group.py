...
class HwPinGroup:
    ...
    :ivar hw_pin_group_content: This aggregation describes the contained
        pins/pin groups.
    ...
    short_name_fragments: None | HwPinGroup.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | HwPinGroup.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_type_ref: None | HwPinGroup.HwTypeRef = field(
        default=None,
        metadata={
            "name": "HW-TYPE-REF",
            "type": "Element",
    ...
    hw_category_refs: None | HwPinGroup.HwCategoryRefs = field(
        default=None,
        metadata={
    ...
    hw_attribute_values: None | HwPinGroup.HwAttributeValues = field(
        default=None,
        metadata={
    ...
    hw_pin_group_content: None | HwPinGroupContent = field(
        default=None,
        metadata={
