...
class DiagnosticReadDtcInformationClass:
    ...
    short_name_fragments: (
        None | DiagnosticReadDtcInformationClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticReadDtcInformationClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticReadDtcInformationClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
