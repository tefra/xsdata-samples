...
class DiagnosticReadDtcInformationClass:
    ...
    short_name_fragments: Optional[
        "DiagnosticReadDtcInformationClass.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticReadDtcInformationClass.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: Optional[
        "DiagnosticReadDtcInformationClass.AccessPermissionRef"
    ] = field(
        default=None,
        metadata={
