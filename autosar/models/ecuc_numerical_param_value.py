...
class EcucNumericalParamValue:
    ...
    :ivar value: Value which is subject to variant handling.
    ...
    definition_ref: Optional["EcucNumericalParamValue.DefinitionRef"] = field(
        default=None,
        metadata={
            "name": "DEFINITION-REF",
            "type": "Element",
    ...
    annotations: Optional["EcucNumericalParamValue.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
