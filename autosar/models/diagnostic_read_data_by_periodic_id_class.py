...
class DiagnosticReadDataByPeriodicIdClass:
    ...
    by periodic Identifier" diagnostic service.
    ...
    :ivar max_periodic_did_to_read: This represents the maximum number
        of data identifiers that can be included in one request.
    :ivar periodic_rates: This represents the description of a
        collection of periodic rates in which the service can be
        executed.
    :ivar scheduler_max_number: This represents the maximum number of
        periodic data identifiers that can be scheduled in parallel.
    ...
    @dataclass
    class PeriodicRates:
        diagnostic_periodic_rate: List[DiagnosticPeriodicRate] = field(
            default_factory=list,
            metadata={
