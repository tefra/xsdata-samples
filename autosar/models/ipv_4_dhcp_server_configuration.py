...
class Ipv4DhcpServerConfiguration:
    ...
    address_range_lower_bound: None | Ip4AddressString = field(
        default=None,
        metadata={
    ...
    address_range_upper_bound: None | Ip4AddressString = field(
        default=None,
        metadata={
    ...
    dns_server_addresses: (
        None | Ipv4DhcpServerConfiguration.DnsServerAddresses
    ) = field(
        default=None,
        metadata={
