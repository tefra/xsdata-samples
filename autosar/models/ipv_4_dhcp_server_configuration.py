...
class Ipv4DhcpServerConfiguration:
    ...
    address_range_lower_bound: Ip4AddressString | None = field(
        default=None,
        metadata={
    ...
    address_range_upper_bound: Ip4AddressString | None = field(
        default=None,
        metadata={
    ...
    dns_server_addresses: Ipv4DhcpServerConfiguration.DnsServerAddresses | None = field(
        default=None,
        metadata={
