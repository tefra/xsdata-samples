...
class HwType:
    ...
    short_name_fragments: Optional["HwType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["HwType.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_type_ref: Optional["HwType.HwTypeRef"] = field(
        default=None,
        metadata={
            "name": "HW-TYPE-REF",
            "type": "Element",
    ...
    hw_category_refs: Optional["HwType.HwCategoryRefs"] = field(
        default=None,
        metadata={
    ...
    hw_attribute_values: Optional["HwType.HwAttributeValues"] = field(
        default=None,
        metadata={
