...
class HwType:
    ...
    annotations: None | HwType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_type_ref: None | HwType.HwTypeRef = field(
        default=None,
        metadata={
            "name": "HW-TYPE-REF",
            "type": "Element",
    ...
    hw_category_refs: None | HwType.HwCategoryRefs = field(
        default=None,
        metadata={
    ...
    hw_attribute_values: None | HwType.HwAttributeValues = field(
        default=None,
        metadata={
