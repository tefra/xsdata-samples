...
class ComKeyToCryptoKeySlotMapping:
    ...
    annotations: None | ComKeyToCryptoKeySlotMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    crypto_service_key_ref: (
        None | ComKeyToCryptoKeySlotMapping.CryptoServiceKeyRef
    ) = field(
        default=None,
        metadata={
    ...
    key_slot_ref: None | ComKeyToCryptoKeySlotMapping.KeySlotRef = field(
        default=None,
        metadata={
            "name": "KEY-SLOT-REF",
            "type": "Element",
