...
class DiagnosticRequestFileTransfer:
    ...
    :ivar request_file_transfer_class_ref: This reference substantiates
        ...
        DiagnosticRequestFileTransfer in the given context.
    ...
    short_name_fragments: Optional["DiagnosticRequestFileTransfer.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    access_permission_ref: Optional["DiagnosticRequestFileTransfer.AccessPermissionRef"] = field(
        default=None,
        metadata={
    ...
    request_file_transfer_class_ref: Optional["DiagnosticRequestFileTransfer.RequestFileTransferClassRef"] = field(
        default=None,
        metadata={
