...
class DiagnosticInhibitSourceEventMapping:
    ...
    :ivar diagnostic_event_ref: This represents the reference to the
        diagnostic event.
    :ivar event_group_ref: This represents the reference to the event
        group
    :ivar inhibition_source_ref: This represents the reference to the
        inhibition source.
    ...
    annotations: None | DiagnosticInhibitSourceEventMapping.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    diagnostic_event_ref: (
        None | DiagnosticInhibitSourceEventMapping.DiagnosticEventRef
    ) = field(
        default=None,
        metadata={
    ...
    event_group_ref: (
        None | DiagnosticInhibitSourceEventMapping.EventGroupRef
    ) = field(
        default=None,
        metadata={
    ...
    inhibition_source_ref: (
        None | DiagnosticInhibitSourceEventMapping.InhibitionSourceRef
    ) = field(
        default=None,
        metadata={
