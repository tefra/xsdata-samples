...
class TdEventModeDeclaration:
    """
    This is used to describe timing events related to mode switch communication at
    VFB level.
    ...
    :ivar entry_mode_declaration_ref: Optional parameter which refines
        the scope of the TDEventModeDeclaration. If the parameter is
    ...
    :ivar exit_mode_declaration_ref: Optional parameter which refines
        ...
        ModeDeclaration.
    :ivar mode_declaration_ref: The referenced mode declaration group
        prototype.
    :ivar td_event_mode_declaration_type: The specific type of this
        timing event.
