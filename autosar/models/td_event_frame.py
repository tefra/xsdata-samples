...
class TdEventFrame:
    ...
    frames between the communication controller and the bus specific
    ...
    :ivar frame_ref: The scope of this timing event.
    :ivar physical_channel_ref: The PhysicalChannel on which the Frame
        is transmitted.
    ...
    annotations: None | TdEventFrame.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_instance_ref: None | TdEventFrame.EcuInstanceRef = field(
        default=None,
        metadata={
    ...
    frame_ref: None | TdEventFrame.FrameRef = field(
        default=None,
        metadata={
            "name": "FRAME-REF",
            "type": "Element",
    ...
    physical_channel_ref: None | TdEventFrame.PhysicalChannelRef = field(
        default=None,
        metadata={
    ...
    td_event_type: None | TdEventFrameTypeEnum = field(
        default=None,
        metadata={
            "name": "TD-EVENT-TYPE",
            "type": "Element",
