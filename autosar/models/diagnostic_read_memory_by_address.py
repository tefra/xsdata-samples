...
class DiagnosticReadMemoryByAddress:
    ...
    short_name_fragments: (
        DiagnosticReadMemoryByAddress.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    access_permission_ref: (
        DiagnosticReadMemoryByAddress.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
    ...
    memory_range_refs: DiagnosticReadMemoryByAddress.MemoryRangeRefs | None = (
        field(
            default=None,
            metadata={
    ...
    read_class_ref: DiagnosticReadMemoryByAddress.ReadClassRef | None = field(
        default=None,
        metadata={
            "name": "READ-CLASS-REF",
            "type": "Element",
