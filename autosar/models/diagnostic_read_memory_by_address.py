...
class DiagnosticReadMemoryByAddress:
    ...
    annotations: None | DiagnosticReadMemoryByAddress.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticReadMemoryByAddress.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    memory_range_refs: None | DiagnosticReadMemoryByAddress.MemoryRangeRefs = (
        field(
            default=None,
            metadata={
    ...
    read_class_ref: None | DiagnosticReadMemoryByAddress.ReadClassRef = field(
        default=None,
        metadata={
            "name": "READ-CLASS-REF",
            "type": "Element",
