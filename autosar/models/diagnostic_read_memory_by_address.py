...
class DiagnosticReadMemoryByAddress:
    ...
    short_name_fragments: DiagnosticReadMemoryByAddress.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticReadMemoryByAddress.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticReadMemoryByAddress.AccessPermissionRef | None = field(
        default=None,
        metadata={
    ...
    memory_range_refs: DiagnosticReadMemoryByAddress.MemoryRangeRefs | None = field(
        default=None,
        metadata={
    ...
    read_class_ref: DiagnosticReadMemoryByAddress.ReadClassRef | None = (
        field(
            default=None,
            metadata={
                "name": "READ-CLASS-REF",
    ...
    class ReadClassRef(Ref):
        dest: DiagnosticReadMemoryByAddressClassSubtypesEnum | None = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
