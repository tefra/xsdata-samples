...
class GlobalTimeEthMaster:
    ...
    :ivar sub_tlv_config: Defines the subTLV fields which shall be
        included in the time sync message.
    ...
    short_name_fragments: Optional["GlobalTimeEthMaster.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["GlobalTimeEthMaster.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_connector_ref: Optional["GlobalTimeEthMaster.CommunicationConnectorRef"] = field(
        default=None,
        metadata={
    ...
    sub_tlv_config: Optional[EthTSynSubTlvConfig] = field(
        default=None,
        metadata={
            "name": "SUB-TLV-CONFIG",
            "type": "Element",
