...
class FlexrayTpNode:
    ...
    annotations: None | FlexrayTpNode.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    connector_refs: None | FlexrayTpNode.ConnectorRefs = field(
        default=None,
        metadata={
            "name": "CONNECTOR-REFS",
            "type": "Element",
    ...
    tp_address_ref: None | FlexrayTpNode.TpAddressRef = field(
        default=None,
        metadata={
            "name": "TP-ADDRESS-REF",
            "type": "Element",
