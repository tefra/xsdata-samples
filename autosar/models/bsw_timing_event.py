...
class BswTimingEvent:
    ...
    :ivar period: Requirement for the time period (in seconds) by which
    ...
    short_name_fragments: Optional["BswTimingEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswTimingEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["BswTimingEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswTimingEvent.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional["BswTimingEvent.DisabledInModeIrefs"] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional["BswTimingEvent.StartsOnEventRef"] = field(
        default=None,
        metadata={
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswTimingEvent.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
