...
class DiagnosticSecurityEventReportingModeMapping:
    ...
    This means that the reporting mode of the security event can be set
    ...
    short_name_fragments: Optional["DiagnosticSecurityEventReportingModeMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticSecurityEventReportingModeMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    data_element_ref: Optional["DiagnosticSecurityEventReportingModeMapping.DataElementRef"] = field(
        default=None,
        metadata={
    ...
    security_event_ref: Optional["DiagnosticSecurityEventReportingModeMapping.SecurityEventRef"] = field(
        default=None,
        metadata={
