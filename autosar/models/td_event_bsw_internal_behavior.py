...
class TdEventBswInternalBehavior:
    ...
    annotations: None | TdEventBswInternalBehavior.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    bsw_module_entity_ref: (
        None | TdEventBswInternalBehavior.BswModuleEntityRef
    ) = field(
        default=None,
        metadata={
    ...
    td_event_bsw_internal_behavior_type: (
        None | TdEventBswInternalBehaviorTypeEnum
    ) = field(
        default=None,
        metadata={
