...
class TdEventBswInternalBehavior:
    ...
    BswInternalBehavior of a BSW module.
    ...
    :ivar occurrence_expression: The occurrence expression for this
        event.
    :ivar bsw_module_entity_ref: The scope of this timing event.
    :ivar td_event_bsw_internal_behavior_type: The specific type of this
        timing event.
    ...
    short_name_fragments: TdEventBswInternalBehavior.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: TdEventBswInternalBehavior.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    bsw_module_entity_ref: TdEventBswInternalBehavior.BswModuleEntityRef | None = field(
        default=None,
        metadata={
    ...
    td_event_bsw_internal_behavior_type: TdEventBswInternalBehaviorTypeEnum | None = field(
        default=None,
        metadata={
