...
class TtcanCommunicationConnector:
    ...
    short_name_fragments: (
        None | TtcanCommunicationConnector.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | TtcanCommunicationConnector.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    comm_controller_ref: (
        None | TtcanCommunicationConnector.CommControllerRef
    ) = field(
        default=None,
        metadata={
    ...
    ecu_comm_port_instances: (
        None | TtcanCommunicationConnector.EcuCommPortInstances
    ) = field(
        default=None,
        metadata={
