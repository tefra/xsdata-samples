...
class TtcanCommunicationConnector:
    ...
    short_name_fragments: Optional["TtcanCommunicationConnector.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TtcanCommunicationConnector.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    comm_controller_ref: Optional["TtcanCommunicationConnector.CommControllerRef"] = field(
        default=None,
        metadata={
    ...
    ecu_comm_port_instances: Optional["TtcanCommunicationConnector.EcuCommPortInstances"] = field(
        default=None,
        metadata={
