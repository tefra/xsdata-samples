...
class J1939NmCluster:
    ...
    :ivar address_claim_enabled: This attribute specifies whether the
        J1939Nm Bsw module is used or not. If this attribute is set to
        false then the J1939Nm configuration shall not be derived from
        the system description. But even in this case the nmNodeId might
        still be necessary for the J1939Rm and J1939Tp.
    ...
    short_name_fragments: Optional["J1939NmCluster.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["J1939NmCluster.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: Optional["J1939NmCluster.CommunicationClusterRef"] = field(
        default=None,
        metadata={
    ...
    nm_nodes: Optional["J1939NmCluster.NmNodes"] = field(
        default=None,
        metadata={
            "name": "NM-NODES",
            "type": "Element",
    ...
    address_claim_enabled: Optional[Boolean] = field(
        default=None,
        metadata={
