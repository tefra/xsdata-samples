...
class DiagnosticGenericUdsNeeds:
    ...
    the capability to process a generic UDS service.
    ...
    short_name_fragments: DiagnosticGenericUdsNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticGenericUdsNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticGenericUdsNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
