...
class DiagnosticGenericUdsNeeds:
    ...
    capability to process a generic UDS service.
    ...
    short_name_fragments: Optional["DiagnosticGenericUdsNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticGenericUdsNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticGenericUdsNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
