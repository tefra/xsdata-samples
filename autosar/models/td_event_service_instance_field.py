...
class TdEventServiceInstanceField:
    ...
    :ivar field_ref: The field provided by the service.
    :ivar td_event_service_instance_field_type: The specific type of
        this timing event.
    ...
    annotations: None | TdEventServiceInstanceField.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    field_ref: None | TdEventServiceInstanceField.FieldRef = field(
        default=None,
        metadata={
            "name": "FIELD-REF",
            "type": "Element",
    ...
    td_event_service_instance_field_type: (
        None | TdEventServiceInstanceFieldTypeEnum
    ) = field(
        default=None,
        metadata={
