...
class J1939RmOutgoingRequestServiceNeeds:
    ...
    ApplicationSwComponentType needs to send a request to another J1939
    node.
    ...
    short_name_fragments: Optional[
        "J1939RmOutgoingRequestServiceNeeds.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["J1939RmOutgoingRequestServiceNeeds.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
