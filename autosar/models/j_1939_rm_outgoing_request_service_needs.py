...
class J1939RmOutgoingRequestServiceNeeds:
    ...
    short_name_fragments: Optional["J1939RmOutgoingRequestServiceNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["J1939RmOutgoingRequestServiceNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
