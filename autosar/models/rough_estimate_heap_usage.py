...
class RoughEstimateHeapUsage:
    ...
    :ivar memory_consumption: Rough estimate of the heap usage. Unit:
        byte.
    ...
    short_name_fragments: Optional["RoughEstimateHeapUsage.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RoughEstimateHeapUsage.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_element_ref: Optional["RoughEstimateHeapUsage.HwElementRef"] = field(
        default=None,
        metadata={
            "name": "HW-ELEMENT-REF",
            "type": "Element",
