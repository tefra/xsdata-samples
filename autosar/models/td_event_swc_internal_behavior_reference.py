...
class TdEventSwcInternalBehaviorReference:
    ...
    :ivar component_iref: The context for the scope of this timing
        event.
    :ivar referenced_td_event_swc_ref: The referenced timing description
        event.
    ...
    short_name_fragments: Optional["TdEventSwcInternalBehaviorReference.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventSwcInternalBehaviorReference.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    referenced_td_event_swc_ref: Optional["TdEventSwcInternalBehaviorReference.ReferencedTdEventSwcRef"] = field(
        default=None,
        metadata={
    ...
    class ReferencedTdEventSwcRef(Ref):
        dest: Optional[TdEventSwcSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
