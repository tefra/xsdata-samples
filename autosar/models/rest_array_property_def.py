...
class RestArrayPropertyDef:
    ...
    element of a rest service where the property is supposed to represent
    an array of other primitive properties.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar element: This aggregation represents the definition of the
        base element type of the array property
    ...
    short_name_fragments: RestArrayPropertyDef.ShortNameFragments | None = field(
        default=None,
        metadata={
