...
class DoIpLogicTesterAddressProps:
    """
    This meta-class acts as a target for references to the DoIpLogicTesterAddress
    and collects DoIpLogicTesterAddress specific settings.
    ...
    class DoIpTesterRoutingActivationRefs:
        ...
        class DoIpTesterRoutingActivationRef(Ref):
            dest: Optional[DoIpRoutingActivationSubtypesEnum] = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
