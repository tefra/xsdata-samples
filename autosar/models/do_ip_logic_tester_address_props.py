...
class DoIpLogicTesterAddressProps:
    ...
    DoIpLogicTesterAddress and collects DoIpLogicTesterAddress specific
    settings.
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar do_ip_tester_routing_activation_refs: Reference to a
        DoIPRoutingActivation describing the possible routing
    ...
    short_name_fragments: DoIpLogicTesterAddressProps.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DoIpLogicTesterAddressProps.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    do_ip_tester_routing_activation_refs: DoIpLogicTesterAddressProps.DoIpTesterRoutingActivationRefs | None = field(
        default=None,
        metadata={
    ...
    class DoIpTesterRoutingActivationRefs:
        ...
        class DoIpTesterRoutingActivationRef(Ref):
            dest: DoIpRoutingActivationSubtypesEnum | None = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
