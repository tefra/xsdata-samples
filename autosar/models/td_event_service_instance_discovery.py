...
class TdEventServiceInstanceDiscovery:
    ...
    :ivar td_event_service_instance_discovery_type: The specific type of
        this timing event.
    ...
    short_name_fragments: Optional["TdEventServiceInstanceDiscovery.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventServiceInstanceDiscovery.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    service_instance_to_port_prototype_mapping_ref: Optional["TdEventServiceInstanceDiscovery.ServiceInstanceToPortPrototypeMappingRef"] = field(
        default=None,
        metadata={
    ...
    td_event_service_instance_discovery_type: Optional[TdEventServiceInstanceDiscoveryTypeEnum] = field(
        default=None,
        metadata={
