...
class TdEventServiceInstanceDiscovery:
    ...
    short_name_fragments: Optional[
        "TdEventServiceInstanceDiscovery.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventServiceInstanceDiscovery.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    td_event_service_instance_discovery_type: Optional[
        TdEventServiceInstanceDiscoveryTypeEnum
    ] = field(
        default=None,
        metadata={
