...
class DiagnosticEcuReset:
    ...
    :ivar ecu_reset_class_ref: This reference substantiates that
        ...
        access shared attributes among all DiagnosticEcuReset in the
        given context.
    :ivar respond_to_reset: This attribute defines whether the response
        to the EcuReset service shall be transmitted before or after the
        actual reset.
    ...
    annotations: None | DiagnosticEcuReset.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: None | DiagnosticEcuReset.AccessPermissionRef = (
        field(
            default=None,
            metadata={
    ...
    ecu_reset_class_ref: None | DiagnosticEcuReset.EcuResetClassRef = field(
        default=None,
        metadata={
    ...
    respond_to_reset: None | DiagnosticResponseToEcuResetEnum = field(
        default=None,
        metadata={
