...
class DiagnosticIoControlClass:
    ...
    short_name_fragments: (
        None | DiagnosticIoControlClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticIoControlClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticIoControlClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
