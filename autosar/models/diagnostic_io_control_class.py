...
class DiagnosticIoControlClass:
    ...
    short_name_fragments: DiagnosticIoControlClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticIoControlClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticIoControlClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
