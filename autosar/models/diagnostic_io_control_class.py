...
class DiagnosticIoControlClass:
    """
    This meta-class contains attributes shared by all instances of the "IO Control"
    diagnostic service.
    ...
    short_name_fragments: Optional["DiagnosticIoControlClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticIoControlClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticIoControlClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
