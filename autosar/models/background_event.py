...
class BackgroundEvent:
    ...
    short_name_fragments: BackgroundEvent.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    activation_reason_representation_ref: BackgroundEvent.ActivationReasonRepresentationRef | None = field(
        default=None,
        metadata={
