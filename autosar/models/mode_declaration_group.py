...
class ModeDeclarationGroup:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar initial_mode_ref: The initial mode of the
        ModeDeclarationGroup. This mode is active before any mode
        switches occurred.
    :ivar mode_declarations: The ModeDeclarations collected in this
        ModeDeclarationGroup. The upper multiplicity of this role has
        been increased to * due to resolving an atpVariation stereotype.
        The previous value was -1.
    :ivar mode_manager_error_behavior: This represents the ability to
        define the error behavior expected by the mode manager in case
        of errors on the mode user side (e.g. terminated mode user).
    :ivar mode_transitions: This represents the avaliable
        ModeTransitions of the ModeDeclarationGroup
    :ivar mode_user_error_behavior: This represents the definition of
        the error behavior expected by the mode user in case of errors
        on the mode manager side (e.g. terminated mode manager).
    :ivar on_transition_value: The value of this attribute shall be
        taken into account by the RTE generator for programmatically
        representing a value used for the transition between two
        statuses.
