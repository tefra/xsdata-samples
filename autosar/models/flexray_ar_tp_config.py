...
class FlexrayArTpConfig:
    ...
    One FlexrayArTpConfig element shall be created for each FlexRay Network
    in the System that uses FlexRay Autosar TP.
    ...
    short_name_fragments: FlexrayArTpConfig.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    annotations: FlexrayArTpConfig.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_cluster_ref: FlexrayArTpConfig.CommunicationClusterRef | None = field(
        default=None,
        metadata={
    ...
    tp_addresss: FlexrayArTpConfig.TpAddresss | None = field(
        default=None,
        metadata={
            "name": "TP-ADDRESSS",
            "type": "Element",
    ...
    tp_channels: FlexrayArTpConfig.TpChannels | None = field(
        default=None,
        metadata={
            "name": "TP-CHANNELS",
            "type": "Element",
    ...
    tp_nodes: FlexrayArTpConfig.TpNodes | None = field(
        default=None,
        metadata={
            "name": "TP-NODES",
            "type": "Element",
