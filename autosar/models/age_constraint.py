...
class AgeConstraint:
    ...
    :ivar maximum: The maximum age.
    :ivar minimum: The minimum age.
    :ivar scope_ref: The scope of an AgeConstraint is any
        TimingDescriptionEvent that indicates any receipt of data.
    ...
    short_name_fragments: Optional["AgeConstraint.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["AgeConstraint.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    trace_refs: Optional["AgeConstraint.TraceRefs"] = field(
        default=None,
        metadata={
            "name": "TRACE-REFS",
            "type": "Element",
    ...
    timing_condition_ref: Optional["AgeConstraint.TimingConditionRef"] = field(
        default=None,
        metadata={
    ...
    scope_ref: Optional["AgeConstraint.ScopeRef"] = field(
        default=None,
        metadata={
            "name": "SCOPE-REF",
            "type": "Element",
