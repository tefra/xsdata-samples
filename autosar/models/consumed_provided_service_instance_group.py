...
class ConsumedProvidedServiceInstanceGroup:
    ...
    :ivar consumed_service_instances: This reference assigns a set of
        ProvidedServiceInstances to the
        ConsumedProvidedServiceInstanceGroup. This property was modified
        due to atpVariation (DirectedAssociationPattern).
    :ivar provided_service_instances: This reference assigns a set of
        ConsumedServiceInstances to the
        ConsumedProvidedServiceInstanceGroup. This property was modified
        due to atpVariation (DirectedAssociationPattern).
    ...
    annotations: None | ConsumedProvidedServiceInstanceGroup.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    consumed_service_instances: (
        None | ConsumedProvidedServiceInstanceGroup.ConsumedServiceInstances
    ) = field(
        default=None,
        metadata={
    ...
    provided_service_instances: (
        None | ConsumedProvidedServiceInstanceGroup.ProvidedServiceInstances
    ) = field(
        default=None,
        metadata={
