...
class SocketConnectionIpduIdentifierSet:
    ...
    :ivar i_pdu_identifiers: Collection of IPduIdentifiers that are
        transmitted over Socket Connections.
    ...
    short_name_fragments: Optional["SocketConnectionIpduIdentifierSet.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SocketConnectionIpduIdentifierSet.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    i_pdu_identifiers: Optional["SocketConnectionIpduIdentifierSet.IPduIdentifiers"] = field(
        default=None,
        metadata={
