...
class SocketConnectionIpduIdentifierSet:
    ...
    short_name_fragments: Optional[
        "SocketConnectionIpduIdentifierSet.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SocketConnectionIpduIdentifierSet.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    i_pdu_identifiers: Optional[
        "SocketConnectionIpduIdentifierSet.IPduIdentifiers"
    ] = field(
        default=None,
        metadata={
