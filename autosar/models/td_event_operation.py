...
class TdEventOperation:
    """
    This is used to describe timing events related to client-server communication
    at VFB level.
    ...
    :ivar occurrence_expression: The occurrence expression for this
        event.
    :ivar component_iref: The context for the scope of this timing
        event.
    :ivar is_external: This attribute is used to refer to external
        events that are related to hardware I/O, like physical sensors
        and actuators, at Virtual Functional Bus (VFB) level.
    :ivar port_prototype_blueprint_ref: The PortPrototypeBlueprint is
        the scope of the timing event.
    :ivar port_ref: The port scope of the timing event.
    :ivar operation_ref: The referenced operation.
    :ivar td_event_operation_type: The specific type of this timing
        event.
    ...
    short_name_fragments: Optional["TdEventOperation.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventOperation.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    port_prototype_blueprint_ref: Optional["TdEventOperation.PortPrototypeBlueprintRef"] = field(
        default=None,
        metadata={
    ...
    port_ref: Optional["TdEventOperation.PortRef"] = field(
        default=None,
        metadata={
            "name": "PORT-REF",
            "type": "Element",
    ...
    operation_ref: Optional["TdEventOperation.OperationRef"] = field(
        default=None,
        metadata={
            "name": "OPERATION-REF",
            "type": "Element",
    ...
    td_event_operation_type: Optional[TdEventOperationTypeEnum] = field(
        default=None,
        metadata={
