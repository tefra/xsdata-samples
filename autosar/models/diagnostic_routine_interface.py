...
class DiagnosticRoutineInterface:
    ...
    annotations: None | DiagnosticRoutineInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | DiagnosticRoutineInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | DiagnosticRoutineInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    request_result: None | ClientServerOperation = field(
        default=None,
        metadata={
            "name": "REQUEST-RESULT",
            "type": "Element",
    ...
    start: None | ClientServerOperation = field(
        default=None,
        metadata={
            "name": "START",
            "type": "Element",
    ...
    stop: None | ClientServerOperation = field(
        default=None,
        metadata={
            "name": "STOP",
            "type": "Element",
