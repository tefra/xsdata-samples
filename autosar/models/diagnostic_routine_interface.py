...
class DiagnosticRoutineInterface:
    ...
    :ivar request_result: This represents the request result method of
        the diagnostic routine.
    :ivar start: This represents the start method of the diagnostic
        routine.
    :ivar stop: This represents the stop method of the diagnostic
        routine.
    ...
    short_name_fragments: DiagnosticRoutineInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRoutineInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: DiagnosticRoutineInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticRoutineInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    request_result: ClientServerOperation | None = field(
        default=None,
        metadata={
            "name": "REQUEST-RESULT",
            "type": "Element",
    ...
    start: ClientServerOperation | None = field(
        default=None,
        metadata={
            "name": "START",
            "type": "Element",
    ...
    stop: ClientServerOperation | None = field(
        default=None,
        metadata={
            "name": "STOP",
            "type": "Element",
