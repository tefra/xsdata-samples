...
class BswAsynchronousServerCallResultPoint:
    ...
    :ivar asynchronous_server_call_point_ref: The call point invoking
        the call to which the result belongs.
    ...
    short_name_fragments: Optional["BswAsynchronousServerCallResultPoint.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswAsynchronousServerCallResultPoint.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    asynchronous_server_call_point_ref: Optional["BswAsynchronousServerCallResultPoint.AsynchronousServerCallPointRef"] = field(
        default=None,
        metadata={
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswAsynchronousServerCallResultPoint.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
