...
class ClientServerArrayElementMapping:
    ...
    or primitive array element is mapped the indexed array element always
    ...
    complex_type_mapping: (
        None | ClientServerArrayElementMapping.ComplexTypeMapping
    ) = field(
        default=None,
        metadata={
    ...
    system_signal_ref: (
        None | ClientServerArrayElementMapping.SystemSignalRef
    ) = field(
        default=None,
        metadata={
    ...
    class ComplexTypeMapping:
        ...
        client_server_record_type_mapping: (
            None | ClientServerRecordTypeMapping
        ) = field(
            default=None,
            metadata={
...
class ClientServerArrayTypeMapping:
    ...
    argument_ref: None | ClientServerArrayTypeMapping.ArgumentRef = field(
        default=None,
        metadata={
            "name": "ARGUMENT-REF",
            "type": "Element",
    ...
    array_element_mappings: (
        None | ClientServerArrayTypeMapping.ArrayElementMappings
    ) = field(
        default=None,
        metadata={
...
class ClientServerRecordElementMapping:
    ...
    "TypeMapping" Element. In that way also the composite datatypes can be
    mapped to SystemSignals. Regardless whether composite or primitive
    record element is mapped the record element always needs to be
    specified.
    ...
    application_record_element_ref: (
        None | ClientServerRecordElementMapping.ApplicationRecordElementRef
    ) = field(
        default=None,
        metadata={
    ...
    complex_type_mapping: (
        None | ClientServerRecordElementMapping.ComplexTypeMapping
    ) = field(
        default=None,
        metadata={
            "name": "COMPLEX-TYPE-MAPPING",
    ...
    implementation_record_element_ref: (
        None | ClientServerRecordElementMapping.ImplementationRecordElementRef
    ) = field(
        default=None,
        metadata={
    ...
    system_signal_ref: (
        None | ClientServerRecordElementMapping.SystemSignalRef
    ) = field(
        default=None,
        metadata={
            "name": "SYSTEM-SIGNAL-REF",
...
class ClientServerRecordTypeMapping:
    ...
    argument_ref: None | ClientServerRecordTypeMapping.ArgumentRef = field(
        default=None,
        metadata={
            "name": "ARGUMENT-REF",
            "type": "Element",
    ...
    record_element_mappings: (
        None | ClientServerRecordTypeMapping.RecordElementMappings
    ) = field(
        default=None,
        metadata={
