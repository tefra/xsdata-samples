...
class PeriodicEventTriggering:
    ...
    short_name_fragments: Optional["PeriodicEventTriggering.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    timing_condition_ref: Optional["PeriodicEventTriggering.TimingConditionRef"] = field(
        default=None,
        metadata={
