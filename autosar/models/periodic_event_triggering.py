...
class PeriodicEventTriggering:
    ...
    :ivar jitter: The maximum jitter of the periodic event occurrence.
    ...
    annotations: None | PeriodicEventTriggering.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    trace_refs: None | PeriodicEventTriggering.TraceRefs = field(
        default=None,
        metadata={
            "name": "TRACE-REFS",
            "type": "Element",
    ...
    timing_condition_ref: None | PeriodicEventTriggering.TimingConditionRef = (
        field(
            default=None,
            metadata={
    ...
    event_ref: None | PeriodicEventTriggering.EventRef = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
