...
class DiagnosticRequestEmissionRelatedDtcClass:
    ...
    short_name_fragments: (
        None | DiagnosticRequestEmissionRelatedDtcClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | DiagnosticRequestEmissionRelatedDtcClass.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticRequestEmissionRelatedDtcClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
