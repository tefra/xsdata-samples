...
class DiagnosticRequestEmissionRelatedDtcClass:
    ...
    all instances of the "Request Emission Related DTC" OBD diagnostic
    service.
    ...
    short_name_fragments: DiagnosticRequestEmissionRelatedDtcClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestEmissionRelatedDtcClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticRequestEmissionRelatedDtcClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
