...
class DiagnosticRequestEmissionRelatedDtcClass:
    ...
    short_name_fragments: (
        DiagnosticRequestEmissionRelatedDtcClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        DiagnosticRequestEmissionRelatedDtcClass.Annotations | None
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        DiagnosticRequestEmissionRelatedDtcClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
