...
class DiagnosticRequestEmissionRelatedDtcClass:
    ...
    short_name_fragments: Optional["DiagnosticRequestEmissionRelatedDtcClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestEmissionRelatedDtcClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestEmissionRelatedDtcClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
