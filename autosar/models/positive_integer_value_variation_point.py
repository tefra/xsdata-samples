...
class PositiveIntegerValueVariationPoint:
    """This class represents an attribute value variation point for positive
    Integer attributes.
    ...
    sysc_string_ref: List["PositiveIntegerValueVariationPoint.SyscStringRef"] = field(
        default_factory=list,
        metadata={
    ...
    sysc_ref: List["PositiveIntegerValueVariationPoint.SyscRef"] = field(
        default_factory=list,
        metadata={
            "name": "SYSC-REF",
            "type": "Element",
