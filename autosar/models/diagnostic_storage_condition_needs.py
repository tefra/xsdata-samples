...
class DiagnosticStorageConditionNeeds:
    ...
    annotations: None | DiagnosticStorageConditionNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | DiagnosticStorageConditionNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    initial_status: None | StorageConditionStatusEnum = field(
        default=None,
        metadata={
            "name": "INITIAL-STATUS",
            "type": "Element",
