...
class DiagnosticStorageConditionNeeds:
    ...
    short_name_fragments: Optional["DiagnosticStorageConditionNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticStorageConditionNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: Optional["DiagnosticStorageConditionNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    initial_status: Optional[StorageConditionStatusEnum] = field(
        default=None,
        metadata={
            "name": "INITIAL-STATUS",
            "type": "Element",
