...
class DiagnosticStorageConditionNeeds:
    ...
    the capability to set a storage condition.
    ...
    :ivar initial_status: Defines the initial status for enable or
        disable of storage of a diagnostic event.
    ...
    short_name_fragments: DiagnosticStorageConditionNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticStorageConditionNeeds.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    audiences: DiagnosticStorageConditionNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    initial_status: StorageConditionStatusEnum | None = field(
        default=None,
        metadata={
            "name": "INITIAL-STATUS",
            "type": "Element",
