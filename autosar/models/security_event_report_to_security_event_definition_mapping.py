...
class SecurityEventReportToSecurityEventDefinitionMapping:
    ...
    reporting a security event to the actual security event that shall be
    reported by this PortPrototype.
    ...
    :ivar reported_security_event_iref: This identifies the mapped
        security event.
    :ivar security_event_definition_ref: This reference identifies the
        definition of the security event.
