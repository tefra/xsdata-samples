...
class AssignNad:
    ...
    assigned_controller_ref: Optional["AssignNad.AssignedControllerRef"] = field(
        default=None,
        metadata={
    ...
    assigned_lin_slave_config_ref: Optional["AssignNad.AssignedLinSlaveConfigRef"] = field(
        default=None,
        metadata={
