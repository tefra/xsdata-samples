...
class SecurityEventFilterChainRefConditional:
    ...
    security_event_filter_chain_ref: Optional["SecurityEventFilterChainRefConditional.SecurityEventFilterChainRef"] = field(
        default=None,
        metadata={
    ...
    class SecurityEventFilterChainRef(Ref):
        dest: Optional[SecurityEventFilterChainSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
