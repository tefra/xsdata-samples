...
@dataclass
class ApplicationEndpointRefConditional:
    """
    This element was generated/modified due to an atpVariation stereotype.

    :ivar application_endpoint_ref:
    ...
    application_endpoint_ref: Optional["ApplicationEndpointRefConditional.ApplicationEndpointRef"] = field(
        default=None,
        metadata={
