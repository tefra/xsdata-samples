...
class DiagnosticRoutineGenericInterface:
    """
    This meta-class represents the ability to implement a generic Routine-
    ...
    short_name_fragments: Optional["DiagnosticRoutineGenericInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRoutineGenericInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticRoutineGenericInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticRoutineGenericInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
