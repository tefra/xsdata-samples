...
class DiagnosticRoutineGenericInterface:
    ...
    short_name_fragments: (
        DiagnosticRoutineGenericInterface.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRoutineGenericInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: (
        DiagnosticRoutineGenericInterface.BlueprintPolicys | None
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticRoutineGenericInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
