...
class DiagnosticRoutineGenericInterface:
    ...
    Routine-focused PortInterface for diagnostics on the adaptive platform.
    ...
    short_name_fragments: DiagnosticRoutineGenericInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRoutineGenericInterface.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: DiagnosticRoutineGenericInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticRoutineGenericInterface.Namespaces | None = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
