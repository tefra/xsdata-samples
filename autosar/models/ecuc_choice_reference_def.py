...
class EcucChoiceReferenceDef:
    ...
    short_name_fragments: Optional[
        "EcucChoiceReferenceDef.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    related_trace_item_ref: Optional[
        "EcucChoiceReferenceDef.RelatedTraceItemRef"
    ] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional[
        "EcucChoiceReferenceDef.EcucValidationConds"
    ] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional[
        "EcucChoiceReferenceDef.ImplementationConfigClasses"
    ] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional[
        "EcucChoiceReferenceDef.MultiplicityConfigClasses"
    ] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional[
        "EcucChoiceReferenceDef.ValueConfigClasses"
    ] = field(
        default=None,
        metadata={
    ...
    destination_refs: Optional["EcucChoiceReferenceDef.DestinationRefs"] = (
        field(
            default=None,
            metadata={
