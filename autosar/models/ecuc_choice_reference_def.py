...
class EcucChoiceReferenceDef:
    ...
    :ivar requires_symbolic_name_value: If this attribute is set to true
        ...
        TPS_ECUC_02108.
    :ivar destination_refs: All the possible parameter containers for
        the reference are specified.
    ...
    short_name_fragments: Optional["EcucChoiceReferenceDef.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EcucChoiceReferenceDef.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: Optional["EcucChoiceReferenceDef.RelatedTraceItemRef"] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional["EcucChoiceReferenceDef.EcucValidationConds"] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional["EcucChoiceReferenceDef.ImplementationConfigClasses"] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional["EcucChoiceReferenceDef.MultiplicityConfigClasses"] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional["EcucChoiceReferenceDef.ValueConfigClasses"] = field(
        default=None,
        metadata={
    ...
    destination_refs: Optional["EcucChoiceReferenceDef.DestinationRefs"] = field(
        default=None,
        metadata={
    ...
    class DestinationRefs:
        destination_ref: List["EcucChoiceReferenceDef.DestinationRefs.DestinationRef"] = field(
            default_factory=list,
            metadata={
