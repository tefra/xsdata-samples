...
class EcucChoiceReferenceDef:
    ...
    short_name_fragments: None | EcucChoiceReferenceDef.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | EcucChoiceReferenceDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: (
        None | EcucChoiceReferenceDef.RelatedTraceItemRef
    ) = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: (
        None | EcucChoiceReferenceDef.EcucValidationConds
    ) = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: (
        None | EcucChoiceReferenceDef.ImplementationConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        None | EcucChoiceReferenceDef.MultiplicityConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: None | EcucChoiceReferenceDef.ValueConfigClasses = (
        field(
            default=None,
            metadata={
    ...
    destination_refs: None | EcucChoiceReferenceDef.DestinationRefs = field(
        default=None,
        metadata={
