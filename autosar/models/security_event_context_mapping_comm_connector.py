...
class SecurityEventContextMappingCommConnector:
    ...
    :ivar mapped_security_events: This aggregation represents (through
        ...
        -1.
    :ivar comm_connectors: This reference identifies the respective
        CommunicationConnector for which the collection of security
        events can be reported. This property was modified due to
        atpVariation (DirectedAssociationPattern).
    ...
    annotations: (
        None | SecurityEventContextMappingCommConnector.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    filter_chains: (
        None | SecurityEventContextMappingCommConnector.FilterChains
    ) = field(
        default=None,
        metadata={
            "name": "FILTER-CHAINS",
    ...
    idsm_instances: (
        None | SecurityEventContextMappingCommConnector.IdsmInstances
    ) = field(
        default=None,
        metadata={
            "name": "IDSM-INSTANCES",
    ...
    mapped_security_events: (
        None | SecurityEventContextMappingCommConnector.MappedSecurityEvents
    ) = field(
        default=None,
        metadata={
    ...
    comm_connectors: (
        None | SecurityEventContextMappingCommConnector.CommConnectors
    ) = field(
        default=None,
        metadata={
