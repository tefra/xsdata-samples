...
class DiagnosticStorageConditionPortMapping:
    ...
    the DiagnosticStorageCondition is mapped.
    ...
    :ivar diagnostic_storage_condition_ref: Reference to the
        StorageCondition which is mapped to a SWC service port with
    ...
    short_name_fragments: (
        DiagnosticStorageConditionPortMapping.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticStorageConditionPortMapping.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
