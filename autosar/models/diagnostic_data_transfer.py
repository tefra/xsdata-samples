...
class DiagnosticDataTransfer:
    ...
    short_name_fragments: None | DiagnosticDataTransfer.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | DiagnosticDataTransfer.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticDataTransfer.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    data_transfer_class_ref: (
        None | DiagnosticDataTransfer.DataTransferClassRef
    ) = field(
        default=None,
        metadata={
    ...
    class DataTransferClassRef(Ref):
        dest: None | DiagnosticDataTransferClassSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
