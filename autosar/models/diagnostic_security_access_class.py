...
class DiagnosticSecurityAccessClass:
    ...
    short_name_fragments: (
        None | DiagnosticSecurityAccessClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticSecurityAccessClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticSecurityAccessClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    shared_timer: None | Boolean = field(
        default=None,
        metadata={
            "name": "SHARED-TIMER",
            "type": "Element",
