...
class RootSwCompositionPrototype:
    ...
    short_name_fragments: (
        None | RootSwCompositionPrototype.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | RootSwCompositionPrototype.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    calibration_parameter_value_set_refs: (
        None | RootSwCompositionPrototype.CalibrationParameterValueSetRefs
    ) = field(
        default=None,
        metadata={
    ...
    flat_map_ref: None | RootSwCompositionPrototype.FlatMapRef = field(
        default=None,
        metadata={
            "name": "FLAT-MAP-REF",
            "type": "Element",
    ...
    software_composition_tref: (
        None | RootSwCompositionPrototype.SoftwareCompositionTref
    ) = field(
        default=None,
        metadata={
    ...
    class CalibrationParameterValueSetRefs:
        ...
        class CalibrationParameterValueSetRef(Ref):
            dest: None | CalibrationParameterValueSetSubtypesEnum = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
    ...
    class FlatMapRef(Ref):
        dest: None | FlatMapSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
