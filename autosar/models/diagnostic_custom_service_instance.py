...
class DiagnosticCustomServiceInstance:
    ...
    short_name_fragments: (
        None | DiagnosticCustomServiceInstance.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticCustomServiceInstance.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticCustomServiceInstance.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    custom_service_class_ref: (
        None | DiagnosticCustomServiceInstance.CustomServiceClassRef
    ) = field(
        default=None,
        metadata={
    ...
    class CustomServiceClassRef(Ref):
        dest: None | DiagnosticCustomServiceClassSubtypesEnum = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
