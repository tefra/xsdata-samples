...
class CryptoKeySlotToPortPrototypeMapping:
    ...
    CryptoKeySlot on deployment level to a given PortPrototype that is typed by
    a CryptoKeySlotInterface.
    ...
    :ivar key_slot_ref: This reference represents the mapped
        CryptoKeySlot.
    ...
    short_name_fragments: Optional["CryptoKeySlotToPortPrototypeMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CryptoKeySlotToPortPrototypeMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    key_slot_ref: Optional["CryptoKeySlotToPortPrototypeMapping.KeySlotRef"] = field(
        default=None,
        metadata={
            "name": "KEY-SLOT-REF",
            "type": "Element",
    ...
    process_ref: Optional["CryptoKeySlotToPortPrototypeMapping.ProcessRef"] = field(
        default=None,
        metadata={
            "name": "PROCESS-REF",
            "type": "Element",
