...
class GlobalTimeCanSlave:
    ...
    short_name_fragments: GlobalTimeCanSlave.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    annotations: GlobalTimeCanSlave.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_connector_ref: GlobalTimeCanSlave.CommunicationConnectorRef | None = field(
        default=None,
        metadata={
