...
class GlobalTimeCanSlave:
    ...
    short_name_fragments: Optional["GlobalTimeCanSlave.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["GlobalTimeCanSlave.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_connector_ref: Optional["GlobalTimeCanSlave.CommunicationConnectorRef"] = field(
        default=None,
        metadata={
