...
class GlobalTimeCanSlave:
    ...
    :ivar crc_validated: Definition of whether or not validation of the
        CRC is supported.
    :ivar sequence_counter_jump_width: Specifies the maximum allowed gap
        of the sequence counter between two SYNC resp. two OFS messages.
    ...
    short_name_fragments: None | GlobalTimeCanSlave.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | GlobalTimeCanSlave.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    communication_connector_ref: (
        None | GlobalTimeCanSlave.CommunicationConnectorRef
    ) = field(
        default=None,
        metadata={
    ...
    sequence_counter_jump_width: None | PositiveInteger = field(
        default=None,
        metadata={
