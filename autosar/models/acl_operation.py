...
class AclOperation:
    ...
    annotations: None | AclOperation.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | AclOperation.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    implied_operation_refs: None | AclOperation.ImpliedOperationRefs = field(
        default=None,
        metadata={
