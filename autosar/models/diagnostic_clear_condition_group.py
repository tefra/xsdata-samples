...
class DiagnosticClearConditionGroup:
    ...
    :ivar clear_condition_refs: This aggregation represents the
        collection of DiagnosticClearConditions that belong to the
    ...
    annotations: None | DiagnosticClearConditionGroup.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    clear_condition_refs: (
        None | DiagnosticClearConditionGroup.ClearConditionRefs
    ) = field(
        default=None,
        metadata={
