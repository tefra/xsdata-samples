...
class DiagnosticPowertrainFreezeFrame:
    ...
    :ivar pid_refs: This represents the PID associated with this
        instance of the OBD mode 0x02 service.
    ...
    short_name_fragments: Optional["DiagnosticPowertrainFreezeFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticPowertrainFreezeFrame.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pid_refs: Optional["DiagnosticPowertrainFreezeFrame.PidRefs"] = field(
        default=None,
        metadata={
            "name": "PID-REFS",
            "type": "Element",
    ...
    class PidRefs:
        ...
        @dataclass
        class PidRef(Ref):
            dest: Optional[DiagnosticParameterIdentifierSubtypesEnum] = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
