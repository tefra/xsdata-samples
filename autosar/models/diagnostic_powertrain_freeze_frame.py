...
class DiagnosticPowertrainFreezeFrame:
    ...
    short_name_fragments: DiagnosticPowertrainFreezeFrame.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticPowertrainFreezeFrame.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    pid_refs: DiagnosticPowertrainFreezeFrame.PidRefs | None = field(
        default=None,
        metadata={
            "name": "PID-REFS",
            "type": "Element",
    ...
    class PidRefs:
        ...
        @dataclass
        class PidRef(Ref):
            dest: DiagnosticParameterIdentifierSubtypesEnum | None = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
