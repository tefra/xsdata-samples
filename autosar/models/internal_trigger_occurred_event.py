...
class InternalTriggerOccurredEvent:
    ...
    :ivar event_source_ref: Internal Triggering Point that triggers the
        event.
    ...
    short_name_fragments: Optional["InternalTriggerOccurredEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["InternalTriggerOccurredEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["InternalTriggerOccurredEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    disabled_mode_irefs: Optional["InternalTriggerOccurredEvent.DisabledModeIrefs"] = field(
        default=None,
        metadata={
    ...
    start_on_event_ref: Optional["InternalTriggerOccurredEvent.StartOnEventRef"] = field(
        default=None,
        metadata={
    ...
    event_source_ref: Optional["InternalTriggerOccurredEvent.EventSourceRef"] = field(
        default=None,
        metadata={
    ...
    class EventSourceRef(Ref):
        dest: Optional[InternalTriggeringPointSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
