...
class DiagnosticRequestOnBoardMonitoringTestResultsClass:
    ...
    short_name_fragments: Optional["DiagnosticRequestOnBoardMonitoringTestResultsClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestOnBoardMonitoringTestResultsClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestOnBoardMonitoringTestResultsClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
