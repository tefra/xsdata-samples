...
class DiagnosticRequestOnBoardMonitoringTestResultsClass:
    ...
    short_name_fragments: (
        None
        | DiagnosticRequestOnBoardMonitoringTestResultsClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: (
        None | DiagnosticRequestOnBoardMonitoringTestResultsClass.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None
        | DiagnosticRequestOnBoardMonitoringTestResultsClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
