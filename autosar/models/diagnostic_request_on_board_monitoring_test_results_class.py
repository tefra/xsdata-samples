...
class DiagnosticRequestOnBoardMonitoringTestResultsClass:
    ...
    all instances of the "Request On-Board Monitoring Test Results" OBD
    diagnostic service.
    ...
    short_name_fragments: DiagnosticRequestOnBoardMonitoringTestResultsClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestOnBoardMonitoringTestResultsClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticRequestOnBoardMonitoringTestResultsClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
