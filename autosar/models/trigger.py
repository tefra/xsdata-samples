...
class Trigger:
    ...
    short_name_fragments: Optional["Trigger.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["Trigger.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    trigger_period: Optional[MultidimensionalTime] = field(
        default=None,
        metadata={
            "name": "TRIGGER-PERIOD",
            "type": "Element",
