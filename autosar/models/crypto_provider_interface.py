...
class CryptoProviderInterface:
    ...
    short_name_fragments: Optional["CryptoProviderInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["CryptoProviderInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["CryptoProviderInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["CryptoProviderInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
