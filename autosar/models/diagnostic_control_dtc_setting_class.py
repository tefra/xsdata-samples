...
class DiagnosticControlDtcSettingClass:
    ...
    short_name_fragments: (
        None | DiagnosticControlDtcSettingClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticControlDtcSettingClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticControlDtcSettingClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    control_option_record_present: None | Boolean = field(
        default=None,
        metadata={
