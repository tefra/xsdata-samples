...
class DiagnosticControlDtcSettingClass:
    ...
    short_name_fragments: (
        DiagnosticControlDtcSettingClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticControlDtcSettingClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        DiagnosticControlDtcSettingClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
