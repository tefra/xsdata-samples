...
class DiagnosticDtcInformationInterface:
    ...
    short_name_fragments: Optional[
        "DiagnosticDtcInformationInterface.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDtcInformationInterface.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: Optional[
        "DiagnosticDtcInformationInterface.BlueprintPolicys"
    ] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDtcInformationInterface.Namespaces"] = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
