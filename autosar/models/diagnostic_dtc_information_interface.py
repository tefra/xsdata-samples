...
class DiagnosticDtcInformationInterface:
    """
    This meta-class represents the ability to implement a PortInterface to access
    the properties of DTCs  on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticDtcInformationInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDtcInformationInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDtcInformationInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDtcInformationInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
