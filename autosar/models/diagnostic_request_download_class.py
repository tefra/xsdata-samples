...
class DiagnosticRequestDownloadClass:
    ...
    "Request Download" diagnostic service.
    ...
    short_name_fragments: DiagnosticRequestDownloadClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestDownloadClass.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: DiagnosticRequestDownloadClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
