...
class DiagnosticRequestDownloadClass:
    ...
    short_name_fragments: (
        None | DiagnosticRequestDownloadClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticRequestDownloadClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRequestDownloadClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
