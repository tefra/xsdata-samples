...
class DiagnosticRequestDownloadClass:
    ...
    short_name_fragments: (
        DiagnosticRequestDownloadClass.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestDownloadClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        DiagnosticRequestDownloadClass.AccessPermissionRef | None
    ) = field(
        default=None,
        metadata={
