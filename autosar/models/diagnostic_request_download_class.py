...
class DiagnosticRequestDownloadClass:
    ...
    short_name_fragments: Optional[
        "DiagnosticRequestDownloadClass.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestDownloadClass.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: Optional[
        "DiagnosticRequestDownloadClass.AccessPermissionRef"
    ] = field(
        default=None,
        metadata={
