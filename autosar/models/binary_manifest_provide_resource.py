...
class BinaryManifestProvideResource:
    ...
    :ivar number_of_notifier_sets: This attribute provides an upper
        limit for the number of notifiers for this resource.
    :ivar supports_multiple_notifier_sets: This attribute indicates
        whether the enclosing BinaryManifestResource supports multiple
        notifiers sets.
    ...
    annotations: None | BinaryManifestProvideResource.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    global_resource_id: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    items: None | BinaryManifestProvideResource.Items = field(
        default=None,
        metadata={
            "name": "ITEMS",
            "type": "Element",
    ...
    resource_definition_ref: (
        None | BinaryManifestProvideResource.ResourceDefinitionRef
    ) = field(
        default=None,
        metadata={
    ...
    resource_guard_value: None | String = field(
        default=None,
        metadata={
    ...
    resource_ref: None | BinaryManifestProvideResource.ResourceRef = field(
        default=None,
        metadata={
            "name": "RESOURCE-REF",
            "type": "Element",
    ...
    number_of_notifier_sets: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    supports_multiple_notifier_sets: None | Boolean = field(
        default=None,
        metadata={
