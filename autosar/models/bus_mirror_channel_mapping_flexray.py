...
class BusMirrorChannelMappingFlexray:
    ...
    short_name_fragments: Optional["BusMirrorChannelMappingFlexray.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BusMirrorChannelMappingFlexray.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    target_pdu_triggerings: Optional["BusMirrorChannelMappingFlexray.TargetPduTriggerings"] = field(
        default=None,
        metadata={
