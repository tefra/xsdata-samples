...
class BusMirrorChannelMappingFlexray:
    ...
    short_name_fragments: (
        None | BusMirrorChannelMappingFlexray.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | BusMirrorChannelMappingFlexray.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    target_pdu_triggerings: (
        None | BusMirrorChannelMappingFlexray.TargetPduTriggerings
    ) = field(
        default=None,
        metadata={
    ...
    transmission_deadline: None | TimeValue = field(
        default=None,
        metadata={
