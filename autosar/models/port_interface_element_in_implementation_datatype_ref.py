...
class PortInterfaceElementInImplementationDatatypeRef:
    ...
    context_data_prototype_refs: Optional["PortInterfaceElementInImplementationDatatypeRef.ContextDataPrototypeRefs"] = field(
        default=None,
        metadata={
    ...
    port_interface_ref: Optional["PortInterfaceElementInImplementationDatatypeRef.PortInterfaceRef"] = field(
        default=None,
        metadata={
    ...
    root_data_prototype_ref: Optional["PortInterfaceElementInImplementationDatatypeRef.RootDataPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    target_data_prototype_ref: Optional["PortInterfaceElementInImplementationDatatypeRef.TargetDataPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    class ContextDataPrototypeRefs:
        context_data_prototype_ref: List["PortInterfaceElementInImplementationDatatypeRef.ContextDataPrototypeRefs.ContextDataPrototypeRef"] = field(
        ...
        class ContextDataPrototypeRef(Ref):
            dest: Optional[CppImplementationDataTypeContextTargetSubtypesEnum] = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
