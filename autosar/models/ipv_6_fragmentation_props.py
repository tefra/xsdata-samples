...
class Ipv6FragmentationProps:
    ...
    tcp_ip_ip_reassembly_buffer_count: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    tcp_ip_ip_reassembly_buffer_size: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    tcp_ip_ip_reassembly_segment_count: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    tcp_ip_ip_reassembly_timeout: None | TimeValue = field(
        default=None,
        metadata={
    ...
    tcp_ip_ip_tx_fragment_buffer_count: None | PositiveInteger = field(
        default=None,
        metadata={
    ...
    tcp_ip_ip_tx_fragment_buffer_size: None | PositiveInteger = field(
        default=None,
        metadata={
