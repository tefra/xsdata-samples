...
class DiagnosticSoftwareClusterProps:
    ...
    short_name_fragments: Optional["DiagnosticSoftwareClusterProps.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticSoftwareClusterProps.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
