...
class DiagnosticDoIpPowerModeInterface:
    ...
    short_name_fragments: (
        DiagnosticDoIpPowerModeInterface.ShortNameFragments | None
    ) = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticDoIpPowerModeInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: (
        DiagnosticDoIpPowerModeInterface.BlueprintPolicys | None
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: DiagnosticDoIpPowerModeInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
