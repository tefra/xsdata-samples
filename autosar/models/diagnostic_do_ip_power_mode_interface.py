...
class DiagnosticDoIpPowerModeInterface:
    ...
    short_name_fragments: Optional[
        "DiagnosticDoIpPowerModeInterface.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDoIpPowerModeInterface.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    blueprint_policys: Optional[
        "DiagnosticDoIpPowerModeInterface.BlueprintPolicys"
    ] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDoIpPowerModeInterface.Namespaces"] = (
        field(
            default=None,
            metadata={
                "name": "NAMESPACES",
