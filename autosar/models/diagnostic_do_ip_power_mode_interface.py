...
@dataclass
class DiagnosticDoIpPowerModeInterface:
    """
    This meta-class represents the ability to implement a PortInterface to
    implement the DoIP Power Mode on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticDoIpPowerModeInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDoIpPowerModeInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDoIpPowerModeInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDoIpPowerModeInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
