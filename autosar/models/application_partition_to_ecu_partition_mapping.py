...
class ApplicationPartitionToEcuPartitionMapping:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar application_partition_refs: Reference to ApplicationPartitions
        that are mapped to an EcuPartition.
    :ivar ecu_partition_ref: Reference to EcuPartition to which the
        ApplicationPartitions are assigned.
