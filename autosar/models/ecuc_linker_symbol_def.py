...
class EcucLinkerSymbolDef:
    """
    Configuration parameter type for Linker Symbol Names like those used to specify
    memory locations of variables and constants.
    ...
    :ivar value_config_classes: Specifies in which
        ...
        EcucModuleDef is set to VENDOR_SPECIFIC_MODULE_DEFINITION, then
        this aggregation is mandatory.
    :ivar derivation: A derivation of a Configuration Parameter value
        can be specified by an informal Calculation Formula or by a
        formal language that can be used to specify the computational
        rules.
    :ivar symbolic_name_value: Specifies that this parameter's value is
        used, together with the aggregating container, to derive a
    ...
    :ivar ecuc_linker_symbol_def_variants: This element was
    ...
    short_name_fragments: Optional["EcucLinkerSymbolDef.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EcucLinkerSymbolDef.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: Optional["EcucLinkerSymbolDef.RelatedTraceItemRef"] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional["EcucLinkerSymbolDef.EcucValidationConds"] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional["EcucLinkerSymbolDef.ImplementationConfigClasses"] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional["EcucLinkerSymbolDef.MultiplicityConfigClasses"] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional["EcucLinkerSymbolDef.ValueConfigClasses"] = field(
        default=None,
        metadata={
    ...
    ecuc_linker_symbol_def_variants: Optional["EcucLinkerSymbolDef.EcucLinkerSymbolDefVariants"] = field(
        default=None,
        metadata={
            "name": "ECUC-LINKER-SYMBOL-DEF-VARIANTS",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
    ...
    @dataclass
    class EcucLinkerSymbolDefVariants:
        ecuc_linker_symbol_def_conditional: List[EcucLinkerSymbolDefConditional] = field(
            default_factory=list,
            metadata={
                "name": "ECUC-LINKER-SYMBOL-DEF-CONDITIONAL",
                "type": "Element",
                "namespace": "http://autosar.org/schema/r4.0",
            }
        )
