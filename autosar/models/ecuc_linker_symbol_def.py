...
class EcucLinkerSymbolDef:
    ...
    short_name_fragments: EcucLinkerSymbolDef.ShortNameFragments | None = (
        field(
            default=None,
            metadata={
    ...
    related_trace_item_ref: EcucLinkerSymbolDef.RelatedTraceItemRef | None = (
        field(
            default=None,
            metadata={
    ...
    ecuc_validation_conds: EcucLinkerSymbolDef.EcucValidationConds | None = (
        field(
            default=None,
            metadata={
    ...
    implementation_config_classes: (
        EcucLinkerSymbolDef.ImplementationConfigClasses | None
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        EcucLinkerSymbolDef.MultiplicityConfigClasses | None
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: EcucLinkerSymbolDef.ValueConfigClasses | None = (
        field(
            default=None,
            metadata={
    ...
    ecuc_linker_symbol_def_variants: (
        EcucLinkerSymbolDef.EcucLinkerSymbolDefVariants | None
    ) = field(
        default=None,
        metadata={
