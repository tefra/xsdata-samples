...
class EcucLinkerSymbolDef:
    ...
    short_name_fragments: None | EcucLinkerSymbolDef.ShortNameFragments = (
        field(
            default=None,
            metadata={
    ...
    annotations: None | EcucLinkerSymbolDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: None | EcucLinkerSymbolDef.RelatedTraceItemRef = (
        field(
            default=None,
            metadata={
    ...
    ecuc_validation_conds: None | EcucLinkerSymbolDef.EcucValidationConds = (
        field(
            default=None,
            metadata={
    ...
    implementation_config_classes: (
        None | EcucLinkerSymbolDef.ImplementationConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        None | EcucLinkerSymbolDef.MultiplicityConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: None | EcucLinkerSymbolDef.ValueConfigClasses = (
        field(
            default=None,
            metadata={
    ...
    derivation: None | EcucDerivationSpecification = field(
        default=None,
        metadata={
            "name": "DERIVATION",
            "type": "Element",
    ...
    symbolic_name_value: None | Boolean = field(
        default=None,
        metadata={
    ...
    ecuc_linker_symbol_def_variants: (
        None | EcucLinkerSymbolDef.EcucLinkerSymbolDefVariants
    ) = field(
        default=None,
        metadata={
    ...
    class EcucLinkerSymbolDefVariants:
        ecuc_linker_symbol_def_conditional: list[
