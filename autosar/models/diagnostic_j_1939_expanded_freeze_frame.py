...
class DiagnosticJ1939ExpandedFreezeFrame:
    ...
    short_name_fragments: DiagnosticJ1939ExpandedFreezeFrame.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticJ1939ExpandedFreezeFrame.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    node_ref: DiagnosticJ1939ExpandedFreezeFrame.NodeRef | None = field(
        default=None,
        metadata={
            "name": "NODE-REF",
            "type": "Element",
    ...
    spn_refs: DiagnosticJ1939ExpandedFreezeFrame.SpnRefs | None = field(
        default=None,
        metadata={
            "name": "SPN-REFS",
            "type": "Element",
