...
class DiagnosticDoIpTriggerVehicleAnnouncementInterface:
    ...
    implement the DoIPTriggerVehicleAnnouncement on the adaptive platform.
    ...
    short_name_fragments: Optional["DiagnosticDoIpTriggerVehicleAnnouncementInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDoIpTriggerVehicleAnnouncementInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDoIpTriggerVehicleAnnouncementInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDoIpTriggerVehicleAnnouncementInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
