...
class DiagnosticClearResetEmissionRelatedInfo:
    ...
    :ivar clear_reset_emission_related_diagnostic_info_class_ref: This
        ...
        among all DiagnosticClearResteEmissionRelatedInfo in the given
        context.
    ...
    annotations: None | DiagnosticClearResetEmissionRelatedInfo.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticClearResetEmissionRelatedInfo.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
