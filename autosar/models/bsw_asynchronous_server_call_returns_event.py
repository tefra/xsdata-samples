...
class BswAsynchronousServerCallReturnsEvent:
    ...
    short_name_fragments: Optional["BswAsynchronousServerCallReturnsEvent.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BswAsynchronousServerCallReturnsEvent.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    activation_reason_representation_ref: Optional["BswAsynchronousServerCallReturnsEvent.ActivationReasonRepresentationRef"] = field(
        default=None,
        metadata={
    ...
    context_limitation_refs: Optional["BswAsynchronousServerCallReturnsEvent.ContextLimitationRefs"] = field(
        default=None,
        metadata={
    ...
    disabled_in_mode_irefs: Optional["BswAsynchronousServerCallReturnsEvent.DisabledInModeIrefs"] = field(
        default=None,
        metadata={
    ...
    starts_on_event_ref: Optional["BswAsynchronousServerCallReturnsEvent.StartsOnEventRef"] = field(
        default=None,
        metadata={
    ...
    event_source_ref: Optional["BswAsynchronousServerCallReturnsEvent.EventSourceRef"] = field(
        default=None,
        metadata={
    ...
    class ContextLimitationRefs:
        context_limitation_ref: List["BswAsynchronousServerCallReturnsEvent.ContextLimitationRefs.ContextLimitationRef"] = field(
            default_factory=list,
            metadata={
    ...
    class EventSourceRef(Ref):
        dest: Optional[BswAsynchronousServerCallResultPointSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
