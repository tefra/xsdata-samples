...
class WorstCaseHeapUsage:
    ...
    :ivar memory_consumption: Worst case heap consumption. Unit: byte.
    ...
    annotations: None | WorstCaseHeapUsage.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    hw_element_ref: None | WorstCaseHeapUsage.HwElementRef = field(
        default=None,
        metadata={
            "name": "HW-ELEMENT-REF",
            "type": "Element",
