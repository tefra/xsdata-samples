...
class VariableDataPrototypeInSystemInstanceRef:
    ...
    context_component_ref: List["VariableDataPrototypeInSystemInstanceRef.ContextComponentRef"] = field(
    ...
    context_composition_ref: Optional["VariableDataPrototypeInSystemInstanceRef.ContextCompositionRef"] = field(
        default=None,
        metadata={
    ...
    context_port_ref: Optional["VariableDataPrototypeInSystemInstanceRef.ContextPortRef"] = field(
        default=None,
        metadata={
    ...
    target_data_prototype_ref: Optional["VariableDataPrototypeInSystemInstanceRef.TargetDataPrototypeRef"] = field(
        default=None,
        metadata={
