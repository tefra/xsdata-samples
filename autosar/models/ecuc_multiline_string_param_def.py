...
class EcucMultilineStringParamDef:
    ...
    :ivar ecuc_multiline_string_param_def_variants: This element was
    ...
    short_name_fragments: Optional["EcucMultilineStringParamDef.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    related_trace_item_ref: Optional["EcucMultilineStringParamDef.RelatedTraceItemRef"] = field(
        default=None,
        metadata={
    ...
    ecuc_validation_conds: Optional["EcucMultilineStringParamDef.EcucValidationConds"] = field(
        default=None,
        metadata={
    ...
    implementation_config_classes: Optional["EcucMultilineStringParamDef.ImplementationConfigClasses"] = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: Optional["EcucMultilineStringParamDef.MultiplicityConfigClasses"] = field(
        default=None,
        metadata={
    ...
    value_config_classes: Optional["EcucMultilineStringParamDef.ValueConfigClasses"] = field(
        default=None,
        metadata={
    ...
    ecuc_multiline_string_param_def_variants: Optional["EcucMultilineStringParamDef.EcucMultilineStringParamDefVariants"] = field(
        default=None,
        metadata={
    ...
    class EcucMultilineStringParamDefVariants:
        ecuc_multiline_string_param_def_conditional: List[EcucMultilineStringParamDefConditional] = field(
            default_factory=list,
            metadata={
