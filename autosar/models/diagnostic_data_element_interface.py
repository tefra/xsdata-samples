...
class DiagnosticDataElementInterface:
    ...
    short_name_fragments: (
        None | DiagnosticDataElementInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticDataElementInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: (
        None | DiagnosticDataElementInterface.BlueprintPolicys
    ) = field(
        default=None,
        metadata={
    ...
    namespaces: None | DiagnosticDataElementInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
