...
class DiagnosticDataElementInterface:
    """
    This meta-class represents the ability to implement a element-of-DID-
    focused PortInterface for diagnostics on the adaptive platform.
    ...
    :ivar read: This represents the method to read the content of an
        element of a diagnostic data identifier.
    :ivar write: This represents the method to write the content of an
        element of a diagnostic data identifier.
    ...
    short_name_fragments: Optional["DiagnosticDataElementInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDataElementInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["DiagnosticDataElementInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["DiagnosticDataElementInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
