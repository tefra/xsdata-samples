...
class ApplicationAssocMapDataType:
    ...
    short_name_fragments: Optional["ApplicationAssocMapDataType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    blueprint_policys: Optional["ApplicationAssocMapDataType.BlueprintPolicys"] = field(
        default=None,
        metadata={
