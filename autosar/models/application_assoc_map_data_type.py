...
class ApplicationAssocMapDataType:
    ...
    :ivar key: Key element of the map that is used to uniquely identify
        the value of the map.
    :ivar value: Value element of the map that stores the content
        associated to a key.
    ...
    annotations: None | ApplicationAssocMapDataType.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | ApplicationAssocMapDataType.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    key: None | ApplicationAssocMapElement = field(
        default=None,
        metadata={
            "name": "KEY",
            "type": "Element",
    ...
    value: None | ApplicationAssocMapElement = field(
        default=None,
        metadata={
            "name": "VALUE",
            "type": "Element",
