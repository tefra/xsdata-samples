...
class EcucStringParamDef:
    ...
    short_name_fragments: None | EcucStringParamDef.ShortNameFragments = field(
        default=None,
        metadata={
    ...
    annotations: None | EcucStringParamDef.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    related_trace_item_ref: None | EcucStringParamDef.RelatedTraceItemRef = (
        field(
            default=None,
            metadata={
    ...
    ecuc_validation_conds: None | EcucStringParamDef.EcucValidationConds = (
        field(
            default=None,
            metadata={
    ...
    implementation_config_classes: (
        None | EcucStringParamDef.ImplementationConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    multiplicity_config_classes: (
        None | EcucStringParamDef.MultiplicityConfigClasses
    ) = field(
        default=None,
        metadata={
    ...
    value_config_classes: None | EcucStringParamDef.ValueConfigClasses = field(
        default=None,
        metadata={
    ...
    ecuc_string_param_def_variants: (
        None | EcucStringParamDef.EcucStringParamDefVariants
    ) = field(
        default=None,
        metadata={
    ...
    class EcucStringParamDefVariants:
        ecuc_string_param_def_conditional: list[
