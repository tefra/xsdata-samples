...
class TriggerInterfaceMapping:
    ...
    annotations: None | TriggerInterfaceMapping.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | TriggerInterfaceMapping.BlueprintPolicys = field(
        default=None,
        metadata={
    ...
    trigger_mappings: None | TriggerInterfaceMapping.TriggerMappings = field(
        default=None,
        metadata={
