...
class TriggerInterfaceMapping:
    ...
    :ivar trigger_mappings: Mapping of two Trigger in two different
        TriggerInterface
    ...
    short_name_fragments: Optional["TriggerInterfaceMapping.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TriggerInterfaceMapping.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["TriggerInterfaceMapping.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    trigger_mappings: Optional["TriggerInterfaceMapping.TriggerMappings"] = field(
        default=None,
        metadata={
            "name": "TRIGGER-MAPPINGS",
            "type": "Element",
            "namespace": "http://autosar.org/schema/r4.0",
        }
    )
