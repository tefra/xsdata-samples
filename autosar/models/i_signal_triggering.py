...
class ISignalTriggering:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar i_signal_group_ref: This reference shall be used if an
        ISignalGroup is transported on the PhysicalChannel. This
        reference forms an XOR relationship with the ISignalTriggering-
        ISignal reference.
    :ivar i_signal_port_refs: References to the ISignalPort on every ECU
        of the system which sends and/or receives the ISignal.
        References for both the sender and the receiver side shall be
        included when the system is completely defined.
    :ivar i_signal_ref: This reference shall be used if an ISignal is
        transported on the PhysicalChannel. This reference forms an XOR
        relationship with the ISignalTriggering-ISignalGroup reference.
    ...
    short_name_fragments: Optional["ISignalTriggering.ShortNameFragments"] = (
        field(
            default=None,
            metadata={
    ...
    class ISignalPortRefs:
        ...
        class ISignalPortRef(Ref):
            dest: Optional[ISignalPortSubtypesEnum] = field(
                default=None,
                metadata={
                    "name": "DEST",
                    "type": "Attribute",
