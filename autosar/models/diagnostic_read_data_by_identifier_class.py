...
class DiagnosticReadDataByIdentifierClass:
    ...
    short_name_fragments: Optional["DiagnosticReadDataByIdentifierClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticReadDataByIdentifierClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticReadDataByIdentifierClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
