...
class DiagnosticReadDataByIdentifierClass:
    ...
    "Read Data by Identifier" diagnostic service.
    ...
    :ivar max_did_to_read: This attribute represents the maximum number
        of allowed DIDs in a single instance of
    ...
    short_name_fragments: (
        None | DiagnosticReadDataByIdentifierClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticReadDataByIdentifierClass.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticReadDataByIdentifierClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    max_did_to_read: None | PositiveInteger = field(
        default=None,
        metadata={
