...
class ApplicationAssocMapElementValueSpecification:
    ...
    value: ApplicationAssocMapElementValueSpecification.Value | None = (
        field(
            default=None,
            metadata={
                "name": "VALUE",
    ...
    class Key:
        ...
        record_value_specification: RecordValueSpecification | None = (
            field(
                default=None,
                metadata={
...
class ApplicationAssocMapValueSpecification:
    ...
    map_element_tuples: ApplicationAssocMapValueSpecification.MapElementTuples | None = field(
        default=None,
        metadata={
...
class CompositeRuleBasedValueSpecification:
    ...
    arguments: CompositeRuleBasedValueSpecification.Arguments | None = (
        field(
            default=None,
            metadata={
                "name": "ARGUMENTS",
