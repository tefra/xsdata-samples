...
class WarningIndicatorRequestedBitNeeds:
    """
    This meta-class represents the ability to explicitly request the
    existence of the WarningIndicatorRequestedBit.
    ...
    short_name_fragments: WarningIndicatorRequestedBitNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: WarningIndicatorRequestedBitNeeds.Annotations | None = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    audiences: WarningIndicatorRequestedBitNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
