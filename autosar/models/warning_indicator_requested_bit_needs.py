...
class WarningIndicatorRequestedBitNeeds:
    ...
    short_name_fragments: (
        None | WarningIndicatorRequestedBitNeeds.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | WarningIndicatorRequestedBitNeeds.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: None | WarningIndicatorRequestedBitNeeds.Audiences = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
