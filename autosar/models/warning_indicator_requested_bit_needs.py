...
class WarningIndicatorRequestedBitNeeds:
    ...
    short_name_fragments: Optional["WarningIndicatorRequestedBitNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["WarningIndicatorRequestedBitNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
