...
class PersistencyFileElement:
    ...
    that it is possible to configure the behavior for accessing the
    represented file at run-time.
    ...
    :ivar update_strategy: This attribute can be used to specify the
        update strategy of the respective PersistencyInterfaceElement.
    ...
    :ivar file_name: This attribute holds filename part of the storage
        location for the PersistencyFileProxy, e.g. file on the file
        system.
