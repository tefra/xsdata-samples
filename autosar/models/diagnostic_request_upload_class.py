...
class DiagnosticRequestUploadClass:
    ...
    short_name_fragments: (
        None | DiagnosticRequestUploadClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticRequestUploadClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticRequestUploadClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
