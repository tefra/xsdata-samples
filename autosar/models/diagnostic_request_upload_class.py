...
class DiagnosticRequestUploadClass:
    ...
    short_name_fragments: Optional["DiagnosticRequestUploadClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticRequestUploadClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticRequestUploadClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
