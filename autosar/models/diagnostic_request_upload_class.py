...
class DiagnosticRequestUploadClass:
    ...
    "Request Upload" diagnostic service.
    ...
    short_name_fragments: DiagnosticRequestUploadClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRequestUploadClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticRequestUploadClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
