...
class TdEventTtCanCycleStart:
    ...
    where a communication cycle starts on a TTCAN cluster.
    ...
    :ivar tt_can_cluster_ref: The scope of this timing event.
    ...
    short_name_fragments: Optional[
        "TdEventTtCanCycleStart.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["TdEventTtCanCycleStart.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    ecu_instance_ref: Optional["TdEventTtCanCycleStart.EcuInstanceRef"] = (
        field(
            default=None,
            metadata={
    ...
    tt_can_cluster_ref: Optional["TdEventTtCanCycleStart.TtCanClusterRef"] = (
        field(
            default=None,
            metadata={
    ...
    class TtCanClusterRef(Ref):
        dest: Optional[TtcanClusterSubtypesEnum] = field(
            default=None,
            metadata={
                "name": "DEST",
                "type": "Attribute",
