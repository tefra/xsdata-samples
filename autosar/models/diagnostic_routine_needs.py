...
class DiagnosticRoutineNeeds:
    ...
    :ivar diag_routine_type: This denotes the type of diagnostic routine
        which is implemented by the referenced server port.
    :ivar rid_number: This represents a routine identifier for the
        diagnostic routine. This allows to predefine the RID number if
    ...
    short_name_fragments: DiagnosticRoutineNeeds.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticRoutineNeeds.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    audiences: DiagnosticRoutineNeeds.Audiences | None = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    diag_routine_type: DiagnosticRoutineTypeEnum | None = field(
        default=None,
        metadata={
    ...
    rid_number: PositiveInteger | None = field(
        default=None,
        metadata={
            "name": "RID-NUMBER",
            "type": "Element",
