...
class SignalBasedEventElementToISignalTriggeringMapping:
    ...
    element that is defined inside of the event in case that the datatype is
    composite to an ISignalTriggering.
    ...
    :ivar filter: Defines an optional filter to be applied during
        translation.
    :ivar i_signal_triggering_ref: Reference to the ISignalTriggering
        that is used to transport a piece of data of an event that is
        defined in a  ServiceInterface in a signal-based way over a
        communication channel.
    :ivar transmission_trigger: Defines whether the source element
        triggers the sending of the respective payload.
