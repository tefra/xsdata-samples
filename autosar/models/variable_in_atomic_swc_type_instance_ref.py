...
class VariableInAtomicSwcTypeInstanceRef:
    ...
    port_prototype_ref: Optional["VariableInAtomicSwcTypeInstanceRef.PortPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    root_variable_data_prototype_ref: Optional["VariableInAtomicSwcTypeInstanceRef.RootVariableDataPrototypeRef"] = field(
        default=None,
        metadata={
    ...
    context_data_prototype_ref: List["VariableInAtomicSwcTypeInstanceRef.ContextDataPrototypeRef"] = field(
    ...
    target_data_prototype_ref: Optional["VariableInAtomicSwcTypeInstanceRef.TargetDataPrototypeRef"] = field(
        default=None,
        metadata={
