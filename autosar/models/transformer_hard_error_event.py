...
class TransformerHardErrorEvent:
    ...
    Client/Server operation or an external trigger but during
    transformation of the data a hard transformer error occurred.
    ...
    :ivar operation_iref: This represents the ClientServerOperation to
        which the TransformerHardErrorEvent refers to.
    :ivar required_trigger_iref: Trigger for which the transformer can
        trigger this TransformerHardErrorEvent
    :ivar trigger_iref: Trigger for which the transformer can trigger
        this TransformerHardErrorEvent
