...
class DiagnosticEventToEnableConditionGroupMapping:
    ...
    :ivar diagnostic_event_ref: Reference to a DiagnosticEvent to which
        an EnableConditionGroup is assigned.
    :ivar enable_condition_group_ref: Reference to an
        EnableConditionGroup assigned to a DiagnosticEvent.
    ...
    annotations: (
        None | DiagnosticEventToEnableConditionGroupMapping.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    diagnostic_event_ref: (
        None | DiagnosticEventToEnableConditionGroupMapping.DiagnosticEventRef
    ) = field(
        default=None,
        metadata={
