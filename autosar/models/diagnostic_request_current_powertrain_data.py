...
class DiagnosticRequestCurrentPowertrainData:
    ...
    :ivar pid_ref: This represents the PID associated with this instance
        of the OBD mode 0x01 service.
    :ivar request_current_powertrain_diagnostic_data_class_ref: This
        ...
        among all DiagnosticRequestCurrentPowertrainData in the given
        context.
    ...
    short_name_fragments: (
        None | DiagnosticRequestCurrentPowertrainData.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticRequestCurrentPowertrainData.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    access_permission_ref: (
        None | DiagnosticRequestCurrentPowertrainData.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
    ...
    pid_ref: None | DiagnosticRequestCurrentPowertrainData.PidRef = field(
        default=None,
        metadata={
            "name": "PID-REF",
            "type": "Element",
    ...
    class RequestCurrentPowertrainDiagnosticDataClassRef(Ref):
        dest: DiagnosticRequestCurrentPowertrainDataClassSubtypesEnum = field(
            metadata={
                "name": "DEST",
                "type": "Attribute",
                "required": True,
