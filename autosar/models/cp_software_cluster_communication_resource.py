...
class CpSoftwareClusterCommunicationResource:
    ...
    :ivar com_props: This aggregation supports the further qualification
        of the enclosing CpSoftwareClusterCommunicationRecource by means
        of additional attributes depending on the nature of the
        CpSoftwareClusterCommunicationRecource.
    ...
    short_name_fragments: CpSoftwareClusterCommunicationResource.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: CpSoftwareClusterCommunicationResource.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    dependent_resources: CpSoftwareClusterCommunicationResource.DependentResources | None = field(
        default=None,
        metadata={
    ...
    is_mandatory: Boolean | None = field(
        default=None,
        metadata={
            "name": "IS-MANDATORY",
            "type": "Element",
    ...
    com_props: DataComProps | None = field(
        default=None,
        metadata={
            "name": "COM-PROPS",
            "type": "Element",
