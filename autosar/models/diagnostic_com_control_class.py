...
class DiagnosticComControlClass:
    ...
    :ivar access_permission_ref: This represents the collection of
        ...
        referencing DiagnosticServiceClass.
    :ivar access_permission_validity: This attribute is responsible for
        clarifying the validity of the accessPermission reference.
    :ivar all_channels_refs: This reference represents the semantics
        that all available channels shall be affected. It is still
        necessary to refer to individual CommunicatuionClusters because
        there could be private CommunicationClusters in the System
        Extract that are not subject to the service "communication
        control". By referring to the applicable CommunicationClusters
        it can be made sure that only the affected CommunicationClusters
        are accessed.
    :ivar specific_channels: This represents the ability to add
        additional attributes to the case that only specific channels
        are supposed to be considered,
    :ivar sub_node_channels: This attribute represents the ability to
        add further attributes to the definition of a specific sub-node
        channel that is subject to the diagnostic service "communication
        control".
