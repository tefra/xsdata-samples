...
class SignalServiceTranslationElementProps:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar element: Reference to the leaf element the
        SignalServiceTranslationElementProps apply to.
    :ivar filter: Defines an optional filter to be applied during
        translation.
    :ivar transmission_trigger: Defines whether the source element
        (which is mapped to the referenced element) triggers the sending
        of the respective payload.
    ...
    annotations: None | SignalServiceTranslationElementProps.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    element: None | SignalServiceTranslationElementProps.Element = field(
        default=None,
        metadata={
            "name": "ELEMENT",
            "type": "Element",
