...
class DiagnosticJ1939Node:
    ...
    :ivar nm_node_ref: This represents the reference to the "virtual
        Ecu" to which the enclosing DiagnosticJ1939Node is associated.
    ...
    short_name_fragments: Optional["DiagnosticJ1939Node.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticJ1939Node.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    nm_node_ref: Optional["DiagnosticJ1939Node.NmNodeRef"] = field(
        default=None,
        metadata={
            "name": "NM-NODE-REF",
            "type": "Element",
