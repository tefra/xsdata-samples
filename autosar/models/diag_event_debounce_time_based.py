...
class DiagEventDebounceTimeBased:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar time_based_fdc_threshold_storage_value: Threshold to allocate
        an event memory entry and to capture the Freeze Frame.
    :ivar time_failed_threshold: This value represents the event-
        specific delay indicating the "failed" status.
    :ivar time_passed_threshold: This value represents the event-
        specific delay indicating the "passed" status.
    ...
    annotations: DiagEventDebounceTimeBased.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    time_failed_threshold: TimeValueValueVariationPoint | None = field(
        default=None,
        metadata={
    ...
    time_passed_threshold: TimeValueValueVariationPoint | None = field(
        default=None,
        metadata={
