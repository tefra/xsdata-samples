...
class DiagnosticDataTransferClass:
    ...
    "Data Transfer" diagnostic service.
    ...
    short_name_fragments: DiagnosticDataTransferClass.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticDataTransferClass.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: DiagnosticDataTransferClass.AccessPermissionRef | None = field(
        default=None,
        metadata={
