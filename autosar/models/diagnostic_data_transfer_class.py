...
class DiagnosticDataTransferClass:
    ...
    short_name_fragments: Optional["DiagnosticDataTransferClass.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticDataTransferClass.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: Optional["DiagnosticDataTransferClass.AccessPermissionRef"] = field(
        default=None,
        metadata={
