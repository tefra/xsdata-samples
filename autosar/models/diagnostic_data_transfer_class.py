...
class DiagnosticDataTransferClass:
    ...
    short_name_fragments: (
        None | DiagnosticDataTransferClass.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | DiagnosticDataTransferClass.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    access_permission_ref: (
        None | DiagnosticDataTransferClass.AccessPermissionRef
    ) = field(
        default=None,
        metadata={
