...
class GeneralPurposeConnection:
    ...
    short_name_fragments: (
        None | GeneralPurposeConnection.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | GeneralPurposeConnection.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    pdu_triggering_refs: None | GeneralPurposeConnection.PduTriggeringRefs = (
        field(
            default=None,
            metadata={
