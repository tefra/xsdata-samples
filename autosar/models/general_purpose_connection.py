...
class GeneralPurposeConnection:
    ...
    :ivar pdu_triggering_refs: Reference to PduTriggerings that are
        connected to each other by a GeneralPurposeConnection.
    ...
    short_name_fragments: Optional["GeneralPurposeConnection.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    pdu_triggering_refs: Optional["GeneralPurposeConnection.PduTriggeringRefs"] = field(
        default=None,
        metadata={
    ...
    class PduTriggeringRefs:
        pdu_triggering_ref: List["GeneralPurposeConnection.PduTriggeringRefs.PduTriggeringRef"] = field(
            default_factory=list,
            metadata={
