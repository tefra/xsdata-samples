...
class DiagnosticDynamicallyDefineDataIdentifierClass:
    ...
    :ivar check_per_source_id: If set to TRUE, the Dcm module shall
        check the session, security and mode dependencies per source
        DIDs with a ReadDataByIdentifier (0x22) with DID in the range
        0xF200 to 0xF3FF. If set to FALSE. the Dcm module shall not
        check the session, security and mode dependencies per source
        DIDs with a ReadDataByIdentifier (0x22) with DID in the range
        0xF200 to 0xF3FF.
    :ivar configuration_handling: This configuration switch defines
        whether DDDID definition is handled as non-volatile information
        or not.
    :ivar subfunctions:
    ...
    annotations: (
        None | DiagnosticDynamicallyDefineDataIdentifierClass.Annotations
    ) = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
    ...
    check_per_source_id: None | Boolean = field(
        default=None,
        metadata={
    ...
    configuration_handling: None | DiagnosticHandleDddiConfigurationEnum = (
        field(
            default=None,
            metadata={
    ...
    subfunctions: (
        None | DiagnosticDynamicallyDefineDataIdentifierClass.Subfunctions
    ) = field(
        default=None,
        metadata={
            "name": "SUBFUNCTIONS",
    ...
    class Subfunctions:
        """
        :ivar subfunction: This attribute contains a list of applicable
            subfunctions for all
