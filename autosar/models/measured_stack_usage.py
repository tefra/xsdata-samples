...
class MeasuredStackUsage:
    ...
    :ivar average_memory_consumption: The average stack usage measured.
        Unit: byte.
    :ivar maximum_memory_consumption: The maximum stack usage measured.
        Unit: byte.
    :ivar minimum_memory_consumption: The minimum stack usage measured.
        Unit: byte.
    ...
    annotations: None | MeasuredStackUsage.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    executable_entity_ref: None | MeasuredStackUsage.ExecutableEntityRef = (
        field(
            default=None,
            metadata={
    ...
    hw_element_ref: None | MeasuredStackUsage.HwElementRef = field(
        default=None,
        metadata={
            "name": "HW-ELEMENT-REF",
            "type": "Element",
