...
class TimeBaseProviderToPersistencyMapping:
    ...
    :ivar persistency_deployment_element_ref: This reference represents
        the PersistencyDeploymentElement where the time value shall be
        stored in and retrieved from.
    :ivar time_base_provider_ref: This reference represents the mapped
        TimeBaseProvider.
    ...
    annotations: None | TimeBaseProviderToPersistencyMapping.Annotations = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    time_base_provider_ref: (
        None | TimeBaseProviderToPersistencyMapping.TimeBaseProviderRef
    ) = field(
        default=None,
        metadata={
