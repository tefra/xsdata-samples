...
class SporadicEventTriggering:
    ...
    short_name_fragments: Optional["SporadicEventTriggering.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    timing_condition_ref: Optional["SporadicEventTriggering.TimingConditionRef"] = field(
        default=None,
        metadata={
