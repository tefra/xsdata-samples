...
class SporadicEventTriggering:
    """
    The SporadicEventTriggering describes the behavior of an event which
    occurs occasionally or singly.
    ...
    annotations: None | SporadicEventTriggering.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    trace_refs: None | SporadicEventTriggering.TraceRefs = field(
        default=None,
        metadata={
            "name": "TRACE-REFS",
            "type": "Element",
    ...
    timing_condition_ref: None | SporadicEventTriggering.TimingConditionRef = (
        field(
            default=None,
            metadata={
    ...
    event_ref: None | SporadicEventTriggering.EventRef = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
    ...
    maximum_inter_arrival_time: None | MultidimensionalTime = field(
        default=None,
        metadata={
    ...
    jitter: None | MultidimensionalTime = field(
        default=None,
        metadata={
            "name": "JITTER",
            "type": "Element",
    ...
    period: None | MultidimensionalTime = field(
        default=None,
        metadata={
            "name": "PERIOD",
            "type": "Element",
