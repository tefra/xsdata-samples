...
class CpSoftwareClusterToResourceMapping:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar provider_ref: CP Software Cluster providing the resource
    :ivar requester_refs: CP Software Cluster requesting the resource
    :ivar service_resource_ref: Service resource for which the mapping
        applies.
