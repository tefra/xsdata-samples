...
class SynchronousServerCallPoint:
    ...
    :ivar return_value_provision: This attribute controls the provision
        ...
        access point.
    :ivar operation_iref: The operation that is called by this runnable.
    :ivar timeout: Time in seconds before the server call times out and
    ...
    short_name_fragments: Optional["SynchronousServerCallPoint.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    called_from_within_exclusive_area_ref: Optional["SynchronousServerCallPoint.CalledFromWithinExclusiveAreaRef"] = field(
        default=None,
        metadata={
