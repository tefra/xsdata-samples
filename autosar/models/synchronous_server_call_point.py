...
class SynchronousServerCallPoint:
    ...
    annotations: None | SynchronousServerCallPoint.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    operation_iref: None | ROperationInAtomicSwcInstanceRef = field(
        default=None,
        metadata={
            "name": "OPERATION-IREF",
            "type": "Element",
    ...
    called_from_within_exclusive_area_ref: (
        None | SynchronousServerCallPoint.CalledFromWithinExclusiveAreaRef
    ) = field(
        default=None,
        metadata={
