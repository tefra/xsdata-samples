...
class DiagnosticIumpr:
    ...
    short_name_fragments: DiagnosticIumpr.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: DiagnosticIumpr.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_ref: DiagnosticIumpr.EventRef | None = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
