...
class DiagnosticIumpr:
    ...
    :ivar event_ref: This reference represents the DiagnosticEvent that
    ...
    short_name_fragments: Optional["DiagnosticIumpr.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DiagnosticIumpr.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    event_ref: Optional["DiagnosticIumpr.EventRef"] = field(
        default=None,
        metadata={
            "name": "EVENT-REF",
            "type": "Element",
