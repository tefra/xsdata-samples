...
class EcuAbstractionSwComponentType:
    ...
    :ivar hardware_element_refs: Reference from the
        EcuAbstractionComponentType to the description of the used
        HwElements.
    ...
    short_name_fragments: Optional["EcuAbstractionSwComponentType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    blueprint_policys: Optional["EcuAbstractionSwComponentType.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    sw_component_documentations: Optional["EcuAbstractionSwComponentType.SwComponentDocumentations"] = field(
        default=None,
        metadata={
    ...
    consistency_needss: Optional["EcuAbstractionSwComponentType.ConsistencyNeedss"] = field(
        default=None,
        metadata={
    ...
    unit_group_refs: Optional["EcuAbstractionSwComponentType.UnitGroupRefs"] = field(
        default=None,
        metadata={
    ...
    internal_behaviors: Optional["EcuAbstractionSwComponentType.InternalBehaviors"] = field(
        default=None,
        metadata={
    ...
    hardware_element_refs: Optional["EcuAbstractionSwComponentType.HardwareElementRefs"] = field(
        default=None,
        metadata={
    ...
    @dataclass
    class UnitGroupRefs:
        unit_group_ref: List["EcuAbstractionSwComponentType.UnitGroupRefs.UnitGroupRef"] = field(
            default_factory=list,
            metadata={
                "name": "UNIT-GROUP-REF",
                "type": "Element",
    ...
    class HardwareElementRefs:
        hardware_element_ref: List["EcuAbstractionSwComponentType.HardwareElementRefs.HardwareElementRef"] = field(
            default_factory=list,
            metadata={
