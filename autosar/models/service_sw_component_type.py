...
class ServiceSwComponentType:
    ...
    short_name_fragments: Optional["ServiceSwComponentType.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    blueprint_policys: Optional["ServiceSwComponentType.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    sw_component_documentations: Optional["ServiceSwComponentType.SwComponentDocumentations"] = field(
        default=None,
        metadata={
    ...
    consistency_needss: Optional["ServiceSwComponentType.ConsistencyNeedss"] = field(
        default=None,
        metadata={
    ...
    internal_behaviors: Optional["ServiceSwComponentType.InternalBehaviors"] = field(
        default=None,
        metadata={
    ...
    @dataclass
    class UnitGroupRefs:
        unit_group_ref: List["ServiceSwComponentType.UnitGroupRefs.UnitGroupRef"] = field(
            default_factory=list,
            metadata={
                "name": "UNIT-GROUP-REF",
                "type": "Element",
