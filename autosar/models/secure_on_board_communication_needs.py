...
class SecureOnBoardCommunicationNeeds:
    ...
    short_name_fragments: Optional["SecureOnBoardCommunicationNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SecureOnBoardCommunicationNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
