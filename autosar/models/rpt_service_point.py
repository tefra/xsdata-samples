...
class RptServicePoint:
    ...
    :ivar annotations: Possibility to provide additional notes while
        ...
        design notes.
    :ivar service_id: Unique ID (Range: 0 ... 65535)  representing the
        service point.
    :ivar symbol: Complete symbol of the function implementing the
    ...
    short_name_fragments: Optional["RptServicePoint.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["RptServicePoint.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
