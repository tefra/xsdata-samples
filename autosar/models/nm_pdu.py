...
class NmPdu:
    ...
    annotations: None | NmPdu.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    i_signal_to_i_pdu_mappings: None | NmPdu.ISignalToIPduMappings = field(
        default=None,
        metadata={
    ...
    nm_data_information: None | Boolean = field(
        default=None,
        metadata={
    ...
    nm_vote_information: None | Boolean = field(
        default=None,
        metadata={
