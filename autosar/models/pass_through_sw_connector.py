...
class PassThroughSwConnector:
    ...
    CompositionSwComponentType to connect two delegation PortPrototypes.
    ...
    :ivar provided_outer_port_ref: This represents the provided outer
        delegation PortPrototype of the PassThroughSwConnector.
    :ivar required_outer_port_ref: This represents the required outer
        delegation PortPrototype of the PassThroughSwConnector.
