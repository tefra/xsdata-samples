...
class LinSporadicFrame:
    ...
    :ivar substituted_frame_refs: Reference to a group of unconditional
        frames that share the same frame slot. In case that more than
        one of the declared frames needs to be transferred, the one
        first listed shall be chosen. Within a channel a LIN Frame shall
        be referenced by only one FrameTriggering. This allows a
        derivation of the identifier of a substituted Frame. The
        identifier is specified in FrameTriggering element. A
        LinUnconditionalFrame associated with a LinSporadicFrame may not
        be allocated in the same LinScheduleTable as the sporadic frame.
    ...
    short_name_fragments: Optional["LinSporadicFrame.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    pdu_to_frame_mappings: Optional["LinSporadicFrame.PduToFrameMappings"] = field(
        default=None,
        metadata={
    ...
    substituted_frame_refs: Optional["LinSporadicFrame.SubstitutedFrameRefs"] = field(
        default=None,
        metadata={
    ...
    class SubstitutedFrameRefs:
        substituted_frame_ref: List["LinSporadicFrame.SubstitutedFrameRefs.SubstitutedFrameRef"] = field(
            default_factory=list,
            metadata={
                "name": "SUBSTITUTED-FRAME-REF",
                "type": "Element",
                "namespace": "http://autosar.org/schema/r4.0",
            }
        )
