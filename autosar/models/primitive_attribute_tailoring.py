...
class PrimitiveAttributeTailoring:
    ...
    :ivar variation_restriction: Restrictions on the usage of variant
        handling.
    :ivar default_value_handling: Specification of how to handle AUTOSAR
        defined default values.
    :ivar sub_attribute_tailorings: Tailors the attribute of a
        &lt;&lt;primitive&gt;&gt; data type.
    :ivar value_restriction: The restriction of the attribute value.
