...
class ConstantSpecification:
    ...
    :ivar value_spec: Specification of an expression leading to a value
        for this constant.
    ...
    short_name_fragments: ConstantSpecification.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: ConstantSpecification.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    value_spec: ConstantSpecification.ValueSpec | None = field(
        default=None,
        metadata={
            "name": "VALUE-SPEC",
            "type": "Element",
