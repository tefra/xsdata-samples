...
class PhmRecoveryActionInterface:
    ...
    short_name_fragments: (
        None | PhmRecoveryActionInterface.ShortNameFragments
    ) = field(
        default=None,
        metadata={
    ...
    annotations: None | PhmRecoveryActionInterface.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | PhmRecoveryActionInterface.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    namespaces: None | PhmRecoveryActionInterface.Namespaces = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    recovery: None | ClientServerOperation = field(
        default=None,
        metadata={
            "name": "RECOVERY",
            "type": "Element",
