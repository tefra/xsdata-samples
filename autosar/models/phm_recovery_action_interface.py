...
class PhmRecoveryActionInterface:
    ...
    :ivar recovery: This aggregation represents the actual recovery
        action
    ...
    short_name_fragments: Optional["PhmRecoveryActionInterface.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PhmRecoveryActionInterface.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["PhmRecoveryActionInterface.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    namespaces: Optional["PhmRecoveryActionInterface.Namespaces"] = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    recovery: Optional[ClientServerOperation] = field(
        default=None,
        metadata={
            "name": "RECOVERY",
            "type": "Element",
