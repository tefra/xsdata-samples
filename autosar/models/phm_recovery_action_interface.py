...
class PhmRecoveryActionInterface:
    ...
    short_name_fragments: PhmRecoveryActionInterface.ShortNameFragments | None = field(
        default=None,
        metadata={
    ...
    annotations: PhmRecoveryActionInterface.Annotations | None = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: PhmRecoveryActionInterface.BlueprintPolicys | None = field(
        default=None,
        metadata={
    ...
    namespaces: PhmRecoveryActionInterface.Namespaces | None = field(
        default=None,
        metadata={
            "name": "NAMESPACES",
            "type": "Element",
    ...
    recovery: ClientServerOperation | None = field(
        default=None,
        metadata={
            "name": "RECOVERY",
            "type": "Element",
