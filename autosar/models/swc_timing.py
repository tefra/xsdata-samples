...
class SwcTiming:
    ...
    chains referring to events which are derived from the classes
    ...
    :ivar timing_resource: The timing resource contains all instance
        ...
        timing view.
    :ivar behavior_ref: This defines the scope of a SwcTiming. All
        corresponding timing descriptions and constraints shall be
        defined within this scope. Note! The reason for the cardinality
        of 0..1 is to ensure backward compatibility.
    :ivar component_ref: Removed. This association between SwcTiming and
        SwComponentType shall not be used to specify the scope of the
        SwcTiming. It is mandatory to use the association between
        SwcTiming and SwcInternalBehavior instead.
    ...
    annotations: None | SwcTiming.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    timing_conditions: None | SwcTiming.TimingConditions = field(
        default=None,
        metadata={
    ...
    timing_descriptions: None | SwcTiming.TimingDescriptions = field(
        default=None,
        metadata={
    ...
    timing_guarantees: None | SwcTiming.TimingGuarantees = field(
        default=None,
        metadata={
    ...
    timing_requirements: None | SwcTiming.TimingRequirements = field(
        default=None,
        metadata={
    ...
    behavior_ref: None | SwcTiming.BehaviorRef = field(
        default=None,
        metadata={
            "name": "BEHAVIOR-REF",
            "type": "Element",
    ...
    component_ref: None | SwcTiming.ComponentRef = field(
        default=None,
        metadata={
            "name": "COMPONENT-REF",
            "type": "Element",
