...
class BuildActionEnvironment:
    ...
    :ivar sdgs: This represents a general data structure  intended to
        denote parameters for the BuildActionEnvironment.
    ...
    short_name_fragments: Optional["BuildActionEnvironment.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["BuildActionEnvironment.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["BuildActionEnvironment.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    sdgs: Optional["BuildActionEnvironment.Sdgs"] = field(
        default=None,
        metadata={
            "name": "SDGS",
            "type": "Element",
