...
class PdurIPduGroup:
    ...
    :ivar communication_mode: This attribute defines the use-case for
        this PduRIPduGroup. For example, in a diagnostic mode all IPdus
        - which are not involved in diagnostic - are disabled. The use
        cases are not limited to a fixed enumeration and can be
        specified as a string.
    :ivar i_pdus: This property was modified due to atpVariation
    ...
    short_name_fragments: Optional["PdurIPduGroup.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["PdurIPduGroup.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    i_pdus: Optional["PdurIPduGroup.IPdus"] = field(
        default=None,
        metadata={
            "name": "I-PDUS",
            "type": "Element",
