...
class DtcStatusChangeNotificationNeeds:
    ...
    short_name_fragments: Optional["DtcStatusChangeNotificationNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DtcStatusChangeNotificationNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
