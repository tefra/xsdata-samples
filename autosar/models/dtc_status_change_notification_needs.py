...
class DtcStatusChangeNotificationNeeds:
    ...
    to get information regarding any DTC status change.
    ...
    :ivar dtc_format_type: This attribute specifies the DTC format.
    ...
    short_name_fragments: Optional[
        "DtcStatusChangeNotificationNeeds.ShortNameFragments"
    ] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["DtcStatusChangeNotificationNeeds.Annotations"] = (
        field(
            default=None,
            metadata={
                "name": "ANNOTATIONS",
    ...
    audiences: Optional["DtcStatusChangeNotificationNeeds.Audiences"] = field(
        default=None,
        metadata={
            "name": "AUDIENCES",
            "type": "Element",
    ...
    dtc_format_type: Optional[DtcFormatTypeEnum] = field(
        default=None,
        metadata={
