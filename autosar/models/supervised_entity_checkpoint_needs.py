...
class SupervisedEntityCheckpointNeeds:
    ...
    short_name_fragments: Optional["SupervisedEntityCheckpointNeeds.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["SupervisedEntityCheckpointNeeds.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
