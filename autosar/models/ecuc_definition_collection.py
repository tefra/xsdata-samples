...
class EcucDefinitionCollection:
    ...
    :ivar short_name_pattern: This attribute represents the pattern
        ...
        etc.)
    :ivar module_refs: References to  the module definitions of
    ...
    short_name_fragments: Optional["EcucDefinitionCollection.ShortNameFragments"] = field(
        default=None,
        metadata={
    ...
    annotations: Optional["EcucDefinitionCollection.Annotations"] = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: Optional["EcucDefinitionCollection.BlueprintPolicys"] = field(
        default=None,
        metadata={
    ...
    module_refs: Optional["EcucDefinitionCollection.ModuleRefs"] = field(
        default=None,
        metadata={
            "name": "MODULE-REFS",
            "type": "Element",
    ...
    @dataclass
    class ModuleRefs:
        module_ref: List["EcucDefinitionCollection.ModuleRefs.ModuleRef"] = field(
            default_factory=list,
            metadata={
                "name": "MODULE-REF",
                "type": "Element",
