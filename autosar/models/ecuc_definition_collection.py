...
class EcucDefinitionCollection:
    ...
    annotations: None | EcucDefinitionCollection.Annotations = field(
        default=None,
        metadata={
            "name": "ANNOTATIONS",
            "type": "Element",
    ...
    blueprint_policys: None | EcucDefinitionCollection.BlueprintPolicys = (
        field(
            default=None,
            metadata={
    ...
    module_refs: None | EcucDefinitionCollection.ModuleRefs = field(
        default=None,
        metadata={
            "name": "MODULE-REFS",
            "type": "Element",
