...
class ManagedCause(Cause):
    ...
    creator, i.e. one which is represented by another situation record
    ...
    managed_cause: None | SituationRecordVersionedReference = field(
        default=None,
        metadata={
            "name": "managedCause",
            "type": "Element",
    ...
    managed_cause_extension: None | ExtensionType = field(
        default=None,
        metadata={
