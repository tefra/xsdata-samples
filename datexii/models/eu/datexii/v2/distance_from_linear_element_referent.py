...
class DistanceFromLinearElementReferent(DistanceAlongLinearElement):
    ...
    referent" on the linear element, in the sense relative to the linear
    element definition rather than the direction of traffic flow or
    optionally towards a "towards referent".
    ...
    distance_from_linear_element_referent_extension: None | ExtensionType = (
        field(
            default=None,
            metadata={
