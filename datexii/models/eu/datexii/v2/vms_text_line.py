...
class VmsTextLine:
    ...
    vms_text_line_colour: None | ColourEnum = field(
        default=None,
        metadata={
    ...
    vms_text_line_flashing: None | bool = field(
        default=None,
        metadata={
    ...
    vms_text_line_html: None | str = field(
        default=None,
        metadata={
    ...
    vms_text_line_extension: None | ExtensionType = field(
        default=None,
        metadata={
