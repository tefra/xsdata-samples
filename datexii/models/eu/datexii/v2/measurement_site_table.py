...
class MeasurementSiteTable:
    ...
    Each location is known as a "measurement site" which can be a point, a
    linear road section or an area.
    ...
    measurement_site_table_identification: None | str = field(
        default=None,
        metadata={
    ...
    measurement_site_table_extension: None | ExtensionType = field(
        default=None,
        metadata={
