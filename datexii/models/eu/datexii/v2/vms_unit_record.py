...
class VmsUnitRecord:
    ...
    vms_unit_identifier: None | str = field(
        default=None,
        metadata={
    ...
    vms_unit_ipaddress: None | str = field(
        default=None,
        metadata={
    ...
    vms_unit_electronic_address: None | str = field(
        default=None,
        metadata={
    ...
    vms_unit_record_extension: None | ExtensionType = field(
        default=None,
        metadata={
