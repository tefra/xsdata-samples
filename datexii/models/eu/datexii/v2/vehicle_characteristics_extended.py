...
class VehicleCharacteristicsExtended:
    ...
    operation_free_of_emission: None | bool = field(
        default=None,
        metadata={
    ...
    load_type2: None | LoadType2Enum = field(
        default=None,
        metadata={
            "name": "loadType2",
            "type": "Element",
    ...
    vehicle_type2: None | VehicleType2Enum = field(
        default=None,
        metadata={
            "name": "vehicleType2",
            "type": "Element",
    ...
    fuel_type2: None | FuelType2Enum = field(
        default=None,
        metadata={
            "name": "fuelType2",
            "type": "Element",
    ...
    vehicle_usage2: None | VehicleUsage2Enum = field(
        default=None,
        metadata={
            "name": "vehicleUsage2",
            "type": "Element",
