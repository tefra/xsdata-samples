...
from netex.models.entities_in_version_rel_structure import EntitiesInVersionRelStructure
from netex.models.entities_in_version_rel_structure import EntityEntity
        ...
        choice=[
            GeneralFrame(
                ...
                members=GeneralFrameMembersRelStructure(
                    choice=[
                        EntityEntity(
                            name_of_class_attribute='ScheduledStopPoint',
                            id='mybus:SSP0001A',
                            versions=EntitiesInVersionRelStructure(
                                choice=[
                                    ScheduledStopPoint(
                                        id='mybus:SSP0001A',
                        ...
                        EntityEntity(
                            name_of_class_attribute='ServiceLink',
                            id='mybu:SL_AtoB01',
                            versions=EntitiesInVersionRelStructure(
                                choice=[
                                    ServiceLink(
                        ...
                        EntityEntity(
                            name_of_class_attribute='ServicePattern',
                            id='mybus:SP_001',
                            versions=EntitiesInVersionRelStructure(
                                choice=[
                                    ServicePattern(
