...
class EntitiesInVersionRelStructure(ContainmentAggregationStructure):
    ...
    choice: Iterable[
        VehicleTypeZoneRestriction | MediumApplicationInstance | CustomerPaymentMeans | ResidentialQualificationEligibility | CommercialProfileEligibility | UserProfileEligibility | ResidentialQualification | AccessRightInProduct | FareStructureElementInSequence | StartTimeAtStopPoint | ControllableElementInSequence | FareElementInSequence | Cell | CustomerPurchasePackagePrice | ParkingPrice | SalesOfferPackagePrice | FulfilmentMethodPrice | CappingRulePrice | FareProductPrice | FareStructureElementPrice | TimeIntervalPrice | TimeUnitPrice | QualityStructureFactorPrice | ControllableElementPrice | ValidableElementPrice | UsageParameterPrice | DistanceMatrixElementPrice | GeographicalIntervalPrice | GeographicalUnitPrice | SeriesConstraintPrice | DefaultDeadRunRunTime | DefaultServiceJourneyRunTime | TimeDemandProfileMember | JourneyPartPosition | EstimatedPassingTime | ObservedPassingTime | TargetPassingTime | DatedPassingTime | TimetabledPassingTime | PassingTime | InterchangeRuleTiming | ParkingCapacity | ParkingProperties | VehicleTypePreference | VehiclePositionAlignment | VehicleQuayAlignment | FlexiblePointProperties | FlexibleLinkProperties | JourneyPatternHeadway | JourneyPatternLayover | JourneyPatternRunTime | JourneyPatternWaitTime | TurnaroundTimeLimitTime | VehicleJourneyLayover | VehicleJourneyRunTime | VehicleJourneyWaitTime | VehicleJourneyHeadway | JourneyHeadway | JourneyLayover | JourneyRunTime | JourneyWaitTime | MediumAccessDeviceSecurityListing | TravelDocumentSecurityListing | RetailDeviceSecurityListing | FareContractSecurityListing | CustomerSecurityListing | CustomerAccountSecurityListing | VehicleEquipmentProfileMember | StairFlight | OnboardStay | Accommodation | ServiceLinkInJourneyPattern | PathLinkInSequence | LinkInJourneyPattern | TimingLinkInJourneyPattern | VehicleMeetingPointInPath | FarePointInPattern | StopPointInJourneyPattern | PlaceInSequence | PointInJourneyPattern | PointOnRoute | TimingPointInJourneyPattern | PointOnLineSection | PointOnSection | SectionInSequence | LinkOnSection | CodespaceAssignment | RelatedOrganisation | PointOnLink | AccessibilityAssessment | AlternativeName | GroupConstraintMember | AlternativeText | Fleet | IndividualPassengerInfo | VehiclePoolingDriverInfo | IndividualTraveller | ParkingBayCondition | RentalAvailability | Smartcard | EmvCard | MobileDevice | MediumAccessDevice | ServiceAccessCode | TravelDocument | CustomerAccount | SalesTransaction | OfferedTravelSpecification | RequestedTravelSpecification | TravelSpecification1 | TravelSpecification2 | FareContractEntry | FareContract | Customer | ParkingTariff | GroupOfSalesOfferPackages | DistributionChannel | Tariff | CustomerPurchasePackage | SalesOfferPackage | FulfilmentMethod | CappingRule | EntitlementProduct | SupplementProduct | PreassignedFareProduct | AmountOfPriceUnitProduct | CappedDiscountRight | UsageDiscountRight | ThirdPartyProduct | SaleDiscountRight | ServiceAccessRight1 | ServiceAccessRight2 | TimeInterval | FareQuotaFactor | FareDemandFactor | QualityStructureFactor | ControllableElement | ValidableElement | AdditionalDriverOption | RentalOption | RentalPenaltyPolicy | VehiclePoolerProfile | SalesOfferPackageEntitlementRequired | SalesOfferPackageEntitlementGiven | MinimumStay | Interchanging | Suspending | UsageValidityPeriod | FrequencyOfUse | StepLimit | Routing | RoundTrip | LuggageAllowance | EntitlementRequired | EntitlementGiven | EligibilityChangePolicy | CompanionProfile | GroupTicket | CommercialProfile | UserProfile | Subscribing | PenaltyPolicy | ChargingPolicy | Cancelling | Reserving | PurchaseWindow | Transferability | Replacing | Refunding | Exchanging | Reselling | GeographicalInterval | SeriesConstraint | CustomerPurchasePackageElement | ParkingChargeBand | SalesOfferPackageElement | FareStructureElement | TimeStructureFactor | TimeUnit | DistanceMatrixElement | GeographicalStructureFactor | GeographicalUnit | FareUnit | FareInterval | FareStructureFactor | PricingService | LimitingRuleInContext | LimitingRule | DiscountingRule | PricingRule | MonthValidityOffset | Rounding | PricingParameterSet | ReliefOpportunity | CourseOfJourneys | VehicleServicePart | VehicleService | TrainBlockPart | CompoundBlock | BlockPart | TrainBlock | Block | DriverTripTime | DriverTrip | DutyPart | AccountableElement | Duty | TimeDemandProfile | VehicleTypeStopAssignment | TrainComponentLabelAssignment | TrainNumber | FlexibleServiceProperties | JourneyPartCouple | CoupledJourney | JourneyPart | InterchangeRule | ServiceJourneyPatternInterchange | ServiceJourneyInterchange | DefaultInterchange | JourneyMeeting | SingleJourney | DatedSpecialService | NormalDatedVehicleJourney | DatedVehicleJourney | SpecialService | DeadRun | ServiceJourney | DatedServiceJourney | TemplateServiceJourney | TemplateVehicleJourney | VehicleJourney | PointOfInterestClassificationHierarchy | TimeDemandType | VehicleJourneyStopAssignment | FlexibleStopAssignment | NavigationPathAssignment | TrainStopAssignment | DynamicStopAssignment | PassengerStopAssignment | LogicalDisplay | LineNetwork | ModeRestrictionAssessment | RouteInstruction | TrainComponent | TrainElement | CompoundTrain | Train | CycleModelProfile | CarModelProfile | Whitelist | Blacklist | SchematicMap | PersonalModeOfOperation | AlternativeModeOfOperation | VehiclePooling | VehicleSharing | VehicleRental | FlexibleOperation | ScheduledOperation | ChargingEquipmentProfile | VehicleEquipmentProfile | VehicleModel | Vehicle | PassengerCarryingRequirementsView | FacilityRequirement | VehicleManoeuvringRequirement | PassengerCarryingRequirement | AcceptedDriverPermit | SimpleVehicleType | VehicleType | TransportType | EquipmentPosition | Level | AllowedLineDirection | DestinationDisplayVariant | DestinationDisplay | FlexibleLine | Line | DeliveryVariant | Notice | OperationalContext | OnlineService | VehicleRentalService | VehicleSharingService | ChauffeuredVehicleService | CarPoolingService | TaxiService | AssistanceBookingService | CateringService | RetailService | MoneyService | HireService | CommunicationService | MeetingPointService | LostPropertyService | LeftLuggageService | ComplaintsService | CustomerService | LuggageService | AssistanceService | TicketingService | RetailDevice | BatteryEquipment | VehicleReleaseEquipment | RefuellingEquipment | VehicleChargingEquipment | CycleStorageEquipment | SeatingEquipment | ShelterEquipment | TrolleyStandEquipment | WaitingRoomEquipment | CrossingEquipment | QueueingEquipment | EntranceEquipment | RampEquipment | LiftCallEquipment | LiftEquipment | TravelatorEquipment | StaircaseEquipment | EscalatorEquipment | PlaceLighting | RoughSurface | GeneralSign | HeadingSign | PlaceSign | SignEquipment | PassengerInformationEquipment | RubbishDisposalEquipment | PassengerBeaconEquipment | HelpPointEquipment | PassengerSafetyEquipment | SanitaryEquipment | TicketValidatorEquipment | TicketingEquipment | WheelchairVehicleEquipment | AccessVehicleEquipment | ComplexFeature | SimpleFeature | SpatialFeature | SingleJourneyPath | ServicePattern | NavigationPath | ServiceJourneyPattern | DeadRunJourneyPattern | JourneyPattern | FlexibleRoute | Route | TimingPattern | Connection | DefaultConnection | SiteConnection | Access | Contact | ControlCentre | OperatingDepartment | OrganisationalUnit | Department | OrganisationPart | RetailConsortium | ServicedOrganisation | GeneralOrganisation | ManagementAgent | TravelAgent | OtherOrganisation | OnlineServiceOperator | Authority | Operator | VehicleMeetingLink | ServiceLink | SitePathLink | PathLink | RouteLink | TimingLink | WireElement | RoadElement | RailwayElement | ActivationLink | VehicleMeetingPoint | BorderPoint | FareScheduledStopPoint | ScheduledStopPoint | PathJunction | RoutePoint | ParkingPoint | GaragePoint | ReliefPoint | TimingPoint | WireJunction | RoadJunction | RailwayJunction | TrafficControlPoint | BeaconPoint | ActivationPoint | Point2 | LineShape | TopographicProjection | ZoneProjection | ComplexFeatureProjection | LinkSequenceProjection | LinkProjection | PointProjection | CompositeFrame | MobilityJourneyFrame | MobilityServiceFrame | SalesTransactionFrame | FareFrame | DriverScheduleFrame | VehicleScheduleFrame | ServiceFrame | TimetableFrame | SiteFrame | InfrastructureFrame | GeneralFrame | ResourceFrame | ServiceCalendarFrame | UicOperatingPeriod | OperatingPeriod | OperatingDay | ServiceCalendar | VehicleSharingPlaceAssignment | VehiclePoolingPlaceAssignment | TaxiServicePlaceAssignment | VehicleServicePlaceAssignment1 | VehicleServicePlaceAssignment2 | DynamicVehicleMeetingPointAssignment | VehicleMeetingPointAssignment1 | VehicleMeetingPointAssignment2 | VehicleAccessCredentialsAssignment | DistributionAssignment | SalesOfferPackageSubstitution | CustomerPurchaseParameterAssignment | SpecificParameterAssignment | GenericParameterAssignmentInContext | GenericParameterAssignment | ValidityParameterAssignment | AccessRightParameterAssignment | JourneyAccounting | TimeDemandTypeAssignment | TransferRestriction | ServiceExclusion | DisplayAssignment | OvertakingPossibility | MeetingRestriction | RestrictedManoeuvre | VehicleTypeAtPoint | ActivationAssignment | SalesNoticeAssignment | NoticeAssignment | CheckConstraintThroughput | CheckConstraintDelay | CheckConstraint | DayTypeAssignment | GroupOfTimebands | Timeband | FareDayType | OrganisationDayType | DayType | PoolOfVehicles | GroupOfSingleJourneys | GroupOfDistributionChannels | GroupOfDistanceMatrixElements | PriceGroup | StandardFareTable | FareTableInContext | FareTable | GroupOfServices | RhythmicalJourneyGroup | HeadwayJourneyGroup | CrewBase | GroupOfTimingLinks | Network | GroupOfLines | GroupOfOperators | GroupOfPlaces | GroupOfLinkSequences | GroupOfTariffZones | MobilityServiceConstraintZone | RoutingConstraintZone | StopArea | AccessZone | VehicleMeetingPlace1 | VehiclePoolingMeetingPlace | VehicleMeetingPlace2 | HailAndRideArea | FlexibleArea | FlexibleQuay | FlexibleStopPlace | Garage | EquipmentPlace | TaxiStand | VehicleStoppingPlace | BoardingPosition | AccessSpace | Quay | PointOfInterestSpace | ParkingComponent | VehicleStoppingPosition | VehiclePoolingParkingArea | VehicleSharingParkingArea | TaxiParkingArea | ParkingArea | MonitoredVehicleSharingParkingBay | VehiclePoolingParkingBay | VehicleSharingParkingBay | ParkingBay | PointOfInterestVehicleEntrance | PointOfInterestEntrance | ParkingPassengerEntrance | ParkingEntranceForVehicles | StopPlaceVehicleEntrance | StopPlaceEntrance | Entrance | PointOfInterest | Parking | TaxiRank | StopPlace | ServiceSite | TopographicPlace | Country | AddressablePlace | PostalAddress | RoadAddress | TransportAdministrativeZone | AdministrativeZone | FareZone | TariffZone | GeneralZone | Zone | GroupOfLinks | GroupOfPoints | Layer | GeneralGroupOfEntities | ResponsibilityRole | ResponsibilitySet | ValueSet | TypeOfFleet | ParkingBayStatus | TypeOfMediumAccessDevice | TypeOfMachineReadability | TypeOfProof | TypeOfConcession | ChargingMoment | TypeOfUsageParameter | TypeOfFareTable | TypeOfPricingRule | PriceUnit | TimingAlgorithmType | PurposeOfJourneyPartition | PointOfInterestClassification | TypeOfParking | TypeOfServiceFeature | Direction | TypeOfSecurityList | TypeOfDriverPermit | PurposeOfEquipmentProfile | TypeOfProductCategory | TypeOfPaymentMethod | ClassOfUse | Submode | OpenTransportMode | TypeOfCodespaceAssignment | TypeOfValidity | PurposeOfGrouping | Branding | DataSource | TypeOfMobilityService | TypeOfRetailDevice | CustomerAccountStatus | TypeOfCustomerAccount | TypeOfFareContractEntry | TypeOfFareContract | TypeOfTravelDocument | TypeOfSalesOfferPackage | TypeOfFareProduct | TypeOfFareStructureElement | TypeOfTariff | TypeOfAccessRightAssignment | TypeOfFareStructureFactor | TypeOfFlexibleService | TypeOfTimeDemandType | TypeOfPassengerInformationEquipment | TypeOfJourneyPattern | TypeOfActivation | TypeOfModeOfOperation | TypeOfPlug | TypeOfBatteryChemistry | TypeOfLine | TypeOfDeliveryVariant | TypeOfNotice | TypeOfCongestion | TypeOfFacility | TypeOfService | TypeOfEquipment | TypeOfFeature | TypeOfLinkSequence | TypeOfPlace | TypeOfTransfer | TypeOfOperation | TypeOfOrganisationPart | TypeOfOrganisation | TypeOfZone | TypeOfLink | TypeOfPoint | TypeOfProjection | TypeOfFrame | TypeOfResponsibilityRole | TypeOfEntity | TypeOfVersion | PassingTimeView | SimpleAvailabilityCondition | ValidDuring | AvailabilityCondition | ValidityRuleParameter | ValidityTrigger | ValidityCondition | Version
    ] = field(
...
class FramesRelStructure(ContainmentAggregationStructure):
    ...
    common_frame: Iterable[
        MobilityJourneyFrame | MobilityServiceFrame | SalesTransactionFrame | FareFrame | DriverScheduleFrame | VehicleScheduleFrame | ServiceFrame | TimetableFrame | SiteFrame | InfrastructureFrame | GeneralFrame | ResourceFrame | ServiceCalendarFrame
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
...
class GeneralFrameMembersRelStructure(ContainmentAggregationStructure):
    ...
    choice: Iterable[
        GeneralFrameMember | Fleet | IndividualPassengerInfo | VehiclePoolingDriverInfo | IndividualTraveller | ParkingBayCondition | RentalAvailability | Smartcard | EmvCard | MobileDevice | MediumAccessDevice | ServiceAccessCode | TravelDocument | CustomerAccount | SalesTransaction | OfferedTravelSpecification | RequestedTravelSpecification | TravelSpecification1 | TravelSpecification2 | FareContractEntry | FareContract | Customer | ParkingTariff | GroupOfSalesOfferPackages | DistributionChannel | Tariff | CustomerPurchasePackage | SalesOfferPackage | FulfilmentMethod | CappingRule | EntitlementProduct | SupplementProduct | PreassignedFareProduct | AmountOfPriceUnitProduct | CappedDiscountRight | UsageDiscountRight | ThirdPartyProduct | SaleDiscountRight | ServiceAccessRight1 | ServiceAccessRight2 | TimeInterval | FareQuotaFactor | FareDemandFactor | QualityStructureFactor | ControllableElement | ValidableElement | AdditionalDriverOption | RentalOption | RentalPenaltyPolicy | VehiclePoolerProfile | SalesOfferPackageEntitlementRequired | SalesOfferPackageEntitlementGiven | MinimumStay | Interchanging | Suspending | UsageValidityPeriod | FrequencyOfUse | StepLimit | Routing | RoundTrip | LuggageAllowance | EntitlementRequired | EntitlementGiven | EligibilityChangePolicy | CompanionProfile | GroupTicket | CommercialProfile | UserProfile | Subscribing | PenaltyPolicy | ChargingPolicy | Cancelling | Reserving | PurchaseWindow | Transferability | Replacing | Refunding | Exchanging | Reselling | GeographicalInterval | SeriesConstraint | CustomerPurchasePackageElement | ParkingChargeBand | SalesOfferPackageElement | FareStructureElement | TimeStructureFactor | TimeUnit | DistanceMatrixElement | GeographicalStructureFactor | GeographicalUnit | FareUnit | FareInterval | FareStructureFactor | PricingService | LimitingRuleInContext | LimitingRule | DiscountingRule | PricingRule | MonthValidityOffset | Rounding | PricingParameterSet | ReliefOpportunity | CourseOfJourneys | VehicleServicePart | VehicleService | TrainBlockPart | CompoundBlock | BlockPart | TrainBlock | Block | DriverTripTime | DriverTrip | DutyPart | AccountableElement | Duty | TimeDemandProfile | VehicleTypeStopAssignment | TrainComponentLabelAssignment | TrainNumber | FlexibleServiceProperties | JourneyPartCouple | CoupledJourney | JourneyPart | InterchangeRule | ServiceJourneyPatternInterchange | ServiceJourneyInterchange | DefaultInterchange | JourneyMeeting | SingleJourney | DatedSpecialService | NormalDatedVehicleJourney | DatedVehicleJourney | SpecialService | DeadRun | ServiceJourney | DatedServiceJourney | TemplateServiceJourney | TemplateVehicleJourney | VehicleJourney | PointOfInterestClassificationHierarchy | TimeDemandType | VehicleJourneyStopAssignment | FlexibleStopAssignment | NavigationPathAssignment | TrainStopAssignment | DynamicStopAssignment | PassengerStopAssignment | LogicalDisplay | LineNetwork | ModeRestrictionAssessment | RouteInstruction | TrainComponent | TrainElement | CompoundTrain | Train | CycleModelProfile | CarModelProfile | Whitelist | Blacklist | SchematicMap | PersonalModeOfOperation | AlternativeModeOfOperation | VehiclePooling | VehicleSharing | VehicleRental | FlexibleOperation | ScheduledOperation | ChargingEquipmentProfile | VehicleEquipmentProfile | VehicleModel | Vehicle | PassengerCarryingRequirementsView | FacilityRequirement | VehicleManoeuvringRequirement | PassengerCarryingRequirement | AcceptedDriverPermit | SimpleVehicleType | VehicleType | TransportType | EquipmentPosition | Level | AllowedLineDirection | DestinationDisplayVariant | DestinationDisplay | FlexibleLine | Line | DeliveryVariant | Notice | OperationalContext | OnlineService | VehicleRentalService | VehicleSharingService | ChauffeuredVehicleService | CarPoolingService | TaxiService | AssistanceBookingService | CateringService | RetailService | MoneyService | HireService | CommunicationService | MeetingPointService | LostPropertyService | LeftLuggageService | ComplaintsService | CustomerService | LuggageService | AssistanceService | TicketingService | RetailDevice | BatteryEquipment | VehicleReleaseEquipment | RefuellingEquipment | VehicleChargingEquipment | CycleStorageEquipment | SeatingEquipment | ShelterEquipment | TrolleyStandEquipment | WaitingRoomEquipment | CrossingEquipment | QueueingEquipment | EntranceEquipment | RampEquipment | LiftCallEquipment | LiftEquipment | TravelatorEquipment | StaircaseEquipment | EscalatorEquipment | PlaceLighting | RoughSurface | GeneralSign | HeadingSign | PlaceSign | SignEquipment | PassengerInformationEquipment | RubbishDisposalEquipment | PassengerBeaconEquipment | HelpPointEquipment | PassengerSafetyEquipment | SanitaryEquipment | TicketValidatorEquipment | TicketingEquipment | WheelchairVehicleEquipment | AccessVehicleEquipment | ComplexFeature | SimpleFeature | SpatialFeature | SingleJourneyPath | ServicePattern | NavigationPath | ServiceJourneyPattern | DeadRunJourneyPattern | JourneyPattern | FlexibleRoute | Route | TimingPattern | Connection | DefaultConnection | SiteConnection | Access | Contact | ControlCentre | OperatingDepartment | OrganisationalUnit | Department | OrganisationPart | RetailConsortium | ServicedOrganisation | GeneralOrganisation | ManagementAgent | TravelAgent | OtherOrganisation | OnlineServiceOperator | Authority | Operator | VehicleMeetingLink | ServiceLink | SitePathLink | PathLink | RouteLink | TimingLink | WireElement | RoadElement | RailwayElement | ActivationLink | VehicleMeetingPoint | BorderPoint | FareScheduledStopPoint | ScheduledStopPoint | PathJunction | RoutePoint | ParkingPoint | GaragePoint | ReliefPoint | TimingPoint | WireJunction | RoadJunction | RailwayJunction | TrafficControlPoint | BeaconPoint | ActivationPoint | Point2 | LineShape | TopographicProjection | ZoneProjection | ComplexFeatureProjection | LinkSequenceProjection | LinkProjection | PointProjection | CompositeFrame | MobilityJourneyFrame | MobilityServiceFrame | SalesTransactionFrame | FareFrame | DriverScheduleFrame | VehicleScheduleFrame | ServiceFrame | TimetableFrame | SiteFrame | InfrastructureFrame | GeneralFrame | ResourceFrame | ServiceCalendarFrame | UicOperatingPeriod | OperatingPeriod | OperatingDay | ServiceCalendar | VehicleSharingPlaceAssignment | VehiclePoolingPlaceAssignment | TaxiServicePlaceAssignment | VehicleServicePlaceAssignment1 | VehicleServicePlaceAssignment2 | DynamicVehicleMeetingPointAssignment | VehicleMeetingPointAssignment1 | VehicleMeetingPointAssignment2 | VehicleAccessCredentialsAssignment | DistributionAssignment | SalesOfferPackageSubstitution | CustomerPurchaseParameterAssignment | SpecificParameterAssignment | GenericParameterAssignmentInContext | GenericParameterAssignment | ValidityParameterAssignment | AccessRightParameterAssignment | JourneyAccounting | TimeDemandTypeAssignment | TransferRestriction | ServiceExclusion | DisplayAssignment | OvertakingPossibility | MeetingRestriction | RestrictedManoeuvre | VehicleTypeAtPoint | ActivationAssignment | SalesNoticeAssignment | NoticeAssignment | CheckConstraintThroughput | CheckConstraintDelay | CheckConstraint | DayTypeAssignment | GroupOfTimebands | Timeband | FareDayType | OrganisationDayType | DayType | PoolOfVehicles | GroupOfSingleJourneys | GroupOfDistributionChannels | GroupOfDistanceMatrixElements | PriceGroup | StandardFareTable | FareTableInContext | FareTable | GroupOfServices | RhythmicalJourneyGroup | HeadwayJourneyGroup | CrewBase | GroupOfTimingLinks | Network | GroupOfLines | GroupOfOperators | GroupOfPlaces | GroupOfLinkSequences | GroupOfTariffZones | MobilityServiceConstraintZone | RoutingConstraintZone | StopArea | AccessZone | VehicleMeetingPlace1 | VehiclePoolingMeetingPlace | VehicleMeetingPlace2 | HailAndRideArea | FlexibleArea | FlexibleQuay | FlexibleStopPlace | Garage | EquipmentPlace | TaxiStand | VehicleStoppingPlace | BoardingPosition | AccessSpace | Quay | PointOfInterestSpace | ParkingComponent | VehicleStoppingPosition | VehiclePoolingParkingArea | VehicleSharingParkingArea | TaxiParkingArea | ParkingArea | MonitoredVehicleSharingParkingBay | VehiclePoolingParkingBay | VehicleSharingParkingBay | ParkingBay | PointOfInterestVehicleEntrance | PointOfInterestEntrance | ParkingPassengerEntrance | ParkingEntranceForVehicles | StopPlaceVehicleEntrance | StopPlaceEntrance | Entrance | PointOfInterest | Parking | TaxiRank | StopPlace | ServiceSite | TopographicPlace | Country | AddressablePlace | PostalAddress | RoadAddress | TransportAdministrativeZone | AdministrativeZone | FareZone | TariffZone | GeneralZone | Zone | GroupOfLinks | GroupOfPoints | Layer | GeneralGroupOfEntities | ResponsibilityRole | ResponsibilitySet | ValueSet | TypeOfFleet | ParkingBayStatus | TypeOfMediumAccessDevice | TypeOfMachineReadability | TypeOfProof | TypeOfConcession | ChargingMoment | TypeOfUsageParameter | TypeOfFareTable | TypeOfPricingRule | PriceUnit | TimingAlgorithmType | PurposeOfJourneyPartition | PointOfInterestClassification | TypeOfParking | TypeOfServiceFeature | Direction | TypeOfSecurityList | TypeOfDriverPermit | PurposeOfEquipmentProfile | TypeOfProductCategory | TypeOfPaymentMethod | ClassOfUse | Submode | OpenTransportMode | TypeOfCodespaceAssignment | TypeOfValidity | PurposeOfGrouping | Branding | DataSource | TypeOfMobilityService | TypeOfRetailDevice | CustomerAccountStatus | TypeOfCustomerAccount | TypeOfFareContractEntry | TypeOfFareContract | TypeOfTravelDocument | TypeOfSalesOfferPackage | TypeOfFareProduct | TypeOfFareStructureElement | TypeOfTariff | TypeOfAccessRightAssignment | TypeOfFareStructureFactor | TypeOfFlexibleService | TypeOfTimeDemandType | TypeOfPassengerInformationEquipment | TypeOfJourneyPattern | TypeOfActivation | TypeOfModeOfOperation | TypeOfPlug | TypeOfBatteryChemistry | TypeOfLine | TypeOfDeliveryVariant | TypeOfNotice | TypeOfCongestion | TypeOfFacility | TypeOfService | TypeOfEquipment | TypeOfFeature | TypeOfLinkSequence | TypeOfPlace | TypeOfTransfer | TypeOfOperation | TypeOfOrganisationPart | TypeOfOrganisation | TypeOfZone | TypeOfLink | TypeOfPoint | TypeOfProjection | TypeOfFrame | TypeOfResponsibilityRole | TypeOfEntity | TypeOfVersion | PassingTimeView | SimpleAvailabilityCondition | ValidDuring | AvailabilityCondition | ValidityRuleParameter | ValidityTrigger | ValidityCondition | Version | EntityEntity
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
