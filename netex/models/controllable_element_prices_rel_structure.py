...
class ControllableElementPricesRelStructure(StrictContainmentAggregationStructure):
    ...
    controllable_element_price_ref_or_cell_ref_or_controllable_element_price: List[Union[CellRef, ControllableElementPriceRef, ControllableElementPrice]] = field(
