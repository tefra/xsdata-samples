...
class GroupOfEntitiesInFrameRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[GroupOfDistributionChannels, GroupOfDistanceMatrixElements, PriceGroup, StandardFareTable, FareTableInContext, FareTable, GroupOfServices, RhythmicalJourneyGroup, HeadwayJourneyGroup, Network, GroupOfLines, CrewBase, GroupOfTimingLinks, GroupOfOperators, GroupOfPlaces, GroupOfLinkSequences, RoutingConstraintZone, StopArea, AccessZone, HailAndRideArea, FlexibleArea, FlexibleQuay, FlexibleStopPlace, VehicleStoppingPlace, BoardingPosition, AccessSpace, Quay, PointOfInterestSpace, ParkingBay, ParkingArea, ParkingComponent, VehicleStoppingPosition, PointOfInterestVehicleEntrance, PointOfInterestEntrance, ParkingPassengerEntrance, ParkingEntranceForVehicles, StopPlaceVehicleEntrance, StopPlaceEntrance, Entrance, PointOfInterest, Parking, StopPlace, ServiceSite, Garage, TopographicPlace, EquipmentPlace, Country, AddressablePlace, PostalAddress, RoadAddress, TransportAdministrativeZone, AdministrativeZone, FareZone, TariffZone, GeneralZone, Zone, GroupOfLinks, GroupOfPoints, Layer, GeneralGroupOfEntities]] = field(
