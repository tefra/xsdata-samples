...
class EntityInVersionInFrameRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[LevelRef, ServiceJourneyPatternInterchangeRef, OperatingDayRef, PathLinkRef, ValidityConditionRef, PurposeOfJourneyPartitionRef, SchematicMapRef, SalesOfferPackageRef, GroupOfStopPlacesRef, DirectionRef, RailwayPointRef, ResponsibilityRoleRef, WirePointRef, AccessRef, ServicePatternRef, SiteFacilitySetRef, TransportAdministrativeZoneRef, PointOfInterestClassificationRef, ThirdPartyProductRef, JourneyPatternLayoverRef, AllTransportOrganisationsRef, GroupOfTimingLinksRef, DistanceMatrixElementInverseRef, InterchangeRuleTimingRef, DiscountingRuleRef, DeadRunJourneyPatternRef, TypeOfFareContractEntryRef, PostalAddressRef, ParkingAreaRef, RhythmicalJourneyGroupRef, SalesOfferPackageEntitlementGivenRef, ModalLinkRefByValue, MonthValidityOffsetRef, NetworkRef, TypeOfJourneyPatternRef, ControllableElementPriceRef, TimeUnitRef, TypeOfCodespaceAssignmentRef, CustomerEligibilityRef, JourneyPartRef, JourneyFrequencyGroupRef, AllOperatorsRef, TimingLinkRef, EntitlementRequiredRef, TypeOfRetailDeviceRef, EstimatedPassingTimeRef, OrganisationalUnitRef, SalesTransactionFrameRef, VersionOfObjectRef, FlexibleQuayRef, BlockPartRef, LogicalDisplayRef, TypeOfOrganisationPartRef, ParkingCapacityRef, SalesOfferPackagePriceRef, TrainRef, RouteLinkRef, WireLinkRef, PassengerSeatRef, TypeOfPointRef, TimeIntervalRef, TravelDocumentRef, ServiceSiteRef, ServiceFacilitySetRef, ControllableElementRef, EntitlementProductRef, StepLimitRef, TypeOfSalesOfferPackageRef, TypeOfServiceFeatureRef, OpenTransportModeRef, ReliefOpportunityRef, TimingPatternRef, AllowedLineDirectionRef, GroupOfTimebandsRef, JourneyMeetingRef, TurnaroundTimeLimitTimeRef, UsageDiscountRightRef, PassingTimeRef, AccommodationRef, ScheduledStopPointRef, TypeOfFareProductRef, VersionRef, PriceUnitRef, TypeOfOperationRef, PricingRuleRef, ValidityTriggerRef, PurposeOfGroupingRef, FareStructureElementRef, DriverTripTimeRef, FareRequestRef, GarageRef, StopPlaceSpaceRef, FareTableColumnRef, ParkingPointRef, TransferabilityRef, DriverTripRef, DeliveryVariantRef, VehicleEquipmentProfileRef, FacilitySetRef, JourneyPatternRef, TypeOfFeatureRef, JourneyPatternWaitTimeRef, CustomerRef, DutyPartRef, ParkingBayRef, TypeOfTravelDocumentRef, CoupledJourneyRef, VehicleJourneyRef, ServiceCalendarFrameRef, CustomerPurchasePackagePriceRef, GroupOfOperatorsRef, VehicleStoppingPositionRef, FarePriceRef, ServiceLinkRefByValue, OfferedTravelSpecificationRef, ChargingMomentRef, ReplacingRef, LineNetworkRef, TypeOfResponsibilityRoleRef, AddressablePlaceRef, PathLinkRefByValue, PreassignedFareProductRef, TypeOfEquipmentRef, ClassOfUseRef, LinkRefByValue, ResidentialQualificationEligibilityRef, AmountOfPriceUnitProductRef, TimeDemandProfileRef, ZoneProjectionRef, ConnectionRef, SiteFrameRef, EligibilityChangePolicyRef, VehicleModelRef, CustomerAccountSecurityListingRef, ParkingChargeBandRef, ParkingRef, UserProfileRef, ActivationLinkRef, OperatingDepartmentRef, VehicleRef, GeographicalIntervalPriceRef, DefaultConnectionRef, TimingPointRef, TypeOfLinkSequenceRef, PlaceRef, DestinationDisplayVariantRef, PassengerCapacityRef, TrainBlockRef, LinkSequenceRef, PointOfInterestVehicleEntranceRef, PurchaseWindowRef, FareFrameRef, TimebandRef, AllAuthoritiesRef, TypeOfPassengerInformationEquipmentRef, TypeOfNoticeRef, StopPlaceEntranceRef, AlternativeNameRef, SalesOfferPackageEntitlementRequiredRef, TypeOfTariffRef, TargetPassingTimeRef, FareTableRef, RoutingRef, TrainInCompoundTrainRef, FareProductPriceRef, AuthorityRef, ParkingPriceRef, DriverRef, TrainComponentRef, InterchangeRuleRef, TypeOfMachineReadabilityRef, ControlCentreRef, LineLinkRefByValue, UserProfileEligibilityRef, FareQuotaFactorRef, TypeOfValidityRef, EntitlementGivenRef, TopographicPlaceRef, CustomerAccountRef, OtherOrganisationRef, TravelDocumentSecurityListingRef, CrewBaseRef, TypeOfServiceRef, TypeOfFrameRef, TypeOfFareContractRef, TariffRef, TariffZoneRef, FlexibleAreaRef, CompoundBlockRef, AccessZoneRef, TypeOfAccessRightAssignmentRef, SchematicMapMemberRef, PassengerCarryingRequirementRef, ServiceFrameRef, EquipmentPlaceRef, ScheduleRequestRef, TypeOfLineRef, TypeOfProductCategoryRef, AddressRef, FlexibleLinkPropertiesRef, TravelSpecificationRef, TrafficControlPointRef, FareDemandFactorRef, RoundingRef, PricingParameterSetRef, StopPlaceVehicleEntranceRef, LogEntryRef, VehicleEntranceRef, InterchangeRef, DriverScheduleFrameRef, SiteComponentRef, ServiceJourneyRef, RoadLinkRefByValue, TimingLinkRefByValue, FareSectionRef, TypeOfCustomerAccountRef, TypeOfLinkRef, SubmodeRef, GeographicalUnitPriceRef, PenaltyPolicyRef, TripPlanRequestRef, ValidityRuleParameterRef, ServiceLinkRef, FulfilmentMethodPriceRef, PointProjectionRef, PointOfInterestHierarchyRef, TypeOfUsageParameterRef, PointOfInterestRef, TemplateServiceJourneyRef, FlexiblePointPropertiesRef, TrainElementRef, TimetabledPassingTimeRef, GroupOfCustomerPurchasePackagesRef, ComplexFeatureProjectionRef, AllOrganisationsRef, DutyRef, ValidableElementPriceRef, JourneyPartCoupleRef, FareScheduledStopPointRef, SupplyContractRef, DefaultDeadRunRunTimeRef, SiteConnectionRef, ParkingTariffRef, CappingRuleRef, ManagementAgentRef, TypeOfCongestionRef, ChargingPolicyRef, StandardFareTableRef, BlacklistRef, GroupOfDistributionChannelsRef, TypeOfTransferRef, OnboardStayRef, TimeStructureFactorRef, GeographicalUnitRef, CommonSectionRef, OperatingPeriodRef, QualityStructureFactorRef, FlexibleServicePropertiesRef, OperationalContextRef, ZoneRef, GeneralSectionRef, RoadAddressRef, BeaconPointRef, SpecialServiceRef, RefundingRef, TrainNumberRef, ResourceFrameRef, TrainBlockPartRef, AccessRightInProductRef, VehiclePositionAlignmentRef, SupplementProductRef, ResidentialQualificationRef, BlockRef, RoadLinkRef, GeographicalIntervalRef, FareStructureElementInSequenceRef, SingleTripFareRequestRef, RoutePointRef, ActivationPointRef, CourseOfJourneysRef, RoutingConstraintZoneRef, StopAreaRef, FulfilmentMethodRef, DeadRunRef, CancellingRef, PricingServiceRef, GroupOfServicesRef, ServicedOrganisationRef, JourneyPatternRunTimeRef, WhitelistRef, LogRef, HailAndRideAreaRef, QuayRef, RoadPointRef, VehicleRequirementRef, TimingAlgorithmTypeRef, TypeOfActivationRef, UsageValidityPeriodRef, RoundingStepRef, SalesOfferPackageElementRef, TopographicProjectionRef, MinimumStayRef, RetailConsortiumRef, RepeatedTripFareRequestRef, PointRef, AccountableElementRef, AdministrativeZoneRef, ReliefPointRef, VehicleQuayAlignmentRef, DataSourceRef, CommercialProfileRef, LayerRef, CompanionProfileRef, ResellingRef, ResponsibilitySetRef, CellRef, EquipmentPositionRef, FlexibleLineRef, StopPlaceRef, GeneralOrganisationRef, FareZoneRef, DepartmentRef, SeriesConstraintPriceRef, ExchangingRef, TimeDemandTypeRef, FareContractEntryRef, RouteRef, CustomerPurchasePackageRef, TypeOfProjectionRef, ProfileParameterRef, FareContractRef, BoardingPositionRef, ValidableElementRef, LineRef, StopFinderRequestRef, ObservedPassingTimeRef, CompoundTrainRef, DatedVehicleJourneyRef, RailwayLinkRefByValue, TypeOfPaymentMethodRef, ServiceAccessRightRef, VehicleTypeRef, JourneyPatternHeadwayRef, QualityStructureFactorPriceRef, LineLinkRef, DistanceMatrixElementRef, TypeOfPlaceRef, GaragePointRef, DestinationDisplayRef, PointOfInterestEntranceRef, ParkingPropertiesRef, TypeOfFareTableRef, SubscribingRef, SuspendingRef, TypeOfConcessionRef, AllDistributionChannelsRef, TypeOfFareStructureElementRef, ControllableElementInSequenceRef, OrganisationPartRef, LineSectionRef, BorderPointRef, RequestedTravelSpecificationRef, ParkingPassengerEntranceRef, GeographicalStructureFactorRef, DistributionChannelRef, FareDayTypeRef, FareStructureElementPriceRef, CustomerPurchasePackageElementRef, SalesTransactionRef, FrequencyOfUseRef, TypeOfDeliveryVariantRef, ReservingRef, GroupOfLinesRef, SaleDiscountRightRef, TypeOfFareStructureFactorRef, WireLinkRefByValue, TimeUnitPriceRef, TypeOfFacilityRef, ServiceCalendarRef, LinkSequenceProjectionRef, CompositeFrameRef, OperatorRef, GeneralFrameRef, LuggageAllowanceRef, FareTableRowRef, ServiceJourneyInterchangeRef, SectionRef, DatedSpecialServiceRef, ParkingEntranceRef, ParentCommonSectionRef, FareContractSecurityListingRef, FareProductRef, ParentSectionRef, JourneyTimingRef, AccessSpaceRef, AlternativeTextRef, SiteRef, TypeOfOrganisationRef, CappedDiscountRightRef, TariffObjectRef, LimitingRuleRef, RailwayLinkRef, DayTypeRef, TimeIntervalPriceRef, VehicleTypePreferenceRef, ModeRef, PriceableObjectRef, FlexibleStopPlaceRef, CustomerSecurityListingRef, TravelAgentRef, LinkProjectionRef, HeadwayJourneyGroupRef, AvailabilityConditionRef, ActivationLinkRefByValue, CommercialProfileEligibilityRef, RetailDeviceSecurityListingRef, BrandingRef, GroupOfDistanceMatrixElementsRef, GroupOfPlacesRef, InfrastructureFrameRef, NavigationPathRef, EntranceRef, TypeOfFlexibleServiceRef, DefaultInterchangeRef, UsageParameterPriceRef, VehicleServicePartRef, TypeOfZoneRef, CappingRulePriceRef, FacilityRequirementRef, RoundTripRef, PurposeOfEquipmentProfileRef, PathJunctionRef, TypeOfPricingRuleRef, GeneralGroupOfEntitiesRef, TimetableFrameRef, GroupTicketRef, PriceGroupRef, RouteLinkRefByValue, ParkingEntranceForVehiclesRef, InterchangingRef, SeriesConstraintRef, VehicleScheduleFrameRef, CustomerAccountStatusRef, NoticeRef, PointOfInterestSpaceRef, RouteInstructionRef, StartTimeAtStopPointRef, GroupOfSalesOfferPackagesRef, OrganisationRef, StopEventRequestRef, ServiceJourneyPatternRef, TypeOfTimeDemandTypeRef, FacilityRef, VehicleServiceRef, VehicleStoppingPlaceRef, TypeOfSecurityListRef, DistanceMatrixElementPriceRef, VehicleManoeuvringRequirementRef, DefaultServiceJourneyTimeRef, SiteElementRef]] = field(
