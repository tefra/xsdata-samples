...
class ObjectFilterByValueStructure:
    ...
    class ObjectReferences:
        choice: List[Union[LevelRef, ServiceJourneyPatternInterchangeRef, OperatingDayRef, PathLinkRef, ValidityConditionRef, PurposeOfJourneyPartitionRef, SchematicMapRef, SalesOfferPackageRef, GroupOfStopPlacesRef, DirectionRef, RailwayPointRef, ResponsibilityRoleRef, WirePointRef, AccessRef, ServicePatternRef, SiteFacilitySetRef, TransportAdministrativeZoneRef, PointOfInterestClassificationRef, ThirdPartyProductRef, JourneyPatternLayoverRef, AllTransportOrganisationsRef, GroupOfTimingLinksRef, DistanceMatrixElementInverseRef, InterchangeRuleTimingRef, DiscountingRuleRef, DeadRunJourneyPatternRef, TypeOfFareContractEntryRef, PostalAddressRef, ParkingAreaRef, RhythmicalJourneyGroupRef, SalesOfferPackageEntitlementGivenRef, MonthValidityOffsetRef, NetworkRef, TypeOfJourneyPatternRef, ControllableElementPriceRef, TimeUnitRef, TypeOfCodespaceAssignmentRef, CustomerEligibilityRef, JourneyPartRef, JourneyFrequencyGroupRef, AllOperatorsRef, TimingLinkRef, EntitlementRequiredRef, TypeOfRetailDeviceRef, EstimatedPassingTimeRef, OrganisationalUnitRef, SalesTransactionFrameRef, VersionOfObjectRef, FlexibleQuayRef, BlockPartRef, LogicalDisplayRef, TypeOfOrganisationPartRef, PassengerStopAssignmentRef, ParkingCapacityRef, SalesOfferPackagePriceRef, TrainRef, RouteLinkRef, WireLinkRef, PassengerSeatRef, TypeOfPointRef, TimeIntervalRef, TravelDocumentRef, ActivationAssignmentRef, ServiceSiteRef, ServiceFacilitySetRef, ControllableElementRef, EntitlementProductRef, StepLimitRef, TypeOfSalesOfferPackageRef, TypeOfServiceFeatureRef, OpenTransportModeRef, ReliefOpportunityRef, TimingPatternRef, AllowedLineDirectionRef, GroupOfTimebandsRef, JourneyMeetingRef, VehicleTypeAtPointRef, TurnaroundTimeLimitTimeRef, UsageDiscountRightRef, PassingTimeRef, AccommodationRef, ScheduledStopPointRef, TypeOfFareProductRef, VersionRef, PriceUnitRef, TypeOfOperationRef, DynamicStopAssignmentRef, PricingRuleRef, ValidityTriggerRef, PurposeOfGroupingRef, FareStructureElementRef, DriverTripTimeRef, JourneyAccountingRef, FareRequestRef, GarageRef, StopPlaceSpaceRef, FareTableColumnRef, ParkingPointRef, TransferabilityRef, DriverTripRef, DeliveryVariantRef, VehicleEquipmentProfileRef, FacilitySetRef, JourneyPatternRef, TypeOfFeatureRef, JourneyPatternWaitTimeRef, CustomerRef, DutyPartRef, ParkingBayRef, TypeOfTravelDocumentRef, CoupledJourneyRef, VehicleJourneyRef, ServiceCalendarFrameRef, CustomerPurchasePackagePriceRef, GroupOfOperatorsRef, VehicleStoppingPositionRef, FarePriceRef, OfferedTravelSpecificationRef, ChargingMomentRef, ReplacingRef, LineNetworkRef, TypeOfResponsibilityRoleRef, AddressablePlaceRef, PreassignedFareProductRef, TypeOfEquipmentRef, ClassOfUseRef, StopAssignmentRef, ResidentialQualificationEligibilityRef, AmountOfPriceUnitProductRef, TimeDemandProfileRef, ZoneProjectionRef, ConnectionRef, SiteFrameRef, EligibilityChangePolicyRef, VehicleModelRef, CustomerAccountSecurityListingRef, ParkingChargeBandRef, ParkingRef, UserProfileRef, ActivationLinkRef, OperatingDepartmentRef, VehicleRef, GeographicalIntervalPriceRef, DefaultConnectionRef, TimingPointRef, DistributionAssignmentRef, TypeOfLinkSequenceRef, PlaceRef, DestinationDisplayVariantRef, PassengerCapacityRef, TrainBlockRef, TrainComponentLabelAssignmentRef, LinkSequenceRef, PointOfInterestVehicleEntranceRef, PurchaseWindowRef, FareFrameRef, TimebandRef, AllAuthoritiesRef, TypeOfPassengerInformationEquipmentRef, TypeOfNoticeRef, StopPlaceEntranceRef, AlternativeNameRef, SalesOfferPackageEntitlementRequiredRef, TypeOfTariffRef, TargetPassingTimeRef, FareTableRef, RoutingRef, TrainStopAssignmentRef, TrainInCompoundTrainRef, FareProductPriceRef, AuthorityRef, VehicleTypeStopAssignmentRef, ParkingPriceRef, DriverRef, TrainComponentRef, InterchangeRuleRef, TypeOfMachineReadabilityRef, ControlCentreRef, UserProfileEligibilityRef, FareQuotaFactorRef, TypeOfValidityRef, EntitlementGivenRef, TopographicPlaceRef, SalesOfferPackageSubstitutionRef, CustomerAccountRef, OtherOrganisationRef, TravelDocumentSecurityListingRef, PathAssignmentRef, CrewBaseRef, TypeOfServiceRef, TypeOfFrameRef, TypeOfFareContractRef, TariffRef, TariffZoneRef, FlexibleAreaRef, CompoundBlockRef, AccessZoneRef, TypeOfAccessRightAssignmentRef, SchematicMapMemberRef, PassengerCarryingRequirementRef, ServiceFrameRef, EquipmentPlaceRef, ScheduleRequestRef, DayTypeAssignmentRef, TypeOfLineRef, TypeOfProductCategoryRef, AddressRef, FlexibleLinkPropertiesRef, TravelSpecificationRef, TrafficControlPointRef, FareDemandFactorRef, InfrastructureLinkRestrictionRef, RoundingRef, PricingParameterSetRef, FlexibleServiceAssignmentRef, StopPlaceVehicleEntranceRef, LogEntryRef, VehicleEntranceRef, InterchangeRef, AssignmentRef, DriverScheduleFrameRef, SiteComponentRef, ServiceJourneyRef, FareSectionRef, TypeOfCustomerAccountRef, TypeOfLinkRef, SubmodeRef, GeographicalUnitPriceRef, PenaltyPolicyRef, TripPlanRequestRef, ValidityRuleParameterRef, ServiceLinkRef, FulfilmentMethodPriceRef, PointProjectionRef, PointOfInterestHierarchyRef, TypeOfUsageParameterRef, PointOfInterestRef, TemplateServiceJourneyRef, FlexiblePointPropertiesRef, TrainElementRef, TimetabledPassingTimeRef, GroupOfCustomerPurchasePackagesRef, ComplexFeatureProjectionRef, AllOrganisationsRef, CheckConstraintDelayRef, DutyRef, ValidableElementPriceRef, JourneyPartCoupleRef, FareScheduledStopPointRef, SupplyContractRef, DefaultDeadRunRunTimeRef, SiteConnectionRef, ParkingTariffRef, CappingRuleRef, ManagementAgentRef, TypeOfCongestionRef, ChargingPolicyRef, StandardFareTableRef, BlacklistRef, GroupOfDistributionChannelsRef, TypeOfTransferRef, OnboardStayRef, TimeStructureFactorRef, GeographicalUnitRef, CommonSectionRef, OperatingPeriodRef, QualityStructureFactorRef, FlexibleServicePropertiesRef, OperationalContextRef, ZoneRef, GeneralSectionRef, RoadAddressRef, BeaconPointRef, SpecialServiceRef, RefundingRef, TrainNumberRef, ResourceFrameRef, TrainBlockPartRef, AccessRightInProductRef, VehiclePositionAlignmentRef, SupplementProductRef, ResidentialQualificationRef, BlockRef, RoadLinkRef, GeographicalIntervalRef, FareStructureElementInSequenceRef, NetworkRestrictionRef, SingleTripFareRequestRef, RoutePointRef, ActivationPointRef, DisplayAssignmentRef, CourseOfJourneysRef, RoutingConstraintZoneRef, StopAreaRef, FulfilmentMethodRef, DeadRunRef, CancellingRef, PricingServiceRef, GroupOfServicesRef, ServicedOrganisationRef, JourneyPatternRunTimeRef, WhitelistRef, LogRef, HailAndRideAreaRef, QuayRef, RoadPointRef, VehicleRequirementRef, TimingAlgorithmTypeRef, TypeOfActivationRef, UsageValidityPeriodRef, RoundingStepRef, SalesOfferPackageElementRef, TopographicProjectionRef, MinimumStayRef, RetailConsortiumRef, RepeatedTripFareRequestRef, PointRef, AccountableElementRef, AdministrativeZoneRef, ReliefPointRef, VehicleQuayAlignmentRef, DataSourceRef, CommercialProfileRef, LayerRef, TransferRestrictionRef, CompanionProfileRef, ResellingRef, ResponsibilitySetRef, CellRef, EquipmentPositionRef, FlexibleLineRef, StopPlaceRef, GeneralOrganisationRef, FareZoneRef, DepartmentRef, SeriesConstraintPriceRef, ExchangingRef, TimeDemandTypeRef, FareContractEntryRef, RouteRef, CustomerPurchasePackageRef, CheckConstraintThroughputRef, TypeOfProjectionRef, ProfileParameterRef, FareContractRef, BoardingPositionRef, ValidableElementRef, LineRef, StopFinderRequestRef, ObservedPassingTimeRef, CompoundTrainRef, DatedVehicleJourneyRef, TypeOfPaymentMethodRef, ServiceAccessRightRef, VehicleTypeRef, JourneyPatternHeadwayRef, QualityStructureFactorPriceRef, LineLinkRef, DistanceMatrixElementRef, VehicleJourneyStopAssignmentRef, TypeOfPlaceRef, GaragePointRef, DestinationDisplayRef, PointOfInterestEntranceRef, ParkingPropertiesRef, TypeOfFareTableRef, SubscribingRef, SuspendingRef, TypeOfConcessionRef, AllDistributionChannelsRef, TypeOfFareStructureElementRef, ControllableElementInSequenceRef, OrganisationPartRef, LineSectionRef, BorderPointRef, RequestedTravelSpecificationRef, ParkingPassengerEntranceRef, GeographicalStructureFactorRef, DistributionChannelRef, FareDayTypeRef, FareStructureElementPriceRef, RestrictedManoeuvreRef, CustomerPurchasePackageElementRef, SalesTransactionRef, CheckConstraintRef, FrequencyOfUseRef, ClassInFrameRef, TypeOfDeliveryVariantRef, ReservingRef, GroupOfLinesRef, SaleDiscountRightRef, TypeOfFareStructureFactorRef, MeetingRestrictionRef, TimeUnitPriceRef, TypeOfFacilityRef, ServiceCalendarRef, LinkSequenceProjectionRef, CompositeFrameRef, OperatorRef, GeneralFrameRef, LuggageAllowanceRef, FareTableRowRef, ServiceJourneyInterchangeRef, SectionRef, DatedSpecialServiceRef, ParkingEntranceRef, ParentCommonSectionRef, FareContractSecurityListingRef, FareProductRef, ParentSectionRef, JourneyTimingRef, ServiceExclusionRef, AccessSpaceRef, AlternativeTextRef, SiteRef, TypeOfOrganisationRef, CappedDiscountRightRef, TariffObjectRef, LimitingRuleRef, RailwayLinkRef, DayTypeRef, TimeIntervalPriceRef, VehicleTypePreferenceRef, ModeRef, PriceableObjectRef, FlexibleStopPlaceRef, CustomerSecurityListingRef, OvertakingPossibilityRef, TravelAgentRef, LinkProjectionRef, HeadwayJourneyGroupRef, AvailabilityConditionRef, CommercialProfileEligibilityRef, RetailDeviceSecurityListingRef, BrandingRef, GroupOfDistanceMatrixElementsRef, GroupOfPlacesRef, InfrastructureFrameRef, NavigationPathRef, EntranceRef, TypeOfFlexibleServiceRef, DefaultInterchangeRef, UsageParameterPriceRef, VehicleServicePartRef, TypeOfZoneRef, CappingRulePriceRef, FacilityRequirementRef, RoundTripRef, PurposeOfEquipmentProfileRef, PathJunctionRef, TypeOfPricingRuleRef, GeneralGroupOfEntitiesRef, TimetableFrameRef, GroupTicketRef, PriceGroupRef, ParkingEntranceForVehiclesRef, InterchangingRef, SeriesConstraintRef, VehicleScheduleFrameRef, CustomerAccountStatusRef, NoticeRef, PointOfInterestSpaceRef, RouteInstructionRef, StartTimeAtStopPointRef, GroupOfSalesOfferPackagesRef, OrganisationRef, StopEventRequestRef, TimeDemandTypeAssigmentRef, ServiceJourneyPatternRef, TypeOfTimeDemandTypeRef, FacilityRef, VehicleServiceRef, VehicleStoppingPlaceRef, TypeOfSecurityListRef, DistanceMatrixElementPriceRef, VehicleManoeuvringRequirementRef, DefaultServiceJourneyTimeRef, SiteElementRef]] = field(
