...
class ObjectFilterByValueStructure:
    ...
    class ObjectReferences:
        choice: List[Union[TravelDocumentRef, RepeatedTripFareRequestRef, SingleTripFareRequestRef, FareRequestRef, StopFinderRequestRef, StopEventRequestRef, ScheduleRequestRef, TripPlanRequestRef, ResidentialQualificationEligibilityRef, CommercialProfileEligibilityRef, UserProfileEligibilityRef, CustomerEligibilityRef, CustomerAccountRef, FareContractRef, CustomerRef, StartTimeAtStopPointRef, ResidentialQualificationRef, TypeOfConcessionRef, TypeOfUsageParameterRef, TariffObjectRef, ParkingTariffRef, TariffRef, TypeOfFareTableRef, FareTableRowRef, FareTableColumnRef, TimeUnitRef, GeographicalUnitRef, ControllableElementInSequenceRef, FareStructureElementInSequenceRef, AccessRightInProductRef, CellRef, CustomerPurchasePackagePriceRef, ParkingPriceRef, TimeIntervalPriceRef, TimeUnitPriceRef, QualityStructureFactorPriceRef, ControllableElementPriceRef, ValidableElementPriceRef, GeographicalIntervalPriceRef, GeographicalUnitPriceRef, UsageParameterPriceRef, SalesOfferPackagePriceRef, DistanceMatrixElementPriceRef, FareStructureElementPriceRef, FulfilmentMethodPriceRef, SeriesConstraintPriceRef, CappingRulePriceRef, FareProductPriceRef, FarePriceRef, CustomerPurchasePackageElementRef, CustomerPurchasePackageRef, ControllableElementRef, ValidableElementRef, SalesOfferPackageEntitlementGivenRef, SalesOfferPackageEntitlementRequiredRef, MinimumStayRef, InterchangingRef, FrequencyOfUseRef, SuspendingRef, UsageValidityPeriodRef, StepLimitRef, RoutingRef, RoundTripRef, LuggageAllowanceRef, EntitlementGivenRef, EntitlementRequiredRef, EligibilityChangePolicyRef, GroupTicketRef, CommercialProfileRef, CompanionProfileRef, UserProfileRef, ProfileParameterRef, SubscribingRef, PenaltyPolicyRef, ChargingPolicyRef, TransferabilityRef, ReplacingRef, RefundingRef, ExchangingRef, ResellingRef, CancellingRef, ReservingRef, PurchaseWindowRef, SalesOfferPackageElementRef, SalesOfferPackageRef, DistanceMatrixElementInverseRef, DistanceMatrixElementRef, FareStructureElementRef, FulfilmentMethodRef, SeriesConstraintRef, CappingRuleRef, EntitlementProductRef, SupplementProductRef, PreassignedFareProductRef, AmountOfPriceUnitProductRef, UsageDiscountRightRef, ThirdPartyProductRef, CappedDiscountRightRef, SaleDiscountRightRef, FareProductRef, ServiceAccessRightRef, TimeIntervalRef, GeographicalIntervalRef, ParkingChargeBandRef, TimeStructureFactorRef, FareQuotaFactorRef, FareDemandFactorRef, QualityStructureFactorRef, GeographicalStructureFactorRef, PriceableObjectRef, MonthValidityOffsetRef, LimitingRuleRef, DiscountingRuleRef, PricingRuleRef, PricingServiceRef, RoundingStepRef, RoundingRef, PricingParameterSetRef, SupplyContractRef, FlexibleServicePropertiesRef, DriverTripTimeRef, DriverTripRef, DutyPartRef, AccountableElementRef, DutyRef, ReliefOpportunityRef, CourseOfJourneysRef, DriverRef, VehicleServicePartRef, VehicleServiceRef, CompoundBlockRef, TrainBlockPartRef, BlockPartRef, TrainBlockRef, BlockRef, JourneyPartCoupleRef, CoupledJourneyRef, JourneyPartRef, TimetabledPassingTimeRef, EstimatedPassingTimeRef, ObservedPassingTimeRef, TargetPassingTimeRef, PassingTimeRef, InterchangeRuleTimingRef, InterchangeRuleRef, ServiceJourneyPatternInterchangeRef, ServiceJourneyInterchangeRef, DefaultInterchangeRef, InterchangeRef, JourneyMeetingRef, TrainNumberRef, RoutingConstraintZoneRef, VehiclePositionAlignmentRef, VehicleQuayAlignmentRef, LogicalDisplayRef, ParkingAreaRef, ParkingPropertiesRef, ParkingCapacityRef, LineNetworkRef, RouteInstructionRef, LevelRef, FlexiblePointPropertiesRef, FlexibleLinkPropertiesRef, TimeDemandProfileRef, TimeDemandTypeRef, VehicleTypePreferenceRef, JourneyPatternHeadwayRef, JourneyPatternLayoverRef, JourneyPatternRunTimeRef, JourneyPatternWaitTimeRef, DefaultServiceJourneyTimeRef, DefaultDeadRunRunTimeRef, TurnaroundTimeLimitTimeRef, JourneyTimingRef, CrewBaseRef, PassengerSeatRef, OperatingDepartmentRef, OperationalContextRef, TrainComponentRef, TrainElementRef, TrainInCompoundTrainRef, TravelDocumentSecurityListingRef, RetailDeviceSecurityListingRef, CustomerAccountSecurityListingRef, FareContractSecurityListingRef, CustomerSecurityListingRef, WhitelistRef, BlacklistRef, SchematicMapMemberRef, SchematicMapRef, DeliveryVariantRef, NoticeRef, VehicleEquipmentProfileRef, VehicleModelRef, VehicleRef, PassengerCapacityRef, FacilityRequirementRef, VehicleManoeuvringRequirementRef, PassengerCarryingRequirementRef, VehicleRequirementRef, CompoundTrainRef, TrainRef, VehicleTypeRef, OnboardStayRef, AccommodationRef, ServiceFacilitySetRef, SiteFacilitySetRef, FacilitySetRef, FacilityRef, ModeRef, SubmodeRef, OpenTransportModeRef, TopographicProjectionRef, ComplexFeatureProjectionRef, LinkSequenceProjectionRef, ZoneProjectionRef, LinkProjectionRef, PointProjectionRef, DatedVehicleJourneyRef, DatedSpecialServiceRef, SpecialServiceRef, TemplateServiceJourneyRef, ServiceJourneyRef, DeadRunRef, VehicleJourneyRef, NavigationPathRef, ServiceJourneyPatternRef, ServicePatternRef, DeadRunJourneyPatternRef, JourneyPatternRef, TimingPatternRef, RouteRef, LinkSequenceRef, SalesTransactionRef, OfferedTravelSpecificationRef, RequestedTravelSpecificationRef, TravelSpecificationRef, FareContractEntryRef, LogEntryRef, AlternativeNameRef, TimebandRef, FareDayTypeRef, DayTypeRef, DefaultConnectionRef, SiteConnectionRef, ConnectionRef, AccessRef, HailAndRideAreaRef, FlexibleAreaRef, FlexibleQuayRef, FlexibleStopPlaceRef, PathJunctionRef, TopographicPlaceRef, EquipmentPlaceRef, EquipmentPositionRef, VehicleStoppingPositionRef, VehicleStoppingPlaceRef, BoardingPositionRef, AccessSpaceRef, QuayRef, StopPlaceSpaceRef, ParkingBayRef, PointOfInterestSpaceRef, StopPlaceVehicleEntranceRef, StopPlaceEntranceRef, ParkingEntranceForVehiclesRef, ParkingPassengerEntranceRef, ParkingEntranceRef, PointOfInterestVehicleEntranceRef, PointOfInterestEntranceRef, VehicleEntranceRef, EntranceRef, SiteComponentRef, StopPlaceRef, ParkingRef, PointOfInterestRef, ServiceSiteRef, SiteRef, SiteElementRef, GarageRef, AddressablePlaceRef, PostalAddressRef, RoadAddressRef, AddressRef, ServiceLinkRef, LineLinkRef, PathLinkRef, TimingLinkRef, RouteLinkRef, WireLinkRef, RoadLinkRef, RailwayLinkRef, ActivationLinkRef, BorderPointRef, FareScheduledStopPointRef, ScheduledStopPointRef, GaragePointRef, ParkingPointRef, ReliefPointRef, TimingPointRef, RoutePointRef, WirePointRef, RoadPointRef, RailwayPointRef, TrafficControlPointRef, BeaconPointRef, ActivationPointRef, PointRef, OperatingPeriodRef, OperatingDayRef, ServiceCalendarRef, AlternativeTextRef, AvailabilityConditionRef, ValidityRuleParameterRef, ValidityTriggerRef, ValidityConditionRef, ResponsibilityRoleRef, ControlCentreRef, OrganisationalUnitRef, DepartmentRef, OrganisationPartRef, AllAuthoritiesRef, AllOperatorsRef, AllTransportOrganisationsRef, AllOrganisationsRef, RetailConsortiumRef, AuthorityRef, OperatorRef, GeneralOrganisationRef, ManagementAgentRef, ServicedOrganisationRef, TravelAgentRef, OtherOrganisationRef, OrganisationRef, ResponsibilitySetRef, DestinationDisplayVariantRef, DestinationDisplayRef, AllowedLineDirectionRef, FlexibleLineRef, LineRef, GroupOfCustomerPurchasePackagesRef, GroupOfSalesOfferPackagesRef, GroupOfDistanceMatrixElementsRef, GroupOfDistributionChannelsRef, StandardFareTableRef, FareTableRef, PriceGroupRef, RhythmicalJourneyGroupRef, HeadwayJourneyGroupRef, JourneyFrequencyGroupRef, GroupOfServicesRef, GroupOfStopPlacesRef, PointOfInterestHierarchyRef, GroupOfTimingLinksRef, GroupOfOperatorsRef, GroupOfPlacesRef, ParentSectionRef, ParentCommonSectionRef, CommonSectionRef, LineSectionRef, FareSectionRef, GeneralSectionRef, SectionRef, LogRef, GroupOfTimebandsRef, PlaceRef, StopAreaRef, AccessZoneRef, TransportAdministrativeZoneRef, AdministrativeZoneRef, FareZoneRef, TariffZoneRef, ZoneRef, LayerRef, NetworkRef, GroupOfLinesRef, GeneralGroupOfEntitiesRef, SalesTransactionFrameRef, FareFrameRef, ServiceFrameRef, DriverScheduleFrameRef, VehicleScheduleFrameRef, TimetableFrameRef, SiteFrameRef, InfrastructureFrameRef, GeneralFrameRef, ResourceFrameRef, ServiceCalendarFrameRef, CompositeFrameRef, DistributionChannelRef, ChargingMomentRef, PriceUnitRef, PurposeOfJourneyPartitionRef, TimingAlgorithmTypeRef, PointOfInterestClassificationRef, DirectionRef, TypeOfActivationRef, PurposeOfEquipmentProfileRef, TypeOfProductCategoryRef, TypeOfPaymentMethodRef, ClassOfUseRef, TypeOfOperationRef, TypeOfCodespaceAssignmentRef, BrandingRef, TypeOfResponsibilityRoleRef, PurposeOfGroupingRef, TypeOfRetailDeviceRef, CustomerAccountStatusRef, TypeOfCustomerAccountRef, TypeOfFareContractEntryRef, TypeOfFareContractRef, TypeOfAccessRightAssignmentRef, TypeOfSalesOfferPackageRef, TypeOfFareStructureElementRef, TypeOfTariffRef, AllDistributionChannelsRef, TypeOfMachineReadabilityRef, TypeOfTravelDocumentRef, TypeOfFareProductRef, TypeOfFareStructureFactorRef, TypeOfPricingRuleRef, TypeOfFlexibleServiceRef, TypeOfPassengerInformationEquipmentRef, TypeOfServiceFeatureRef, TypeOfCongestionRef, TypeOfTimeDemandTypeRef, TypeOfJourneyPatternRef, TypeOfSecurityListRef, TypeOfDeliveryVariantRef, TypeOfNoticeRef, TypeOfServiceRef, TypeOfFacilityRef, TypeOfEquipmentRef, TypeOfProjectionRef, TypeOfFeatureRef, TypeOfLinkSequenceRef, TypeOfOrganisationPartRef, TypeOfOrganisationRef, TypeOfPlaceRef, TypeOfTransferRef, TypeOfZoneRef, TypeOfLinkRef, TypeOfPointRef, TypeOfLineRef, TypeOfValidityRef, TypeOfFrameRef, DataSourceRef, VersionRef, VersionOfObjectRef, DistributionAssignmentRef, SalesOfferPackageSubstitutionRef, JourneyAccountingRef, TrainComponentLabelAssignmentRef, TransferRestrictionRef, ServiceExclusionRef, FlexibleServiceAssignmentRef, VehicleTypeStopAssignmentRef, PathAssignmentRef, TrainStopAssignmentRef, VehicleJourneyStopAssignmentRef, DynamicStopAssignmentRef, PassengerStopAssignmentRef, StopAssignmentRef, DisplayAssignmentRef, CheckConstraintThroughputRef, CheckConstraintDelayRef, CheckConstraintRef, TimeDemandTypeAssigmentRef, OvertakingPossibilityRef, MeetingRestrictionRef, RestrictedManoeuvreRef, InfrastructureLinkRestrictionRef, VehicleTypeAtPointRef, NetworkRestrictionRef, ActivationAssignmentRef, DayTypeAssignmentRef, AssignmentRef, ClassInFrameRef]] = field(
