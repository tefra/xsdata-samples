...
class ObjectFilterByValueStructure:
    ...
    object_references: ObjectFilterByValueStructure.ObjectReferences | None = field(
        default=None,
        metadata={
    ...
    class ObjectReferences:
        choice: Iterable[
            TripLegRef | IndividualPassengerInfoRef | VehiclePoolingDriverInfoRef | IndividualTravellerRef | ServiceAccessCodeRef | TravelDocumentRef | RepeatedTripFareRequestRef | SingleTripFareRequestRef | FareRequestRef | StopFinderRequestRef | StopEventRequestRef | ScheduleRequestRef | TripPlanRequestRef | CustomerPaymentMeansRef | MediumApplicationInstanceRef | MobileDeviceRef | EmvCardRef | SmartcardRef | ResidentialQualificationEligibilityRef | CommercialProfileEligibilityRef | UserProfileEligibilityRef | CustomerAccountRef | FareContractRef | CustomerRef | VehicleTypeZoneRestrictionRef | StartTimeAtStopPointRef | ResidentialQualificationRef | TypeOfConcessionRef | TypeOfUsageParameterRef | TariffObjectRef | ParkingTariffRef | TariffRef | TypeOfFareTableRef | FareTableRowRef | FareTableColumnRef | TimeUnitRef | GeographicalUnitRef | ControllableElementInSequenceRef | FareStructureElementInSequenceRef | AccessRightInProductRef | CellRef | CustomerPurchasePackagePriceRef | ParkingPriceRef | TimeIntervalPriceRef | TimeUnitPriceRef | QualityStructureFactorPriceRef | ControllableElementPriceRef | ValidableElementPriceRef | GeographicalIntervalPriceRef | GeographicalUnitPriceRef | UsageParameterPriceRef | SeriesConstraintPriceRef | SalesOfferPackagePriceRef | DistanceMatrixElementPriceRef | FareStructureElementPriceRef | FulfilmentMethodPriceRef | CappingRulePriceRef | FareProductPriceRef | FarePriceRef | CustomerPurchasePackageElementRef | CustomerPurchasePackageRef | ControllableElementRef | ValidableElementRef | AdditionalDriverOptionRef | RentalOptionRef | RentalPenaltyPolicyRef | SalesOfferPackageEntitlementGivenRef | SalesOfferPackageEntitlementRequiredRef | MinimumStayRef | InterchangingRef | FrequencyOfUseRef | SuspendingRef | UsageValidityPeriodRef | StepLimitRef | RoutingRef | RoundTripRef | LuggageAllowanceRef | EntitlementGivenRef | EntitlementRequiredRef | EligibilityChangePolicyRef | GroupTicketRef | CommercialProfileRef | VehiclePoolerProfileRef | CompanionProfileRef | UserProfileRef | ProfileParameterRef | SubscribingRef | PenaltyPolicyRef | ChargingPolicyRef | TransferabilityRef | ReplacingRef | RefundingRef | ExchangingRef | ResellingRef | CancellingRef | ReservingRef | BookingPolicyRef | PurchaseWindowRef | SeriesConstraintRef | SalesOfferPackageElementRef | SalesOfferPackageRef | DistanceMatrixElementInverseRef | DistanceMatrixElementRef | FareStructureElementRef | FulfilmentMethodRef | CappingRuleRef | EntitlementProductRef | SupplementProductRef | PreassignedFareProductRef | AmountOfPriceUnitProductRef | UsageDiscountRightRef | ThirdPartyProductRef | CappedDiscountRightRef | SaleDiscountRightRef | FareProductRef | ServiceAccessRightRef | TimeIntervalRef | GeographicalIntervalRef | ParkingChargeBandRef | TimeStructureFactorRef | FareQuotaFactorRef | FareDemandFactorRef | QualityStructureFactorRef | GeographicalStructureFactorRef | PriceableObjectRef | MonthValidityOffsetRef | LimitingRuleRef | DiscountingRuleRef | PricingRuleRef | PricingServiceRef | RoundingStepRef | RoundingRef | PricingParameterSetRef | FlexibleServicePropertiesRef | DriverTripTimeRef | DriverTripRef | DutyPartRef | AccountableElementRef | DutyRef | ReliefOpportunityRef | CourseOfJourneysRef | DriverRef | VehicleServicePartRef | VehicleServiceRef | CompoundBlockRef | TrainBlockPartRef | BlockPartRef | TrainBlockRef | BlockRef | JourneyPartCoupleRef | CoupledJourneyRef | JourneyPartRef | TimetabledPassingTimeRef | EstimatedPassingTimeRef | ObservedPassingTimeRef | TargetPassingTimeRef | PassingTimeRef | InterchangeRuleTimingRef | InterchangeRuleRef | ServiceJourneyPatternInterchangeRef | ServiceJourneyInterchangeRef | DefaultInterchangeRef | InterchangeRef | JourneyMeetingRef | SupplyContractRef | TrainNumberRef | RoutingConstraintZoneRef | VehiclePositionAlignmentRef | VehicleQuayAlignmentRef | LogicalDisplayRef | ParkingPropertiesRef | ParkingCapacityRef | LineNetworkRef | RouteInstructionRef | FlexiblePointPropertiesRef | FlexibleLinkPropertiesRef | TimeDemandProfileRef | TimeDemandTypeRef | VehicleTypePreferenceRef | JourneyPatternHeadwayRef | JourneyPatternLayoverRef | JourneyPatternRunTimeRef | JourneyPatternWaitTimeRef | DefaultServiceJourneyTimeRef | DefaultDeadRunRunTimeRef | TurnaroundTimeLimitTimeRef | JourneyTimingRef | CrewBaseRef | TrainComponentRef | TrainElementRef | TrainInCompoundTrainRef | PassengerSeatRef | TravelDocumentSecurityListingRef | MediumAccessDeviceSecurityListingRef | RetailDeviceSecurityListingRef | CustomerAccountSecurityListingRef | FareContractSecurityListingRef | CustomerSecurityListingRef | WhitelistRef | BlacklistRef | SchematicMapMemberRef | SchematicMapRef | CycleModelProfileRef | CarModelProfileRef | ModeRestrictionAssessmentRef | DeliveryVariantRef | NoticeRef | VehicleProfileRef | VehicleEquipmentProfileMemberRef | ChargingEquipmentProfileRef | VehicleEquipmentProfileRef | VehicleModelRef | VehicleRef | PassengerCapacityRef | FacilityRequirementRef | VehicleManoeuvringRequirementRef | PassengerCarryingRequirementRef | VehicleRequirementRef | SimpleVehicleTypeRef | CompoundTrainRef | TrainRef | VehicleTypeRef | TransportTypeRef | OnboardStayRef | AccommodationRef | ServiceFacilitySetRef | SiteFacilitySetRef | FacilitySetRef | FacilityRef | OperatingDepartmentRef | OperationalContextRef | LevelRef | ModeRef | SubmodeRef | OpenTransportModeRef | TopographicProjectionRef | ComplexFeatureProjectionRef | LinkSequenceProjectionRef | ZoneProjectionRef | LinkProjectionRef | PointProjectionRef | TripRef | TripPatternTripRef | SingleJourneyPathRef | SingleJourneyRef | DatedVehicleJourneyRef | DatedSpecialServiceRef | SpecialServiceRef | TemplateServiceJourneyRef | ServiceJourneyRef | DeadRunRef | VehicleJourneyRef | ServiceJourneyPatternRef | ServicePatternRef | DeadRunJourneyPatternRef | JourneyPatternRef | TimingPatternRef | NavigationPathRef | RouteRef | LinkSequenceRef | ContactRef | SalesTransactionRef | OfferedTravelSpecificationRef | RequestedTravelSpecificationRef | TravelSpecificationRef | FareContractEntryRef | LogEntryRef | AlternativeNameRef | TimebandRef | FareDayTypeRef | DayTypeRef | DefaultConnectionRef | SiteConnectionRef | ConnectionRef | AccessRef | HailAndRideAreaRef | FlexibleAreaRef | FlexibleQuayRef | FlexibleStopPlaceRef | PathJunctionRef | EquipmentPlaceRef | EquipmentPositionRef | TopographicPlaceRef | VehiclePoolingMeetingPlaceRef | VehicleMeetingPlaceRef | GarageRef | VehicleStoppingPositionRef | VehicleStoppingPlaceRef | BoardingPositionRef | AccessSpaceRef | TaxiStandRef | QuayRef | StopPlaceSpaceRef | VehiclePoolingParkingBayRef | MonitoredVehicleSharingParkingBayRef | VehicleSharingParkingBayRef | ParkingBayRef | VehiclePoolingParkingAreaRef | VehicleSharingParkingAreaRef | TaxiParkingAreaRef | ParkingAreaRef | PointOfInterestSpaceRef | StopPlaceVehicleEntranceRef | StopPlaceEntranceRef | ParkingEntranceForVehiclesRef | ParkingPassengerEntranceRef | ParkingEntranceRef | PointOfInterestVehicleEntranceRef | PointOfInterestEntranceRef | VehicleEntranceRef | EntranceRef | SiteComponentRef | TaxiRankRef | StopPlaceRef | ParkingRef | PointOfInterestRef | ServiceSiteRef | SiteRef | SiteElementRef | AddressablePlaceRef | PostalAddressRef | RoadAddressRef | AddressRef | OnwardVehicleMeetingLinkRef | VehicleMeetingLinkRef | ServiceLinkRef | LineLinkRef | TimingLinkRef | WireLinkRef | RoadLinkRef | RailwayLinkRef | ActivationLinkRef | PathLinkRef | RouteLinkRef | VehicleMeetingPointRef | WirePointRef | RoadPointRef | RailwayPointRef | TrafficControlPointRef | BeaconPointRef | ActivationPointRef | BorderPointRef | FareScheduledStopPointRef | ScheduledStopPointRef | GaragePointRef | ParkingPointRef | ReliefPointRef | TimingPointRef | RoutePointRef | PointRef | UicOperatingPeriodRef | OperatingPeriodRef | OperatingDayRef | ServiceCalendarRef | AlternativeTextRef | AvailabilityConditionRef | ValidityRuleParameterRef | ValidityTriggerRef | ValidityConditionRef | ResponsibilityRoleRef | ControlCentreRef | OrganisationalUnitRef | DepartmentRef | OrganisationPartRef | AllAuthoritiesRef | AllOperatorsRef | AllPublicTransportOrganisationsRef | AllTransportOrganisationsRef | AllOrganisationsRef | RetailConsortiumRef | OnlineServiceOperatorRef | GeneralOrganisationRef | ManagementAgentRef | ServicedOrganisationRef | TravelAgentRef | OtherOrganisationRef | AuthorityRef | OperatorRef | OrganisationRef | ResponsibilitySetRef | DestinationDisplayVariantRef | DestinationDisplayRef | AllowedLineDirectionRef | FlexibleLineRef | LineRef | GroupOfCustomerPurchasePackagesRef | PoolOfVehiclesRef | GroupOfSalesOfferPackagesRef | GroupOfDistanceMatrixElementsRef | GroupOfDistributionChannelsRef | GroupOfSingleJourneysRef | StandardFareTableRef | FareTableRef | PriceGroupRef | RhythmicalJourneyGroupRef | HeadwayJourneyGroupRef | JourneyFrequencyGroupRef | GroupOfServicesRef | GroupOfStopPlacesRef | PointOfInterestHierarchyRef | GroupOfTimingLinksRef | FleetRef | GroupOfOperatorsRef | GroupOfPlacesRef | ParentSectionRef | ParentCommonSectionRef | CommonSectionRef | LineSectionRef | FareSectionRef | GeneralSectionRef | SectionRef | GroupOfTariffZonesRef | LogRef | GroupOfTimebandsRef | PlaceRef | MobilityServiceConstraintZoneRef | StopAreaRef | TransportAdministrativeZoneRef | AccessZoneRef | AdministrativeZoneRef | FareZoneRef | TariffZoneRef | ZoneRef | LayerRef | NetworkRef | GroupOfLinesRef | GeneralGroupOfEntitiesRef | MobilityJourneyFrameRef | MobilityServiceFrameRef | SalesTransactionFrameRef | FareFrameRef | ServiceFrameRef | DriverScheduleFrameRef | VehicleScheduleFrameRef | TimetableFrameRef | SiteFrameRef | InfrastructureFrameRef | GeneralFrameRef | ResourceFrameRef | ServiceCalendarFrameRef | CompositeFrameRef | ParkingBayConditionRef | RentalAvailabilityRef | ParkingBayStatusRef | TypeOfMediumAccessDeviceRef | TypeOfProofRef | DistributionChannelRef | ChargingMomentRef | PriceUnitRef | PurposeOfJourneyPartitionRef | TimingAlgorithmTypeRef | TypeOfParkingRef | PointOfInterestClassificationRef | TypeOfActivationRef | TypeOfFleetRef | DirectionRef | TypeOfDriverPermitRef | AcceptedDriverPermitRef | PurposeOfEquipmentProfileRef | TypeOfProductCategoryRef | TypeOfPaymentMethodRef | ClassOfUseRef | TypeOfOperationRef | TypeOfCodespaceAssignmentRef | BrandingRef | TypeOfResponsibilityRoleRef | PurposeOfGroupingRef | TypeOfRetailDeviceRef | CustomerAccountStatusRef | TypeOfCustomerAccountRef | TypeOfFareContractEntryRef | TypeOfFareContractRef | TypeOfAccessRightAssignmentRef | TypeOfSalesOfferPackageRef | TypeOfFareStructureElementRef | TypeOfTariffRef | AllDistributionChannelsRef | TypeOfMachineReadabilityRef | TypeOfTravelDocumentRef | TypeOfMobilityServiceRef | TypeOfFareProductRef | TypeOfFareStructureFactorRef | TypeOfPricingRuleRef | TypeOfFlexibleServiceRef | TypeOfPassengerInformationEquipmentRef | TypeOfTimeDemandTypeRef | TypeOfJourneyPatternRef | TypeOfSecurityListRef | TypeOfPlugRef | TypeOfBatteryChemistryRef | TypeOfServiceFeatureRef | TypeOfDeliveryVariantRef | TypeOfNoticeRef | TypeOfCongestionRef | TypeOfServiceRef | TypeOfFacilityRef | TypeOfModeOfOperationRef | PersonalModeOfOperationRef | VehiclePoolingRef | VehicleSharingRef | VehicleRentalRef | FlexibleModeOfOperationRef | ScheduledModeOfOperationRef | TypeOfEquipmentRef | TypeOfProjectionRef | TypeOfFeatureRef | TypeOfLinkSequenceRef | TypeOfOrganisationPartRef | TypeOfOrganisationRef | TypeOfPlaceRef | TypeOfTransferRef | TypeOfZoneRef | TypeOfLinkRef | TypeOfPointRef | TypeOfLineRef | TypeOfValidityRef | TypeOfFrameRef | DataSourceRef | VersionRef | VersionOfObjectRef | VehiclePoolingPlaceAssignmentRef | VehicleSharingPlaceAssignmentRef | TaxiServicePlaceAssignmentRef | VehicleServicePlaceAssignmentRef | DynamicVehicleMeetingPointAssignmentRef | VehicleMeetingPointAssignmentRef | VehicleAccessCredentialsAssignmentRef | DistributionAssignmentRef | SalesOfferPackageSubstitutionRef | JourneyAccountingRef | TrainComponentLabelAssignmentRef | TransferRestrictionRef | ServiceExclusionRef | FlexibleServiceAssignmentRef | VehicleTypeStopAssignmentRef | PathAssignmentRef | TrainStopAssignmentRef | VehicleJourneyStopAssignmentRef | DynamicStopAssignmentRef | PassengerStopAssignmentRef | StopAssignmentRef | DisplayAssignmentRef | TimeDemandTypeAssignmentRef | OvertakingPossibilityRef | MeetingRestrictionRef | RestrictedManoeuvreRef | InfrastructureLinkRestrictionRef | VehicleTypeAtPointRef | NetworkRestrictionRef | ActivationAssignmentRef | CheckConstraintThroughputRef | CheckConstraintDelayRef | CheckConstraintRef | DayTypeAssignmentRef | AssignmentRef | ClassInFrameRef
        ] = field(
