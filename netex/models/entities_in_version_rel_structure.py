...
class EntitiesInVersionRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[DriverScheduleFrame, LuggageAllowance, StopArea, AssistanceService, ScheduledStopPoint, CustomerService, RetailDeviceSecurityListing, TrafficControlPoint, GroupTicket, CrewBase, Zone, StartTimeAtStopPoint, FareInterval, DeliveryVariant, RoutingConstraintZone, UsageValidityPeriod, SiteConnection, JourneyPartCouple, FareContractEntry, HeadingSign, DutyPart, AmountOfPriceUnitProduct, QueueingEquipment, Layer, HeadwayJourneyGroup, CustomerPurchasePackagePrice, SanitaryEquipment, LimitingRuleInContext, JourneyWaitTime, FareProductPrice, RhythmicalJourneyGroup, TypeOfEntity, GeographicalStructureFactor, RequestedTravelSpecification, GeneralOrganisation, TransportAdministrativeZone, Accommodation, ControlCentre, NoticeAssignment, GeneralGroupOfEntities, GroupOfTimebands, TravelSpecification2, RoundTrip, OperatingPeriod, DefaultDeadRunRunTime, ReliefOpportunity, DatedServiceJourney, Rounding, MonthValidityOffset, RailwayJunction, TrolleyStandEquipment, MinimumStay, LineNetwork, QualityStructureFactorPrice, LeftLuggageService, TimeDemandType, SeriesConstraint, SalesTransaction, PriceGroup, TypeOfDeliveryVariant, UicOperatingPeriod, DistributionChannel, DriverTrip, TimeDemandTypeAssignment, TypeOfOperation, JourneyPatternLayover, ValidityRuleParameter, JourneyPattern, FlexibleRoute, TypeOfRetailDevice, GroupOfDistanceMatrixElements, TrainComponent, FlexiblePointProperties, EntranceEquipment, TypeOfZone, Block, LogicalDisplay, SpecialService, RetailService, FareUnit, LimitingRule, TravelDocumentSecurityListing, Line, VehicleServicePart, EscalatorEquipment, TypeOfPassengerInformationEquipment, DatedPassingTime, SpecificParameterAssignment, UsageDiscountRight, VehicleJourneyStopAssignment, PriceUnit, FareScheduledStopPoint, DeadRunJourneyPattern, PricingService, Notice, AlternativeName, StaircaseEquipment, ParkingArea, ServiceJourney, ReliefPoint, Exchanging, Country, RestrictedManoeuvre, TimingPattern, CheckConstraintThroughput, DatedVehicleJourney, GeographicalUnitPrice, WireElement, DefaultServiceJourneyRunTime, FlexibleStopPlace, Operator, TrainElement, PassengerStopAssignment, SeriesConstraintPrice, TimeStructureFactor, Level, FlexibleQuay, TargetPassingTime, CourseOfJourneys, ClassOfUse, FareContract, CustomerPurchasePackageElement, TypeOfCodespaceAssignment, StopPlace, TypeOfFeature, RoadAddress, AlternativeText, PointOnLink, DistributionAssignment, AddressablePlace, EquipmentPlace, "GeneralFrame", TypeOfFlexibleService, NavigationPathAssignment, EntitlementProduct, PointOfInterestVehicleEntrance, ZoneProjection, RoadElement, FareDemandFactor, TicketingEquipment, TypeOfVersion, CycleStorageEquipment, VehicleJourneyRunTime, ValidableElement, ServiceCalendarFrame, TimeUnit, CommercialProfileEligibility, GroupOfDistributionChannels, MeetingRestriction, Cell, TypeOfServiceFeature, SignEquipment, TypeOfOrganisation, GeographicalUnit, ServiceExclusion, TravelatorEquipment, ResidentialQualificationEligibility, VehicleModel, PostalAddress, ServiceAccessRight2, GroupConstraintMember, PlaceInSequence, Reserving, CompoundBlock, TurnaroundTimeLimitTime, VehicleJourneyLayover, SalesOfferPackageEntitlementGiven, FlexibleStopAssignment, Vehicle, PointOfInterest, Department, GeographicalIntervalPrice, ValueSet, TypeOfUsageParameter, LiftEquipment, VehicleStoppingPlace, StopPointInJourneyPattern, ParkingEntranceForVehicles, TypeOfSecurityList, CompanionProfile, TypeOfActivation, TimeIntervalPrice, GaragePoint, AccessSpace, AccessRightInProduct, VehicleTypeStopAssignment, TicketValidatorEquipment, SalesOfferPackageSubstitution, Network, ParkingTariff, Reselling, VehicleManoeuvringRequirement, TypeOfFareProduct, DeadRun, OperatingDay, TypeOfFareContract, Authority, Entrance, DefaultInterchange, PricingRule, GeographicalInterval, Customer, PurposeOfGrouping, Version, SalesOfferPackagePrice, TypeOfFacility, ParkingProperties, OperatingDepartment, ValidityCondition, MeetingPointService, UsageParameterPrice, JourneyPatternRunTime, VehicleTypePreference, OpenTransportMode, ValidableElementPrice, ParkingChargeBand, CustomerSecurityListing, TypeOfEquipment, TypeOfTimeDemandType, Replacing, PreassignedFareProduct, TimingPoint, ServiceCalendar, TypeOfTransfer, RampEquipment, StandardFareTable, AccountableElement, DestinationDisplayVariant, TrainStopAssignment, CustomerAccountStatus, CheckConstraint, EstimatedPassingTime, CustomerAccountSecurityListing, ValidityTrigger, ValidityParameterAssignment, VehicleJourney, SalesOfferPackage, VehicleScheduleFrame, Whitelist, ActivationLink, JourneyRunTime, SalesNoticeAssignment, Garage, PointOfInterestSpace, LostPropertyService, RoutePoint, VehicleEquipmentProfile, LinkOnSection, SectionInSequence, GroupOfLinks, DayTypeAssignment, BoardingPosition, TopographicPlace, UserProfile, DisplayAssignment, FareStructureElement, TypeOfFareStructureFactor, SiteFrame, TypeOfSalesOfferPackage, LinkInJourneyPattern, FareTableInContext, TimingLinkInJourneyPattern, RouteLink, MoneyService, CrossingEquipment, GroupOfLinkSequences, ServicedOrganisation, ParkingPrice, HireService, SimpleAvailabilityCondition, GroupOfLines, FareStructureElementPrice, TimeDemandProfile, GroupOfSalesOfferPackages, DataSource, FlexibleArea, TimingPointInJourneyPattern, ChargingPolicy, "CompositeFrame", TypeOfValidity, JourneyPatternWaitTime, EntitlementRequired, TravelDocument, DefaultConnection, RoughSurface, Routing, AccessEquipment, ChargingMoment, Direction, Suspending, PathLink, VehicleService, FacilityRequirement, ParkingBay, PassengerInformationEquipment, TypeOfTravelDocument, TicketingService, Duty, TimingLink, VehicleStoppingPosition, StepLimit, LinkProjection, NormalDatedVehicleJourney, ResidentialQualification, RouteInstruction, PointOnRoute, Tariff, ServiceLinkInJourneyPattern, InterchangeRule, TypeOfFareStructureElement, JourneyPartPosition, TrainComponentLabelAssignment, OnboardStay, AccessZone, AccessRightParameterAssignment, Access, OrganisationDayType, FareStructureElementInSequence, TimeDemandProfileMember, TypeOfPlace, CustomerEligibility, WireJunction, FlexibleServiceProperties, ActivationAssignment, GroupOfPoints, FareFrame, Train, TypeOfLine, FareContractSecurityListing, LineShape, PassengerCarryingRequirementsView, TimingAlgorithmType, TypeOfTariff, LinkSequenceProjection, AccessibilityAssessment, TimetabledPassingTime, BeaconPoint, TypeOfLinkSequence, JourneyAccounting, GroupOfServices, ShelterEquipment, CustomerAccount, ManagementAgent, TimetableFrame, PricingParameterSet, TransferRestriction, VehicleTypeAtPoint, GroupOfTimingLinks, Refunding, FrequencyOfUse, VehiclePositionAlignment, DayType, DistanceMatrixElement, StopPlaceEntrance, Blacklist, ParkingComponent, ServicePattern, SalesOfferPackageEntitlementRequired, TrainBlockPart, FareTable, DestinationDisplay, ServiceLink, FareElementInSequence, OtherOrganisation, ServiceFrame, SalesTransactionFrame, CodespaceAssignment, Connection, OvertakingPossibility, ObservedPassingTime, RetailDevice, RubbishDisposalEquipment, TypeOfJourneyPattern, PassingTime, ResponsibilitySet, EntitlementGiven, ServiceSite, TravelSpecification1, Timeband, CompoundTrain, ParkingPassengerEntrance, PointOnSection, CappedDiscountRight, ServiceJourneyInterchange, TypeOfFareTable, Quay, ValidDuring, LuggageService, CateringService, DistanceMatrixElementPrice, QualityStructureFactor, WaitingRoomEquipment, TypeOfPricingRule, CustomerPurchasePackage, PurposeOfJourneyPartition, OfferedTravelSpecification, PathLinkInSequence, FareDayType, TypeOfLink, SitePathLink, AssistanceBookingService, GenericParameterAssignmentInContext, PointInJourneyPattern, Point2, GroupOfOperators, DiscountingRule, PointOfInterestClassification, BorderPoint, OrganisationalUnit, TypeOfCongestion, TypeOfPaymentMethod, RailwayElement, FarePointInPattern, TypeOfFareContractEntry, PathJunction, BlockPart, OrganisationPart, ControllableElementInSequence, ControllableElementPrice, VehicleJourneyWaitTime, TypeOfFrame, RetailConsortium, TypeOfResponsibilityRole, FareZone, ControllableElement, TypeOfAccessRightAssignment, PassingTimeView, VehicleQuayAlignment, FareQuotaFactor, AccessVehicleEquipment, TypeOfConcession, ResourceFrame, TypeOfOrganisationPart, ParkingCapacity, TemplateServiceJourney, DynamicStopAssignment, AdministrativeZone, PointOnLineSection, TypeOfPoint, SeatingEquipment, InterchangeRuleTiming, TypeOfNotice, Submode, SalesOfferPackageElement, WheelchairVehicleEquipment, ServiceAccessRight1, CoupledJourney, PassengerSafetyEquipment, TariffZone, TypeOfProductCategory, ParkingPoint, StopPlaceVehicleEntrance, JourneyPart, NavigationPath, GenericParameterAssignment, TimeInterval, VehicleJourneyHeadway, SupplementProduct, PointOfInterestClassificationHierarchy, JourneyHeadway, PlaceLighting, EligibilityChangePolicy, PointProjection, ThirdPartyProduct, FlexibleLinkProperties, ComplaintsService, DriverTripTime, ServiceJourneyPattern, TypeOfProjection, FareStructureFactor, JourneyMeeting, TypeOfMachineReadability, JourneyLayover, Branding, PlaceSign, GeneralSign, FulfilmentMethod, JourneyPatternHeadway, TypeOfService, PurchaseWindow, ActivationPoint, CommunicationService, TrainNumber, GeneralZone, Route, Interchanging, FlexibleLine, PurposeOfEquipmentProfile, TimeUnitPrice, ServiceJourneyPatternInterchange, UserProfileEligibility, DatedSpecialService, GroupOfPlaces, AllowedLineDirection, FulfilmentMethodPrice, TopographicProjection, CappingRulePrice, CommercialProfile, PenaltyPolicy, AvailabilityCondition, HelpPointEquipment, TravelAgent, CappingRule, EquipmentPosition, OperationalContext, VehicleType, TrainBlock, SaleDiscountRight, PointOfInterestEntrance, VehicleChargingEquipment, ComplexFeatureProjection, Subscribing, HailAndRideArea, Transferability, StairFlight, TemplateVehicleJourney, CheckConstraintDelay, TypeOfCustomerAccount, Parking, InfrastructureFrame, CustomerPurchaseParameterAssignment, PassengerCarryingRequirement, Cancelling, SchematicMap, RoadJunction]] = field(
...
class GeneralFrameMembersRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[DriverScheduleFrame, LuggageAllowance, StopArea, AssistanceService, ScheduledStopPoint, CustomerService, TrafficControlPoint, GroupTicket, CrewBase, Zone, FareInterval, DeliveryVariant, RoutingConstraintZone, UsageValidityPeriod, SiteConnection, JourneyPartCouple, FareContractEntry, HeadingSign, DutyPart, AmountOfPriceUnitProduct, QueueingEquipment, Layer, HeadwayJourneyGroup, SanitaryEquipment, LimitingRuleInContext, RhythmicalJourneyGroup, TypeOfEntity, GeographicalStructureFactor, RequestedTravelSpecification, GeneralOrganisation, TransportAdministrativeZone, ControlCentre, NoticeAssignment, GeneralGroupOfEntities, GroupOfTimebands, TravelSpecification2, RoundTrip, OperatingPeriod, ReliefOpportunity, DatedServiceJourney, Rounding, EntityEntity, MonthValidityOffset, RailwayJunction, TrolleyStandEquipment, MinimumStay, LineNetwork, LeftLuggageService, TimeDemandType, SeriesConstraint, SalesTransaction, PriceGroup, TypeOfDeliveryVariant, UicOperatingPeriod, DistributionChannel, DriverTrip, TimeDemandTypeAssignment, TypeOfOperation, ValidityRuleParameter, JourneyPattern, FlexibleRoute, TypeOfRetailDevice, GroupOfDistanceMatrixElements, TrainComponent, EntranceEquipment, TypeOfZone, Block, LogicalDisplay, SpecialService, RetailService, FareUnit, LimitingRule, Line, VehicleServicePart, EscalatorEquipment, TypeOfPassengerInformationEquipment, SpecificParameterAssignment, UsageDiscountRight, VehicleJourneyStopAssignment, PriceUnit, FareScheduledStopPoint, DeadRunJourneyPattern, PricingService, Notice, StaircaseEquipment, ParkingArea, GeneralFrameMember, ServiceJourney, ReliefPoint, Exchanging, Country, RestrictedManoeuvre, TimingPattern, CheckConstraintThroughput, DatedVehicleJourney, WireElement, FlexibleStopPlace, Operator, TrainElement, PassengerStopAssignment, TimeStructureFactor, Level, FlexibleQuay, CourseOfJourneys, ClassOfUse, FareContract, CustomerPurchasePackageElement, TypeOfCodespaceAssignment, StopPlace, TypeOfFeature, RoadAddress, DistributionAssignment, AddressablePlace, EquipmentPlace, "GeneralFrame", TypeOfFlexibleService, NavigationPathAssignment, EntitlementProduct, PointOfInterestVehicleEntrance, ZoneProjection, RoadElement, FareDemandFactor, TicketingEquipment, TypeOfVersion, CycleStorageEquipment, ValidableElement, ServiceCalendarFrame, TimeUnit, GroupOfDistributionChannels, MeetingRestriction, TypeOfServiceFeature, SignEquipment, TypeOfOrganisation, GeographicalUnit, ServiceExclusion, TravelatorEquipment, VehicleModel, PostalAddress, ServiceAccessRight2, Reserving, CompoundBlock, FlexibleStopAssignment, SalesOfferPackageEntitlementGiven, Vehicle, PointOfInterest, Department, ValueSet, TypeOfUsageParameter, LiftEquipment, VehicleStoppingPlace, ParkingEntranceForVehicles, TypeOfSecurityList, CompanionProfile, TypeOfActivation, GaragePoint, AccessSpace, TicketValidatorEquipment, VehicleTypeStopAssignment, SalesOfferPackageSubstitution, Network, ParkingTariff, Reselling, VehicleManoeuvringRequirement, TypeOfFareProduct, DeadRun, OperatingDay, TypeOfFareContract, Authority, Entrance, DefaultInterchange, PricingRule, GeographicalInterval, Customer, PurposeOfGrouping, Version, TypeOfFacility, OperatingDepartment, ValidityCondition, MeetingPointService, OpenTransportMode, ParkingChargeBand, TypeOfEquipment, TypeOfTimeDemandType, Replacing, PreassignedFareProduct, TimingPoint, ServiceCalendar, TypeOfTransfer, RampEquipment, StandardFareTable, AccountableElement, DestinationDisplayVariant, TrainStopAssignment, CustomerAccountStatus, CheckConstraint, ValidityTrigger, ValidityParameterAssignment, VehicleJourney, SalesOfferPackage, VehicleScheduleFrame, Whitelist, ActivationLink, SalesNoticeAssignment, Garage, PointOfInterestSpace, LostPropertyService, RoutePoint, VehicleEquipmentProfile, GroupOfLinks, DayTypeAssignment, BoardingPosition, TopographicPlace, UserProfile, DisplayAssignment, FareStructureElement, TypeOfFareStructureFactor, SiteFrame, TypeOfSalesOfferPackage, FareTableInContext, RouteLink, MoneyService, CrossingEquipment, GroupOfLinkSequences, ServicedOrganisation, HireService, SimpleAvailabilityCondition, GroupOfLines, TimeDemandProfile, GroupOfSalesOfferPackages, DataSource, FlexibleArea, ChargingPolicy, "CompositeFrame", TypeOfValidity, EntitlementRequired, TravelDocument, DefaultConnection, RoughSurface, Routing, AccessEquipment, ChargingMoment, Direction, Suspending, PathLink, VehicleService, FacilityRequirement, ParkingBay, PassengerInformationEquipment, TypeOfTravelDocument, TicketingService, Duty, TimingLink, VehicleStoppingPosition, StepLimit, LinkProjection, NormalDatedVehicleJourney, RouteInstruction, Tariff, InterchangeRule, TypeOfFareStructureElement, TrainComponentLabelAssignment, AccessZone, AccessRightParameterAssignment, Access, OrganisationDayType, TypeOfPlace, WireJunction, FlexibleServiceProperties, ActivationAssignment, GroupOfPoints, FareFrame, Train, TypeOfLine, LineShape, PassengerCarryingRequirementsView, TimingAlgorithmType, TypeOfTariff, LinkSequenceProjection, BeaconPoint, TypeOfLinkSequence, JourneyAccounting, GroupOfServices, ShelterEquipment, CustomerAccount, ManagementAgent, TimetableFrame, PricingParameterSet, TransferRestriction, VehicleTypeAtPoint, GroupOfTimingLinks, Refunding, FrequencyOfUse, DayType, DistanceMatrixElement, StopPlaceEntrance, Blacklist, ParkingComponent, ServicePattern, SalesOfferPackageEntitlementRequired, TrainBlockPart, FareTable, DestinationDisplay, ServiceLink, OtherOrganisation, ServiceFrame, SalesTransactionFrame, Connection, OvertakingPossibility, RetailDevice, RubbishDisposalEquipment, TypeOfJourneyPattern, ResponsibilitySet, EntitlementGiven, ServiceSite, TravelSpecification1, Timeband, CompoundTrain, ParkingPassengerEntrance, CappedDiscountRight, ServiceJourneyInterchange, TypeOfFareTable, Quay, ValidDuring, LuggageService, CateringService, QualityStructureFactor, WaitingRoomEquipment, TypeOfPricingRule, CustomerPurchasePackage, PurposeOfJourneyPartition, OfferedTravelSpecification, FareDayType, TypeOfLink, SitePathLink, AssistanceBookingService, GenericParameterAssignmentInContext, Point2, GroupOfOperators, DiscountingRule, PointOfInterestClassification, BorderPoint, OrganisationalUnit, TypeOfCongestion, TypeOfPaymentMethod, RailwayElement, TypeOfFareContractEntry, PathJunction, BlockPart, OrganisationPart, TypeOfFrame, RetailConsortium, TypeOfResponsibilityRole, FareZone, ControllableElement, TypeOfAccessRightAssignment, PassingTimeView, FareQuotaFactor, AccessVehicleEquipment, TypeOfConcession, ResourceFrame, TypeOfOrganisationPart, TemplateServiceJourney, DynamicStopAssignment, AdministrativeZone, TypeOfPoint, SeatingEquipment, TypeOfNotice, Submode, SalesOfferPackageElement, WheelchairVehicleEquipment, ServiceAccessRight1, CoupledJourney, PassengerSafetyEquipment, TariffZone, TypeOfProductCategory, ParkingPoint, StopPlaceVehicleEntrance, JourneyPart, NavigationPath, GenericParameterAssignment, TimeInterval, SupplementProduct, PointOfInterestClassificationHierarchy, PlaceLighting, EligibilityChangePolicy, PointProjection, ThirdPartyProduct, ComplaintsService, DriverTripTime, ServiceJourneyPattern, TypeOfProjection, FareStructureFactor, JourneyMeeting, TypeOfMachineReadability, Branding, PlaceSign, GeneralSign, FulfilmentMethod, TypeOfService, PurchaseWindow, ActivationPoint, CommunicationService, TrainNumber, GeneralZone, Route, Interchanging, FlexibleLine, PurposeOfEquipmentProfile, ServiceJourneyPatternInterchange, DatedSpecialService, GroupOfPlaces, AllowedLineDirection, TopographicProjection, CommercialProfile, PenaltyPolicy, AvailabilityCondition, HelpPointEquipment, TravelAgent, CappingRule, EquipmentPosition, OperationalContext, VehicleType, TrainBlock, SaleDiscountRight, PointOfInterestEntrance, VehicleChargingEquipment, ComplexFeatureProjection, Subscribing, HailAndRideArea, Transferability, TemplateVehicleJourney, CheckConstraintDelay, TypeOfCustomerAccount, Parking, InfrastructureFrame, CustomerPurchaseParameterAssignment, PassengerCarryingRequirement, Cancelling, SchematicMap, RoadJunction]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class FramesRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[DriverScheduleFrame, ResourceFrame, GeneralFrame, TimetableFrame, FareFrame, InfrastructureFrame, ServiceCalendarFrame, VehicleScheduleFrame, ServiceFrame, SalesTransactionFrame, SiteFrame]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
