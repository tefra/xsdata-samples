...
class EntitiesInVersionRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[ResidentialQualificationEligibility, CommercialProfileEligibility, UserProfileEligibility, CustomerEligibility, ResidentialQualification, AccessRightInProduct, FareStructureElementInSequence, StartTimeAtStopPoint, ControllableElementInSequence, FareElementInSequence, Cell, CustomerPurchasePackagePrice, ParkingPrice, SalesOfferPackagePrice, FulfilmentMethodPrice, CappingRulePrice, FareProductPrice, FareStructureElementPrice, TimeIntervalPrice, TimeUnitPrice, QualityStructureFactorPrice, ControllableElementPrice, ValidableElementPrice, UsageParameterPrice, DistanceMatrixElementPrice, GeographicalIntervalPrice, GeographicalUnitPrice, SeriesConstraintPrice, DefaultDeadRunRunTime, DefaultServiceJourneyRunTime, TimeDemandProfileMember, JourneyPartPosition, EstimatedPassingTime, ObservedPassingTime, TargetPassingTime, DatedPassingTime, TimetabledPassingTime, PassingTime, InterchangeRuleTiming, ParkingCapacity, ParkingProperties, VehicleTypePreference, VehiclePositionAlignment, VehicleQuayAlignment, StairFlight, FlexiblePointProperties, FlexibleLinkProperties, JourneyPatternHeadway, JourneyPatternLayover, JourneyPatternRunTime, JourneyPatternWaitTime, TurnaroundTimeLimitTime, VehicleJourneyLayover, VehicleJourneyRunTime, VehicleJourneyWaitTime, VehicleJourneyHeadway, JourneyHeadway, JourneyLayover, JourneyRunTime, JourneyWaitTime, TravelDocumentSecurityListing, RetailDeviceSecurityListing, FareContractSecurityListing, CustomerSecurityListing, CustomerAccountSecurityListing, OnboardStay, Accommodation, ServiceLinkInJourneyPattern, PathLinkInSequence, LinkInJourneyPattern, TimingLinkInJourneyPattern, FarePointInPattern, StopPointInJourneyPattern, PlaceInSequence, PointInJourneyPattern, PointOnRoute, TimingPointInJourneyPattern, PointOnLineSection, PointOnSection, SectionInSequence, LinkOnSection, CodespaceAssignment, PointOnLink, AccessibilityAssessment, AlternativeName, GroupConstraintMember, AlternativeText, TravelDocument, CustomerAccount, SalesTransaction, OfferedTravelSpecification, RequestedTravelSpecification, TravelSpecification1, TravelSpecification2, FareContractEntry, FareContract, Customer, ParkingTariff, GroupOfSalesOfferPackages, DistributionChannel, Tariff, CustomerPurchasePackage, SalesOfferPackage, FulfilmentMethod, CappingRule, EntitlementProduct, SupplementProduct, PreassignedFareProduct, AmountOfPriceUnitProduct, CappedDiscountRight, UsageDiscountRight, ThirdPartyProduct, SaleDiscountRight, ServiceAccessRight1, ServiceAccessRight2, TimeInterval, FareQuotaFactor, FareDemandFactor, QualityStructureFactor, ControllableElement, ValidableElement, SalesOfferPackageEntitlementRequired, SalesOfferPackageEntitlementGiven, MinimumStay, Interchanging, Suspending, UsageValidityPeriod, FrequencyOfUse, StepLimit, Routing, RoundTrip, LuggageAllowance, EntitlementRequired, EntitlementGiven, EligibilityChangePolicy, CompanionProfile, GroupTicket, CommercialProfile, UserProfile, Subscribing, PenaltyPolicy, ChargingPolicy, Cancelling, Reserving, PurchaseWindow, Transferability, Replacing, Refunding, Exchanging, Reselling, GeographicalInterval, SeriesConstraint, CustomerPurchasePackageElement, ParkingChargeBand, SalesOfferPackageElement, FareStructureElement, TimeStructureFactor, TimeUnit, DistanceMatrixElement, GeographicalStructureFactor, GeographicalUnit, FareUnit, FareInterval, FareStructureFactor, PricingService, LimitingRuleInContext, LimitingRule, DiscountingRule, PricingRule, MonthValidityOffset, Rounding, PricingParameterSet, ReliefOpportunity, CourseOfJourneys, VehicleServicePart, VehicleService, TrainBlockPart, CompoundBlock, BlockPart, TrainBlock, Block, DriverTripTime, DriverTrip, DutyPart, AccountableElement, Duty, TimeDemandProfile, FlexibleServiceProperties, VehicleTypeStopAssignment, TrainComponentLabelAssignment, TrainNumber, DatedSpecialService, NormalDatedVehicleJourney, DatedVehicleJourney, SpecialService, DeadRun, ServiceJourney, DatedServiceJourney, TemplateServiceJourney, TemplateVehicleJourney, VehicleJourney, JourneyPartCouple, CoupledJourney, JourneyPart, InterchangeRule, ServiceJourneyPatternInterchange, ServiceJourneyInterchange, DefaultInterchange, JourneyMeeting, PointOfInterestClassificationHierarchy, TimeDemandType, FlexibleStopAssignment, VehicleJourneyStopAssignment, NavigationPathAssignment, TrainStopAssignment, DynamicStopAssignment, PassengerStopAssignment, LogicalDisplay, Level, LineNetwork, RouteInstruction, AllowedLineDirection, DestinationDisplayVariant, DestinationDisplay, FlexibleLine, Line, OperationalContext, TrainComponent, TrainElement, CompoundTrain, Train, VehicleEquipmentProfile, VehicleModel, Vehicle, PassengerCarryingRequirementsView, FacilityRequirement, VehicleManoeuvringRequirement, PassengerCarryingRequirement, VehicleType, Whitelist, Blacklist, SchematicMap, DeliveryVariant, Notice, EquipmentPosition, AssistanceBookingService, CateringService, RetailService, MoneyService, HireService, CommunicationService, MeetingPointService, LostPropertyService, LeftLuggageService, ComplaintsService, CustomerService, LuggageService, AssistanceService, TicketingService, RetailDevice, TicketValidatorEquipment, TicketingEquipment, SeatingEquipment, ShelterEquipment, TrolleyStandEquipment, WaitingRoomEquipment, CrossingEquipment, QueueingEquipment, EntranceEquipment, RampEquipment, LiftEquipment, TravelatorEquipment, StaircaseEquipment, EscalatorEquipment, PlaceLighting, RoughSurface, AccessEquipment, GeneralSign, HeadingSign, PlaceSign, SignEquipment, WheelchairVehicleEquipment, AccessVehicleEquipment, VehicleChargingEquipment, CycleStorageEquipment, PassengerInformationEquipment, RubbishDisposalEquipment, HelpPointEquipment, PassengerSafetyEquipment, SanitaryEquipment, ServicePattern, NavigationPath, ServiceJourneyPattern, DeadRunJourneyPattern, JourneyPattern, FlexibleRoute, Route, TimingPattern, Connection, DefaultConnection, SiteConnection, Access, OrganisationalUnit, ControlCentre, OperatingDepartment, Department, OrganisationPart, RetailConsortium, Authority, Operator, ServicedOrganisation, GeneralOrganisation, ManagementAgent, TravelAgent, OtherOrganisation, ServiceLink, SitePathLink, PathLink, RouteLink, TimingLink, WireElement, RoadElement, RailwayElement, ActivationLink, BorderPoint, FareScheduledStopPoint, ScheduledStopPoint, PathJunction, RoutePoint, ParkingPoint, GaragePoint, ReliefPoint, TimingPoint, WireJunction, RoadJunction, RailwayJunction, TrafficControlPoint, BeaconPoint, ActivationPoint, Point2, LineShape, TopographicProjection, ZoneProjection, ComplexFeatureProjection, LinkSequenceProjection, LinkProjection, PointProjection, "CompositeFrame", SalesTransactionFrame, FareFrame, DriverScheduleFrame, VehicleScheduleFrame, ServiceFrame, TimetableFrame, SiteFrame, InfrastructureFrame, "GeneralFrame", ResourceFrame, ServiceCalendarFrame, UicOperatingPeriod, OperatingPeriod, OperatingDay, ServiceCalendar, DistributionAssignment, SalesOfferPackageSubstitution, CustomerPurchaseParameterAssignment, SpecificParameterAssignment, GenericParameterAssignmentInContext, GenericParameterAssignment, ValidityParameterAssignment, AccessRightParameterAssignment, JourneyAccounting, TimeDemandTypeAssignment, TransferRestriction, ServiceExclusion, DisplayAssignment, CheckConstraintThroughput, CheckConstraintDelay, CheckConstraint, OvertakingPossibility, MeetingRestriction, RestrictedManoeuvre, VehicleTypeAtPoint, ActivationAssignment, SalesNoticeAssignment, NoticeAssignment, DayTypeAssignment, GroupOfTimebands, Timeband, FareDayType, OrganisationDayType, DayType, GroupOfDistributionChannels, GroupOfDistanceMatrixElements, PriceGroup, StandardFareTable, FareTableInContext, FareTable, GroupOfServices, RhythmicalJourneyGroup, HeadwayJourneyGroup, Network, GroupOfLines, CrewBase, GroupOfTimingLinks, GroupOfOperators, GroupOfPlaces, GroupOfLinkSequences, RoutingConstraintZone, StopArea, AccessZone, HailAndRideArea, FlexibleArea, FlexibleQuay, FlexibleStopPlace, VehicleStoppingPlace, BoardingPosition, AccessSpace, Quay, PointOfInterestSpace, ParkingBay, ParkingArea, ParkingComponent, VehicleStoppingPosition, PointOfInterestVehicleEntrance, PointOfInterestEntrance, ParkingPassengerEntrance, ParkingEntranceForVehicles, StopPlaceVehicleEntrance, StopPlaceEntrance, Entrance, PointOfInterest, Parking, StopPlace, ServiceSite, Garage, TopographicPlace, EquipmentPlace, Country, AddressablePlace, PostalAddress, RoadAddress, TransportAdministrativeZone, AdministrativeZone, FareZone, TariffZone, GeneralZone, Zone, GroupOfLinks, GroupOfPoints, Layer, GeneralGroupOfEntities, ResponsibilitySet, ValueSet, TypeOfMachineReadability, TypeOfConcession, ChargingMoment, TypeOfUsageParameter, TypeOfFareTable, TypeOfPricingRule, PriceUnit, TimingAlgorithmType, PurposeOfJourneyPartition, TypeOfServiceFeature, PointOfInterestClassification, Direction, PurposeOfEquipmentProfile, TypeOfSecurityList, TypeOfProductCategory, TypeOfPaymentMethod, ClassOfUse, Submode, OpenTransportMode, TypeOfCodespaceAssignment, TypeOfValidity, PurposeOfGrouping, Branding, DataSource, TypeOfRetailDevice, CustomerAccountStatus, TypeOfCustomerAccount, TypeOfFareContractEntry, TypeOfFareContract, TypeOfTravelDocument, TypeOfSalesOfferPackage, TypeOfFareProduct, TypeOfFareStructureElement, TypeOfTariff, TypeOfAccessRightAssignment, TypeOfFareStructureFactor, TypeOfFlexibleService, TypeOfTimeDemandType, TypeOfPassengerInformationEquipment, TypeOfCongestion, TypeOfJourneyPattern, TypeOfLine, TypeOfActivation, TypeOfDeliveryVariant, TypeOfNotice, TypeOfFacility, TypeOfService, TypeOfEquipment, TypeOfFeature, TypeOfLinkSequence, TypeOfPlace, TypeOfTransfer, TypeOfOperation, TypeOfOrganisationPart, TypeOfOrganisation, TypeOfZone, TypeOfLink, TypeOfPoint, TypeOfProjection, TypeOfFrame, TypeOfResponsibilityRole, TypeOfEntity, TypeOfVersion, PassingTimeView, SimpleAvailabilityCondition, ValidDuring, AvailabilityCondition, ValidityRuleParameter, ValidityTrigger, ValidityCondition, Version]] = field(
...
class GeneralFrameMembersRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[GeneralFrameMember, TravelDocument, CustomerAccount, SalesTransaction, OfferedTravelSpecification, RequestedTravelSpecification, TravelSpecification1, TravelSpecification2, FareContractEntry, FareContract, Customer, ParkingTariff, GroupOfSalesOfferPackages, DistributionChannel, Tariff, CustomerPurchasePackage, SalesOfferPackage, FulfilmentMethod, CappingRule, EntitlementProduct, SupplementProduct, PreassignedFareProduct, AmountOfPriceUnitProduct, CappedDiscountRight, UsageDiscountRight, ThirdPartyProduct, SaleDiscountRight, ServiceAccessRight1, ServiceAccessRight2, TimeInterval, FareQuotaFactor, FareDemandFactor, QualityStructureFactor, ControllableElement, ValidableElement, SalesOfferPackageEntitlementRequired, SalesOfferPackageEntitlementGiven, MinimumStay, Interchanging, Suspending, UsageValidityPeriod, FrequencyOfUse, StepLimit, Routing, RoundTrip, LuggageAllowance, EntitlementRequired, EntitlementGiven, EligibilityChangePolicy, CompanionProfile, GroupTicket, CommercialProfile, UserProfile, Subscribing, PenaltyPolicy, ChargingPolicy, Cancelling, Reserving, PurchaseWindow, Transferability, Replacing, Refunding, Exchanging, Reselling, GeographicalInterval, SeriesConstraint, CustomerPurchasePackageElement, ParkingChargeBand, SalesOfferPackageElement, FareStructureElement, TimeStructureFactor, TimeUnit, DistanceMatrixElement, GeographicalStructureFactor, GeographicalUnit, FareUnit, FareInterval, FareStructureFactor, PricingService, LimitingRuleInContext, LimitingRule, DiscountingRule, PricingRule, MonthValidityOffset, Rounding, PricingParameterSet, ReliefOpportunity, CourseOfJourneys, VehicleServicePart, VehicleService, TrainBlockPart, CompoundBlock, BlockPart, TrainBlock, Block, DriverTripTime, DriverTrip, DutyPart, AccountableElement, Duty, TimeDemandProfile, FlexibleServiceProperties, VehicleTypeStopAssignment, TrainComponentLabelAssignment, TrainNumber, DatedSpecialService, NormalDatedVehicleJourney, DatedVehicleJourney, SpecialService, DeadRun, ServiceJourney, DatedServiceJourney, TemplateServiceJourney, TemplateVehicleJourney, VehicleJourney, JourneyPartCouple, CoupledJourney, JourneyPart, InterchangeRule, ServiceJourneyPatternInterchange, ServiceJourneyInterchange, DefaultInterchange, JourneyMeeting, PointOfInterestClassificationHierarchy, TimeDemandType, FlexibleStopAssignment, VehicleJourneyStopAssignment, NavigationPathAssignment, TrainStopAssignment, DynamicStopAssignment, PassengerStopAssignment, LogicalDisplay, Level, LineNetwork, RouteInstruction, AllowedLineDirection, DestinationDisplayVariant, DestinationDisplay, FlexibleLine, Line, OperationalContext, TrainComponent, TrainElement, CompoundTrain, Train, VehicleEquipmentProfile, VehicleModel, Vehicle, PassengerCarryingRequirementsView, FacilityRequirement, VehicleManoeuvringRequirement, PassengerCarryingRequirement, VehicleType, Whitelist, Blacklist, SchematicMap, DeliveryVariant, Notice, EquipmentPosition, AssistanceBookingService, CateringService, RetailService, MoneyService, HireService, CommunicationService, MeetingPointService, LostPropertyService, LeftLuggageService, ComplaintsService, CustomerService, LuggageService, AssistanceService, TicketingService, RetailDevice, TicketValidatorEquipment, TicketingEquipment, SeatingEquipment, ShelterEquipment, TrolleyStandEquipment, WaitingRoomEquipment, CrossingEquipment, QueueingEquipment, EntranceEquipment, RampEquipment, LiftEquipment, TravelatorEquipment, StaircaseEquipment, EscalatorEquipment, PlaceLighting, RoughSurface, AccessEquipment, GeneralSign, HeadingSign, PlaceSign, SignEquipment, WheelchairVehicleEquipment, AccessVehicleEquipment, VehicleChargingEquipment, CycleStorageEquipment, PassengerInformationEquipment, RubbishDisposalEquipment, HelpPointEquipment, PassengerSafetyEquipment, SanitaryEquipment, ServicePattern, NavigationPath, ServiceJourneyPattern, DeadRunJourneyPattern, JourneyPattern, FlexibleRoute, Route, TimingPattern, Connection, DefaultConnection, SiteConnection, Access, OrganisationalUnit, ControlCentre, OperatingDepartment, Department, OrganisationPart, RetailConsortium, Authority, Operator, ServicedOrganisation, GeneralOrganisation, ManagementAgent, TravelAgent, OtherOrganisation, ServiceLink, SitePathLink, PathLink, RouteLink, TimingLink, WireElement, RoadElement, RailwayElement, ActivationLink, BorderPoint, FareScheduledStopPoint, ScheduledStopPoint, PathJunction, RoutePoint, ParkingPoint, GaragePoint, ReliefPoint, TimingPoint, WireJunction, RoadJunction, RailwayJunction, TrafficControlPoint, BeaconPoint, ActivationPoint, Point2, LineShape, TopographicProjection, ZoneProjection, ComplexFeatureProjection, LinkSequenceProjection, LinkProjection, PointProjection, "CompositeFrame", SalesTransactionFrame, FareFrame, DriverScheduleFrame, VehicleScheduleFrame, ServiceFrame, TimetableFrame, SiteFrame, InfrastructureFrame, "GeneralFrame", ResourceFrame, ServiceCalendarFrame, UicOperatingPeriod, OperatingPeriod, OperatingDay, ServiceCalendar, DistributionAssignment, SalesOfferPackageSubstitution, CustomerPurchaseParameterAssignment, SpecificParameterAssignment, GenericParameterAssignmentInContext, GenericParameterAssignment, ValidityParameterAssignment, AccessRightParameterAssignment, JourneyAccounting, TimeDemandTypeAssignment, TransferRestriction, ServiceExclusion, DisplayAssignment, CheckConstraintThroughput, CheckConstraintDelay, CheckConstraint, OvertakingPossibility, MeetingRestriction, RestrictedManoeuvre, VehicleTypeAtPoint, ActivationAssignment, SalesNoticeAssignment, NoticeAssignment, DayTypeAssignment, GroupOfTimebands, Timeband, FareDayType, OrganisationDayType, DayType, GroupOfDistributionChannels, GroupOfDistanceMatrixElements, PriceGroup, StandardFareTable, FareTableInContext, FareTable, GroupOfServices, RhythmicalJourneyGroup, HeadwayJourneyGroup, Network, GroupOfLines, CrewBase, GroupOfTimingLinks, GroupOfOperators, GroupOfPlaces, GroupOfLinkSequences, RoutingConstraintZone, StopArea, AccessZone, HailAndRideArea, FlexibleArea, FlexibleQuay, FlexibleStopPlace, VehicleStoppingPlace, BoardingPosition, AccessSpace, Quay, PointOfInterestSpace, ParkingBay, ParkingArea, ParkingComponent, VehicleStoppingPosition, PointOfInterestVehicleEntrance, PointOfInterestEntrance, ParkingPassengerEntrance, ParkingEntranceForVehicles, StopPlaceVehicleEntrance, StopPlaceEntrance, Entrance, PointOfInterest, Parking, StopPlace, ServiceSite, Garage, TopographicPlace, EquipmentPlace, Country, AddressablePlace, PostalAddress, RoadAddress, TransportAdministrativeZone, AdministrativeZone, FareZone, TariffZone, GeneralZone, Zone, GroupOfLinks, GroupOfPoints, Layer, GeneralGroupOfEntities, ResponsibilitySet, ValueSet, TypeOfMachineReadability, TypeOfConcession, ChargingMoment, TypeOfUsageParameter, TypeOfFareTable, TypeOfPricingRule, PriceUnit, TimingAlgorithmType, PurposeOfJourneyPartition, TypeOfServiceFeature, PointOfInterestClassification, Direction, PurposeOfEquipmentProfile, TypeOfSecurityList, TypeOfProductCategory, TypeOfPaymentMethod, ClassOfUse, Submode, OpenTransportMode, TypeOfCodespaceAssignment, TypeOfValidity, PurposeOfGrouping, Branding, DataSource, TypeOfRetailDevice, CustomerAccountStatus, TypeOfCustomerAccount, TypeOfFareContractEntry, TypeOfFareContract, TypeOfTravelDocument, TypeOfSalesOfferPackage, TypeOfFareProduct, TypeOfFareStructureElement, TypeOfTariff, TypeOfAccessRightAssignment, TypeOfFareStructureFactor, TypeOfFlexibleService, TypeOfTimeDemandType, TypeOfPassengerInformationEquipment, TypeOfCongestion, TypeOfJourneyPattern, TypeOfLine, TypeOfActivation, TypeOfDeliveryVariant, TypeOfNotice, TypeOfFacility, TypeOfService, TypeOfEquipment, TypeOfFeature, TypeOfLinkSequence, TypeOfPlace, TypeOfTransfer, TypeOfOperation, TypeOfOrganisationPart, TypeOfOrganisation, TypeOfZone, TypeOfLink, TypeOfPoint, TypeOfProjection, TypeOfFrame, TypeOfResponsibilityRole, TypeOfEntity, TypeOfVersion, PassingTimeView, SimpleAvailabilityCondition, ValidDuring, AvailabilityCondition, ValidityRuleParameter, ValidityTrigger, ValidityCondition, Version, EntityEntity]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class FramesRelStructure(ContainmentAggregationStructure):
    ...
    choice: List[Union[SalesTransactionFrame, FareFrame, DriverScheduleFrame, VehicleScheduleFrame, ServiceFrame, TimetableFrame, SiteFrame, InfrastructureFrame, GeneralFrame, ResourceFrame, ServiceCalendarFrame]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
