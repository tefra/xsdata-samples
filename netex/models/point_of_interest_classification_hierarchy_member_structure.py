...
class PointOfInterestClassificationHierarchyMemberStructure(VersionedChildStructure):
    ...
    parent_classification_ref: Optional[PointOfInterestClassificationRefStructure] = field(
        default=None,
        metadata={
    ...
    point_of_interest_classification_ref: Optional[PointOfInterestClassificationRefStructure] = field(
        default=None,
        metadata={
