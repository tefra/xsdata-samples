...
class TimetabledPassingTimeVersionedChildStructure(
    ...
    latest_arrival_time: None | XmlTime = field(
        default=None,
        metadata={
    ...
    latest_arrival_day_offset: None | int = field(
        default=None,
        metadata={
    ...
    earliest_departure_time: None | XmlTime = field(
        default=None,
        metadata={
    ...
    earliest_departure_day_offset: None | int = field(
        default=None,
        metadata={
