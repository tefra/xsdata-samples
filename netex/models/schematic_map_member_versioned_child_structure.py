...
class SchematicMapMemberVersionedChildStructure(VersionedChildStructure):
    ...
    choice_1: Optional[Union[TopographicProjection, ZoneProjection, ComplexFeatureProjection, LinkSequenceProjection, LinkProjection, PointProjection]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
