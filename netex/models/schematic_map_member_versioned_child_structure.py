...
class SchematicMapMemberVersionedChildStructure(VersionedChildStructure):
    ...
    choice_1: Optional[Union[PointProjection, LinkSequenceProjection, ComplexFeatureProjection, LinkProjection, ZoneProjection, TopographicProjection]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
