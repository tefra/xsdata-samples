...
class SchematicMapMemberVersionedChildStructure(VersionedChildStructure):
    ...
    projection: TopographicProjection | ZoneProjection | ComplexFeatureProjection | LinkSequenceProjection | LinkProjection | PointProjection | None = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
