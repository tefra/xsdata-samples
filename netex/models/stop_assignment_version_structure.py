...
class StopAssignmentVersionStructure(AssignmentVersionStructure1):
    ...
    fare_scheduled_stop_point_ref_or_scheduled_stop_point_ref_or_scheduled_stop_point: Optional[Union[ScheduledStopPointRef, ScheduledStopPoint, FareScheduledStopPointRef]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
