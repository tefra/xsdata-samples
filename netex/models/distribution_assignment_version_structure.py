...
class DistributionAssignmentVersionStructure(AssignmentVersionStructure2):
    ...
    all_countries_ref_or_country_ref: None | AllCountriesRef | CountryRef = (
        field(
            default=None,
            metadata={
                "type": "Elements",
    ...
    allowed_in_country: None | bool = field(
        default=None,
        metadata={
    ...
    allowed_in_channel: None | bool = field(
        default=None,
        metadata={
    ...
    restricted_to_channel: None | bool = field(
        default=None,
        metadata={
    ...
    mandatory_product: None | bool = field(
        default=None,
        metadata={
    ...
    initial_carrier: None | bool = field(
        default=None,
        metadata={
            "name": "InitialCarrier",
            "type": "Element",
    ...
    transit_carrier: None | bool = field(
        default=None,
        metadata={
            "name": "TransitCarrier",
            "type": "Element",
    ...
    requires_registration: None | bool = field(
        default=None,
        metadata={
