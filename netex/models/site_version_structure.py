...
class SiteVersionStructure(SiteElementVersionStructure):
    ...
    parent_site_ref: SiteRefStructure | None = field(
        default=None,
        metadata={
            "name": "ParentSiteRef",
            "type": "Element",
    ...
    adjacent_sites: SiteRefsRelStructure | None = field(
        default=None,
        metadata={
            "name": "adjacentSites",
            "type": "Element",
    ...
    contained_in_place_ref: TopographicPlaceRefStructure | None = field(
        default=None,
        metadata={
    ...
    levels: LevelsRelStructure | None = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.netex.org.uk/netex",
