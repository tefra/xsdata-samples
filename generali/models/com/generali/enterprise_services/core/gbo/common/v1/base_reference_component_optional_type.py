...
class BaseReferenceComponentOptionalType(BaseComponentType):
    ...
    identifier and a lifecycle state that reference another business
    object.</description>.
    ...
    ids: None | BaseReferenceComponentOptionalTypeIds = field(
        default=None,
        metadata={
            "name": "IDs",
            "type": "Element",
    ...
    categories: None | BaseReferenceComponentOptionalTypeCategories = field(
        default=None,
        metadata={
            "name": "Categories",
            "type": "Element",
