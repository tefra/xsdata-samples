...
class DateTimeType:
    ...
    mponentsTechnicalSpecification:2">UNDT000004</ns1:UniqueID> <ns1:Acronym xmlns:
    ...
    ncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">Date
    Time.
    ...
    <ns1:PrimaryRepresentationTerm xmlns:ns1="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">Date Time</ns1:PrimaryRepresentationTerm>
    <ns1:PrimitiveType xmlns:ns1="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">dateTime</ns1:PrimitiveType>
    """
