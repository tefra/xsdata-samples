...
class PercentType:
    ...
    dard:CoreComponentsTechnicalSpecification:2">Percent.
    ...
    <ns1:Definition xmlns:ns1="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">A particular percentage, a ratio of two measures.</ns1:Definition>
