...
class QuantityType:
    """
    <ns1:UniqueID
    xmlns:ns1="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">UNDT000009</ns1:UniqueID>
    <ns1:Acronym
    ...
    counted number of non-monetary units possibly including
    fractions.</ns1:Definition> <ns1:PrimaryRepresentationTerm
    xmlns:ns1="urn:un:unece:uncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">Quantity</ns1:PrimaryRepresentationTerm>
    <ns1:PrimitiveType
