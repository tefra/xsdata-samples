...
class QuantityType:
    ...
    mponentsTechnicalSpecification:2">UNDT000009</ns1:UniqueID> <ns1:Acronym xmlns:
    ...
    ncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">Quantity
    .
