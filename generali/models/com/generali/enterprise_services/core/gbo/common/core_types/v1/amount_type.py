...
class AmountType:
    ...
    mponentsTechnicalSpecification:2">UNDT000001</ns1:UniqueID> <ns1:Acronym xmlns:
    ...
    ncefact:documentation:standard:CoreComponentsTechnicalSpecification:2">Amount.
