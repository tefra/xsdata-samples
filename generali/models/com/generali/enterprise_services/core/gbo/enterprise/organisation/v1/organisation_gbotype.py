...
class OrganisationGbotype:
    ...
    ultimate_gunsname: None | str = field(
        default=None,
        metadata={
    ...
    ultimate_dunsnumber: None | str = field(
        default=None,
        metadata={
    ...
    national_idtype: None | str = field(
        default=None,
        metadata={
            "name": "NationalIDType",
            "type": "Element",
    ...
    out_of_business: None | bool = field(
        default=None,
        metadata={
            "name": "OutOfBusiness",
            "type": "Element",
    ...
    party_roles: None | OrganisationGbotypePartyRoles = field(
        default=None,
        metadata={
            "name": "PartyRoles",
            "type": "Element",
    ...
    user_last_change_by: None | str = field(
        default=None,
        metadata={
