...
from generali.models.com.generali.enterprise_services.core.gbo.enterprise.agreement.v1.pricing_interest_type_amount_types import PricingInterestTypeAmountTypes
