...
from generali.models.com.generali.enterprise_services.core.gbo.enterprise.agreement.v1.underwriter_role_type import UnderwriterRoleType
...
class UnderwriterInvolvement(ContactInvolvement):
    underwriter_role: Optional[UnderwriterRoleType] = field(
        default=None,
        metadata={
