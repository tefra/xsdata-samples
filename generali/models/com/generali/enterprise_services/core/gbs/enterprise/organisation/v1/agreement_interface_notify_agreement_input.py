...
from generali.models.com.generali.enterprise_services.core.gbs.enterprise.organisation.v1.agreement_interface_notify_agreement_input_body import AgreementInterfaceNotifyAgreementInputBody
