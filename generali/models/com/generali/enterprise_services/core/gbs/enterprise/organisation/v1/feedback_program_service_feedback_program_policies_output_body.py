...
from generali.models.com.generali.enterprise_services.core.gbs.enterprise.organisation.v1.feedback_program_service_feedback_program_policies_output_body_fault import FeedbackProgramServiceFeedbackProgramPoliciesOutputBodyFault
...
class FeedbackProgramServiceFeedbackProgramPoliciesOutputBody:
    ...
    fault: Optional[FeedbackProgramServiceFeedbackProgramPoliciesOutputBodyFault] = field(
        default=None,
        metadata={
            "name": "Fault",
            "type": "Element",
